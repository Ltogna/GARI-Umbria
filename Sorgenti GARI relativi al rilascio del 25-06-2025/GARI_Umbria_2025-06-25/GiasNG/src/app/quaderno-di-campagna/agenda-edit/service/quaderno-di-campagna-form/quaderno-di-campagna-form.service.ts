...
import {PKImpianto} from 'app/Model/anagrafiche/Impianto';
...
export class QdCFormService {
    ...
    setTestataVisitaModel(listaAttivita: Attivita[], qdCFormModel: QdCFormModel) {
        ...
        if (this.objParametriAgenda.Lav_Cod === enum_LAVCOD.VISITA) {   //aggiunto set del flag
            ...
            qdCFormModel.Trattamento.Testata.TestataVisita.impOrarioFine_Visita = (this.permessiUtenteService.getImpostazione_SuperUser(enum_Impostazioni_Utenti.SUPERUSER_UTILIZZO_ORARI_INIZIO_FINE)) ? +this.permessiUtenteService.getImpostazione_SuperUser(enum_Impostazioni_Utenti.SUPERUSER_UTILIZZO_ORARI_INIZIO_FINE).Valore : 1;
            let nrOreVisita = (this.permessiUtenteService.getImpostazione_SuperUser(enum_Impostazioni_Utenti.SUPERUSER_NR_ORE_VISITA)) ? +this.permessiUtenteService.getImpostazione_SuperUser(enum_Impostazioni_Utenti.SUPERUSER_NR_ORE_VISITA).Valore : 1;
            ...
            if (this.objParametriAgenda.TipoOperazioneDB === Enum_DBTypeOperation.Update) {
                ...
                let impStatoVisita = this.permessiUtenteService.getImpostazione_SuperUser(enum_Impostazioni_Utenti.SUPERUSER_STATO_VISITA);
            ...
            if (!qdCFormModel.Trattamento.Testata.flagVisita) {     //se arrivo dal menu Visite, non popolo le griglie degli operatori e delle macchine
                ...
                if(risorse && risorse.length > 0){
                    risorse.forEach((risorsa: Risorsa)=>{
                        ...
                        this.setGridMacchineModel(risorsaMacchina, qdCFormModel);
                    });
                }
              ...
              this.gestionerichiesteservice.ObjPageToMemorize.QdCFormValue && this.gestionerichiesteservice.ObjPageToMemorize.objParametriAgenda){
                ...
                if(ObjPageToMemorize.QdCFormValue){
                    ...
                    if(qdCFormModel?.Trattamento?.Testata?.Operazioni?.length === 1 &&
                        qdCFormModel?.Trattamento?.Testata?.Operazioni?.findIndex(o=>+ o.primaryKey.codice === enum_LAVCOD.CONFUSIONE_DISORIENTAMENTO_SESSUALE ||
                                                                                                + o.primaryKey.codice === enum_LAVCOD.TRATTAMENTO_POST_RACCOLTA ||
                                                                                                + o.primaryKey.codice === enum_LAVCOD.CONCIA_SEME) > -1){
    ...
    private setTestataModel(
        ...
        if(TipoOperazioneDB === Enum_DBTypeOperation.Write) {
            ...
            qdCFormModel.Trattamento.Testata.Data = new Date();
            ...
            qdCFormModel.Trattamento.Testata.Ora = new Date(new Date().setHours(0, 0, 0, 0));
        } else {

            if(listaAttivita.length > 0) {

                //Per i dati in comune da assegnare al QdCFormModel prendo il primo elemento della listaAttivita
                qdCFormModel.Trattamento.Testata.Data = listaAttivita[0].inizio;
    ...
    private setGridImpiantiSelezionatiModel(listaAttivita: Attivita[], qdCFormModel: QdCFormModel){
            ...
            if(attivita.centriDiCosto){
                attivita.centriDiCosto.forEach(esercizioCDC => {
                    if (esercizioCDC.classType === "EsercizioCDC") {
                        ...
                        if(PKesercizio > 0 &&
                          PKimpianto.codice > 0 &&
                          PKappezzamento.codice > 0 &&
                          PKcentroAziendale.codice > 0 &&
                          PKcentroAziendale.partitaIva !== ""){

                          //Inserisco l'impianto solo se non è già presente
                          if(qdCFormModel.Trattamento.Impianti.ImpiantiSelezionati.findIndex(i=>i.PIVA === PKcentroAziendale.partitaIva &&
                            i.SA_COD === PKcentroAziendale.codice &&
                            i.APPEZZA === PKappezzamento.codice &&
                            i.ID_REG === PKimpianto.codice &&
                            i.Progetto_Cod === PKesercizio) === -1){
        ...
        if(Sup_Trattata > 0){
            ...
            qdCFormModel.Trattamento.Superfici.Sup_Trattata = this.funzionicomuniservice.roundNumber(Sup_Trattata,this.qdcservice.Obj_Default_Numeric_Settings.decimals);
            qdCFormModel.Trattamento.Superfici.Sup_Selezionata = this.funzionicomuniservice.roundNumber(Sup_Trattata,this.qdcservice.Obj_Default_Numeric_Settings.decimals);
        }
    ...
    private setGridMacchineModel(risorsaMacchina: RisorsaMacchina, qdCFormModel: QdCFormModel){
    ...
    private setAcquaModel(listaAttivita: Attivita[],qdCFormModel: QdCFormModel){
        ...
        if(flag_risorsa_acqua){
            ...
            if(Dose_Acqua === DoseAcqua.HA){
                qdCFormModel.Trattamento.Acqua.Acqua_Ha = this.funzionicomuniservice.roundNumber(Acqua_Ha,this.qdcservice.Obj_Default_Numeric_Settings.decimals);
                qdCFormModel.Trattamento.Acqua.Acqua_Tot = this.funzionicomuniservice.roundNumber((qdCFormModel.Trattamento.Superfici.Sup_Trattata * Acqua_Ha),this.qdcservice.Obj_Default_Numeric_Settings.decimals);
            }else if(Dose_Acqua === DoseAcqua.TOTALE){
                qdCFormModel.Trattamento.Acqua.Acqua_Tot = this.funzionicomuniservice.roundNumber(Acqua_Tot,this.qdcservice.Obj_Default_Numeric_Settings.decimals);
                qdCFormModel.Trattamento.Acqua.Acqua_Ha = this.funzionicomuniservice.roundNumber((Acqua_Tot / qdCFormModel.Trattamento.Superfici.Sup_Trattata),this.qdcservice.Obj_Default_Numeric_Settings.decimals);
            }
    ...
    private setSezioneProdottoModel(
        ...
        if (
            ...
            if(Prodotto){
                ...
                ProdottoDaInserire = this.qdcservice.setCodDescrMultiColumnComboboxProdotto(elem_cod,ProdottoDaInserire);

                //Un solo prodotto uguale per ogni sezione prodotto
                let inserisci_prodotto_in_griglia: boolean = this.Controlla_Se_Inserire_Prodotto(sezione_prodotto,ProdottoDaInserire,lavorazione);

                if(inserisci_prodotto_in_griglia) {
                    //No MultiCentro
                    ...
                    if(MagazziniMovimentazioni && MagazziniMovimentazioni.length > 0) {
                        ...
                        MagazziniMovimentazioni.forEach((m: RilevamentoDiMagazzino) => {
                            ...
                            new_ProdottoDaInserire = this.qdcservice.setCodDescrMultiColumnComboboxProdotto(elem_cod,new_ProdottoDaInserire);
                            ...
                            const newRow = this.griddosiprodottiservice.getRigaGridDosiProdotti(
                                ...
                                Centro_Aziendale,
                                lavorazione,
                                qdCFormModel.Trattamento.Testata.Data,
                                flagTipoDose,
                            ...
                            listaAttivita_con_parametri_aggiuntivi.forEach(Attivita_con_parametri_aggiuntivi=> {
                                ...
                                if(
                                    ...
                                    switch(sezione_prodotto.Categoria_Magazzino) {
                                        case FORMULATI:
                                        case INSETTI:
                                            risorsaProdotto = (Attivita_con_parametri_aggiuntivi.risorse.filter(r=>r.classType === "DettaglioTrattamento") as DettaglioTrattamento[]).find(d=> { return this.Controlla_Se_Stesso_Formulato(d,dose_prodotto.Prodotto); }) as RisorsaProdotto;
                                            break;
                                        case FERTILIZZANTI:
                                    ...
                                    if(risorsaProdotto) {
                                        ...
                                        if(dose_prodotto.flagDoseQuantitaTotale === enum_doseQuantitaTotale.Qta_Totale) {
                                            ...
                                            risorsaProdotto.MagazziniMovimentazioni.forEach(rilevamentoMagazzino => {
                                                ...
                                                if(this.Controlla_Se_Stesso_Magazzino(dose_prodotto.Prodotto.MagazziniMovimentazioni,[rilevamentoMagazzino])) {
                    ...
                    if(
                        ...
                        sezione_prodotto.DosiProdotti.forEach(dose_prodotto => {
                            ...
                            if(dose_prodotto.flagDoseQuantitaTotale === enum_doseQuantitaTotale.Qta_Totale) {
                                ...
                                dose_prodotto.DoseTot_Ha = this.funzionicomuniservice.roundNumber(dose_prodotto.DoseTot_Ha, this.qdcservice.Obj_Default_Numeric_Settings.decimals);

                                let obj_Dose_ha_hl = this.misceleservice.calcola_dose_ha_hl_da_dose_tot(Dose_Ha, Dose_Hl,
                                    Sup_Trattata, flag_acqua,Acqua_Tot, DoseTot_Ha,Operazione);
                                ...
                                switch(dose_prodotto.flagTipoDose) {
                                    case enum_TipoMezzo.Ettaro:
                                        let obj_Dose_Hl_Tot = this.misceleservice.calcola_dose_hl_tot_ha_da_dose_ha(Dose_Hl, DoseTot_Ha,
                                            Dose_Ha,Sup_Trattata, flag_acqua, Acqua_Tot, Operazione);
                                    ...
                                    case enum_TipoMezzo.Ettolitro:
                                        let obj_Dose_Ha_Tot = this.misceleservice.calcola_dose_ha_tot_ha_da_dose_hl(Dose_Ha, DoseTot_Ha,
                                            Dose_Hl,Sup_Trattata, flag_acqua,Acqua_Tot);
    ...
    Controlla_Se_Inserire_Prodotto(
            ...
            switch (Categoria_Magazzino_Prodotto){
                ...
                case INSETTI:
                    ...
                    index = sezione_prodotto.DosiProdotti.findIndex(d=> d.Operazione.primaryKey.codice === Operazione.primaryKey.codice &&
                        this.Controlla_Se_Stesso_Formulato(d.Prodotto,ProdottoDaInserire_Trattamento));
                    break;
                case FERTILIZZANTI:
        ...
        if(index > -1)
            inserisci_prodotto = false;

        return inserisci_prodotto;
    }

    private Controlla_Se_Stesso_Formulato(formulato_1: DettaglioTrattamento | MultiColumnComboboxTrattamento, formulato_2: DettaglioTrattamento | MultiColumnComboboxTrattamento):boolean{
        ...
        if(formulato_1.prodotto.codice === formulato_2.prodotto.codice &&
            ...
            this.Controlla_Se_Stesso_Magazzino(formulato_1.MagazziniMovimentazioni,formulato_2.MagazziniMovimentazioni)){
    ...
    private Controlla_Se_Stesso_Fertilizzante(fertilizzante_1: DettaglioFertilizzazione | MultiColumnComboboxFertilizzazione, fertilizzante_2: DettaglioFertilizzazione | MultiColumnComboboxFertilizzazione):boolean{
        ...
        if(fertilizzante_1.prodotto.codice === fertilizzante_2.prodotto.codice &&
            this.Controlla_Se_Stesso_Magazzino(fertilizzante_1.MagazziniMovimentazioni,fertilizzante_2.MagazziniMovimentazioni)){
    ...
    private Controlla_Se_Stessa_Semente(semente_1: DettaglioSemina | MultiColumnComboboxSemina, semente_2: DettaglioSemina | MultiColumnComboboxSemina): boolean{
        ...
        if(semente_1.prodotto.codice === semente_2.prodotto.codice &&
            ...
            this.Controlla_Se_Stesso_Magazzino(semente_1.MagazziniMovimentazioni,semente_2.MagazziniMovimentazioni)){
    ...
    private Controlla_Se_Stesso_Magazzino(magazzini_movimentazioni_1: RilevamentoDiMagazzino[],magazzini_movimentazioni_2: RilevamentoDiMagazzino[]){
