...
export class GridProdottiDaTrattareHttpService extends AbstractGridConfigService<GridProdottiDaTrattareServerResult> {
  ...
  private kendoColumns: KendoGridColumn[] = [
    ...
    new KendoGridColumn({ field: 'partitaIva', title: '' }, { editable: false, hidden: true }),
    ...
    new KendoGridColumn({ field: 'qta', title: this.translocoService.translate('QtaTrattataQuintali') }, { editable: this.qdcservice.abilitaGrid, format: '{0:n4}', numeric: this.qdcservice.Obj_Default_Numeric_Settings }),
  ];
