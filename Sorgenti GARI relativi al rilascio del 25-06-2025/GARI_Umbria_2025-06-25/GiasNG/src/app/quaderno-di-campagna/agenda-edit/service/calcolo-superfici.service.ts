...
export class CalcoloSuperficiService {
    ...
    public ricalcoloSuperfici(dataItem:any):boolean {
        ...
        if(superfici_calcolate.SupRiduzioneBuffer < dataItem.Sup_Riduzione_BufferZone) {
            ...
            superfici_calcolate.Sup_Trattata = this.funzionicomuniservice.roundNumber((dataItem.Sup_Imp-dataItem.Sup_Riduzione_BufferZone),this.qdCService.Obj_Default_Numeric_Settings.decimals);
        }
        ...
        if(event){
            ...
            switch (colonna_editata){
                ...
                case "Perc_Riduzione_Deriva":
                    ...
                    //cambio la sup riduzione
                    dataItem.Sup_Riduzione_BufferZone = this.funzionicomuniservice.roundNumber((dataItem.Sup_Imp-superfici_calcolate.Sup_Trattata),this.qdCService.Obj_Default_Numeric_Settings.decimals);
    ...
    private calcolo(Sup_Imp: number, perc_riduzione_deriva: number, SupBZ_Riduzione: number,SupBZ_Riduzione_QdC: number, lunghezza: number): SupTrattata_SupRiduzioneBuffer {
        ...
        ret.Sup_Trattata = this.funzionicomuniservice.roundNumber((Sup_Imp-sup_rid),this.qdCService.Obj_Default_Numeric_Settings.decimals);
    ...
    private calcolaSupRid(buffer_min: number, perc_riduzione_deriva: number, SupBZ_Riduzione: number, lunghezza: number) {
        ...
        sup_rid = this.funzionicomuniservice.roundNumber((sup_rid/10000),this.qdCService.Obj_Default_Numeric_Settings.decimals);
        return sup_rid;
    }
    ...
    calcoloPercentualeAbbatimento(Sup_Imp: number,Sup_Imp_help:number){
        ...
        if (percAbb > 0 && percAbb < 100)
        {
            ...
            let supTrattabile = this.funzionicomuniservice.roundNumber(supImpianto * percAbb / 100 , this.qdCService.Obj_Default_Numeric_Settings.decimals);
