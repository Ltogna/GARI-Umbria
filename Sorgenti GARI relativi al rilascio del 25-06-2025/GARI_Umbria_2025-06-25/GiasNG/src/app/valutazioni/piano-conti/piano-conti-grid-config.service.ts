...
export class PianoContiHttpService extends AbstractGridConfigService<PianoContiKendoServerResult> {
    ...
    constructor(injector: Injector,
        ...
        this.columns = [
            ...
            new KendoGridColumn({ field: 'Piva', title: this.translocoService.translate('PartitaIVA') }, { resizable: true, editable: this.permessoEdit, hidden: true, media: '(min-width: ' + SMARTPHONE_WIDTH + 'px)', width: 120 }),
