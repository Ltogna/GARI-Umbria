...
export class ValutazioniHttpService extends AbstractGridConfigService<any> {
    ...
    constructor(injector: Injector,
        ...
        this.columns = [
            ...
            new KendoGridColumn({ field: 'Piva', title: this.translocoService.translate('PartitaIVA') }, { resizable: true, editable: this.permessoEdit, media: '(min-width: ' + SMARTPHONE_WIDTH + 'px)', width: 120 }),
