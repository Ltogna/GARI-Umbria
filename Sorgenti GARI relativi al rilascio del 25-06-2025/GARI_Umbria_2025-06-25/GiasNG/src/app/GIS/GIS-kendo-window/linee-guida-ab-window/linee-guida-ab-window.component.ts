...
import { Chiave_SalvaGrafica_Out, GisClient, RispostaStandard_1OfSalvaNuovoAB_Out, SalvaNuovoAB_In } from 'app/Service/api.service';
...
export class LineeGuidaABWindowComponent {
  ...
  private createMarkerOptions(feature: GeoJson_Feature_New<GeoJSONAgroGisProp>): google.maps.MarkerOptions {
  ...
  private getCenter(feature: GeoJson_Feature_New<GeoJSONAgroGisProp>): google.maps.LatLng | null {
