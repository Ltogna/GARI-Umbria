...
export class EditFeatureWindowService {
  ...
  public load(feature: GeoJson_Feature_New<GeoJSONAgroGisProp>): void {
  ...
  public update(feature: google.maps.Data.Feature, gMap: google.maps.Map): void {
    ...
    if (this.layerService.LayerSelected.getValue().Option_Value != enum_TipologiaLayer.Entita) {
      return;
    }
    ...
    google.maps.event.addListener(infoWindow, 'domready', () => {
      document.getElementById(`save-${id}`).onclick = () => {
        ...
        this.editFeatureService.editThisFeature(feature);
      };
