...
export class FeatureInformationService {
  ...
  private featuresById = new Map<string, GeoJson_Feature_New<GeoJSONAgroGisProp>>();
  ...
  public addFeatures(projection: google.maps.Projection, isTmp: boolean, ...features: GeoJson_Feature_New<GeoJSONAgroGisProp>[]): void {
    for (const feature of features) {
      ...
      const totalOriginalAreas = feature.properties.TotalOriginalArea;
      const totalOriginalFeatures = feature.properties.TotalOriginalFeatureNumber;
  ...
  public getById(id: string): GeoJson_Feature_New<GeoJSONAgroGisProp> | null {
  ...
  public getByLayer(layerId: string): GeoJson_Feature_New<GeoJSONAgroGisProp>[] {
    return [...this.featuresById.values()].filter(x => x.properties.layer == layerId);
  }

  public getByNode(layerId: string, nodeKey: string): GeoJson_Feature_New<GeoJSONAgroGisProp>[] {
  ...
  public getAll(): GeoJson_Feature_New<GeoJSONAgroGisProp>[] {
    const result = [];
