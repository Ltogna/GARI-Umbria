...
import {enum_FeatureProperty, enum_FeatureGeometryType} from '../GIS-enum/GIS-feature';
import {RetinaturaService} from './retinatura.service';
import {SharedDataService} from './shared-data.service';
import {FeatureType, GeoJSONAgroGisProp, GeoJson_Feature_New} from '../../Model/GIS/GisDataReadRval_New';
...
export class DataLayerStyleService {
    ...
    public getFeatureStyle(feature: GeoJson_Feature_New<GeoJSONAgroGisProp>): google.maps.Data.StyleOptions {
    ...
    private getDataLayerStyleWithScalaColori(f: GeoJson_Feature_New<GeoJSONAgroGisProp>, temaSelezionato: TemaSelezionato, scalaColori: DatiColoreTema[]): google.maps.Data.StyleOptions {
        let coloreTema = null;
    ...
    private handleDefault(feature: GeoJson_Feature_New<GeoJSONAgroGisProp>, coloreTema: string): google.maps.Data.StyleOptions {
    ...
    private handleInOsservazione(feature: GeoJson_Feature_New<GeoJSONAgroGisProp>, coloreTema: string): google.maps.Data.StyleOptions {
