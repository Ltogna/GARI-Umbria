...
import { ChiaveAlbero } from 'app/Service/api.service';
...
export class FeatureService {
    ...
    private featureSelezionate: GeoJson_Feature_New<GeoJSONAgroGisProp>[] = [];
    ...
    featureDaCopiare: GeoJson_Feature_New<GeoJSONAgroGisProp> = null;
    ...
    public setFeatureSelezionate(featureSelezionate: GeoJson_Feature_New<GeoJSONAgroGisProp>[]) {
        this.featureSelezionateSource.next(featureSelezionate);
    }

    public addFeatureSelezionata(feature: GeoJson_Feature_New<GeoJSONAgroGisProp>) {
        let featureSelezionate = this.getFeatureSelezionate();
        featureSelezionate.push(feature);
        this.featureSelezionateSource.next(featureSelezionate);
    }

    public removeFeatureSelezionata(feature: GeoJson_Feature_New<GeoJSONAgroGisProp>) {
    ...
    public getFeatureSelezionate(): GeoJson_Feature_New<GeoJSONAgroGisProp>[] {
        return this.featureSelezionateSource.getValue();
    }

    public getFeatureSelezionate$(): Observable<GeoJson_Feature_New<GeoJSONAgroGisProp>[]> {
        return this.featureSelezionateSource.asObservable();
    }

    public getFeatureSelezionataById(featureId: string): GeoJson_Feature_New<GeoJSONAgroGisProp> {
    ...
    public getChiaveAlberoCompletaByFeature(feature: GeoJson_Feature_New<GeoJSONAgroGisProp>) {
        const chiaveAlbero = feature.properties.chiavealbero;
        return FunzioniComuniService.chiaveAlberoRidottaToBig(chiaveAlbero);
    }

    public getObjChiaveAlberoByFeature(feature: GeoJson_Feature_New<GeoJSONAgroGisProp>): ChiaveAlbero {
    ...
    // Feature da copiare
    public setFeatureDaCopiare(feature: GeoJson_Feature_New<GeoJSONAgroGisProp>) {
        this.featureDaCopiareSource.next(feature);
    }

    public getFeatureDaCopiare(): GeoJson_Feature_New<GeoJSONAgroGisProp> {
    ...
    // Permessi
    public getPermessiFeature(feature: GeoJson_Feature_New<GeoJSONAgroGisProp>): PermessiFeature {
