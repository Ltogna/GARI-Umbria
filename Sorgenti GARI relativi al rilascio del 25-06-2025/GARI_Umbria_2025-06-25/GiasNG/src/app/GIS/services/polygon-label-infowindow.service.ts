...
export class PolygonLabelInfowindowService {
    ...
    private GestioneEtichettaEstraiTesto(etichetta: string, tipoEtichetta: number = 1): string {
    ...
    public createPolyLabelAssociatedInfoWindow(feature: GeoJson_Feature_New<GeoJSONAgroGisProp>): void {
        ...
        let etichettaTesto: string = '';
        if (feature.properties.etichetta == '' || feature.properties.etichetta == undefined) {
            etichettaTesto = this.GestioneEtichettaEstraiTesto(feature.properties.Testo);
        } else {
            etichettaTesto = this.formatLabel(feature.properties.etichetta);
        }
    ...
    public deletePolylabel(feature: GeoJson_Feature_New<GeoJSONAgroGisProp>): void {
        this.infoWindowClustererService.removePolyLabelAssociatedWithFeature(feature);
    }

    public catchPolygonChange(feature: GeoJson_Feature_New<GeoJSONAgroGisProp>): void {
