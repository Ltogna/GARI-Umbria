...
export class WidgetConfigComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.gestioneMultiAziendaService.nazioneMultiAziendaSubject.asObservable()
      .pipe(skip(1), takeUntilDestroyed())
      .subscribe(() => this.widgetConfigService.changeConfiguration(this.widgets));
    this.gestioneMultiAziendaService.annoMultiAziendaSubject.asObservable()
      .pipe(skip(1), takeUntilDestroyed())
      .subscribe(() => this.widgetConfigService.changeConfiguration(this.widgets));
  }
