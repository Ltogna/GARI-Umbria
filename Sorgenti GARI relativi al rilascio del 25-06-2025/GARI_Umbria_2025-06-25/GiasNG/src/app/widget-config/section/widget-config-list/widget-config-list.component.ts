...
export class WidgetConfigListComponent implements OnInit {
  ...
  protected widgetsMultiAzienda: boolean;
  ...
  private handleMultiCompanyChange(checked: boolean) {
    if (checked) {
      ...
      this.gestioneMultiAziendaService.annoSelezionatoMultiAzienda = this.gestioneMultiAziendaService.yearsList[0];
      this.gestioneMultiAziendaService.getCountriesListFromAPI();
    }

    this.widgetsMultiAzienda = checked;
