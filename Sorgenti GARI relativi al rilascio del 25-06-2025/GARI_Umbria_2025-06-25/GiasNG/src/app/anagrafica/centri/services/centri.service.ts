...
import { GiasIstatService, LoadingService } from 'gias-ui-kit';
...
export class CentriService {
  ...
  //     return this.http.post_legacy(ScriviCentroLink, postFn, true, false).pipe(take(1), tap(
  //         (e) => {loadingService.set_isLoading({ isLoading: false, component: gridElRef });}
  //     ))
  // }
