...
export class OperationsMassEditComponent implements OnInit {
    ...
    get attivitaSiMagazzino(): number[] {
        return [
            LAVCOD_TRATTAMENTO_ANTIPARASSITARIO, // 74
            LAVCOD_CONCIA_SEME, // 13
            LAVCOD_DISERBO, // 18
            LAVCOD_TRATTAMENTO_FITOREGOLATORE, // 103
            LAVCOD_DISTRIBUZIONE_INSETTI, // 16
            LAVCOD_CONFUSIONE_SESSUALE, // 118
            LAVCOD_DISORIENTAMENTO_SESSUALE, // 121
            LAVCOD_CATTURE_MASSA, // 122
            LAVCOD_GEODISINFESTAZIONE, // 155
            LAVCOD_DISSECCAMENTO, // 158
            LAVCOD_TRATTAMENTO_POST_RACCOLTA, // 163
            LAVCOD_INSTALLAZIONE_TRAPPOLE, // 107
            LAVCOD_REINNESCO_TRAPPOLE, // 150
            LAVCOD_FERTIRRIGAZIONE, // 26
            LAVCOD_DISTRIBUZIONE_CONCIME, // 14
            LAVCOD_CONCIMAZIONE_FOGLIARE, // 123
            LAVCOD_DISTRIBUZIONE_AMMENDANTI, // 124
            LAVCOD_SARCHIATURA_CONCIMAZIONE, // 156
            LAVCOD_TRATTAMENTO_ANTIBUTTERATURA // 106
        ];
    }
