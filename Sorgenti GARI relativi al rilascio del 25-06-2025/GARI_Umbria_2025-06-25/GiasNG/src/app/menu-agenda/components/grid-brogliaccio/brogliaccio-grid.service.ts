...
export class BrogliaccioGridConfig extends AbstractGridConfigService<KendoServerResult> {
  ...
  private permessoDocContab: boolean;
  ...
  constructor(
    ...
    let impostazioneSuperUser = this.permessiUtenteService.getImpostazione_SuperUser(enum_Impostazioni_Utenti.SUPERUSER_IMPEDISCI_INS_MOD_BROGLIACCIO);
  ...
  private getRemovalDecisionBtns(): Array<Actions> {
