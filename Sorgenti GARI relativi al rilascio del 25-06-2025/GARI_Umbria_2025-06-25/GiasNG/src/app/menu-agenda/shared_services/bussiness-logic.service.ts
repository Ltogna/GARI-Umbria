...
import {enum_ID_Area_Alert, enum_LAVCOD, enum_PagineGiasNG} from "../../Model/TipiEnumerativi";
...
export class BussinessMenuAgendaService implements OnDestroy {
  ...
  public CheckAttachedDocuments(dataItem): Observable<boolean> {
    return this.ajaxAgronicaAPIService.ajaxAPIPost('Documenti/EsistonoDocumentiAllegati', {
      Piva: dataItem.Piva, IdAgenda: +dataItem.id_agenda
