...
export class GestioneRichiesteService {
  ...
  private gestionePassaggioSitoAgenda(PaginaRichiesta: number,
  ...
  goToFiltrino(sitoRedirect: number, paginaRedirect: number): Promise<string> {
    ...
    var modalitaFiltroRicerca = this.impostazioniUtenteService.getImpostazione_SuperUser(enum_Impostazioni_Utenti.SUPERUSER_Mod_Filtro_Ricerca);
