...
import { catchError, filter, forkJoin, from, map, Observable, of, take, takeUntil, tap } from "rxjs";
...
export abstract class ZooPrescriptionsInProgressGridConfigService extends AbstractGridConfigService<KendoServerResultImpl> {
  ...
  protected _gridColumns = [
    ...
    new KendoGridColumn({ field: 'ProtocolloCodice', title: this.transloco.translate('Numero') }, { editable: false }),
    ...
    new KendoGridColumn({ field: 'Note_Agenda', title: this.transloco.translate('Numero') }, { editable: false }),
