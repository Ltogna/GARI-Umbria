...
Public Class GestioneRichieste
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            ElseIf Not Request.Form("TxtParametri") Is Nothing Then
                '----------------------------------------------------
            ...
            ElseIf Not Request.Form("TxtVariabiliStampe") Is Nothing Then
                '----------------------------------------------------
            ...
            If Not Request.Form("TxtVariabiliStampe") Is Nothing Then
                '------------------- ATTENZIONE!!!!!!!!!!!!!!!!! ---------------------------
    ...
    Private Sub Gestione_Redirect(ByVal htVariabiliStampe As System.Collections.Hashtable,
        ...
        Select Case Report
            ...
            Case enum_CodificaStampe.Fatture,
                ...
                If Not htVariabiliStampe("preview") Is Nothing AndAlso htVariabiliStampe("preview") <> "" Then
            ...
            Case enum_CodificaStampe.DDT_Contabilizzato_Emesso,
                ...
                Else
                    ...
                    If checkPrezzo = 1 And Lav_Cod <> LAVCOD_CONFERIMENTO And Lav_Cod <> LAVCOD_CONFERIMENTO_DIVERSI Then
            ...
            Case enum_CodificaStampe.PianoDeiConti,
                ...
                If Not IsNothing(htVariabiliStampe("ric_cod")) AndAlso IsNumeric(htVariabiliStampe("ric_cod")) = True Then
                    If Chk_SP = 1 Then
                ...
                If Not IsNothing(htVariabiliStampe("cod_conto")) AndAlso IsNumeric(htVariabiliStampe("cod_conto")) = True Then
                    If Chk_SP = 1 Then
                ...
                If Not IsNothing(htVariabiliStampe("tipo_cod")) AndAlso IsNumeric(htVariabiliStampe("tipo_cod")) = True Then
            ...
            Case enum_CodificaStampe.RisultatoAnalisiConformita
                ...
                If htVariabiliStampe.ContainsKey("sa_cod") = True Then
    ...
    Friend Sub ImpostaCultura(ByRef lingua As Lingua)
        If Not lingua Is Nothing AndAlso lingua.CodiceISO IsNot Nothing Then
