...
Public Class Scheda_OP_Tipo_2
        ...
        If Not Me.IsPostBack Then
            ...
            Select Case Tipo_Stampa
                ...
                Case enum_CodificaStampe.Impegnativa_Pomodoro_Industria
                    ...
                    CType(rptStampa.Section20.ReportObjects("TextPiva2"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = Piva
    ...
    Public Sub CaricaDs_Particelle(ByRef DSParticelle As DS_Scheda_OP_Tipo_2,
        ...
        stbQuery.Append(" SELECT  Reg_Impianti.PIVA, Reg_Impianti.SA_COD, Reg_Impianti.APPEZZA, Reg_Impianti.ID_REG, Reg_Impianti.Sup_Imp,  ")
    ...
    Public Sub CaricaDs_Impianti(ByRef DSImpianti As DS_Scheda_OP_Tipo_2_Varieta)
        ...
        stbQuery.Append(" SELECT  Reg_Impianti.PIVA, Reg_Impianti.SA_COD, Reg_Impianti.APPEZZA, Reg_Impianti.ID_REG,  ")
