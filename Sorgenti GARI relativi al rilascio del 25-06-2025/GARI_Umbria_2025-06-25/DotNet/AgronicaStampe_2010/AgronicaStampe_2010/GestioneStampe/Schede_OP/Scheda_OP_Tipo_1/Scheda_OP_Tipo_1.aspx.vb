...
Public Class Scheda_OP_Tipo_1
    ...
    Public Sub CaricaDs_Impianti(ByRef DSImpianti As DS_Scheda_OP_Tipo_1)
        ...
        sSql.Length = 0
        sSql.AppendLine(" SELECT 0 as totale, Reg_Impianti.PIVA, Reg_Impianti.SA_COD, Reg_Impianti.APPEZZA, Reg_Impianti.ID_REG,  ")
        sSql.AppendLine(" Centri_Aziendali.sa_nome, Appezzamento.APP_NOME, ")
    ...
    Public Sub CaricaDs_SitiProduttivi(ByRef DSSitiProduttivi As DS_Scheda_OP_Tipo_1)
        ...
        sSql.AppendLine("Select sa_nome, com_des As Com_Des,ind_des as Ind_Des,sum(Sup_Imp) As Sup_Imp, Reg_Impianti.Piva, Reg_Impianti.Sa_Cod, Veg_Des  ")
        ...
        If Not Session("strParametri") Is Nothing Then
            ...
            sSql.AppendLine(strFiltroImpianti)
        Else
            sSql.AppendLine("And Reg_Impianti.piva = '" & Piva & "' ")
        End If
        sSql.AppendLine("Group BY sa_nome, com_des, ind_des, s.veg_cod, s.veg_des, Reg_Impianti.Piva, Reg_Impianti.Sa_Cod  ")
