...
Public Class ImpegnoProduzioneSocixCentri
    ...
    Private Sub Stampa_ProdSociDivisoxCentri()
        ...
        Try
            ...
            Dim ListaPive As List(Of String) = DSImprese.Imprese_StampaMassiva.AsEnumerable().AsParallel().
        ...
        Try
            ...
            For Each drCentri As DataRow In dtCentri.Rows
                ...
                drReport(dsReportCentri._DS_CentriConLogo.PivaColumn) = drCentri.Field(Of String)("piva")
            ...
            For Each drParticelle As DataRow In dtParticelle.Rows
                ...
                drReport(dsReportParticelleCatastali.DT_ParticelleCatastalixCentri.PIVAColumn) = drParticelle.Field(Of String)("piva")
            ...
            For Each drSuperficie As DataRow In dtSuperficieSpecie.Rows
                ...
                drReport(dsReportSuperficieSpecie.DT_SuperficieSpeciexCentri.pivaColumn) = drSuperficie.Field(Of String)("piva")
