...
#End Region
    ...
    '###########################################################################
    Private Sub Visualizza_Totali_PerSingoloProdotto(ByRef Log_Errori As String, _
                                                    ByVal FlagSingoloProdotto As Boolean, _
                                                    ByVal Tot_Qta_Carico As Decimal, _
                                                    ByVal Tot_Qta_Scarico As Decimal, _
                                                    ByVal Udm_Sim_totale As String, _
        ...
        Try
            ...
            If FlagSingoloProdotto = True Then
                ...
                CType(rptStampa.Section1.ReportObjects("TxtProdotto"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = _
                ...
                If CInt(Qs_Mat_Cod) <> 0 Then
                    ...
                    objMP.Recupera_Extra(Qs_Elem_Cod, _
                                        Qs_Mat_Cod, _
                                        0, _
                                        filtro, _
                                        udm_cod_extra, _
