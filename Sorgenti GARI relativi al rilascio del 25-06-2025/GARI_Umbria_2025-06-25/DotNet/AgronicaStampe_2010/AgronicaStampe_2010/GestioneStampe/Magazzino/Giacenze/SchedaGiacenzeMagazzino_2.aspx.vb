...
#End Region
    ...
    '###########################################################################
    Private Sub Carica_DSGiacenzeMagazzino(ByRef DSGiacenzeMagazzino As DS_GiacenzeMagazzino, _
        ...
        Try
            ...
            If Qs_0Raggruppa_1Standard = 0 Then
                DT = objGIACENZE.SchedaGiacenzeMagazzino_Raggruppamento(CDate(QS_DataStampa), _
                                                                            CStr(Qs_Piva), _
                                                                            CInt(Qs_Sa_Cod), _
            ...
            Else
                DT = objGIACENZE.SchedaGiacenzeMagazzino(CDate(QS_DataStampa), _
                                                            CStr(Qs_Piva), _
                                                            CInt(Qs_Sa_Cod), _
                                                            CInt(Qs_Fabbricato_Cod), _
                                                            CInt(Qs_Elem_Cod), _
    ...
    '            LinkWsFitofarmaci = Server.MapPath("http://www.agronica.it/AgronicaWebService/AgroWS_Fitofarmaci.asmx")
    '        Else
