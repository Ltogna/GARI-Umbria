        ...
        Select Case _lavCod
            ...
            Case LAVCOD_BOLLA_EMESSA, LAVCOD_DDT_CONTABILIZZATO_EMESSO,
                ...
                If x_Id_Cf_Cliente = enum_Contatti_IdCf.ContattoEstero Then
                    parametro.IntestazioneRiga2 = _traduttore.ValoreDizionarioTraduzioneComuni("VAT: IT") & _piva
                Else
                    parametro.IntestazioneRiga2 = _traduttore.ValoreDizionarioTraduzioneComuni("Partita IVA: ") & _piva
                End If
        ...
        Try
            ...
            Select Case _progressivoGias
                ...
                Case Else
                    ...
                    If personalizzazioniRegioneUmbria IsNot Nothing AndAlso personalizzazioniRegioneUmbria <> "" Then
