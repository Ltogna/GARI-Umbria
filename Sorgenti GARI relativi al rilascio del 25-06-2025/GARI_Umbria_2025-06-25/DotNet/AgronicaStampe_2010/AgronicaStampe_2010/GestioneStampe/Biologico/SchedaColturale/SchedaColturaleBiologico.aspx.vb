...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
                ...
                For j = 0 To UBound(ArraySezioni)
                    ...
                    Select Case ArraySezioni(j)
                        ...
                        Case "e"     'Trappole Installate, Confusione Sessuale, Disorientamento Sessuale, Cattura Massa
                            ...
                            'spostati 118,121 
                            StrLav_Cod &= CStr(LAVCOD_INSTALLAZIONE_TRAPPOLE) & ", " & CStr(LAVCOD_CATTURE_MASSA) & ","
        ...
        If Not Me.IsPostBack Then
            ...
            Try
                ...
                CType(rptStampa.Section1.ReportObjects("TextPiva"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = AgronicaCoreStampeDAL.Stampe_QDC.Pulisci_Piva_Fittizia(Qs_Piva)
    ...
    Private Sub Carica_DSSchedaColturaleBiologico(ByRef DSSchedaColturaleBiologico As DS_SchedaColturaleBiologico, ByRef DS_SchedaColturaleBiologico_Sort As DS_SchedaColturaleBiologico,
        ...
        sSql.Length = 0
        sSql.AppendLine(" SELECT DISTINCT Agenda.id_agenda, Agenda.Lav_Cod, Reg_Impianti.PIVA, Reg_Impianti.SA_COD, ")
        sSql.AppendLine("")
        ...
        sSql.AppendLine(" Movimenti_dettagli.Qta AS Qta_Tot, --Qta_Tot è usata solo nelle trappole ")
        ...
        sSql.AppendLine("Movimenti.Modalita_Applicazione,")
        sSql.AppendLine("ModAppl.Modalita_Applicazione_Descrizione,")
        sSql.AppendLine("CodiciACA.Nr_domanda_ACA")
        ...
        sSql.AppendLine("")
        sSql.AppendLine(" WHERE Imprese_Progetti.Regolamento_Cod = 4 ")
        ...
        sSql.AppendLine(" And Reg_Impianti.PIVA = '" & Qs_Piva & "'")
        ...
        'objSQL.EseguiQuery_Lettura(objParametri_Server, sSql.ToString, "SchedaColturaleBiologico.Carica_DSSchedaColturaleBiologico", DSSchedaColturaleBiologico, _
        '                           DSSchedaColturaleBiologico.DataSetName)
        ...
        Else
            ...
            For i = 0 To DSSchedaColturaleBiologico.DS_SchedaColturaleBiologico2.Rows.Count - 1
                ...
                'sup_app = DSSchedaColturaleBiologico.DS_SchedaColturaleBiologico2.Rows(i).Item("sup_app")
                ...
                If Not HTIdAgenda.ContainsKey(id_agenda) Then
                    'HTIdAgenda.Add(id_agenda, sup_app)
                    HTIdAgenda.Add(id_agenda, 0)
                    'Else
                    '    memo_sup_app = HTIdAgenda(id_agenda)
                    '    sup_app = sup_app + memo_sup_app
                    '    HTIdAgenda(id_agenda) = sup_app
                End If
            Next
            '--- fine commento
            ...
            For i = 0 To DSSchedaColturaleBiologico.DS_SchedaColturaleBiologico2.Rows.Count - 1
                ...
                '---------------------------------------------------------------------------
                'CONTROLLO se è stato inserito il numero dell'Appezzamento nel PAP
                'se esiste metto questo, altrimenti il nome (come nella scheda di campagna)

                'If drR.NumApp_PAP <> "" Then
                '    drR.App_Nome = drR.NumApp_PAP
                'Else
                'se il nome dell'appezzamento contiene un numero indico questo
                'altrimenti metto appezza-basecode
                ...
                Select Case drR.Elem_Cod
                    ...
                    Case SEMENTI
                        ...
                        End If
                        'If flagVisualizzaLottoSemine = False Then
                        '    drR.Materia_Prima = drR.Mat_Des
                        'Else
                        '    If lotto.ToLower = "indefinito" Then
                        '        lotto = ""
                    ...
                    Case SEMILAVORATI_VEGETALI, TRASFORMATI_VEGETALI
                        ...
                        'If flagVisualizzaLottoRaccolte = False Then
                        '    drR.Materia_Prima = drR.Mat_Des
                        'Else
                        '    If lotto.ToLower = "indefinito" Then
                        '        lotto = ""
                    ...
                    Case FORMULATI   'prodotti fitosanitari
                        ...
                        '    strAvv = IIf(drR.Av_Gru_Des.Trim.EndsWith(","), drR.Av_Gru_Des.Trim.Remove(drR.Av_Gru_Des.Trim.Length - 1, 1), drR.Av_Gru_Des)
                        'ElseIf Not IsDBNull(drR.Av_Des_Vol) AndAlso drR.Av_Des_Vol <> "" Then
                        '    strAvv = IIf(drR.Av_Des_Vol.Trim.EndsWith(","), drR.Av_Des_Vol.Trim.Remove(drR.Av_Des_Vol.Trim.Length - 1, 1), drR.Av_Des_Vol)
                        'End If
                    ...
                    Case TRAPPOLE   'trappole
                        ...
                        '    '24/07/2018: patch
                        '    'visualizzava la qta tot su ogni impianto e quindi la qta si moltiplicava
                        '    'Case 107, 118, 121, 122
                        '    '    drR.Materia_Prima = drR.Trap_Des
                        '    '    drR.Qta = Arrotonda(drR.Qta_Tot, Qs_Arrotondamento)
                        '    Case LAVCOD_CONFUSIONE_SESSUALE, LAVCOD_DISORIENTAMENTO_SESSUALE
                        '        drR.Qta = Arrotonda(drR.Qta, Qs_Arrotondamento)
                        '    Case LAVCOD_INSTALLAZIONE_TRAPPOLE, LAVCOD_CATTURE_MASSA
                        '        'queste operazioni sono salvate diversamente rispetto alla confusione
                        '        'metto la qta tot in un impianto e 0 negli altri
                        '        'ripartisco allora il num totale delle trappole

                        '        'nel caso del raggruppamento non occorre fare la ripartizione perchè viene visualizzato poi il totale
                        '        If Session("RaggruppaXCampo") = True Then
                        '            drR.Qta = Arrotonda(drR.Qta, Qs_Arrotondamento)
                        '        Else
                        '            Dim qta_tot_trap As Decimal = drR.Qta_Tot
                        '            Dim sup_app_trap As Decimal = HTIdAgenda(id_agenda)
                        '            drR.Qta = Arrotonda((qta_tot_trap / sup_app_trap) * drR.Sup_App, 0)
                        '        End If
                ...
                'drR.Note &= CostiAccessori(drR.Piva, drR.Id_Agenda, _
                '    Flag_Nasc_Resp, Flag_Nasc_Oper, _
                '    Flag_Nasc_Macc, _
                '    Flag_Nasc_DataFirma, _
                '    Flag_Nasc_DataUltMan _
                '    ) 
                ...
                Select Case drR.Lav_Cod
                    ...
                    Case LAVCOD_IRRIGAZIONE       'se ho un irrigazione ricavo i dati
                        ...
                        If Not IsNothing(RsIrrigazione) AndAlso RsIrrigazione.Rows.Count > 0 Then
                            ...
                            drR.Qta = CStr(Arrotonda(RsIrrigazione.Rows(0).Item("Qta_Ril"), Qs_Arrotondamento)) & strOre
                    ...
                    Case LAVCOD_FASI_FENOLOGICHE       'se ho un osservazione fasi fenologiche ricavo i dati
                        ...
                        'RsOsservazionefasi = objMovDest.Leggi_Dati_OsservazioneFasi(drR.Piva, drR.Sa_Cod, drR.Appezza, drR.Id_Reg, drR.Id_Agenda, "", "", objParametri_Server)

                        'If Not IsNothing(RsOsservazionefasi) Then

                        '    Dim Fasi As String = ""

                        '    For j = 0 To RsOsservazionefasi.Rows.Count - 1
                        '        Fasi &= RsOsservazionefasi.Rows(j).Item("ff_des") & " (" & CDate(RsOsservazionefasi.Rows(j).Item("data_ril")).ToShortDateString & "), "
                        '    Next
                        ...
                        If Not IsNothing(DtRilievoAvversitaCampo) AndAlso DtRilievoAvversitaCampo.Rows.Count <> 0 Then
                            ...
                            For Each rilievo In DtRilievoAvversitaCampo.Rows
                                If drR.Udm_Cod = rilievo.Item("udm_Cod") AndAlso
                                    ...
                                    'drR.Qta = DtRilievoAvversitaCampo.Rows(0).Item("qta")
                                    drR.Qta = Arrotonda(rilievo.Item("qta"), Qs_Arrotondamento)

                                    'DSSchedaColturaleBiologico.DS_SchedaColturaleBiologico2.AddDS_SchedaColturaleBiologico2Row(
                                    '    drR.Data_Movimento, drR.Veg_Cod, drR.Veg_Des, drR.Cul_Cod, drR.Cul_Des,
                                    '    drR.Appezza, drR.Id_Reg, drR.App_Nome, drR.Sup_App,
                                    '    drR.Ha, drR.Are, drR.Lav_Cod, drR.Lav_Des, "",
                                    '    rilievo.Item("Av_Des_Vol"),
                                    '    rilievo.Item("udm_cod"),
                                    '    rilievo.Item("UDM_SIM"),
                                    '    rilievo.Item("qta"),
                                    '    drR.Id_Agenda, drR.Piva, drR.Sa_Cod, drR.Cau_Mov, drR.Data, drR.NumApp_PAP,
                                    '    0, 0, 0, 0, "", "", "",
                                    '    "", "",
                                    '    drR.Campo_Cod, drR.Grva_Cod, drR.Grva_Des, drR.Av_Des_Vol, drR.Av_Gru_Des,
                                    '    drR.Id_Mov_Det, drR.Note, drR.dose_tot_reale,
                                    '    drR.Udm_Sim_Reale, drR.udm_cod_reale, drR.sup_trattata, drR.Lotto)
                                End If

                            Next
                        End If

                    Case LAVCOD_RILIEVO_INDICI_MATURITA   'Rilievo Indici Maturità
                    ...
                    Case LAVCOD_CONFUSIONE_SESSUALE, LAVCOD_DISORIENTAMENTO_SESSUALE 'confusione-disorientamento sessuale
                ...
                If Session("RaggruppaXCampo") = True Then '-----------
                    ...
                    If i > 0 Then
                        ...
                        (drR.Item("Av_Gru") = drR_Prec.Item("Av_Gru")) Then
                            ...
                            Next
                            If trovato = False Then
                                drR.App_Nome = drR_Prec.App_Nome + ", " + drR.App_Nome
                            Else
    ...
    Private Sub LeggiPersonalizzazioniRegioneUmbria()
        If Not HttpContext.Current.Session("ASG_objParametri_Super_Server") Is Nothing Then
            ...
            DTConfigSiti = objConfigSiti.Leggi(0, "personalizzazioniRegioneUmbria", "", "", objParametriSuperServer)
            If Not IsNothing(DTConfigSiti) AndAlso DTConfigSiti.Rows.Count > 0 Then
                personalizzazioniRegioneUmbria = DTConfigSiti.Rows(0).Item("Valore")
                If IsNothing(personalizzazioniRegioneUmbria) Then
