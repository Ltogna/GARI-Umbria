            ...
            <div style="display: flex; align-items: stretch; padding: 20px; border-radius: 16px; border: 1px solid #ddd; background: #FFF">
                        ...
                        <div style="display: flex; width: 100%">
                            ...
                            <div style="width: 50%">
                                ...
                                <div class="cfp-checkbox-row" id="sezioniVeneto-right" style="display: none">
                                    ...
                                    <input name="ddlSchede" id="ddlSchede" class="form-control" style="width: 120px" />
                                </div>
                            </div>  
                        </div>
                    </div>
                ...
                <div style="display: flex; flex-direction: column; width: 50%; padding-left: 16px;">
                    ...
                    <div style="width: 100%; padding-top: 18px;">
                        ...
                        <!-- CROPS -->
                        <div style="display: flex; width: 100%; margin-bottom: 16px; border-radius: 10px; border: 1px solid #ddd; padding: 16px; padding-bottom: 12px;">
                            <div style="width: 40%; display: flex; flex-direction: column;">
                                ...
                                <div style="width: 50%">
                                    <div class="cfp-checkbox-col">
                                        ...
                                        <div class="cfp-checkbox-row">
                                            ...
                                            <label for="chkRaggruppaXCampo">Raggruppa per Intervento</label>
                                        </div>
                                        <div class="cfp-checkbox-row">
                                            <input type="checkbox" name="checkMostraDataStampa"  class="kendoSwitch" />
                        ...
                        <%--                <div class="cfp-checkbox-row">
                                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                                <label for="checkSuperfici" style="margin-right: 5px;">Sup. Appezzamenti</label>
                                                <input type="checkbox" name="checkSuperfici" id="checkSuperfici" class="kendoSwitch" />
                                                <label for="checkSuperfici" style="margin-left: 5px;">Sup. Impianti</label>
                                            </div>
                                        </div>--%>
                            ...
                            <!-- GlobalGAP nascosto -->
                            <div id="DivGlobalGap" style="display: none; margin-bottom: 10px;">
                                <div class="btn btn-info" onclick="img_globalGap()" runat="server" style="margin-bottom: 5px;">
                                    <i class="fa fa-eye"></i>Inserisci i dati GLOBAL - GAP
                                </div>
                                <div>
                                    <input type="checkbox" id="check_globalgap" name="check_globalgap" class="kendoSwitch" />
                                    <label for="check_globalgap">Visualizza titolo GLOBAL - GAP</label>
                                </div>
                            </div>
                            <!-- Elemento nascosto -->
                            ...
                            <!-- Tempo rientro nascosto -->
                            <div id="DivTempoRientro" runat="server" visible="false" style="margin-bottom: 10px;">
                                <div class="form-group">
                                    <div class="input-group">
