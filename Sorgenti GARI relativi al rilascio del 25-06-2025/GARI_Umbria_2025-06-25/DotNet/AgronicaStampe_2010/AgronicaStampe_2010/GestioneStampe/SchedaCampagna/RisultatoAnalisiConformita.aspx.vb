    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack Then
            ...
            Try
                ...
                Qs_Veg_Cod = Stringa_Decodifica(Request.QueryString("veg_cod").ToString, _
                   AgroKey_EncoderDecoder, _
                   Server)

                Qs_Data_Da = Stringa_Decodifica(Request.QueryString("data_da").ToString, _
                   AgroKey_EncoderDecoder, _
                   Server)

                Qs_Data_A = Stringa_Decodifica(Request.QueryString("data_a").ToString, _
                   AgroKey_EncoderDecoder, _
                   Server)

                Qs_Sa_Cod = Stringa_Decodifica(Request.QueryString("sa_cod").ToString, _
                               AgroKey_EncoderDecoder, _
                               Server)
