                        ...
                        Case Is >= Num_Raccolte
                            ...
                            For j = 0 To Num_Semine - 1
                                ...
                                Inserisci_Riga(DtRisultati, _
                                               ...
                                               DtImpianti.Rows(i).Item("appezza"), _
                                               DtImpianti.Rows(i).Item("id_reg"), _
                                               drSemine(j).Item("rag_soc"), _
                                               drSemine(j).Item("sa_nome"), _
                                               Campo_Des, _
                                               drSemine(j).Item("app_nome"), _
                                               drSemine(j).Item("veg_cod"), _
                                               drSemine(j).Item("veg_des"), _
                                               drSemine(j).Item("cul_cod"), _
                                               drSemine(j).Item("cul_des"), _
                                               drSemine(j).Item("grva_cod_veg"), _
                                               Grva_Des, _
                                               drSemine(j).Item("Reg_Impianti_Validita_Inizio"), _
                                               drSemine(j).Item("Reg_Impianti_Validita_Fine"), _
                                               drSemine(j).Item("sup_imp"), _
                                               drSemine(j).Item("P_HA"), _
                                               drSemine(j).Item("resa_prevista_HA"), _
                                               Id_Semina, _
                                               Data_Semina, _
                                               Lotto_Seme, _
                                               Udm_Seme, _
                        ...
                        Case Is < Num_Raccolte
                            ...
                            For j = 0 To Num_Raccolte - 1
                                ...
                                Inserisci_Riga(DtRisultati, _
                                               ...
                                               DtImpianti.Rows(i).Item("appezza"), _
                                               DtImpianti.Rows(i).Item("id_reg"), _
                                               drRaccolte(j).Item("rag_soc"), _
                                               drRaccolte(j).Item("sa_nome"), _
                                               Campo_Des, _
                                               drRaccolte(j).Item("app_nome"), _
                                               drRaccolte(j).Item("veg_cod"), _
                                               drRaccolte(j).Item("veg_des"), _
                                               drRaccolte(j).Item("cul_cod"), _
                                               drRaccolte(j).Item("cul_des"), _
                                               drRaccolte(j).Item("grva_cod_veg"), _
                                               Grva_Des, _
                                               drRaccolte(j).Item("Reg_Impianti_Validita_Inizio"), _
                                               drRaccolte(j).Item("Reg_Impianti_Validita_Fine"), _
                                               drRaccolte(j).Item("sup_imp"), _
                                               drRaccolte(j).Item("P_HA"), _
                                               drRaccolte(j).Item("resa_prevista_HA"), _
                                               Id_Semina, _
                                               Data_Semina, _
                                               Lotto_Seme, _
                                               Udm_Seme, _
