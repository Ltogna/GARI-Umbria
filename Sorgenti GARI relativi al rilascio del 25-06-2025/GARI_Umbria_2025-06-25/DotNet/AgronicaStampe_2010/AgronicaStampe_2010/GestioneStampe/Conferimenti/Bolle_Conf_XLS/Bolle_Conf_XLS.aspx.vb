                ...
                For i = 0 To DT.Rows.Count - 1
                    ...
                    Try
                        ...
                        With DT.Rows(i)
                            ...
                            .Item("peso_netto") = AgronicaCoreDataProvider.Agro_Math.ArrotondaVal_0(.Item("peso_netto"))
                            ...
                            objConfFun.Calcola_NettoPagamento(.Item("peso_netto"),
                            ...
                            If Not String.IsNullOrWhiteSpace(sigla_calib) Then
                                .Item(sigla_calib) = .Item("netto_Pagamento")
                            Else
                                .Item("Nessuna_Class") = .Item("netto_Pagamento")
                            End If
                            ...
                            If Not HT_riepilogo.Contains(CodiceXRaggruppamento) Then
                                ...
                                HT_riepilogo.Add(CodiceXRaggruppamento, CDec(.Item("netto_Pagamento")))
                                ...
                                Mtx_riepilogo(R_MTX_MAT_COD, i_Mtx_Col) = CInt(.Item("Mat_Cod"))
                                Mtx_riepilogo(R_MTX_VEG_COD, i_Mtx_Col) = CInt(.Item("Veg_cod"))
                                Mtx_riepilogo(R_MTX_CUL_COD, i_Mtx_Col) = CInt(.Item("cul_cod"))
                                Mtx_riepilogo(R_MTX_REG_COD, i_Mtx_Col) = CInt(.Item("Reg_cod"))
                                '--
                                Mtx_riepilogo(R_MTX_SPECIE, i_Mtx_Col) = Descr_Specie
                                Mtx_riepilogo(R_MTX_VARIETA, i_Mtx_Col) = Descr_Varieta
                                Mtx_riepilogo(R_MTX_REG_DES, i_Mtx_Col) = CStr(.Item("Reg_des"))
                                '--
                                Mtx_riepilogo(R_MTX_TOT_NETTO, i_Mtx_Col) = CDec(.Item("netto_Pagamento"))
                                ...
                                Mtx_riepilogo(curr_i_Mtx_righe, i_Mtx_Col) = CDec(.Item("netto_Pagamento"))
                            ...
                            Else
                                ...
                                HT_riepilogo(CodiceXRaggruppamento) = Tot_Netto_Su_Raggruppamento + CDec(.Item("netto_Pagamento"))
                                ...
                                'aggiungo al totale precedente il netto a pagamento della riga corrente
                                Mtx_riepilogo(curr_i_Mtx_righe, curr_i_Mtx_col) = Tot_Netto_x_Calibro + CDec(.Item("netto_Pagamento"))
