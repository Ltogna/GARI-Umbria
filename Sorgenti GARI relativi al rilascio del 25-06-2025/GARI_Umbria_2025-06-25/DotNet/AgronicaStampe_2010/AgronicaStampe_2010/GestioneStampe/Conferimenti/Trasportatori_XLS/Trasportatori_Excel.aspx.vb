            ...
            If Not IsNothing(DT) Then
                ...
                For i = 0 To DT.Rows.Count - 1
                    ...
                    With DT.Rows(i)
                        ...
                        .Item("Netto_Trasportato") = AgronicaCoreDataProvider.Agro_Math.ArrotondaVal_0(.Item("Netto_Trasportato"))
                        ...
                        objConfFun.Calcola_NettoPagamento(.Item("Netto_Trasportato"),
                                                    .Item("Degrado_Perc"),
                                                    .Item("Udm_Cod"),
                                                    .Item("Degrado"),
