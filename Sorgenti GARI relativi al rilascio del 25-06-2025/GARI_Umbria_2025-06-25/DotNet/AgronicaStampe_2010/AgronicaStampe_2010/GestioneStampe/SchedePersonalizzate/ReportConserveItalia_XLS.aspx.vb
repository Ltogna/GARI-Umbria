...
#End Region
                ...
                For j = 0 To 14
                    ...
                    Select Case j
                        ...
                        Case 1
                            ...
                            Riga.Cells(j).InnerHtml = IIf(Not IsDBNull(Dv.Item(i).Item("piva")), "&nbsp;" & Dv.Item(i).Item("piva"), "&nbsp;")
    ...
    Private Sub CreaDtRisultati()
        ...
        If Not IsNothing(DT) AndAlso DT.Rows.Count > 0 Then
            ...
            For i = 0 To DT.Rows.Count - 1
                ...
                If Not IsDBNull(DT.Rows(i).Item("appezza")) And Not IsDBNull(DT.Rows(i).Item("id_reg")) Then
    ...
    Private Sub Crea_Stringa_Filtro()
        ...
        Dim Lista_Province_R As New AgronicaCoreMetaSchemaDAL.Lista_Province_R
        ...
        Dim XML_DatiPive As System.Xml.XmlElement
        Dim XML_Piva As System.Xml.XmlElement
        Dim XMLs_Piva As System.Xml.XmlNodeList
        ...
        If Not XML_DatiGerarchiaImprese Is Nothing Then
        ...
        If TrattamentoAntiparassitario = True Then
            strAvversita = " <b>Avversita': </b>"
        ElseIf Diserbo = True Then
        ...
        For i = 1 To Avversita_R.Numero_Avversita(objParametri_Server)
            If XML_Agenda.GetAttribute("av_cod" & i) <> "" Then
                strAvversita += Avversita_R.AvDes_from_AvCod(XML_Agenda.GetAttribute("av_cod" & i), Nothing, AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_JoinCompleta, "", "", objParametri_Server) & "; "
            Else
                Exit For
            End If
        Next
