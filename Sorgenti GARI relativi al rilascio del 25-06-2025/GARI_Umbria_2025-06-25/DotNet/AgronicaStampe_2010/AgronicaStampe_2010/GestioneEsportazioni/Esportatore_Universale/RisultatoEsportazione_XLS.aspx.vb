...
#End Region
    ...
    Public Sub ElaboraCellaHTML( _
                            ByRef Cella As HtmlTableCell, _
                            ByVal Bordo_Spessore As Integer, _
                            ByVal Bordo_Tipo As String, _
                            ByVal Bordo_Colore As String, _
                            ByVal Sfondo_Colore As String, _
                            ByVal Testo_Allineamento As String, _
                            Optional ByVal Testo_Allineamento_Verticale As String = "top", _
                            Optional ByVal Colspan As Integer = 0, _
                            Optional ByVal Font_Weigth As String = "", _
                            Optional ByVal Font_Size As String = "", _
