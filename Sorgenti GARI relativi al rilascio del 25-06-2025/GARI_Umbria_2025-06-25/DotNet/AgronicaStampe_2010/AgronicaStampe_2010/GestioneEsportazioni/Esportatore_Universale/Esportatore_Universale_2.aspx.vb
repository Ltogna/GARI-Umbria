...
Public Class Esportatore_Universale_2
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Session("ASG_Utente_Username") = "" Then
            '----- Chiudo la finestra
            'Master.FindControl("Form1").Controls.Add( _
            '    New LiteralControl( _
            '        "<script language='javascript'>window.close();</script>"))
            Page.RegisterClientScriptBlock("key", "<script language='javascript'>window.close();</script>")
        End If
...
22:
    ...
    Private Function Esportazione_Centri(ByRef XmlDoc As XmlDocument, ByRef DT As DataTable, ByRef Log As String) As String
        ...
        Try
            ...
            stbQ.AppendLine(" Centri_Aziendali.PIVA, ")
    ...
    Private Function Esportazione_Imprese(ByRef XmlDoc As XmlDocument, ByRef DT As DataTable, ByRef Log As String) As String
        ...
        Try
            stbQ.Length = 0
            stbQ.AppendLine(" ")
            stbQ.AppendLine(" SELECT DISTINCT Impresa.PIVA, ISNULL(Impresa.rag_soc, ' ') AS rag_soc, ")
