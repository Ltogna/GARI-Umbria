...
#Region "DropDown Aziende"
    ...
    Private Shared Function CaricaComboImprese(objParametri_Server As AgronicaCoreParametri, objParametri_Utenti As AgronicaCoreParametri) As DropDownList
        ...
        AgronicaCoreUtility.CaricaListControl.ImpreseConFiltroUtente(ddl_ComboImprese, True, "", "",
...
#Region "Elenco Sintetico Con/Senza dettagli"
    ...
    Private Shared Function getElencoSintetico(v_inizio As Date, v_fine As Date,
        ...
        Dim stringInsertObj = New AgronicaCoreUtility.QueryBuilderUtility
        Dim piveInsertString = stringInsertObj.GeneraStringaInsertDaList("#pive", FiltroAggiuntivo_Imprese.Split(",").ToList)
        ...
        Dim DtPraticheSottoscrizioneQdC As DataTable
        Dim DtPraticheStatoAttuale As DataTable
        Dim DtAccessi As DataTable
        ...
        For Each dr As DataRow In DT_Esporta_Dettagli.Rows
            ...
            If Not DtOpMag Is Nothing Then
                DrOpM = DtOpMag.Select("piva='" & dr.Item("piva") & "'")
                If Not DrOpM Is Nothing Then
            ...
            If Not DtOpCamp Is Nothing Then
                DrOpC = DtOpCamp.Select("piva='" & dr.Item("piva") & "'")
                If Not DrOpC Is Nothing Then
            ...
            If Not DtPua Is Nothing Then
                DrPua = DtPua.Select("piva='" & dr.Item("piva") & "'")
                If Not DrPua Is Nothing Then
            ...
            If Not DtPCon Is Nothing Then
                DrPCon = DtPCon.Select("piva='" & dr.Item("piva") & "'")
                If Not DrPCon Is Nothing Then
            ...
            If esisteServizioQdCBluArancio Then
                ...
                If Not DtPraticheSottoscrizioneQdC Is Nothing AndAlso Not IsDBNull(dr.Item("piva")) AndAlso dr.Item("piva") <> "" Then
                    ...
                    If Not DrPraticheSottoscrizioneQdC Is Nothing Then
                ...
                If Not DtPraticheStatoAttuale Is Nothing AndAlso Not IsDBNull(dr.Item("piva")) AndAlso dr.Item("piva") <> "" Then
                    ...
                    If Not DrPraticheStatoAttuale Is Nothing Then
...
#End Region
    ...
    Private Shared Function setObjParametri(ByRef objParametri_Server As AgronicaCoreParametri, ByRef objParametri_Utenti As AgronicaCoreParametri) As Boolean
