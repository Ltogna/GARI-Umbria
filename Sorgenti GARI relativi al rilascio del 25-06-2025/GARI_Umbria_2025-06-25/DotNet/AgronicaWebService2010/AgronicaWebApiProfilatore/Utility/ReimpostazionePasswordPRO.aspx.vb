...
Public Class ReimpostazionePasswordPRO
    ...
    Private ReadOnly tokenProfitosan As String = "VZ1VTzBNGtIS3tYeeWBAknB3c8K0XCLMnKK1"
    ...
    Private Function controllaNuovaPassword(nuovaPassword As String) As Boolean
        ...
        Return objUtenti.ValidaComplessitaPassword(nuovaPassword)
    ...
    Private Function modificaPassword() As String
        ...
        Dim baseUrlApiProfitosan = ConfigurationManager.AppSettings("BaseUrlApiProfitosan")
