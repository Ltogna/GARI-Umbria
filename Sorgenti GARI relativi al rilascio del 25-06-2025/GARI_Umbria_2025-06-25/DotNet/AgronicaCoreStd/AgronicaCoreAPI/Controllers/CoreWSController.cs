...
namespace AgronicaCoreAPI.Controllers
{
    public class CoreWSController
    {
        ...
        private JObject Request(HttpMethod method, string request, string content)
        {
            ...
            if (_request.Headers.TryGetValue("cookie", out var headerValues))
            {
        ...
        public CoreWSController(HttpClient hc, string baseAddr, string bearerToken, HttpRequest request)
        {
        ...
        public RispostaStandard CopiaVisibilitaUtenti(CoreWSRequest<CoreWS_Generic<CopiaImpostazioniObj>> request)
        {
        ...
        public RispostaStandard AttivaDisattivaConfigurazione(CoreWSRequest<CoreWS_Generic<AttivazioneConfigurazioneAlgoritmiCartografici>> request)
        {
        ...
        public RispostaStandard GetRapportiContabCodDescr(APICallsBasic request)
        {
        ...
        public RispostaStandard<ControllaMassimali_QdC> ControllaMassimali(CoreWSRequest<CoreWS_Generic<object>> request)
        {
        ...
        public RispostaStandard Controllo_Inserimento_Dose_Prodotto(CoreWSRequest<CoreWS_Generic<object>> request)
        {
