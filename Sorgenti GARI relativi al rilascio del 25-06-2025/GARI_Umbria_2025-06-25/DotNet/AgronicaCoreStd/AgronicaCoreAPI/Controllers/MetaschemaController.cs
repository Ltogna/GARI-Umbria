...
namespace AgronicaCoreAPI.Controllers
{
    public class MetaschemaController : BaseController
    {
        ...
        public ObjectResult GetOperazioni([FromHeader] string Authorization)
        {
            ...
            try
            {
                //string webService = coreWSBaseURL + "/Metaschema/Operazioni.asmx/Leggi_Operazioni_APP";
                //CoreWS_Operazioni coreWSModel_Operazioni = new CoreWS_Operazioni(objP_super_server, objP_server, objP_utenti);
                //EseguiChiamateApi xChiamata = new EseguiChiamateApi(webService, tokenChiamateWS, versioneClientChiamate);
                //RispostaStandard risposta = xChiamata.ChiamaWS<CoreWS_Operazioni>(coreWSModel_Operazioni);
