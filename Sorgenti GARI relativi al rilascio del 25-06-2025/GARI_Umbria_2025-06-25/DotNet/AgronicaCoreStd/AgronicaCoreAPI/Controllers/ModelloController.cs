    ...
    public class ModelloController : BaseController
    {
        ...
        public ObjectResult GetAziende([FromHeader] string Authorization)
        {
            ...
            try
            {
                ...
                // var r = ws.LeggiImprese(new APICallsBasic(objP_super_server, objP_server, objP_utenti));
                ...
                // result.RispostaStringa = adapter.leggiImprese(r.RispostaStringa);
                
                // result.Compressa = true;
                // result.RispostaCompressa = zip(r.RispostaStringa);
            }
