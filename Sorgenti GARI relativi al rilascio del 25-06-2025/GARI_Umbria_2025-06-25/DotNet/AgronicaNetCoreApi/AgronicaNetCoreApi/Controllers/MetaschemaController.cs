    ...
    public class MetaschemaController : BaseController
    {
        ...
        public async Task<IActionResult> GetSpecie_FiltroUtente([FromBody] LeggiSpecieVegetali_IN leggiSpecie_IN)
        {
            ...
            try
            {
                ...
                dtConVisibilita_OUT = await _specieVegetaliService.SpecieVegetali_GestioneFiltroUtente_LeggiAsync(
                    leggiSpecie_IN, objParametriUtenti);
        ...
        public async Task<IActionResult> GetCultivar([FromBody] Cultivar_GestioneFiltroUtente_Leggi_IN leggiCultivar_IN)
        {
            ...
            try
            {
                ...
                DataTable cultivar = await _specieVegetaliService.Cultivar_GestioneFiltroUtente_LeggiAsync(leggiCultivar_IN,objParametriUtenti);
        ...
        public async Task<IActionResult> GetGruppiVegetali_FiltroUtente(int gru_cod)
        {
            ...
            try
            {
                ...
                DataTable gruppiVegetali = await _specieVegetaliService.GruppoVegetale_GestioneFiltroUtente_LeggiAsync(gru_cod, objParametriUtenti);
        ...
        public async Task<IActionResult> GetOperazioni_FiltroUtente([FromBody] LeggiOperazioni_IN inData)
        {
            ...
            try
            {
                ...
                dtConVisibilita_OUT = await _operazioniService.Operazioni_GestioneFiltroUtente_LeggiAsync(inData,objParametriServer,
                    UtilityAgronica.convertStringtoOBJparametri(auth.objP.objP_utenti, _securitySettings));
        ...
        public async Task<IActionResult> LeggiVarieta([FromQuery] int culCod, [FromQuery] int vegCod)
        {
            ...
            try
            {
                ...
                var result = await _specieVegetaliService.LeggiVarietaAsync(culCod, vegCod, objParametriUtenti);
