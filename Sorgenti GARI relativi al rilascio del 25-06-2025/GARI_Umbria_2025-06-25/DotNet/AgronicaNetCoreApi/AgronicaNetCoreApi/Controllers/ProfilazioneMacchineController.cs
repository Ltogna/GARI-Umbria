...
public class ProfilazioneMacchineController : BaseController
{
    ...
    public async Task<IActionResult> Leggi([FromQuery] int idProfiloDati)
    {
        ...
        try
        {
            ...
            var result = await _profilazioneMacchineService.LeggiAsync(idProfiloDati, objParams);
    ...
    public async Task<IActionResult> UpdateCaratteristicheMacchina([FromBody] CaratteristicheMacchina_In body)
    {
        ...
        try
        {
            ...
            var objParams = ExtractObjParametriServerAndSetCulture(auth);
            var result = await _profilazioneMacchineService.UpdateCaratteristicheMacchinaAsync(body, objParams);
