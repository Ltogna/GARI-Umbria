...
public class NoteController : BaseController
{
    ...
    public async Task<IActionResult> LeggiNoteInterventoUtilizzo()
    {
        ...
        try
        {
            ...
            var result = await _noteService.LeggiNoteInterventoUtilizzoAsync(0, objParams);
    ...
    public async Task<IActionResult> LeggiProfilazioneNote([FromQuery] int notaUtilizzoCod)
    {
        ...
        try
        {
            ...
            var objParams = ExtractObjParametriServerAndSetCulture(auth);
            var result =
                await _noteService.LeggiProfilazioneNoteAsync(notaUtilizzoCod, 0, true, "", objParams);
    ...
    public async Task<IActionResult> SalvaNote([FromBody] SalvaNote_In body)
    {
        ...
        try
        {
            ...
            var objParams = ExtractObjParametriServerAndSetCulture(auth);
            var result = await _profilazioneImpreseService.SalvaNoteAsync(body, objParams);
    ...
    public async Task<IActionResult> LeggiNote([FromQuery] int vegCod, [FromQuery] int lavCod, [FromQuery] string? piva)
    {
        ...
        try
        {
            ...
            var objParams = ExtractObjParametriServerAndSetCulture(auth);
            var result = await _noteService.LeggiNoteAsync(piva ?? "", lavCod, vegCod, objParams);
    ...
    public async Task<IActionResult> LeggiGruppoNote()
    {
        ...
        try
        {
            ...
            var objParams = ExtractObjParametriServerAndSetCulture(auth);
            var result = await _noteService.LeggiGruppoNoteAsync(objParams);
    ...
    public async Task<IActionResult> CancellaNota([FromQuery] int notaCod)
    {
        ...
        try
        {
            ...
            var objParams = ExtractObjParametriServerAndSetCulture(auth);
            var result = await _noteService.CancellaNotaAsync(notaCod, objParams);
    ...
    public async Task<IActionResult> SalvaGruppoNote([FromBody] SalvaGruppoNote_In body)
    {
        ...
        try
        {
            ...
            var objParams = ExtractObjParametriServerAndSetCulture(auth);
            var result = await _noteService.SalvaGruppoNoteAsync(body, objParams);
    ...
    public async Task<IActionResult> AggiornaGruppoNote([FromBody] SalvaGruppoNote_In body)
    {
        ...
        try
        {
            ...
            var objParams = ExtractObjParametriServerAndSetCulture(auth);
            var result = await _noteService.AggiornaGruppoNoteAsync(body, objParams);
    ...
    public async Task<IActionResult> CancellaGruppoNote([FromQuery] int gruppoNoteCod)
    {
        ...
        try
        {
            ...
            var objParams = ExtractObjParametriServerAndSetCulture(auth);
            var result = await _noteService.CancellaGruppoNoteAsync(gruppoNoteCod, objParams);
    ...
    public async Task<IActionResult> LeggiNoteXUtilizzo([FromQuery] int notaUtilizzoCod, [FromQuery] int notaGruppoCod)
    {
        ...
        try
        {
            ...
            var objParams = ExtractObjParametriServerAndSetCulture(auth);
            var result = await _noteService.LeggiNoteXUtilizzoAsync(notaUtilizzoCod, notaGruppoCod, objParams);
    ...
    public async Task<IActionResult> AggiungiNota([FromQuery] string notaDes, int notaGruppoCod)
    {
        ...
        try
        {
            ...
            var objParams = ExtractObjParametriServerAndSetCulture(auth);
            var result = await _noteService.AggiungiNotaAsync(notaDes, notaGruppoCod, objParams);
        ...
        [FromQuery] int notaUtilizzoCod)
    {
        ...
        try
        {
            ...
            var objParams = ExtractObjParametriServerAndSetCulture(auth);
            var result =
                await _noteService.LeggiNoteInterventoUtilizzoGruppiAsync(notaGruppoCod, notaUtilizzoCod, objParams);
    ...
    public async Task<IActionResult> SalvaGruppoNoteCompleto([FromBody] SalvaGruppoNoteCompleto_In body)
    {
        ...
        try
        {
            ...
            var objParams = ExtractObjParametriServerAndSetCulture(auth);
            var result = await _noteService.SalvaGruppoNoteCompletoAsync(body, objParams);
