...
namespace AgronicaNetCoreApi.Controllers
{
    public abstract class BaseController : ControllerBase
    {
        ...
        protected AgronicaCoreParametri ExtractObjParametriServerAndSetCulture(AuthenticationCheckResult auth)
        {
        ...
        protected AgronicaCoreParametri ExtractObjParametriUtentiAndSetCulture(AuthenticationCheckResult auth)
        {
