	...
	public OperazioniZooController(IServiceProvider provider, IOptions<SecuritySettings> securitySettings, IStringLocalizer<Messages> localizer) : base(provider, securitySettings, localizer)
        ...
        public async Task<IActionResult> GetCentriAziendali([FromQuery] string piva)
        {
            ...
            try
            {
                ...
                DataTable centri = await _operazioniZooService.LeggiCentriAziendaliZooAsync(piva, objParametriServer);
        ...
        public async Task<IActionResult> GetStalle([FromQuery] string piva, int centro)
        {
            ...
            try
            {
                ...
                DataTable stalle = await _operazioniZooService.LeggiStalleZooAsync(piva, centro, objParametriServer);
        ...
        public async Task<IActionResult> GetOperazioni()
        {
            ...
            try
            {
                ...
                var operazioni = await _operazioniZooService.LeggiOperazioniZooAsync(objParametriServer,
                                                                                     UtilityAgronica.convertStringtoOBJparametri(auth.objP.objP_utenti, _securitySettings));
        ...
        public async Task<IActionResult> GetOperazioniPreferite()
        {
            ...
            try
            {
                ...
                var objParametriServer = ExtractObjParametriServerAndSetCulture(auth);
                var operazioniPreferite = await _operazioniZooService.LeggiOperazioniZooPreferiteAsync(objParametriServer,
                                                                                                       UtilityAgronica.convertStringtoOBJparametri(auth.objP.objP_utenti, _securitySettings));
        ...
        public async Task<IActionResult> ScriviFirstSomministrazioniDaProtocollo(int Id_Protocollo, List<Attivita> Somministrazioni)
        {
            ...
            try
            {
                ...
                AgronicaCoreParametri objParametriServer = UtilityAgronica.convertStringtoOBJparametri(auth.objP.objP_server, _securitySettings);
                AgronicaCoreParametri objParametriUtenti = UtilityAgronica.convertStringtoOBJparametri(auth.objP.objP_utenti, _securitySettings);
                var r = await _trattamentoZooService.CreaTrattamentoDaProtocollo(Id_Protocollo, Somministrazioni, objParametriServer, objParametriUtenti);
        ...
        public async Task<IActionResult> GetAttivitaTrattamentoZooFromAgenda(string Piva, int Id_Agenda)
        {
            ...
            try
            {
                ...
                AgronicaCoreParametri objP = UtilityAgronica.convertStringtoOBJparametri(auth.objP.objP_server, _securitySettings);
                Attivita? attivita = await _trattamentoZooService.GetAttivitaFromAgenda(Piva, Id_Agenda, objP);
        ...
        public async Task<IActionResult> LeggiGiacenzaFarmaci([FromBody] InData.Zoo.LeggiGiacenzaFarmaci leggiFarmaci)
        {
            ...
            try
            {
                ...
                AgronicaCoreParametri objParametriSuperServer = UtilityAgronica.convertStringtoOBJparametri(auth.objP.objP_super_server, _securitySettings);
                AgronicaCoreParametri objParametriServer = UtilityAgronica.convertStringtoOBJparametri(auth.objP.objP_server, _securitySettings);
                AgronicaCoreParametri objParametriUtenti = UtilityAgronica.convertStringtoOBJparametri(auth.objP.objP_utenti, _securitySettings);
        ...
        public async Task<IActionResult> ConfermaSomministrazioneFutura(Attivita Somministrazione)
        {
            ...
            try
            {
                ...
                AgronicaCoreParametri objParametriServer = UtilityAgronica.convertStringtoOBJparametri(auth.objP.objP_server, _securitySettings);
                AgronicaCoreParametri objParametriUtenti = UtilityAgronica.convertStringtoOBJparametri(auth.objP.objP_utenti, _securitySettings);
                var r = await _trattamentoZooService.ScriviModificaSomministrazione(Somministrazione, objParametriServer, objParametriUtenti);
