    ...
    public class WidgetDocumentaleController : BaseController
    {
        ...
        public async Task<IActionResult> GetDocumentRecap([FromBody] DateTime timeStart)
        {
            ...
            try
            {
                ...
                var res = await _widgetDocumentaleService.GetDocumentRecapAsync(timeStart, objParametriServer, UtilityAgronica.convertStringtoOBJparametri(auth.objP.objP_utenti, _securitySettings)) ?? throw new Exception("Nessun dato recuperato");
