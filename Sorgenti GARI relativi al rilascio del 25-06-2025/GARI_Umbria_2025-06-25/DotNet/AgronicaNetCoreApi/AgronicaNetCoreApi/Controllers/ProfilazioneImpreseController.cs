...
public class ProfilazioneImpreseController : BaseController
{
    ...
    public async Task<IActionResult> SalvaProfilazione([FromBody] SalvaProfilazione_In body)
    {
        ...
        try
        {
            ...
            var objParams = ExtractObjParametriServerAndSetCulture(auth);
            var result = await _profilazioneImpreseService.SalvaProfilazioneAsync(body, objParams);
    ...
    public async Task<IActionResult> LeggiProfilazioneMacchineXContatti([FromQuery] string? piva, [FromQuery] int vegCod)
    {
        ...
        try
        {
            ...
            var objParams = ExtractObjParametriServerAndSetCulture(auth);
            var result =
                await _profilazioneImpreseService.LeggiProfilazioneMacchineXContattiAsync(piva ?? "", vegCod, objParams);
        ...
        [FromQuery] int notaUtilizzoCod, [FromQuery] int lavCod, [FromQuery] int vegCod, [FromQuery] string? piva)
    {
        ...
        try
        {
            ...
            var objParams = ExtractObjParametriServerAndSetCulture(auth);
            var result =
                await _profilazioneImpreseService.CancellaAsync(piva ?? "", notaUtilizzoCod, idGruppo, lavCod, vegCod, objParams);
        ...
        [FromQuery] string? piva)
    {
        ...
        try
        {
            ...
            var objParams = ExtractObjParametriServerAndSetCulture(auth);
            var result =
                await _profilazioneImpreseService.PropagaSuTutteLeOperazioniAsync(piva ?? "", lavCod, vegCod, objParams);
    ...
    public async Task<IActionResult> AggiornaOreMinuti([FromBody] AggiornaOreMinuti_In body)
    {
        ...
        try
        {
            ...
            var objParams = ExtractObjParametriServerAndSetCulture(auth);
            var result =
                await _profilazioneImpreseService.AggiornaOreMinutiAsync(body, objParams);
