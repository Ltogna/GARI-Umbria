...
namespace AgronicaNetCore.Operazione.DAL.DataLayer.Agenda
{
    public class Magazzino : DAL_Base, IMagazzino
    {
...
)
        {
            ...
            bool visibilita_totale = await _utentiProfili.VisibilitaTotaleGiasOnline(objParametriUtenti);
            /// TODO 1
            ...
            try
            {
                ...
                bool flagJoinSuperUserCac = await GetFlagJoinCac(objParametriUtenti);
                ...
                for (i = 1; i <= i_tot; i++)
                {
                    ...
                    if (!visibilita_totale)
                    {
                        ...
                        SQL_Generale.AppendLine(" ON Mov_Destinazioni.PIVA = uva.Piva AND Mov_Destinazioni.Sa_Cod = uva.Sa_Cod AND uva.Entita_Cod = 2 ");
                    }
                    ...
                    SchedeMagazzinoGestioneJoin(ref SQL_Generale, parSql, parSqlIn, Elem_Cod, i, isFreshAndFood, flagRecuperaCodArticolo, flagJoinSuperUserCac, objParametriServer.PivaSuperUser);
        ...
        private async Task<bool> GetFlagJoinCac(AgronicaCoreParametri objParametriUtenti)
        {
            ...
            try
            {
                string joinSuperUser = await _utentiImpostazioni.ImpostazioneValore1_from_ImpostazioneCod(Enum_Impostazioni_Utenti.SUPERUSER_JoinCacPivaSuperUser, 2, objParametriUtenti);
        ...
        public void SchedeMagazzinoGestioneJoin(ref StringBuilder SQL_Generale, Dictionary<string, object> parSql, Dictionary<string, Dictionary<Type, List<object>>> parSqlIn, int Elem_Cod, int i, bool isFreshAndFood = false, bool flagRecuperaCodArticolo = false, bool flagJoinSuperUserCac = false, string pivaSuperUser = "")
        {
            if (Elem_Cod == 0)
            {
                switch (i)
        ...
        /// Join Materie Prime
        /// </summary>
        private string SchedeMagazzino_Join_7()
        {
            StringBuilder sqlProdottiJoin = new StringBuilder();
        ...
        /// Join Materie Prime
        /// </summary>
        private string SchedeMagazzino_Join_10(bool isFreshAndFood)
        {
            StringBuilder sqlProdottiJoin = new StringBuilder();
        ...
        /// </summary>
        private string SchedeMagazzino_Join_11()
        {
            StringBuilder sqlProdottiJoin = new StringBuilder();
