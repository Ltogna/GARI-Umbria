...
Public Class MenuStampeBootstrap
    ...
    Public Shared Function caricaStampePreferite() As RispostaStandard
        ...
        Try
            ...
            Dim expObj = objUtentiImpostazioni.Leggi_Utente_Poi_SuperUser(enum_Impostazioni_Utenti.UTENTE_STAMPE_PREFERITE, 1, AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta,
                                              "", "", objParametri_Utenti).ToExpandoObject
