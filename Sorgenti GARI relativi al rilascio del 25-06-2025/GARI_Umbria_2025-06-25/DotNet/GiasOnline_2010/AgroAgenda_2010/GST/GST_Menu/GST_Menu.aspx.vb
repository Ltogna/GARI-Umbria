...
Partial Class GST_Menu
    ...
    Public Shared Function StampaElenco(ByVal Sportello As String) As String
        ...
        Dim dt As DataTable = objR.Leggi(id_Sportello, 0, objParametri_Server)
    ...
    Public Shared Function MostraMessaggi(ByVal Sportello As String) As InterferenzeNotifiche
        ...
        Dim strInterferenze As String = objInterferenze.MostraInterferenzeGlobali_New(id_Specie, CodiceFiscaleTecnico, False, DataInizioSportello, DataFineSportello, objParametri_Server)
        ...
        Dim objR As New AgronicaCoreSementieriDAL.Sementieri_Sportello_LOG_R
        Dim dt As DataTable = objR.Leggi(sportello_cod, 0, objParametri_Server)
