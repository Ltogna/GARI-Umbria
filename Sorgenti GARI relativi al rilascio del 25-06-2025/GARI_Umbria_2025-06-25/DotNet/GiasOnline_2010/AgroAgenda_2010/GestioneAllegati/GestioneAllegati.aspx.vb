...
Public Class GestioneAllegati
    ...
    <WebMethod(EnableSession:=True)>
    Public Shared Function RicercaDDLIndice(ByVal piva As String, ByVal id_indice As Integer, ByVal tipocampo As Integer, ByVal elenco_tipo As Integer, ByVal elenco_cod As Integer, ByVal data_riferimento As String) As RispostaStandard
        ...
        Try
            ...
            Dim leggi As New AgronicaCoreScadenziario.Alert_Indice_R
            DT = leggi.LeggiDDLIndice(piva, id_indice, tipocampo, elenco_tipo, elenco_cod, data_riferimento, objParametri_Server)
