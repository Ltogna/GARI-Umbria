...
#End Region
    ...
    Public Shared Function Leggi_Elenco_Tipo(ByVal piva As String) As RispostaStandard
        ...
        Try
            ...
            Dim leggi As New AgronicaCoreAnagrafeDAL.Rapporti_Contabili_R
            DT = leggi.Contatti_RapportiContabili_Leggi(0, 0, False, False, False, False, False, False, False, enumSelezioneVariabile.Selezione_TabellaCompleta, "Rapporti_Contabili.Cod_rapporto < 0 OR Rapporti_Contabili.Cod_rapporto = -28", "", objParametri_Server)
            ...
            DR_Elenco = DT_Elenco.NewRow
            DR_Elenco.Item("Elenco_Tipo") = 5
            DR_Elenco.Item("Elenco_Cod") = 0
            DR_Elenco.Item("Elenco_Des") = AgronicaAgenda_2010.MacchinaAttrezzatura
            DR_Elenco.Item("Elenco_Key") = DR_Elenco.Item("Elenco_Tipo") & "_" & DR_Elenco.Item("Elenco_Cod")
            DT_Elenco.Rows.Add(DR_Elenco)

            DR_Elenco = DT_Elenco.NewRow
            DR_Elenco.Item("Elenco_Tipo") = 6
            DR_Elenco.Item("Elenco_Cod") = 0
