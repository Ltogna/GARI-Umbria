...
Public Class IrrigazioneBS
    ...
    Public Shared Function Leggi_Specie(ByVal piva As String,
        ...
        Try
            ...
            Dim Carica_Tutte_Specie_Esistenti As Boolean = False
            ...
            Dim CaricaxPDC As Boolean = False
    ...
    Private Sub Ripristina_Dati_nei_Controlli_xRicetta(ByVal Xml_Operazione As String,
        ...
        Dim PrimoProdotto As Boolean = False
        ...
        If Not XML_DatiRicetta_Dettagli Is Nothing Then
            ...
            For i = 0 To XMLs_Ricetta_Dettaglio.Count - 1
                ...
                If Cau_Mov = AgronicaCoreDataProvider.CostantiPersonalizzate.CAU_LAVORAZIONE Then
                    ...
                    If Not XMLs_RicettaDestinazione Is Nothing AndAlso XMLs_RicettaDestinazione.Count > 0 Then
                        ...
                        For j = 0 To XMLs_RicettaDestinazione.Count - 1
                            ...
                            If CInt(objParametriAgenda.Veg_Cod) = 0 And CInt(Dt_Imp.Rows(0).Item("id_cod")) <> 0 Then
                                If j = 0 Then
...
#End Region
    ...
    Public Shared Function Leggi_DSS_Irrigazione(ByVal data As Date, ByVal piva As String, ByVal sa_cod As Integer,
        ...
        Try
            ...
            Dim DT = DSS_Irrigazione.Leggi_Precedenti(piva, sa_cod, appezza, id_reg, progetto_cod,
