...
#Region "Salvataggio"
        ...
        Select Case TipoSalvataggio
            ...
            Case enum_Tipo_Salvataggio.Salva_e_Esci
                ...
                Else
                    ...
                    Try
                        ...
                        ElseIf sitoorigine = Enum_SiteRedirector.Sito_AgronicaAgenda_2010 And paginaOnLineRitorno = enum_PagineAgenda_2010.Pagina_Visite_Lista Then
            ...
            Case enum_Tipo_Salvataggio.Salva_e_Vai_ai_Costi
                ...
                Else
                    ...
                    PaginaLink &= "?p=" & Sicurezza.Stringa_Codifica(objParametriAgenda.Piva, AgroKey_EncoderDecoder) &
                        ...
                        For Each lav As String In listaLavCod
                            ...
                            Select Case lav
                                ...
                                Case LAVCOD_FASI_FENOLOGICHE
                                    ...
                                    Dim listaFasi As List(Of String) = (From x In righeModificateArray Where CStr(x("lav_cod")) = LAVCOD_FASI_FENOLOGICHE And CStr(x("sa_cod")) = sacod
    ...
    Private Function CreaOggettoAgendaAltreLavorazioni(Sa_Cod As Integer, lav_cod_selez As String, idAg As Integer, OggettoDellaVisita As enum_OggettoVisita) As Operazione_Agenda
        ...
        '------------------------------------------------
        Call Calcola_BaseCode_TopCode(BaseCode, TopCode, Session("ASG_ProgressivoGIAS"))
        ...
        For Each avvUdm As String In listaAvvUdm
            ...
            For Each cRow In righeFiltrate
                ...
                If Movimento_Destinazione.Piva <> Agenda.Piva Or Movimento_Destinazione.Sa_Cod <> Agenda.Sa_Cod Then
                    'passa ad altra colonna, perchè la colonna riguarda un altro centro
                    Dim cftygv = 0
                Else
            ...
            Case LAVCOD_RILIEVO_AVVERSITA_CAMPO
                ...
                If udmdes.Contains("%") Then
                    ...
                    If CDbl(valoreRilevato) > 100 Then
                        causa = Resources.AgronicaAgenda_2010.NonPuòEssereMaggioreDi100
                        Return False
                    End If

                ElseIf udmdes.Contains("(s/n)") Or udmdes.Contains("(S/N)") Then
                    'si/no, TODO: disambiguare per il multilingua
                    If Not IsNumeric(valoreRilevato) Then
                        causa = Resources.AgronicaAgenda_2010.DeveEssere1O0NelCasoDiPrezenzaONonPresenza
                        Return False
                    End If
                    If CInt(valoreRilevato) <> 1 And CInt(valoreRilevato) <> 0 Then
                        causa = Resources.AgronicaAgenda_2010.DeveEssere1NelCasoDiRilevamentoDellAvversi
                        Return False
                    End If
                Else
                    'numero
...
#Region "Caricamento dei dati"
    ...
    Private Sub AnnullaTutto(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If objParametriAgenda.SitoOrigine = Enum_SiteRedirector.Sito_AgronicaAgenda_2010 And (
            objParametriAgenda.PaginaSitoOrigine = enum_PagineAgenda_2010.Pagina_Trattamenti OrElse
            objParametriAgenda.PaginaSitoOrigine = enum_PagineAgenda_2010.Gis OrElse
            objParametriAgenda.PaginaSitoOrigine = enum_PagineAgenda_2010.Pagina_Filtrone) Then
        ...
        Try
            ...
            ElseIf sitoorigine = Enum_SiteRedirector.Sito_AgronicaAgenda_2010 And paginaOnLineRitorno = enum_PagineAgenda_2010.Pagina_Visite_Lista Then
                link = "../Visite/Visite_Lista.aspx"
            ElseIf sitoorigine = Enum_SiteRedirector.Sito_AgronicaAgenda_2010 And paginaOnLineRitorno = enum_PagineAgenda_2010.Pagina_Visite_ListaDettagli Then
    ...
    Public Shared Function caricaListaPreset() As RispostaStandard
        ...
        Try
            ...
            If objPA.Lav_Cod = "0" Then
                r.Errore = DirectCast(HttpContext.GetLocalResourceObject("~/App_LocalResources/RilieviBS.aspx.resx", "ErroreOperazioneNonImpostata"), String)
                r.RispostaOK = False
                Return r
            End If
    ...
    Private Sub RipristinaControlliDaAgenda()
        ...
        If Not IsNothing(Agenda) Then
            ...
            If Agenda.Raccoglitore_Cod <> 0 Then
                ...
                If Not ListaOperazioni Is Nothing Then
    ...
    Private Function GeneraTabella(ByVal genera_DaMaster As Boolean, ByRef Agenda As Operazione_Agenda)
    ...
    Private Sub AggiungiRigaTabellaFinale_DaAltreLavorazioni(
        ...
        dr("Operazione") = DirectCast(GetLocalResourceObject("Visita Personalizzata"), String) 'XXXXXXXXXXXXXXXXXXXXXXX
        dr("av_cod") = 0
        dr("udm_cod") = 0
        dr("ff_cod") = 0
    ...
    Private Function RilievoIndiceMaturitaGeneraDescrizione(ByVal Lista_IndiciMaturita As List(Of AgronicaCoreMetaSchemaBIZ.IndiciMaturita), ByVal rilievo As rilievoAvv) As String
        ...
        Dim rval As String = (From aa In Lista_IndiciMaturita
                              Where aa.udm_cod = rilievo.Udm_cod _
                                And aa.ind_mat_cod = rilievo.Av_cod
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Master.Master.Header_versione = VERSIONE_HEADER_DEFAULT
