...
#End Region
    ...
    Private Sub Cambiato_Disciplinare()
        ...
        If objParametriAgenda.Disciplinare <> ComboDisciplinari1.Valore_Combo Then
            ...
            'CType(Ricerca.FindControlIterative(Page.Master, "ImgBtn_CheckDPI"), ImageButton).Visible = True
            If objParametriAgenda.Disciplinare <> "0" And objParametriAgenda.Disciplinare <> "-2" Then
                CType(Ricerca.FindControlIterative(Page.Master, "ImgBtn_Disciplinare"), ImageButton).Visible = True
                'CType(Ricerca.FindControlIterative(Page.Master, "ImgBtn_CheckDPI"), ImageButton).Visible = True
    ...
    Public Sub Aggiorna_Dpi()
        ...
        If LockModifica.Visible = False Then
            CaricaGriglia_Avversita()
        End If
    ...
    Private Sub CaricaGriglia_Avversita(Optional ByVal FrCod As Integer = 0)
        ...
        End If
        '---------------------------------------------------------------
        If objParametriAgenda.Veg_Cod.Split("/")(0) = "" Or objParametriAgenda.Veg_Cod.Split("/")(0) = "-1" Then
        ...
        Select Case Session("Collegamento_Fito")
                ...
                If Session("Collegamento_DPI") = True Then
                    ...
                    Select Case objParametriAgenda.Disciplinare
                        ...
                        Case "0", "-2"
                            ...
                            If IsNothing(Dt_Avv_Tot) And IsNothing(Dt_Inf_Tot) Then
            ...
            Case Else
                ...
                Dim DrInfTmp() As DataRow
                Dim DrInfGruTmp() As DataRow
                ...
                If Not IsNothing(DtAvvTmp) Then
                    For i = 0 To DtAvvTmp.Rows.Count - 1
                        ...
                        If Not DrInf Is Nothing AndAlso DrInf.Length > 0 Then
                            Dr.Item("Avversita_Infestanti") = 1
                        Else
                            Dr.Item("Avversita_Infestanti") = 0
                        End If
                ...
                If Not IsNothing(DtAvvGruTmp) Then
                    For i = 0 To DtAvvGruTmp.Rows.Count - 1
                        ...
                        If Not DrInfGru Is Nothing AndAlso DrInfGru.Length > 0 Then
                            Dr.Item("Avversita_Infestanti") = 1
                        Else
                            Dr.Item("Avversita_Infestanti") = 0
                        End If
    ...
    Private Function CreaOggettoAgenda_Normale(ByVal Sa_Cod As Integer, _
        ...
        If Not Session("vs_dtDosi") Is Nothing Then
        ...
        If rbl_DoseHL.Checked = True Then
            'HL
            Movimento.Mezzo = 0
        Else
            'q
        ...
        If rbl_QtaDose.Checked = True Then
            'dose
        ...
        If rblAcqua_HA.Checked = True Then
    ...
    Private Sub Ripristina_Dati_nei_Controlli()
        ...
        'Dim CoadiuvanteCorroborante As Boolean
        ...
        Dim DoseMinTemp, DoseMaxTemp As Decimal
                        ...
                        Case CAU_TRATTAMENTO
                            ...
                            If Not IsNothing(Agenda.Movimenti(i).Movimenti_Dettagli_Tecnici) Then
                                ...
                                For j = 0 To Agenda.Movimenti(i).Movimenti_Dettagli_Tecnici.Count - 1
                                    ...
                                    If Agenda.Movimenti(i).Movimenti_Dettagli_Tecnici(j).Av_Cod = 0 And _
                                ...
                                For j = 0 To Agenda.Movimenti(i).Movimenti_Dettagli.Count - 1
                                    ...
                                    Select Case Agenda.Movimenti(i).Movimenti_Dettagli(j).Elem_Cod
                                        ...
                                        Case FORMULATI
                                            ...
                                            If Not DT_Fr Is Nothing AndAlso DT_Fr.Rows.Count > 0 Then
                                            ...
                                            If rbl_DoseHL.Checked = True Then 'todo, hl ha ??
                                                Udm_Des = "[" & Udm_Sim & "/hl]"
                                            Else
                                                Udm_Des = "[" & Udm_Sim & "/q]"
                                            End If
                                            ...
                                            If rbl_DoseHA.Checked = True Then
                                                '/ha
                                            ...
                                            If Carenza = -1 Or Carenza = 0 Then
                                        ...
                                        Case Else
                                            ...
                                            For l = 0 To GridViewMagazzino.Rows.Count - 1
                                                If CInt(GridViewMagazzino.Rows(l).Cells(2).Text) = Mat_Cod And _
                                                    CInt(GridViewMagazzino.Rows(l).Cells(3).Text) = Cod_Progetto And _
                                                    CInt(GridViewMagazzino.Rows(l).Cells(4).Text) = Cal_Cod And _
                                    ...
                                    If Dpi_Cod = Disciplinare_Cod Then
                                        ...
                                        If Grfi_Cod = 0 Then
                                            If Copertura = 1 And Flag_Protetto = 1 Then
                                                ...
                                                Exit For
                                            ElseIf (Copertura = 0 And Flag_Protetto = 0) Or _
                                            (Copertura = 0 And Flag_Protetto = -1) Or _
                                            (Copertura = 0 And Flag_Protetto = 2) Then
                                                Disciplinare_Valore = ComboDisciplinari1.ddl_Disciplinari.Items(c).Value
                                                Exit For
                                            End If
                                        Else
...
#Region "GESTIONE DOSI"
    ...
    Private Sub GridView_Dosi_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView_Dosi.RowCommand
        ...
        Dim QuantitaParziale As Decimal = 0
        ...
        If Not Dt_Dosi Is Nothing Then
            ...
            Select Case e.CommandName
                ...
                Case "Modifica"
                    ...
                    If ComboFiltriAggiuntiviAgenda1.ddl_FiltriAggiuntivi.SelectedValue <> "0" Then
                        ...
                        If TipoRichiesto <> enum_TipoFormulato.Coadiuvanti And TipoRichiesto <> enum_TipoFormulato.Corroboranti_Fisiofarmaci Then
                            ...
                            If Not Array_AvCod_Temp Is Nothing Then
                                ...
                                Next
                            End If
                            If Not Array_AvGru_Temp Is Nothing Then
                    ...
                    If Dt.Rows.Count < 1 Then
                        ...
                        If ComboDisciplinari1.ddl_Disciplinari.SelectedValue = "0" And ComboFiltriAggiuntiviAgenda1.ddl_FiltriAggiuntivi.SelectedValue <> "0" Then
...
#End Region
    ...
    Private Sub CaricaKG(ByVal unitaMisuraSelezionata As Integer)
        ...
        If Not Cmb_UdM Is Nothing AndAlso Not Cmb_UdM.Items Is Nothing Then
    ...
    Private Sub Imposta_DosiEtichetta(ByVal DoseEtichetta As String)
        ...
        Else
            ...
            If CopiaQuantita = True Then
                ...
                If Me.rbl_DoseHA.Enabled = True Then
...
#End Region
                        ...
                        If ArrayTmp.Length > 1 Then
                            ...
                            For i = 6 To ArrayTmp.Length - 1
                                ...
                                If Not ArrayDose Is Nothing AndAlso ArrayDose.Length > 0 Then
                                    ...
                                    AcquaMin = ArrayDose(4)
                                    AcquaMax = ArrayDose(5)
                                    AcquaUdm_Cod = ArrayDose(6)
                                    AcquaUdm_Sim = ArrayDose(7)

                                    Da_Epoca = ArrayDose(8)
                                    A_Epoca = ArrayDose(9)

                                    Limite = ArrayDose(10)
                                    LimiteUdm_Cod = ArrayDose(11)
                                    LimiteUdm_Sim = ArrayDose(12)

                                    Flag_Fioritura = ArrayDose(14)
                                    Intervallo_Min = ArrayDose(15)
                                    Intervallo_Max = ArrayDose(16)
    ...
    Protected Sub EventoAggiornamentoAvversita_Click(sender As Object, e As EventArgs) Handles EventoAggiornamentoAvversita.Click
        ...
        If ComboFiltriAggiuntiviAgenda1.Valore_Combo = 1 And ComboFormulati.Valore_Combo.Length > 0 Then
            ...
            Dim Dose_Consigliata As Decimal = 0
            Dim Dose_Consigliata_Udm As Integer = 0
            Dim grfi_cod As Integer = 0
    ...
    Protected Sub ImgBtn_DoseInserisci_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImgBtn_DoseInserisci.Click
        ...
        If Not Session("DoseEtichetta") Is Nothing Then
            Dose_Etichetta = Session("DoseEtichetta")
        End If
        If Not Session("DoseMax") Is Nothing Then
    ...
    Private Function ControllaDose(ByRef Dose As Decimal, ByRef Dose_Tot As Decimal)
        ...
        If True Then
            ...
            If DoseMassimaHaPresente And Not BloccoDoseMassimaHa Then
                Return False
            End If
        End If
        ...
        If Not DoseMassimaHaPresente Then
            ...
            If DoseMassimaHLPresente And Not BloccoDoseMassimaHL Then
                Return False
            End If
        End If
        ...
        If True Then
            ...
            If DoseMinimaHAPresente And Not BloccoDoseMinimaHA Then
                Return False
            End If
        End If
        ...
        If Not DoseMinimaHAPresente Then
            ...
            If DoseMinimaHLPresente And Not BloccoDoseMinimaHL Then
                Return False
            End If
        End If
    ...
    Private Function ControllaDoseMassimaHa(ByRef DosePresente As Boolean, ByRef SuperataDose As Boolean, ByRef SuperataDoseDiserbo As Boolean) As Boolean
        ...
        If Not Session("D_HA_Max") Is Nothing AndAlso Session("D_HA_Max") <> 0 Then
            DosePresente = True
            ...
            If Not Session("D_HA_Max_Diserbo") Is Nothing AndAlso Session("D_HA_Max_Diserbo") <> 0 Then
    ...
    Private Function ControllaDoseMassimaHL(ByRef DosePresente As Boolean, ByRef SuperataDose As Boolean, ByRef SuperataDoseDiserbo As Boolean) As Boolean
        ...
        SuperataDoseDiserbo = False
        'HL
        If Not Session("D_HL_Max") Is Nothing AndAlso Session("D_HL_Max") <> 0 Then
            DosePresente = True
            'se ho una dose massima a ettaro
    ...
    Private Function ControllaDoseMinimaHA(ByRef DosePresente As Boolean, ByRef SuperataDose As Boolean) As Boolean
        DosePresente = False
        SuperataDose = False
        If Not Session("D_HA_Min") Is Nothing AndAlso Session("D_HA_Min") <> 0 Then
            DosePresente = True
            'se ho una dose massima a ettaro
    ...
    Private Function ControllaDoseMinimaHL(ByRef DosePresente As Boolean, ByRef SuperataDose As Boolean) As Boolean
        DosePresente = False
        SuperataDose = False
        If Not Session("D_HL_Min") Is Nothing AndAlso Session("D_HL_Min") <> 0 Then
            DosePresente = True
            'se ho una dose massima a ettaro
    ...
    Private Function ControllaAcqua() As Boolean
        ...
        If Not session("Acqua_Max") Is Nothing AndAlso session("Acqua_Max") <> 0 Then
        ...
        If Not session("Acqua_Min") Is Nothing AndAlso session("Acqua_Min") <> 0 Then
    ...
    Private Function ControllaSelezioneUnitadiMisura(ByRef UdmCod As Integer, ByRef UdmDesSimbolo As String, ByRef UdmDes As String, ByRef UdmCodTrasformato As Integer) As Boolean
        ...
        Else
            ...
            If Me.rbl_DoseHL.Checked = True Then
    ...
    Private Sub btn_cerca_avv_Click(sender As Object, e As System.EventArgs) Handles btn_cerca_avv.Click
        ...
        If Not DtAvv Is Nothing AndAlso DtAvv.Rows.Count > 0 Then
