...
<WebMethod(EnableSession:=True)> _
    ...
    Private Function SalvaTutto() As Boolean
        ...
        Dim StringaXmlCostiAccessori As String

        Dim Flag_Insert As Boolean = False

        Dim Old_Id_Agenda As String
        Dim New_Id_Agenda As String
    ...
    Private Function Ripristina_Dati_nei_Controlli() As String
        ...
        'Dim xmlCostiAccessori As System.Xml.XmlElement
        ...
        Dim frm_LavorazioneCodice As Integer = 0
        Dim frm_DataOperazione As Date
        Dim frm_NoteIntervento As String
        Dim frm_NumDoc As Integer
        Dim frm_CodRisUm As Integer
        Dim frm_ElemCod() As Integer
        Dim frm_ProCod() As Integer
        Dim frm_MatCod As New List(Of Integer)
        Dim frm_Lavorazione_ElementoGestito As Integer
        ...
        If Not IsNothing(Agenda) Then
            ...
            If Not IsNothing(Agenda.Movimenti) Then
                Dim MovimentiMacchine As List(Of Movimento) = New List(Of Movimento)
