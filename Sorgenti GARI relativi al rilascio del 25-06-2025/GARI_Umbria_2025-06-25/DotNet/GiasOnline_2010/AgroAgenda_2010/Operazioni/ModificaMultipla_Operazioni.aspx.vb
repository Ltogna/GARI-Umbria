...
Public Class ModificaMultipla_Operazioni
    ...
    Private Sub CaricaListaMacchinari()
        ...
        Select Case PivaSingola
            Case True
                ...
                If chk_solo_privati_macchine.Checked = True Then
                    pubblici = False
                Else
                    pubblici = True
                End If
    ...
    Private Sub CaricaListaPersone()
        ...
        Select Case PivaSingola
            Case True
                'carico le macchine aziendali + quelle pubbliche
                If chk_solo_privati_contatti.Checked = True Then
    ...
    Protected Sub Btn_Salva_Click(sender As Object, e As EventArgs) Handles Btn_Salva.Click
        ...
        Select Case Combo_Modifiche.SelectedValue
            ...
            Case enum_ModificaMultiplaOperazioni.AggiungiMacchina
                ...
                If chk_elimina_precedenti_macchine.Checked = True Then
                                ...
                                For j = 0 To Agenda.Movimenti(i).Movimenti_Dettagli.Count - 1
                                    ...
                                    If Not IsNothing(Agenda.Movimenti(i).Movimenti_Dettagli(j).Movimenti_Destinazioni) Then
                                        ...
                                        For x = 0 To Agenda.Movimenti(i).Movimenti_Dettagli(j).Movimenti_Destinazioni.Count - 1
                                            ...
                                            For a = 0 To objParametriAgenda.Impianti.Count - 1
                                                If objParametriAgenda.Impianti(a).Piva = Agenda.Movimenti(i).Movimenti_Dettagli(j).Movimenti_Destinazioni(x).Piva And
                                                   objParametriAgenda.Impianti(a).Sa_Cod = Agenda.Movimenti(i).Movimenti_Dettagli(j).Movimenti_Destinazioni(x).Sa_Cod And
                                                   objParametriAgenda.Impianti(a).Appezza = Agenda.Movimenti(i).Movimenti_Dettagli(j).Movimenti_Destinazioni(x).Appezza And
                                ...
                                For j = 0 To Agenda.Movimenti(i).Movimenti_Dettagli.Count - 1
                                    ...
                                    If Not IsNothing(Agenda.Movimenti(i).Movimenti_Dettagli(j).Movimenti_Destinazioni) Then
                                        ...
                                        For x = 0 To Agenda.Movimenti(i).Movimenti_Dettagli(j).Movimenti_Destinazioni.Count - 1
                                            ...
                                            For a = 0 To objParametriAgenda.Impianti.Count - 1
                                                If objParametriAgenda.Impianti(a).Piva = Agenda.Movimenti(i).Movimenti_Dettagli(j).Movimenti_Destinazioni(x).Piva And _
                                                   objParametriAgenda.Impianti(a).Sa_Cod = Agenda.Movimenti(i).Movimenti_Dettagli(j).Movimenti_Destinazioni(x).Sa_Cod And _
                                                   objParametriAgenda.Impianti(a).Appezza = Agenda.Movimenti(i).Movimenti_Dettagli(j).Movimenti_Destinazioni(x).Appezza And _
                                                   objParametriAgenda.Impianti(a).ID_Reg = Agenda.Movimenti(i).Movimenti_Dettagli(j).Movimenti_Destinazioni(x).Id_Destinazione Then
        ...
        For m = 0 To GridView_Macchine.Rows.Count - 1
            ...
            If CType(GridView_Macchine.Rows(m).FindControl("ChkSelezionaMacchina"), CheckBox).Checked = True Then
                ...
                Dt = objDettagliR.Leggi(Piva, Sa_Cod, Id_Agenda, Id_Mov, 0, 0, 0, Mac_Cod, _
                           "", 0, 0, 0, 0, 0, 0, AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta, _
                           "", "", objParametri_Server)
    ...
    Private Function AggiungiContatti(ByVal Id_Agenda As Integer, _
        ...
        If EliminaPrecedenti = True Then
            ...
            If Not DtMovC Is Nothing AndAlso DtMovC.Rows.Count > 0 Then
        ...
        For m = 0 To GridView_Contatti.Rows.Count - 1
            ...
            If CType(GridView_Contatti.Rows(m).FindControl("ChkSelezionaContatto"), CheckBox).Checked = True Then
                ...
                DtMov = objMovimento.Leggi(Piva, 0, Id_Agenda, 0, 0, Cau_Mov, _
                        AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta, _
                        "", "", objParametri_Server)
                ...
                DtMovDet = objDettagliR.Leggi(Piva, Sa_Cod, Id_Agenda, Id_Mov, 0, 0, 0, Cod_Risum, _
                                     Cau_Mov, 0, 0, 0, 0, 0, 0, AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta, _
                                    "", "", objParametri_Server)
