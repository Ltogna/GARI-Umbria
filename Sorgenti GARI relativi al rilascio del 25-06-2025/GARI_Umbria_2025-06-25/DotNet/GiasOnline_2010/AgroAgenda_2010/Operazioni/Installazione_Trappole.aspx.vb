...
#Region "Metodi Eseguiti nel Load"
            ...
            For j = 0 To agenda.Movimenti(i).Movimenti_Dettagli.Count - 1
                ...
                For x = 0 To agenda.Movimenti(i).Movimenti_Dettagli(j).Movimenti_Dettagli_Tecnici.Count - 1
                    ...
                    If x = 0 Then
                        ...
                        'Parametri guali per tutte le trappole dell'operazione:
                    ...
                    ElseIf _
                        TrappolaCodiceDittaTrappola <> agenda.Movimenti(i).Movimenti_Dettagli(j).Movimenti_Dettagli_Tecnici(x).Ditta_cod Or
                        TrappolaSiglaAv <> agenda.Movimenti(i).Movimenti_Dettagli(j).Movimenti_Dettagli_Tecnici(x).Sigla_av Or
    ...
    Private Sub ImpostaValoriSelezionatiCombo()
        ...
        Try
            ...
            If IsNothing(objParametriAgenda.InstallazioneTrappola.CodiceProdotto) Or
        ...
        Try
            ...
            If IsNothing(objParametriAgenda.InstallazioneTrappola.AvCod) Or
    ...
    Private Function GeneraTabellaHtmlTrappole(ByVal genera_DaMaster As Boolean) As Boolean
        ...
        If genera_DaMaster Then
            ...
            If cmb_Trappola.SelectedItem.Value = "" Or cmb_Trappola.SelectedItem.Value = "0" Or cmb_Trappola.SelectedItem.Text = "" Then
                Messaggi.AgroMsgBox(Resources.AgronicaAgenda_2010.IndicareLaTrappola, Page, , UpdatePanelGridImpianti)
                Return False
            End If

            If cmb_Avversita.SelectedItem.Value = "" Or cmb_Avversita.SelectedItem.Value = "0" Or cmb_Avversita.SelectedItem.Text = "" Then
    ...
    Public Function TrapDur_from_TrapCod2(
                                   ByVal TrapCod As Integer,
    ...
    Public Function Abbreviazione_from_AvCod2(
                                    ByVal AvCod As Integer,
...
#Region "Creazione oggetto Agenda"
    ...
    Private Function Crea_Agenda(ByRef ListaImp As List(Of AgronicaCoreModello.ParametriAgenda_Temp.Impianto), ByRef Sa_Cod As Integer, ByRef Agenda As Operazione_Agenda, ByRef messaggio_errore As String) As Boolean
        ...
        Else
            ...
            '    'devo controollare corrispondenza tra cobo e operazione
            '    Throw New NotImplementedException
            'End If
        End If
    ...
    Private Function Crea_Agenda_Movimento_Scarico(ByRef inneschiNumTotale As Integer, ByRef Agenda As Operazione_Agenda, ByVal NumeroTrappoleCentro As Decimal, ByRef Messaggio_Errore As String) As Boolean
        ...
        If CInt(Txt_NumeroTrappole.Text) > 0 Then
            ...
            Else
                ...
                If objParametriAgenda.Lav_Cod = LAVCOD_INSTALLAZIONE_TRAPPOLE Or
...
#Region "Salvataggio"
    ...
    Private Function SalvaOperazioneAgenda(ByRef messaggio_errore As String) As Boolean
        ...
        If objParametriAgenda.Tipo_Operazione = enum_TipoOperazioneDB.Modifica AndAlso
            (objParametriAgenda.Lav_Cod = LAVCOD_INSTALLAZIONE_TRAPPOLE Or objParametriAgenda.Lav_Cod = LAVCOD_CATTURE_MASSA) Then
            If cmb_Trappola.SelectedItem.Value = "" Or cmb_Trappola.SelectedItem.Value = "0" Or cmb_Trappola.SelectedItem.Text = "" Then
    ...
    Private Sub gestisciTipoSalvataggio()
        ...
        Select Case TipoSalvataggio
            Case enum_Tipo_Salvataggio.Salva_e_Esci
                ...
                If objParametriAgenda.Lav_Cod = LAVCOD_INSTALLAZIONE_TRAPPOLE Or objParametriAgenda.Lav_Cod = LAVCOD_CATTURE_MASSA Then
                    sblocca()
                End If
    ...
    Private Sub RigeneraTabellaPerSalvataggio()
        ...
        For i = 1 To TabellaTrappole.Rows.Count - 1
            ...
            For j = 0 To Request.Form.AllKeys.Length - 1
                If Not IsNothing(Request.Form.AllKeys(j)) AndAlso (Request.Form.AllKeys(j).EndsWith("grupporiga" & i - 1) = True) Then
