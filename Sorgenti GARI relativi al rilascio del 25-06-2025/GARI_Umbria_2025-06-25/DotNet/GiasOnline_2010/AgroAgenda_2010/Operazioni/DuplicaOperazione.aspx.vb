...
Imports AgronicaCoreModello.OperazioneAgenda
...
Public Class DuplicaOperazione
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            If OperazioniMultiAziendali = True Then
    ...
    Private Sub RecuperaIntervallo()
        ...
        Else
            ...
            For i = 0 To XMLs_Movimento.Count - 1
                ...
                If CInt(XML_Movimento.GetAttribute("cau_mov")) >= 2050 And CInt(XML_Movimento.GetAttribute("cau_mov")) <= 2300 Then
                        ...
                        For z = 0 To XMLs_MovimentoDestinazione.Count - 1
                            ...
                            Else
                                ...
                                For y = 0 To UBound(frm_Appezza)
                                    ...
                                    If frm_Appezza(y) = Appezza And frm_IdReg(y) = Id_Imp Then
    ...
    Private Shared Sub Carica_Impianti(objParametriAgenda As ParametriAgenda, dtInterventi As DataTable, ByRef strImpiantiKendo As String, ByRef DataViewImpianti As DataTable)
        ...
        If Not objParametriAgenda.Impianti Is Nothing AndAlso objParametriAgenda.Impianti.Count > 0 Then
            ...
            'Ricavo le date delle opearzioni d'agenda. i miei impianti devono essere validi in quelle date
    ...
    Private Sub ImpiantiAziendeInParametriAgenda()
        ...
        If Not DtElencoImpianti Is Nothing And DtElencoImpianti.Rows.Count > 0 Then
            ...
            For Each tempImp As DataRow In DtElencoImpianti.Rows
                ...
                If Not AttributiImp Is Nothing AndAlso AttributiImp.Rows.Count > 0 Then
    ...
    Protected Sub Btn_SalvaTutto_Click(sender As Object, e As EventArgs) Handles Btn_SalvaTutto.Click
        ...
        Call Calcola_BaseCode_TopCode(frm_BaseCode, frm_TopCode,
        ...
        For i = 0 To ListaOperazioniIn.Count - 1
            ...
            'Inizio i controlli solo dopo la prima iterazione (per aver popolato il precednete)
            If i > 0 Then
        ...
        If Not Session("DtOperazioniNonSalvate") Is Nothing AndAlso HiddenVarie.Value <> "" Then
        ...
        For Each OperazioneIn As AgronicaCoreModello.DuplicaOperazione_parametriInput In ListaOperazioniIn
            ...
            global_Flag_Insert = (global_Flag_Insert And Flag_Insert)
            ...
            If OperazioneIn.isLastxMultiAttivita Then
                If Flag_Insert = False Or Log_Errori <> "" Or Alert_Errori <> "" Or global_Raccoglitore_Alert_Errori <> "" Then
                    'inserimento fallito
        ...
        Else
            ...
            '---------------------------------------------------
            If FlagSalvaNonConformi = False Then
    ...
    Private Sub CopiaUnOperazione(ByVal id_agenda As Integer,
        ...
        Try
            ...
            If chk_ImpostaCopiaCosti.Checked = False Then
                        ...
                        For impresa = 0 To strPiva.Length - 1
                            ...
                            If Not strCentri Is Nothing AndAlso strCentri.Length > 0 Then
                                ...
                                For x = 0 To strCentri.Length - 1
                                    ...
                                    If FlagSalvaNonConformi = True Then
                                        ...
                                        If Not DrOpDaSalvare Is Nothing AndAlso DrOpDaSalvare.Length > 0 Then
                                    ...
                                    Else
                                                ...
                                                Select Case Session("ControllaBlocco")
                                                    ...
                                                    Case "1", "2" '1=blocco 2=alert
                                                        ...
                                                        If Session("ControllaBlocco") = "1" Then
                                                            If CorrettoConformita = False Then
                                        ...
                                        If (Not isFromNG AndAlso Session("UTENTE_COD_BLOCCA_SE_SUPERA_GIACENZE") = True) OrElse
                                            ...
                                            If CorrettoMagazzino = False Then
                                                If isBloccante Then
                                        ...
                                        If CorrettoMagazzino = True And CorrettoConformita = True Then
...
#End Region
                    ...
                    If Agenda.Movimenti(s).Movimenti_Dettagli.Count > 0 Then
                        ...
                        For p = 0 To Agenda.Movimenti(s).Movimenti_Dettagli.Count - 1
                            ...
                            If Agenda.Movimenti(s).Movimenti_Dettagli(p).Movimenti_Destinazioni.Count > 0 Then
                                ...
                                If (qta_in_data <> 0 And Not (qta_in_data < QTA_GiancenzeVisualizzate And qta_in_data > -QTA_GiancenzeVisualizzate)) Then
    ...
    Private Function VerificaStringaErrori(ByVal RisultatoVerifica As String, ByRef strErrore As String) As Boolean
        ...
        If XML_DatiNonConformi.HasChildNodes = False Then
            Conforme = True
        Else
            Conforme = False
        End If
    ...
    Private Function CheckValiditaDistinta(ByVal validita_inizio_distinta As String, ByVal validita_fine_distinta As String, ByVal data As Date) As Boolean
        ...
        If ((IsDate(validita_inizio_distinta) = False) Or
            (IsDate(validita_inizio_distinta) AndAlso CDate(validita_inizio_distinta) <= data)) And
            ((IsDate(validita_fine_distinta) = False) Or
