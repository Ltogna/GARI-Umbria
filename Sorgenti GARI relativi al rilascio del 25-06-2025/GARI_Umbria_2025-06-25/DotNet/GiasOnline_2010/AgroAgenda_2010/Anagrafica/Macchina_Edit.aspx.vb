...
Partial Class Macchina_Edit
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.Txt_DataInizioUtilizzo.Text = DateTime.Now.Today
        'Me.Txt_DataInizioUtilizzo_1.Text = Now.Today
    ...
    Public Shared Function CaricaGrigliaCostoUnitario(ByVal piva As String, ByVal mat_cod As Integer) As RispostaStandard
        ...
        If Not HttpContext.Current.Session("righeInseriteGrigliaCosto") Is Nothing AndAlso
            Not HttpContext.Current.Session("righeModificateGrigliaCosto") Is Nothing AndAlso
            Not HttpContext.Current.Session("righeEliminateGrigliaCosto") Is Nothing AndAlso
            Not HttpContext.Current.Session("tutteleRigheGrigliaCosto") Is Nothing Then
            ...
            If Not HttpContext.Current.Session("righeInseriteGrigliaCosto") Is Nothing AndAlso
               ...
               Not HttpContext.Current.Session("tutteleRigheGrigliaCosto") Is Nothing Then
                ...
                If Not righeModificate Is Nothing Then
                    ...
                    Next
                End If
                If Not righeEliminate Is Nothing Then
                    ...
                    Next
                End If
                If Not tutteleRighe Is Nothing Then
    ...
    Private Sub Salva_Tutto_NEW()
        ...
        If Not righeInseriteGrigliaCosto Is Nothing Then
        ...
        If Not righeModificateGrigliaCosto Is Nothing Then
        ...
        Try
            ...
            If ErroreGrigliaCosto = False Then


                Dim obj As New AgronicaCoreContabDAL.Prodotti_Costi_W


                If Not righeInseriteGrigliaCosto Is Nothing AndAlso righeInseriteGrigliaCosto.Any Then
                ...
                If Not righeModificateGrigliaCosto Is Nothing AndAlso righeModificateGrigliaCosto.Any Then
                ...
                If Not righeEliminateGrigliaCosto Is Nothing AndAlso righeEliminateGrigliaCosto.Any Then
    ...
    Private Function XML_GeneraStringoneFinale() As String
        ...
        Descrizione += IIf(Me.Cmb_Tipo.SelectedIndex <> -1, Me.Cmb_Tipo.SelectedItem.Text, "")
        ...
        Try
            ...
            Select Case Operazione
                ...
                Case enum_TipoOperazioneDB.Modifica
                    ...
                    'ma in alcuni archivi, non si sa perchè,
                    'la piva dell'ioperazione di agenda è diversa dalla piva di parco_macchine!
