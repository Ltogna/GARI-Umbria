...
Public Class Modifica_Multipla_Zoo
    ...
    Public Shared Function getRazze(ByVal SPE_COD, ByVal GEN_COD) As RispostaStandard
        ...
        Try
            ...
            Dim Lista_Razze_Animali_R As New Lista_Razze_Animali_R

            Dim DT As DataTable = Lista_Razze_Animali_R.Leggi(GEN_COD, SPE_COD, -1, enumSelezioneVariabile.Selezione_TabellaDatiMinimi, "", "", objParametri_Server)
            '
            Dim Rows() As DataRow = DT.Select()
            '
            Dim TempDt As DataTable = New DataView(Rows.CopyToDataTable()).ToTable(False, "RAZ_DES", "RAZ_COD")
    ...
    Public Shared Function getRazzeGriglia(ByVal SPE_COD, ByVal GEN_COD) As RispostaStandard
        ...
        Try
            ...
            Dim DT As DataTable = Lista_Razze_Animali_R.Leggi(GEN_COD, SPE_COD, -1, "", "", "", objParametri_Server)

            Dim Rows() As DataRow = DT.Select()

            Dim DTrisposta As DataTable = New DataView(Rows.CopyToDataTable()).ToTable(False, "RAZ_DES", "RAZ_COD")

            r.RispostaStringa = Newtonsoft.Json.JsonConvert.SerializeObject(DTrisposta)
            r.RispostaOK = True
    ...
    Public Shared Function getRazzeGrigliaMadre(ByVal SPE_COD, ByVal GEN_COD) As RispostaStandard
        ...
        Try
            ...
            DTrisposta.Columns(0).ColumnName = "RazDes_Madre"
            DTrisposta.Columns(1).ColumnName = "RazCod_Madre"
            DTrisposta.AcceptChanges()
    ...
    Public Shared Function getRazzeGrigliaPadre(ByVal SPE_COD, ByVal GEN_COD) As RispostaStandard
        ...
        Try
            ...
            DTrisposta.Columns(0).ColumnName = "RazDes_Padre"
            DTrisposta.Columns(1).ColumnName = "RazCod_Padre"
            DTrisposta.AcceptChanges()
