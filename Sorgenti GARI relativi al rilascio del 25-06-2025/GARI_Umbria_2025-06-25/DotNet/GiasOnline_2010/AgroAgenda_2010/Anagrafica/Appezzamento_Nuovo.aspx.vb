...
Public Class Appezzamento_Nuovo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        clc.CodiciTerreno(Cmb_CodiciTerreno, True, AgronicaAgenda_2010.Seleziona.ToUpper(), "", "", "", objParametri_Server)
    ...
    Private Sub Salva_Tutto(ByVal tipo As Integer)
        ...
        Dim StrMetodoProduzione As String
        ...
        Dim objAppezzamento As New AgronicaCoreAnagrafeBIZ.Appezzamento_W 'Object  'Agro_Anagrafe.Appezzamento_W
        ...
        Try
            ...
            Dim P_HA As Decimal
            Dim P_IMPIANTO As Decimal
            'Dim ResaPrevista_HA As Decimal
            Dim ResaPrevista_IMPIANTO As Decimal
        ...
        If Errore = False And Errore2 = False Then
    ...
    Public Function Salva_Particelle(ByVal type As Integer, ByVal dataInizio As Date, ByVal dataFine As Date)
            ...
            For Each particella In list_part
                ...
                If Not Particelle_hash.ContainsKey(chiaveP_hash) Then
                    ...
                    For Each particella2 In list_part2
                        ...
                        If particella.CodiceIstat_Provincia = particella2.CodiceIstat_Provincia And
                            particella.CodiceIstat_Comune = particella2.CodiceIstat_Comune And
                            particella.Sezione = particella2.Sezione And
                            particella.Foglio = particella2.Foglio And
                            particella.Numero = particella2.Numero And
                            ...
                            If IsNumeric(particella2.SuperficieImpiegata) Then
                                ...
                                If type <> 0 Then
                                    ...
                                    If Macrouso_Cod <> "" And Macrouso_Cod <> "&nbsp;" And Not Macrousi_hash.ContainsKey(chiaveM_hash) Then
                                    ...
                                    If Veg_Cod_Agea <> "" And Veg_Cod_Agea <> "&nbsp;" And Not Utilizzi_hash.ContainsKey(chiaveU_hash) Then
