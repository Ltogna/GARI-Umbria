...
Partial Class Fabbricato_Edit
                    ...
                    For i As Integer = 0 To dt_conf_prop.Rows.Count - 1
                        ...
                        For j As Integer = 0 To dt_conf_prop.Rows.Count - 1
                            ...
                            If i <> j Then
                                ...
                                If (iValidita_Inizio >= jValidita_Inizio And iValidita_Inizio <= jValidita_Fine) Or
                                    (iValidita_Fine <= jValidita_Inizio And iValidita_Fine >= jValidita_Fine) Then
    ...
    Public Shared Function Ripristina_cbl_idoneita()
        ...
        If Not HttpContext.Current.Session("idoneita") = Nothing Then
    ...
    Private Sub RipristinaDatiNeiControlli()
        ...
        Dim XMLs_StallaCaratteristiche As System.Xml.XmlNodeList
        Dim XML_StallaCaratteristica As System.Xml.XmlElement
        ...
        ElseIf Operazione = enum_TipoOperazioneDB.Modifica OrElse Operazione = enum_TipoOperazioneDB.Lettura Then
            ...
            Dim StallaAttributoDes As String
            Dim UdmCod_Attributo As String
            Dim UdmDes_Attributo As String
            Dim UdmSim_Attributo As String
    ...
    Private Sub Salva_Tutto()
        ...
        Try
            ...
            If chk_MagazzinoFarmaci.Checked = True AndAlso Tipo_Fabbricato_Cod = MAGAZZINO Then
            ...
            If chk_VisibileApp.Checked = True Then
                Visibile_da_App = 1
            Else
                Visibile_da_App = 0
            End If

            If chk_DefaultOrtofrutta.Checked = True Then
            ...
            Dim XmlStallaCaratteristica As System.Xml.XmlElement
            ...
            If Operazione = enum_TipoOperazioneDB.Modifica Then
                ...
                If (Session("StrXmlStallaCaratteristicheAttuali") IsNot Nothing AndAlso
                   Session("StrXmlStallaCaratteristicheAttuali").ToString <> "") Or
