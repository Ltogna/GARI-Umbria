...
Partial Class Centro_Edit
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not dtAnagrafeLog Is Nothing AndAlso dtAnagrafeLog.Rows.Count > 0 Then
            For Each rAnagrafeLog In dtAnagrafeLog.Rows
                If rAnagrafeLog.Item("Modulo_Generazione") = 2 Or rAnagrafeLog.Item("Modulo_Generazione") = 5 Then
    ...
    Private Sub RipristinaDatiNeiControlli()
        ...
        ElseIf Operazione = enum_TipoOperazioneDB.Modifica OrElse Operazione = enum_TipoOperazioneDB.Lettura Then
            ...
            If DTCentri.Rows.Count > 0 Then
                ...
                Dim objRubrica As New AgronicaCoreAnagrafeDAL.CentrixRubrica_Read 'Agro_Anagrafe_AD.CentrixRubrica_Read
    ...
    Private Function UltimoIdCodiceOperatore() As Integer
        ...
        Dim objCodiceOperatore As New Agro_Sequenze  'New Agro_Anagrafe_AD.Agro_Sequenze()
    ...
    Private Sub Salva_Tutto()
        ...
        Dim StrDatiCentriAziendali As String
        ...
        Dim Sa_Cod_CentroEsterno As Integer
        ...
        '''    Dim objImpresa As object 'Agro_Anagrafe.Impresa_W
        ...
        Dim StrRubricaGruppo_del As String
        ...
        Dim StrCentroGruppo_del As String
        ...
        Try
            ...
            If Operazione = enum_TipoOperazioneDB.Scrittura Then
                ...
                If Me.Chk_Magazzino.Checked = True Then
                    ...
                    Dim objSeqFabbricati As New Agro_Sequenze  'Agro_Anagrafe2_AD.Agro_Sequenze
