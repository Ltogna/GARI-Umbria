                                                            ...
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon alert-info" id="lbl_ImpIrrigazione" for="Cmb_ImpIrrigazione">
                                                                        <asp:Localize meta:resourcekey="ImpiantoIrrigazione" runat="server">Imp. Irrigazione</asp:Localize>
                                                                    </span>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="input-group">
                                                                                    <span class="input-group-addon alert-info" id="lbl_Germinabilita" for="Txt_Germinabilita">
                                                                                        <asp:Localize meta:resourcekey="Germinabilità" runat="server">Germinabilità</asp:Localize>
                                                                                        [%] *
                                                                                    </span>
                                                                        ...
                                                                        <div class="form-horizontal">
                                                                             <div class="form-group">                                                                                 
                                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                                    ...
                                                                                    <label aria-describedby="ChkMaschiSesto" id="lbl_CoverCrops" class="k-checkbox-label" for="ChkMaschiSesto">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                                                        <div class="form-horizontal">
                                                                            <div class="form-group">
                                                                                <div class="input-group">
                                                                                    <span class="input-group-addon alert-info" id="lbl_Genetica_M" for="Txt_Genetica_F">
                                                                                        <asp:Localize meta:resourcekey="Genetica" runat="server">Genetica</asp:Localize>
                                                                                    </span>
