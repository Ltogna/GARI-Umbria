    ...
    Public Shared Function Controlla_Costo(ByVal parametri As String) As RispostaStandard
        ...
        For i = 0 To DT_Costi.Rows.Count - 1
            ...
            If DT_Costi.Rows(i).Item("Udm_Des") = unita Then
                ...
                If (dataI >= CDate(DT_Costi.Rows(i).Item("Validita_Inizio")) And dataI <= CDate(DT_Costi.Rows(i).Item("Validita_Fine"))) Or (dataF <= CDate(DT_Costi.Rows(i).Item("Validita_Inizio")) And dataF >= CDate(DT_Costi.Rows(i).Item("Validita_Fine"))) Then
                    interseca = True
                    r.RispostaOK = False
                    r.Errore = "Le date inserite si interecano con alcune precedentemente inserite"
                    Exit For
                End If
   ...
   <WebMethod(EnableSession:=True)> _
    ...
    Private Sub InserisciRigaCosto(ByVal ID As Integer, _
        ...
        If Not ViewState("Dt_Costi") Is Nothing Then
            ...
            For i = 0 To Dt_Costi.Rows.Count - 1
                If Dt_Costi.Rows(i).Item("Udm_Cod") = Udm_Cod And _
                    Dt_Costi.Rows(i).Item("Validita_Inizio") = Validita_Inizio And _
                    Dt_Costi.Rows(i).Item("Validita_Fine") = Validita_Fine And _
    ...
    Protected Sub salvacontatto()
        ...
        Dim Base, Top, progressivo_base_top As Integer

        Call Calcola_BaseCode_TopCode(Base, _
                                      Top, _
        ...
        If RBL_TipoUtente.SelectedValue = "0" Then
            ...
            If Cod_Contatto.Length = 11 And Cod_Contatto.Chars(0) = "F" And IsNumeric(Cod_Contatto.Substring(1)) Then
            ...
            If Cod_Contatto = "" Or Nome = "" Or Cognome = "" Then
        ...
        Else
            ...
            If Cod_Contatto.Length = 11 And Cod_Contatto.Chars(0) = "F" And IsNumeric(Cod_Contatto.Substring(1)) Then
                'contatto generato automaticamente
            Else
                If Cod_Contatto.Length <> 11 Or Not IsNumeric(Cod_Contatto) Then
            ...
            If Cod_Contatto = "" Or Rag_Soc = "" Then
        ...
        Else
            ...
            For i = 0 To risultato_Rubrica.Count - 1
                If risultato_Rubrica(i).descr.Trim.ToLower = "n.telefono:" Or risultato_Rubrica(i).descr.Trim.ToLower = "n. telefono:" Or
                            risultato_Rubrica(i).descr.Trim.ToLower = "telefono" Or risultato_Rubrica(i).descr.Trim.ToLower = "tel." Or
                            risultato_Rubrica(i).descr.Trim.ToLower = "telefono:" Or risultato_Rubrica(i).descr.Trim.ToLower = "tel.:" Or
                            risultato_Rubrica(i).descr.Trim.ToLower = "n.telefono" Or risultato_Rubrica(i).descr.Trim.ToLower = "tel" Then
                    trovato = True
            ...
            trovato = False
            For i = 0 To risultato_Rubrica.Count - 1
                If risultato_Rubrica(i).descr.Trim.ToLower = "cellulare:" Or risultato_Rubrica(i).descr.Trim.ToLower = "cellulare" Or
                    risultato_Rubrica(i).descr.Trim.ToLower = "cell" Or risultato_Rubrica(i).descr.Trim.ToLower = "cell." Or risultato_Rubrica(i).descr.Trim.ToLower = "cellure" Then
                    trovato = True
                    cod_rubrica = risultato_Rubrica(i)._cod_rubrica
                    Exit For
                End If
            ...
            trovato = False
            For i = 0 To risultato_Rubrica.Count - 1
                If risultato_Rubrica(i).descr.Trim.ToLower = "fax:" Or risultato_Rubrica(i).descr.Trim.ToLower = "fax" Then
                    trovato = True
                    cod_rubrica = risultato_Rubrica(i)._cod_rubrica
                    Exit For
                End If
            ...
            trovato = False
            For i = 0 To risultato_Rubrica.Count - 1
                If risultato_Rubrica(i).descr.Trim.ToLower = "e-mail:" Or risultato_Rubrica(i).descr.Trim.ToLower = "email" Or
                    risultato_Rubrica(i).descr.Trim.ToLower = "e-mail" Or risultato_Rubrica(i).descr.Trim.ToLower = "e.mail" Or
                    risultato_Rubrica(i).descr.Trim.ToLower = "email" Or risultato_Rubrica(i).descr.Trim.ToLower = "email." Or
        ...
        For j = 0 To DTRapporti.Rows.Count - 1
            ...
            If DTRapporti.Rows(j).Item("checked") = 1 Then
                ...
                Dim ArrayID() As Integer
                If Not ViewState("ArrayID") Is Nothing Then
                    ArrayID = ViewState("ArrayID")
                End If


                If Not HttpContext.Current.Session("Dt_Costi_Origine") Is Nothing Then
                ...
                'If Not ViewState("Dt_Costi") Is Nothing Then
                If Not HttpContext.Current.Session("Dt_Costi") Is Nothing Then
