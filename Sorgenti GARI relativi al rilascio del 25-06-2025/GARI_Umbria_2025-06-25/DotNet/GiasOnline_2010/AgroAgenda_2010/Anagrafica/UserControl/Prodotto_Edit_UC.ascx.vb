...
Public Class Prodotto_Edit_UC
    ...
    Public Shared Function EditProdotto(ByVal piva As String, ByVal mat_cod As Integer, ByVal elem_cod As Integer, ByVal duplica As Boolean, ByVal proprietario As Boolean, ByVal sa_cod As Integer) As RispostaStandard
        ...
        Try
            ...
            If duplica = True AndAlso dtProdotto.Rows.Count > 0 Then
                ...
                If CInt(dtProdotto(0)("Udm_Cod_Extra")) <> 0 OrElse CInt(dtProdotto(0)("Flag_Variazione")) <> 0 OrElse
                    ...
                    If Not listModuliAttivi_anagrafe_log Is Nothing AndAlso listModuliAttivi_anagrafe_log.Count > 0 Then
    ...
    Public Shared Function PermessoModificaProdotto(ByVal piva As String, ByVal sa_cod As Integer) As RispostaStandard
        ...
        Else
            If piva = objParametriAgenda.Piva Then
                possoModificare = True
            Else
                strRes = "Il prodotto è stato creato da un'altra impresa."
            End If
        End If
    ...
    Public Shared Function Leggi_XddlRazzaAnimale(ByVal Gen_Cod As Integer, ByVal Spe_Cod As Integer) As RispostaStandard
        ...
        Try
            Dim List As New DropDownList
            AgronicaCoreUtility.CaricaListControl.Lista_Razze_Animali(List, True, "Tutte le Razze", -1, Gen_Cod, Spe_Cod, "", "", objParametriServer)
    ...
    Public Shared Function Leggi_CategoriaRisorsa(ByVal piva As String, ByVal Tipo_Classe As Integer)
        ...
        Try
            ...
            If Not dt Is Nothing AndAlso dt.Rows.Count > 0 Then
                ...
                r.RispostaStringa = JsonConvert.SerializeObject(catRisLIst, Newtonsoft.Json.Formatting.None)
            Else
    ...
    Public Shared Function Leggi_Modulo_Anagrafe(ByVal piva As String)
        ...
        Try
            ...
            r.RispostaStringa = JsonConvert.SerializeObject(listModuliAttivi_anagrafe_log, Newtonsoft.Json.Formatting.None)
            r.RispostaOK = True
    ...
    Public Shared Function ComponiMessaggioDiAvvisoCancellazioneProdotto(ByVal piva As String, ByVal elem_cod As Integer, ByVal mat_cod As Integer, ByVal sa_cod As Integer, ByVal isalias As Boolean)
        ...
        Try
            ...
            If isalias = True Then
                ...
                Dim Alias_Associato = objMaterie_Prime_Alias.IsAlias(piva, mat_cod,
                                                                    objParametriServer)

                If Alias_Associato = True Then
                    Msg += "-Tutte le Associazioni con gli altri Prodotti (essendo un Prodotto per Descrizioni Alternative).<br>"
                End If

            ElseIf isalias = False Then

                    'Se il Prodotto è pubblico avviso l'utente che verrano cancellati i Prezzi inseriti anche da altri Utenti
                    If sa_cod = -1 Then
                    Dim obj As New Prodotti_Costi_R
                    ...
                    If Not dt_Prodotti_Costi Is Nothing AndAlso dt_Prodotti_Costi.Rows.Count > 0 Then
                        Msg += "-I Prezzi inseriti da altre Aziende su questo Prodotto essendo Pubblico.<br>"
                    End If
                ...
                If Not List_ListiniPrezzi Is Nothing AndAlso List_ListiniPrezzi.Count > 0 Then
                    Msg += "-I Listini Associati.<br>"
                End If
                ...
                If Not List_CampionamentoConferito Is Nothing AndAlso List_CampionamentoConferito.Count > 0 Then
                    Msg += "-Le Tabelle Di Campionamento e i Listini di Liquidazione Associati.<br>"
                End If
            End If
    ...
    Public Shared Function Leggi_XddlAlias(ByVal piva As String, ByVal elem_cod As Integer, ByVal sa_cod As Integer)
        ...
        Try
            ...
            If Not dtAlias Is Nothing AndAlso dtAlias.Rows.Count > 0 Then
            ...
            r.RispostaStringa = JsonConvert.SerializeObject(jArrayAlias, Newtonsoft.Json.Formatting.None)
        ...
        Try
            ...
            If dtLog.Rows.Count > 0 Then
                ...
                If dtModuli.Rows.Count = 0 Then
                    ...
                    'eccezione
                    MsgErrore += "L'anagrafica non può essere eliminata poichè incluso in moduli gias. Contattare l'amministratore."

                Else
                    Dim Modulo_Descrizione As String = dtModuli(0)("Modulo_Descrizione").ToString
                    MsgErrore += "L'anagrafica è inclusa nel modulo '" & Modulo_Descrizione & "' e non può pertanto essere eliminata."
                End If
            ...
            If Controllo_Log_Ok Then
                ...
                If dtReferenze.Rows.Count > 0 Then
                    ...
                    MsgErrore += "L'anagrafica non può essere eliminata poichè collegata alla referenza aziendale '" & dtReferenze(0)("Mat_Des").ToString & "'."
    ...
    Public Shared Function CaricaCategorieMagazzinoXUtente() As RispostaStandard
        ...
        Try
            ...
            r.RispostaStringa = JsonConvert.SerializeObject(Dt_CategMag, Newtonsoft.Json.Formatting.None)
            r.RispostaOK = True
    ...
    Public Shared Function Leggi_ImpostazioneUtente() As RispostaStandard
        ...
        Try
            ...
            If dtImpostazioni.Rows.Count > 0 Then
                ...
                If Not DrFiltroAbilitaDDL Is Nothing AndAlso DrFiltroAbilitaDDL.Count > 0 Then
                ...
                If Not DrFiltroImballaggio Is Nothing AndAlso DrFiltroImballaggio.Count > 0 Then
                ...
                If Not DrFiltroContenitori Is Nothing AndAlso DrFiltroContenitori.Count > 0 Then
    ...
    Public Shared Function ControlliPrimaDelSubmit(ByVal model As String, ByVal importato As Boolean) As RispostaStandard
        ...
        Try
            ...
            If Not parametri.DatiTecnici Is Nothing AndAlso importato = False Then
            ...
            If Not parametri.Configurazione Is Nothing AndAlso importato = False Then
            ...
            If Not parametri.DatiTecnici Is Nothing AndAlso
                Not parametri.DatiTecnici.UDM_Cod Is Nothing AndAlso
                Not parametri.ParametriQualitativiDatiTecnici Is Nothing AndAlso
                Not parametri.ParametriQualitativiDatiTecnici.Campi Is Nothing AndAlso
                Not String.IsNullOrEmpty(parametri.ParametriQualitativiDatiTecnici.Campi) AndAlso
                importato = False Then
            ...
            If Not parametri.Traduzioni Is Nothing Then
            ...
            If parametri.StoricoPrezzi IsNot Nothing AndAlso importato = False Then
            ...
            If Not parametri.AltriDati Is Nothing Then
            ...
            ' Checks su alias
            If Not parametri.DescrizioniAlternative Is Nothing AndAlso
               parametri.ChkAlias = 0 AndAlso
                parametri.IsMateriaPrima = True Then
        ...
        Catch ex As Exception
            Return New RispostaStandard With {.RispostaOK = False, .RispostaStringa = "Errore durante l'operazione: " & vbCrLf & Gestione_Eccezioni_2015.MessaggioCompletoDataEccezione(ex, True, source:=True)}
        End Try
    ...
    Public Shared Function Submit(ByVal model As String) As RispostaStandard
        ...
        Try
            ...
            If parametri.IsMateriaPrima Then
                If Not parametri.DatiTecnici Is Nothing Then
                    ErroreSalvataggio = SalvaMateriaPrima(parametri, nuovo_Mat_Cod, errori)
                    If (ErroreSalvataggio = True) Then
            ...
            ' Salvataggio dati contabilita e altri dati (perchè vengo salvati entrambi nella tabella Prodotti_Extra_Privata)
            ...
            If Not parametri.DatiContabilita Is Nothing OrElse Not parametri.AltriDati Is Nothing Then
            ...
            If Not parametri.ParametriQualitativiCalibri Is Nothing Then
            ...
            If Not parametri.ParametriQualitativiIndici Is Nothing Then
            ...
            If ((Not parametri.ParametriQualitativiDatiTecnici Is Nothing AndAlso
                Not parametri.ParametriQualitativiDatiTecnici.Campi Is Nothing AndAlso
                Not String.IsNullOrEmpty(parametri.ParametriQualitativiDatiTecnici.Campi)) OrElse
                (Not parametriDatiTecnici Is Nothing AndAlso
                parametriDatiTecnici.Elimina_Referenza_ParamQualDTec = True)) Then

                Dim Cod_Articolo As String = parametri.CodiceProdotto
                If parametri.TipoOperazioneDB = enum_TipoOperazioneDB.Modifica AndAlso Not parametri.NuovoCodiceProdotto Is Nothing AndAlso
    ...
    Private Shared Function SalvaMateriePrimeXLingue(
       ...
       ByRef errori As String) As Boolean
        ...
        Try
            ...
            If Not righeEliminate Is Nothing AndAlso righeEliminate.Any Then
            ...
            If Not righeInserite Is Nothing AndAlso righeInserite.Any Then
            ...
            If Not righeModificate Is Nothing AndAlso righeModificate.Any Then
                ...
                For Each mpl As MateriaPrimaXLInguaModel In righeModificate
                    ...
                    If Not mpl.Lingua_Cod_Letta Is Nothing Then
    ...
    Private Shared Function SalvaParametriQualitativiCalibri(ByVal piva As String,
       ...
       ByVal calibri As ParametriQualitativiCalibriModel) As Boolean
        ...
        Try
            ...
            'PS(Udm_Cod lo passo a 0 perchè nella tabella non c'è nessuna riga con Udm_Cod diverso da 0)
            'mat_Cod = 3024
            If Not calibri.RigheScelte Is Nothing AndAlso calibri.RigheScelte.Any Then
                Dim Scrittura_OK As Boolean = False
    ...
    Private Shared Function SalvaParametriQualitativiIndici(ByVal piva As String,
       ...
       ByVal indici As ParametriQualitativiIndiciModel) As Boolean
        ...
        Try
            ...
            'PS(Udm_Cod lo passo a 0 perchè nella tabella non c'è nessuna riga con Udm_Cod diverso da 0)
            'mat_Cod = 3024
            If Not indici.RigheScelte Is Nothing AndAlso indici.RigheScelte.Any Then
                Dim Scrittura_OK As Boolean = False
                objParametriServer.FlagCancellazioneLogica = AgronicaCoreDataProvider.AgronicaCoreParametri.enumCancellazioneLogica.CancellazioneFisica
        ...
        Try
            ...
            If Not righeModificate Is Nothing AndAlso righeModificate.Any Then
                ...
                For Each a As MateriePrimeAliasModel In righeModificate
                    ...
                    If Not a.Mat_Cod_Alias_Old Is Nothing Then
    ...
    Private Shared Function SalvaMateriaPrima(ByVal parametri As SalvaProdottoModel, ByRef new_mat_cod As Integer, ByRef errori As String) As Boolean
        ...
        Try
            ...
            If Not dTec.SementiEMaterialiVivaisti Is Nothing And dTec.SementiEMaterialiVivaisti.HasValue Then
                Sem_Cod = dTec.SementiEMaterialiVivaisti
            End If
            If Not dTec.SpecieVegetali Is Nothing And dTec.SpecieVegetali.HasValue Then
                ...
                End If
            End If
            If Not dTec.VarietaColturale Is Nothing And dTec.VarietaColturale.HasValue Then
                CUl_Cod = dTec.VarietaColturale
            End If
            If Not dTec.Regolamento Is Nothing And dTec.Regolamento.HasValue Then
                Regolamento = dTec.Regolamento
            End If
            If Not dTec.DittaDiProvenienza Is Nothing And dTec.DittaDiProvenienza.HasValue Then
                Ditta_Cod = dTec.DittaDiProvenienza
            End If
            If Not dTec.TipologiaVarietale Is Nothing And dTec.TipologiaVarietale.HasValue Then
                Grva_Cod_Veg = dTec.TipologiaVarietale
            End If
            If Not dTec.Referenza Is Nothing And dTec.Referenza.HasValue Then
                Mat_Cod_Referenza = dTec.Referenza
                ChkReferenza = 0
            End If
            If Not parametri.Categoria_Risorsa Is Nothing And parametri.Categoria_Risorsa.HasValue Then
                Cat_Cod = parametri.Categoria_Risorsa
            End If
            If Not parametri.Linea_Cod Is Nothing And parametri.Linea_Cod.HasValue Then
                Linea_Cod = parametri.Linea_Cod
            End If
            If Not parametri.ChkReferenza Is Nothing And parametri.ChkReferenza.HasValue Then
                ChkReferenza = parametri.ChkReferenza
            End If
            If Not dTec.Finalita_Produttiva Is Nothing And dTec.Finalita_Produttiva.HasValue Then
                Grfi_Cod = dTec.Finalita_Produttiva
            End If
            If Not dTec.UDM_Cod Is Nothing And dTec.UDM_Cod.HasValue Then
                Udm_Cod = dTec.UDM_Cod
            End If
            If Not IsNothing(dTec.Cod_TecnologiaSementi) And dTec.Cod_TecnologiaSementi.HasValue Then
                Cod_TecnologiaSementi = dTec.Cod_TecnologiaSementi
            End If
            If Not IsNothing(dTec.Germinabilita) And dTec.Germinabilita.HasValue Then
                Germinabilita = dTec.Germinabilita
            End If
            If Not dTec.SpecieAnimali Is Nothing Then
                ...
                End If
            End If
            If Not dTec.IndirizzoAnimale Is Nothing Then
                ...
                End If
            End If
            If Not dTec.RazzaAnimale Is Nothing Then
            ...
            End If
            If Not parametri.Cal_Cod Is Nothing Then
                Cal_Cod = CInt(parametri.Cal_Cod)
            End If
            If Not parametri.Codice_Esterno Is Nothing Then
                Codice_Esterno = parametri.Codice_Esterno
            End If
            If Not parametri.Flag_Importato Is Nothing Then
            ...
            If Not parametri.ChkAlias Is Nothing Then
            ...
            If Not config Is Nothing Then
                ...
                If Not config.Otabella_Cod_Base Is Nothing Then
                    OTabella_Cod_Base = CInt(config.Otabella_Cod_Base)
                End If
                If Not config.Peso_Set Is Nothing Then
                    Peso_Set = CInt(config.Peso_Set)
                End If
                If Not config.TipoPeso Is Nothing Then
                    Tipo_Peso = CInt(config.TipoPeso)
                End If
                If Not config.Tara Is Nothing Then
                    Tara = CDec(config.Tara)
                End If
                If Not config.Qta_Extra Is Nothing Then
                    Qta_Extra = CDec(config.Qta_Extra)
                End If
                If Not config.Udm_Cod_Extra Is Nothing Then
                    Udm_Cod_Extra = CInt(config.Udm_Cod_Extra)
                End If
                If Not config.Confezione_Cod Is Nothing Then
                    Confezione_Cod = config.Confezione_Cod
                End If
                If Not config.Contenitore Is Nothing Then
                ...
                Select Case ELem_COd
                    Case BENI_CONFEZ_VEGETALE
                        If Not config.Flag_CompLotto Is Nothing Then
                            Extra_Int = config.Flag_CompLotto
                        End If
                    Case ALTRE_MATERIE
                        If Not config.Flag_UtilizzoCA Is Nothing Then
            ...
            Select Case parametri.TipoOperazioneDB
                Case enum_TipoOperazioneDB.Scrittura, enum_TipoOperazioneDB.Copia
                    ...
                    Call Calcola_BaseCode_TopCode(Base,
                                          Top,
                    ...
                    If Not parametri.ParametriQualitativiDatiTecnici Is Nothing AndAlso
                       Not parametri.ParametriQualitativiDatiTecnici.Campi Is Nothing Then
                    ...
                    If Flag_Importato = 0 Then
                        If parametri.Componi_Cod_ArticoloDaCodice_Esterno = True AndAlso
                            Not Codice_Esterno Is Nothing AndAlso Codice_Esterno <> "" AndAlso
                ...
                Case enum_TipoOperazioneDB.Modifica
                    ...
                    If parametri.Proprietario = True Then
                        ...
                        ElseIf Not dTec.Elimina_Referenza_ParamQualDTec Is Nothing AndAlso
            ...
            If (Not config Is Nothing AndAlso
               (Not listModuliAttivi_anagrafe_log Is Nothing AndAlso listModuliAttivi_anagrafe_log.Contains(enum_Omni_Modulo_Generazione.FreshFood))) Then
                ...
                If tabella_cod <> 0 Then
                    ...
                    If DT.Rows.Count > 0 Then
                        ...
                        If Not Par_cod Is Nothing Then
                            'Modifica
    ...
    Private Shared Function Controlli_ParametriQualitativiDatiTecnici(ByVal param As ParametriQualitativiDatiTecniciModel, ByVal UDM_Cod As Integer, ByRef errori As String) As Boolean
        ...
        If Not campi Is Nothing Then
            ...
            If Not confezione Is Nothing AndAlso Not contenitore Is Nothing AndAlso UDM_Cod <> 38 Then

                If CInt(confezione.Val_Cod) < CInt(contenitore.Val_Cod) Then
                    'i18N Il Numero di confezione per contenitore devono avere un valore maggiore del Numero di contenitori per imballo.
                    errori += "Il Numero di confezione per contenitore devono avere un valore maggiore del Numero di contenitori per imballo."
                    Return False
                End If
            End If

        Else
            'i18N Errore nei Parametri Qualitativi da tradurre
            errori += "Errore nei Parametri Qualitativi."
            Return False
        End If
    ...
    Private Shared Function Controlli_ConfigurazioneProdotti(ByVal config As ConfigurazioniModel, ByRef errori As String) As Boolean
        ...
        If config.Flag_Udm_Cod_Extra = 1 And config.Peso_Set = 0 Then
            ...
            If Not IsNumeric(config.Qta_Extra) Then
                'i18N Peso/capacità nominale da tradurre
                errori += "Peso/capacità nominale non impostato."
                Return False
            End If


            If CDec(config.Qta_Extra) = 0 And config.Flag_Imballaggio = 0 And config.Flag_Contenitore = 0 Then
                'i18N Il peso/capacità nominale non può essere nullo da tradurre
                errori += "Il peso/capacità nominale non può essere nullo."
                Return False
            End If
    ...
    Private Shared Function SalvaDatiContabilitaEAltriDati(ByVal piva As String,
        ...
        Try
            ...
            If Not dati_contab Is Nothing Then
            ...
            If Not altri_dati Is Nothing Then
                EAN = altri_dati.EAN
            ...
            If Aliquota_Iva Is Nothing AndAlso Aliquota_Iva_Compensazione Is Nothing AndAlso
                ...
                Conto_Patrimoniale_Acquisto Is Nothing AndAlso Conto_Patrimoniale_Vendita Is Nothing AndAlso
                  Not altri_dati Is Nothing AndAlso EAN = "" AndAlso Barcode = "" AndAlso Ingredienti = "" AndAlso
                ...
                If Salva = True Then
                    ...
                    Select Case TipoOperazione
                        ...
                        Case enum_TipoOperazioneDB.Modifica
                            ...
                            If MateriaPrima = False OrElse (MateriaPrima = True AndAlso Proprietario = True) Then
    ...
    Private Shared Function SalvaParametriQualitativiDatiTecnici(ByVal piva As String,
        ...
        If Not listModuliAttivi_anagrafe_log Is Nothing AndAlso
           ...
           listModuliAttivi_anagrafe_log.Contains(enum_Omni_Modulo_Generazione.Zoo)) Then
            ...
            Try
                If Not param.Campi Is Nothing AndAlso param.Campi.Any Then
                ...
                ElseIf Elimina_Referenza = True Then
    ...
    Private Shared Function Controlli_XCategoriaProdotto(ByVal parametri As SalvaProdottoModel, ByRef errori As String) As Boolean
        ...
        If parametri.Componi_Cod_ArticoloDaCodice_Esterno = False Then
            ' Controlli su codice articolo
            If parametri.Opzioni.ConsentiCodiciDuplicati = False Then
                ...
                If Not parametri.NuovoCodiceProdotto Is Nothing AndAlso parametri.NuovoCodiceProdotto <> String.Empty Then
                ...
                If duplicato = True Then
                    'i18N Il Codice Prodotto è già stato assegnato da tradurre
                    errori += "Il Codice Prodotto " & CodiceProdotto.ToString & " è già stato assegnato ad un altro prodotto. <br>"
                    Return False
                End If
            End If
            ...
            If parametri.Opzioni.CodiceMaxLenght > 0 Then
                ...
                If parametri.CodiceProdotto.Length > parametri.Opzioni.CodiceMaxLenght Then
                    ...
                    'i18N Inserire un Codice Prodotto di massimo da tradurre
                    errori += "Inserire un Codice Prodotto di massimo " & parametri.Opzioni.CodiceMaxLenght & " caratteri. <br>"
                    Return False
                End If
            End If

            If parametri.Descrizione.Length < 3 Then
                'i18N Inserire una descrizione di almeno 3 caratteri
                errori += "Inserire una Descrizione di almeno 3 caratteri. <br>"
                Return False
            End If

        ElseIf parametri.Componi_Cod_ArticoloDaCodice_Esterno = True Then
            ...
            If parametri.Codice_Esterno Is Nothing OrElse
                ...
                'i18N Inserire un Codice Esterno corretto
                errori += "Inserire un Codice Esterno corretto. <br>"
                Return False
            End If
            ...
            Select Case (parametri.CategoriaProdotto)
                Case SEMENTI
                    ...
                    If dtec.SementiEMaterialiVivaisti <= 0 OrElse dtec.SementiEMaterialiVivaisti Is Nothing Then
                        'i18N E' necessario selezionare una Tipologia di Semente da tradurre
                        errori += "E' necessario selezionare una Tipologia di Semente. <br>"
                    End If

                    If dtec.SpecieVegetali < 0 OrElse dtec.SpecieVegetali Is Nothing Then
                        'i18N E' necessario selezionare una Specie Vegetale da tradurre
                        errori += "E' necessario selezionare una Specie Vegetale. <br>"
                    End If

                    If dtec.VarietaColturale <= 0 OrElse dtec.VarietaColturale Is Nothing Then
                        'i18N E' necessario selezionare una Varietà Colturale da tradurre
                        errori += "E' necessario selezionare una Varietà Colturale. <br>"
                    End If
            ...
            'Case SEMILAVORATI_ANIMALI, BENI_CONFEZ_ANIMALE, TRASFORMATI_ANIMALI
                Case SEMILAVORATI_ANIMALI, TRASFORMATI_ANIMALI
                    ...
                    If dtec.SpecieAnimali = "" OrElse dtec.SpecieAnimali = "0" OrElse dtec.SpecieAnimali Is Nothing Then
                        'i18N E' necessario selezionare una Specie Animale da tradurre
                        errori += "E' necessario selezionare una Specie Animale. <br>"
                    End If
                    ...
                    If parametri.CategoriaProdotto = SEMILAVORATI_ANIMALI Then
                        If dtec.IndirizzoAnimale = "" OrElse dtec.IndirizzoAnimale = "0" OrElse dtec.IndirizzoAnimale = "-1" OrElse dtec.IndirizzoAnimale Is Nothing Then
                            ...
                            errori += "E' necessario selezionare una Indirizzo Produttivo corretto. <br>"
                        End If

                        If dtec.RazzaAnimale = "" OrElse dtec.RazzaAnimale = "0" OrElse dtec.RazzaAnimale = "-1" OrElse dtec.RazzaAnimale Is Nothing Then
                            'i18N Razza Animale da tradurre
                            errori += "E' necessario selezionare una Razza Animale corretto. <br>"
                        End If
                    End If
    ...
    Private Shared Function Controlli_SalvaMateriePrimeXLingue(ByVal traduzioni As TraduzioniModel, ByRef errori As String) As Boolean
        ...
        If Not righeInserite Is Nothing Then
            For Each ins As MateriaPrimaXLInguaModel In righeInserite
                ...
                If esistenti.Count > 1 Then
                    'i18N Non è possibile specificare due traduzioni con la stessa lingua da tradurre
                    errori += "Non è possibile specificare due traduzioni con la stessa lingua " & nome_lingua
                    Return False
                End If
        ...
        If Not righeModificate Is Nothing Then
    ...
    Private Shared Function Controlli_SalvaProdottiExtraPrivata(ByVal AltriDati As AltriDatiModel,
        ...
        If Barcode <> "" Then
            ...
            If Not DT Is Nothing AndAlso DT.Rows.Count > 0 Then
                'i18N Barcode Interno già presente. Inserire un Barcode diverso.
                errori += "Barcode Interno già presente. Inserire un Barcode diverso."
                Return False
            End If
    ...
    Private Shared Function Controlli_SalvaProdottiAlias(ByVal descrizioni_alternative As DescrizioniAlternativeModel,
        ...
        If Not righeInserite Is Nothing Then
            ...
            For Each ins As MateriePrimeAliasModel In righeInserite
                ...
                If esistenti.Count > 1 Then
                    'i18N Sono state inserite delle Descrizioni Alternative con lo stesso Prodotto
                    errori += "Sono state inserite delle Descrizioni Alternative con lo stesso Prodotto: " & mat_des_alias_ins
                    Return False
                End If
            Next
        End If
        ...
        If Not righeModificate Is Nothing Then
            ...
            For Each modi As MateriePrimeAliasModel In righeModificate
                ...
                If esistenti.Count > 1 Then
                    'i18N Sono state modificate delle Descrizioni Alternative con lo stesso Prodotto
                    errori += "Sono state modificate delle Descrizioni Alternative con lo stesso Prodotto: " & mat_des_alias_modi
                    Return False
                End If
            Next
        End If
    ...
    Public Shared Function Cancella_Prodotto(ByVal model As String, ByVal mat_cod_referenza As Integer, ByVal ParametroQual As Integer, ByVal Sa_Cod As Integer) As RispostaStandard
        ...
        Try
            ...
            If (prodotto.TipoOperazioneDB = enum_TipoOperazioneDB.Cancellazione) Then
                ...
                If prodotto.IsMateriaPrima = True Then
                ...
                ElseIf prodotto.IsMateriaPrima = False Then
