...
function kendoProdotto_inizializza(divKendo, keys) {
    ...
    var parametriKendoGrid = {
        ...
        colonneCustomKendoGrid: [
            {
                command: {
                    //i18N Info/Modifica/Duplica/Cancella da tradurre
                    //Per i prodotti di banche dati nascondo il duplica
                    template: "<div class='btn btn-info btnInfo' style='display:block;width:70px;border:0px;' onclick=infoProdotto(this.closest('tr'),this.closest('.k-grid'))>Info</div>" +
                        "<div class='btn btn-success btnModifica' style='display:block;width:70px;border:0px;' onclick=modificaProdotto(this.closest('tr'),this.closest('.k-grid'))>Modifica</div>" +
                        "<div class='btn btn-info btnDuplica' style='display:block;width:70px;border:0px;' onclick=duplicaProdotto(this.closest('tr'),this.closest('.k-grid'))>Duplica</div>" +
                        "<div class='btn btn-danger btnCancella' style='display:block;width:70px;border:0px;' onclick=eliminaProdotto(this.closest('tr'),this.closest('.k-grid'))>Cancella</div>"
