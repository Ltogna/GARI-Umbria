...
Partial Class Campo_Edit
    ...
    'AgronicaCoreUtility.CaricaListControl.GruppoVegetale(CType(Me.Cmb_GruppoVegetale, ListControl), _
    '                                                              True, "", "", _
    ...
    Public Shared Function Carica_Specie_Vegetali() As String
        ...
        AgronicaCoreUtility.CaricaListControl.SpecieVegetale_Optimize_x_PDC_Modificata2(cmb,
            ...
            If Not IsDBNull(DTCampi.Rows(0).Item("Gru_Cod")) Then
                ...
                Select Case DTCampi.Rows(0).Item("Gru_Cod")
                    ...
                    Case 1, 2, 3    'Mono-Specie
                        ...
                        'AgronicaCoreUtility.CaricaListControl.SpecieVegetale_Optimize(CType(Me.Cmb_SpecieVegetale, ListControl), _
                        '                                                              True, "", "", _
                        ...
                        AgronicaCoreUtility.CaricaListControl.SpecieVegetale_Optimize_x_PDC_Modificata2(Cmb_SpecieVegetale,
                                                                                True, AgronicaAgenda_2010.Seleziona.ToUpper(), "", HttpContext.Current.Session("ASG_objParametri_Server"))
    ...
    Private Sub Salva_Tutto()
        ...
        Dim SAU_Totale As Double
        Dim SAU_Biologico As Double
        Dim SAU_Conversione As Double
        Dim SAU_Convenzionale As Double
        Dim ConfiniRischio As String
        ...
        If Trim(Campo_Des) = "" And Campo_Tipo = 1 Then
            Campo_Des = "Serra 001"
        End If
                   ...
                   (DTRs2.Rows.Count > 0) Then
                    ...
                    For j = 0 To DTRs2.Rows.Count - 1
                        ...
                        For i = 0 To Dt.Rows.Count - 1
                            ...
                            If Sezione = "&nbsp;" Or Sezione = "" Then
                                Sezione = "0"
                            End If

                            If Subalterno = "&nbsp;" Or Subalterno = "" Then
                                Subalterno = "0"
                            End If

                            If Prov = DTRs2.Rows(j).Item("prov") And
                               Com = DTRs2.Rows(j).Item("com") And
                               Sezione = DTRs2.Rows(j).Item("sezione") And
                               Foglio = DTRs2.Rows(j).Item("foglio") And
                               Numero = DTRs2.Rows(j).Item("numero") And
