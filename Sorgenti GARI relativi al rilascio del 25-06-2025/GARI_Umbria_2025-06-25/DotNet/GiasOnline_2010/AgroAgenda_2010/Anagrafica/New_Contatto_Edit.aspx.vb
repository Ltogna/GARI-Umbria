...
Public Class New_Contatto_Edit
    ...
    Public Shared Function TabellaQualifiche() As RispostaStandard
        ...
        If Not HttpContext.Current.Session("Qualifiche") Is Nothing Then
    ...
    Public Shared Function CaricaIndirizziTipo(ByVal piva As String) As RispostaStandard
        ...
        Try
            ...
            indirizziPersonalizzati.ForEach(Function(s)
    ...
    Public Shared Function CaricaRapportiContabili(
        ...
        Try
            ...
            rapportiContabili.ForEach(Function(s)
    ...
    Private Sub CaricaDettagliContabili(ByVal risultato As XElement)
        ...
        If Not risultato.@provvigione Is Nothing AndAlso Not String.IsNullOrEmpty(risultato.@provvigione) Then
            hf_dettCont_provvigione_agente.Value = risultato.@provvigione
        End If

        If Not risultato.@provvigione_capoarea Is Nothing AndAlso Not String.IsNullOrEmpty(risultato.@provvigione_capoarea) Then
            hf_dettCont_provvigione_capoarea.Value = risultato.@provvigione_capoarea
        End If

        If Not risultato.@agente_cod Is Nothing AndAlso Not String.IsNullOrEmpty(risultato.@agente_cod) Then
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Dim Dt_Indirizzi As DataTable
            Dim Dt_Indirizzi_New As DataTable
                ...
                If Dati <> "" Then
                    ...
                    Select Case risultato.@id_cf.ToString()
                        ...
                        Case PERSONA_FISICA
                            ...
                            If Txt_Nome.Text = "" And Txt_Cognome.Text = "" Then
    ...
    Private Shared Function Controlla_Altri_Dati(ByVal piva As String, ByVal codContatto As String, ByVal param As ParametriSalvaTutto, ByRef errori As String) As Boolean
        ...
        If piva <> codContatto Then
            ...
            If Not String.IsNullOrEmpty(param.AltriDati.CodiceAccisa) And param.AltriDati.TipoDestinazione = "0" Then
            ...
            If String.IsNullOrEmpty(param.AltriDati.CodiceAccisa) And param.AltriDati.TipoDestinazione <> "0" Then
        ...
        If param.GestisciContabilita Then
            If Not String.IsNullOrEmpty(param.DettagliContabilita.DestinazioneDiversa_Cod) _
                And param.DettagliContabilita.DestinazioneDiversa_Cod <> "0" And
                (String.IsNullOrEmpty(param.DettagliContabilita.IndirizzoDestinazioneDiversa_Cod) Or
    ...
    Private Shared Function Controlla_Costi(ByVal piva As String, ByVal codContatto As String, ByVal param As ParametriSalvaTutto, ByRef errori As String) As Boolean
        ...
        Dim tutteLeRighe As List(Of CostiModel) = New List(Of CostiModel)()
        Dim almenoUnoSbagliato As Boolean = False
    ...
    Private Shared Function Controlla_IndirizziKendo(ByVal param As ParametriSalvaTutto,
        ...
        If param.ItaEste = 0 Then
            If (Not IsNothing(param.righeInseriteGrid_Indirizzi) And param.righeInseriteGrid_Indirizzi <> "" And Not IsNothing(param.righeModificateGrid_Indirizzi) And param.righeModificateGrid_Indirizzi <> "") Then

                Dim settingLoc As New JsonSerializerSettings With {.DateTimeZoneHandling = DateTimeZoneHandling.Local}

                'Dim inseritiModificati As List(Of IndirizzoModel) = New List(Of IndirizzoModel)()
                Dim tutteLeRighe As List(Of IndirizzoModel) = New List(Of IndirizzoModel)()
                ...
                For Each row As IndirizzoModel In righeNonCancellate
                    If (row.Tipo_Indirizzo = "0" Or IsNothing(row.Tipo_Indirizzo)) Then
            ...
            End If
        Else
            If (Not IsNothing(param.righeNonCancellateGrid_Indirizzi) And param.righeNonCancellateGrid_Indirizzi <> "[]" And param.righeNonCancellateGrid_Indirizzi <> "") Then
                ...
                If (righeNonCancellate.Count() <> 0) Then
                    ...
                    For Each row As IndirizzoModel In righeNonCancellate
                        ...
                        Select Case (row.Tipo_Indirizzo)
                            Case 1 : If (row.Stato.ToString().ToUpper().Equals("ITALIA") Or row.Stato.ToString().ToUpper().Equals("IT")) Then
                                    errori = DirectCast(HttpContext.GetLocalResourceObject("~/Anagrafica/New_Contatto_Edit.aspx", "ErroreStatoSedeOperativa"), String)
                                    retVal = False
                                End If
                            Case 102 : If (row.Stato.ToString().ToUpper().Equals("ITALIA") Or row.Stato.ToString().ToUpper().Equals("IT")) Then
                                    errori = DirectCast(HttpContext.GetLocalResourceObject("~/Anagrafica/New_Contatto_Edit.aspx", "ErroreStatoSedeAziendale"), String)
                                    retVal = False
                                End If
                            Case 103 : If (row.Stato.ToString().ToUpper().Equals("ITALIA") Or row.Stato.ToString().ToUpper().Equals("IT")) Then
                                    errori = DirectCast(HttpContext.GetLocalResourceObject("~/Anagrafica/New_Contatto_Edit.aspx", "ErroreSatoStabilimento"), String)
                                    retVal = False
                                End If
                            Case 201 : If (Not row.Stato.ToString().ToUpper().Equals("ITALIA") And Not row.Stato.ToString().ToUpper().Equals("IT")) Then
                    ...
                    If Not IsNothing(so) Then
                        ...
                        "~/Anagrafica/New_Contatto_Edit.aspx", "ContattoEsteroNecessitaStatoInIndirizzoPrincipale"), String)
                            retVal = False
                        Else
                            If so.Stato.ToString().ToUpper().Equals("ITALIA") Or so.Stato.ToString().ToUpper().Equals("IT") Then
    ...
    Private Shared Function Controlla_RapportiCOntabili(
        ...
        Dim inseritiModificati As List(Of RapportoContabileModel) = New List(Of RapportoContabileModel)()
        Dim eliminati As List(Of RapportoContabileModel) = New List(Of RapportoContabileModel)()
        Dim tutteLeRighe As List(Of RapportoContabileModel) = New List(Of RapportoContabileModel)()
        Dim almenoUnoSbagliato As Boolean = False
        ...
        If tutteLeRighe.Any Then
            ...
            ' ricavo rapporti contabili ragrrupati per tipo rapporto
    ...
    <WebMethod(EnableSession:=True)>
    Public Shared Function ControllaLiquidita(
                    ByVal piva As String,
                    ByVal codContatto As String,
                    ByVal codLiquidita As Integer) As RispostaStandard
        ...
        Try
            ...
            If codLiquidita <> 0 Then
                ...
                dt = dal.Leggi(
                piva, objParametriAgenda.Sa_Cod, 0, 0, 0, codLiquidita, 0, False, False, False,
    ...
    Public Shared Function CheckPreSalva(ByVal piva As String, ByVal param As String) As RispostaStandard
        ...
        Try
            ...
            If parametri.TipoUtente = "0" Then
                ...
                If codContatto = "" Or String.IsNullOrEmpty(parametri.Nome) Or String.IsNullOrEmpty(parametri.Cognome) Then
                ...
                If Not parametri.Fittizio Then
                    If codContatto.Length = 11 And (codContatto.Chars(0) = "F" Or codContatto.Chars(0) = "-") And IsNumeric(codContatto.Substring(1)) Then
            ...
            Else
                ...
                If codContatto = "" Or String.IsNullOrEmpty(parametri.RagioneSociale) Then
                ...
                If Not parametri.Fittizio Then
                    ...
                    If Not parametri.ItaEste = 2 Then
                        ...
                        If codContatto.Length = 11 And (codContatto.Chars(0) = "F" Or codContatto.Chars(0) = "-") And IsNumeric(codContatto.Substring(1)) Then
                            'contatto generato automaticamente
                        Else
                            If codContatto.Length <> 11 Or Not IsNumeric(codContatto) Then
                    ...
                    Else
                        ...
                        Else
                            If codContatto.Length > 25 Then
                                r.RispostaStringa = "La partita iva non è corretta. Inserire una partita iva lunga al massimo 25 caratteti o generarne una con il pulsante apposito."
                                r.RispostaOK = False
                                Return r
                            End If
                        End If
    ...
    End Sub
    Private Shared Sub PreparaSalvataggioRubrica(
        ByVal righeInseriteGrid_Rubrica As String,
        ...
        Dim settingLoc As New JsonSerializerSettings With {.DateTimeZoneHandling = DateTimeZoneHandling.Local}
        Dim inseritiModificati As List(Of RubricaModel) = New List(Of RubricaModel)()
        Dim elimintati As List(Of RubricaModel) = New List(Of RubricaModel)()
    ...
    Private Sub AnnullaTutto(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If objParametriAgenda.Piva_Origine <> "" And objParametriAgenda.Piva_Origine <> objParametriAgenda.Piva Then
