...
#End Region
  ...
  <WebMethod(EnableSession:=True)> _
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim objCodici As New AgronicaCoreAnagrafeDAL.Imprese_Codici_Read 'Agro_Anagrafe_AD.Imprese_Codici_Read
        ...
        Dim objIndirizzi As New AgronicaCoreAnagrafeDAL.ImpresexIndirizzi_R  'Agro_Anagrafe_AD.ImpresexIndirizzi_R
        Dim DTIndirizzi As DataTable 'As ADODB.Recordset
        Dim strContatti As String

        'variabili per la lettura dell'xml dei contatti
        ...
        Dim XML_RapCon As System.Xml.XmlElement
        Dim XMLs_RapCon As System.Xml.XmlNodeList
        Dim XML_DatiRapportoContabile As System.Xml.XmlElement
        ...
        AgronicaCoreUtility.CaricaListControl.FormeGiuridiche(Cmb_FormaGiuridica, True, AgronicaAgenda_2010.Seleziona.ToUpper(), "", "", "", objParametri_Server)
        ...
        Dim objC As New AgronicaCoreUtility.CaricaListControl
        objC.CaricaCombo_Tecnici(CmbTecnico, True, AgronicaAgenda_2010.Seleziona.ToUpper(), "", objParametri_Server.PivaSuperUser, "", "", objParametri_Server)
    ...
    Private Sub Salva_Tutto()
        ...
        Try
            ...
            Dim objImpresa As New AgronicaCoreAnagrafeBIZ.Impresa_W  'Agro_Anagrafe.Impresa_W
            ...
            If Me.Opt_TipoImpresa.Checked = True Then
                TipoImpresaGerarchia = 1
            End If

            If Me.Opt_TipoCooperativa.Checked = True Then
                TipoImpresaGerarchia = 2
            End If

            If Me.Opt_TipoConsorzio.Checked = True Then
                TipoImpresaGerarchia = 3
            End If

            If Me.Opt_TipoOP.Checked = True Then
            ...
            Try
                ...
                If Operazione = enum_TipoOperazioneDB.Scrittura Then
                    ...
                    Dim objCentroAziendale As New AgronicaCoreAnagrafeBIZ.CentroAziendale_W  'Agro_Anagrafe.CentroAziendale_W
                    ...
                    If Chk_Centro.Checked Then
                        ...
                        If Chk_Magazzino.Checked = True Then

                            Dim objSequenza As New AgronicaCoreDataProvider.Agro_Sequenze        'New Agro_Anagrafe_AD.Agro_Sequenze
                            ...
                            Dim objSeqFabbricati As New AgronicaCoreDataProvider.Agro_Sequenze  'Agro_Anagrafe2_AD.Agro_Sequenze
                            Dim objFabbricati As New AgronicaCoreAnagrafeDAL.Fabbricati_W  'Agro_Anagrafe2_AD.Fabbricati_W
