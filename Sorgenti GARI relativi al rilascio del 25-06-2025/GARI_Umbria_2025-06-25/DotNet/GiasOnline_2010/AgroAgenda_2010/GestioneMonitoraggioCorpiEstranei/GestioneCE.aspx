...
<table class="boxColore" style="width:100%; " aria-hidden="true">
    <tr >
        ...
        <td style=" vertical-align:top; padding-left:15px;">
            <div>
                <asp:ImageButton ImageUrl="~/AB_Immagini/Icone32/Lente.ico" ID="ID_Trova" runat="server" ToolTip="Cerca i monitoraggi in base al filtro impostato" />                   
            ...
            <asp:Panel  runat="server" ID="Pannello_Inserimento"  Visible="false" >
                ...
                <table id="Pannello_CE_Insert" style=" vertical-align:top; " runat="server" aria-hidden="true">
                    <tr>
                        ...
                        <tr>
                        <td style="padding-left:15px;">   
                            <asp:TextBox ID="Txt_Cod_CorpoEstraneo" runat="server" class="txtUI" Width="200"></asp:TextBox>     
