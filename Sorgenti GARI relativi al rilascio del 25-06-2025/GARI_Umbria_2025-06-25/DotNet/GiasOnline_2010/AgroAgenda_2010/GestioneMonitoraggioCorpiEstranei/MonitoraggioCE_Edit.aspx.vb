...
Public Class MonitoraggioCE_Edit
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not IsNothing(Request.QueryString("act")) Then
                ...
                act = Stringa_Decodifica(Request.QueryString("act").ToString, _
                               AgroKey_EncoderDecoder, _
                               Server)
                P_get = Qs_Piva
            End If
            ...
            If Not IsNothing(Request.QueryString("saCod")) Then
                saCod_get = Stringa_Decodifica(Request.QueryString("saCod").ToString, _
                                               AgroKey_EncoderDecoder, _
                                               Server)
            End If

            If Not IsNothing(Request.QueryString("idAgenda")) Then
                idAgenda_get = Stringa_Decodifica(Request.QueryString("idAgenda").ToString, _
                                               AgroKey_EncoderDecoder, _
                                               Server)
            End If

            If Not IsNothing(Request.QueryString("idMov")) Then
                idMov_get = Stringa_Decodifica(Request.QueryString("idMov").ToString, _
                                               AgroKey_EncoderDecoder, _
                                               Server)
            ...
            Else
                ...
                Select Case Txt_InsertCE.Value
                    ...
                    Case "1" 'inseriti dei CE -> fare il refresh dei menù a tendina
                        ...
                        Carica_CE()
                        'dopo il caricamento riazzero al casella
                        Txt_InsertCE.Value = ""
            ...
            Select Case CInt(Session("ASG_ProgressivoGIAS"))
                Case enum_CodiceGIAS_Clienti.Fruttagel
                    ...
                    AgronicaCoreUtility.CaricaListControl.Prefisso_BolleAccettazione_FRG(Me.Cmb_Prefisso, _
                                                                                            False, "", "", _
    ...
    'perchè veniva fatto il controllo di esistenza sempre sulla prima
    Private Sub CaricaDatiBolla(ByVal Controlla As Boolean, ByVal Provenienza As Integer)
        ...
        If Cmb_Produttori.SelectedValue <> "0" And Cmb_Produttori.SelectedValue <> "" Then
        ...
        If Not IsNothing(DT) AndAlso DT.Rows.Count > 0 Then
            ...
            If Controlla = True Then
                ...
                If Provenienza = 2 And DT.Rows.Count > 1 Then
                    ' se sto cercando dal numero di ddt e sono state trovate più bolle,
                    'non faccio il controllo sulla prima trovata 
                    'lo faccio quando l'utenteseleziona il produttore nel menù a tendina
                ...
                Else
                    ...
                    If objCE.EsisteRegistrazioneBolla(Qs_Piva, _
                                                        prefisso, _
                                                        CInt(txt_Numero_Bolla.Text), _
                                                        "", _
                                                        Txt_Bolla_Anno.Text, _
    ...
    Private Sub Ripristina_Dati_nei_Controlil()
        ...
        DT = objAgenda.Leggi(P_get, saCod_get, idAgenda_get, 0, _
        ...
        DT = objMovimenti.Leggi(P_get, saCod_get, idAgenda_get, idMov_get, _
                                0, "", _
                                AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta, _
                                "", _
                                    "", _
        ...
        '' proseguo con il caricamento dei dettagli dalla tabella movimenti_dettagliù
        DT = objMovimentiDettagli.Leggi(P_get, saCod_get, idAgenda_get, idMov_get, _
    ...
    Private Function Carica_CE() As Boolean
        ...
        Try
            ...
            DT = objCorpoEstraneo.Leggi(0, AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaDatiMinimi, _
            "", "", objParametri_Server)
            ...
            End If
            'linea 1 
            AgronicaCoreUtility.CaricaListControl.CorpiEstranei(CType(Cmb_TipoCE_AE_1, ListControl), _
                                                                True, "", "0", _
                                                                DT, "", "", objParametri_Server)
            AgronicaCoreUtility.CaricaListControl.CorpiEstranei(CType(Cmb_TipoCE_CO_1, ListControl), _
                                                                True, "", "0", _
                                                                DT, "", "", objParametri_Server)
            AgronicaCoreUtility.CaricaListControl.CorpiEstranei(CType(Cmb_TipoCE_CM_1, ListControl), _
                                                                True, "", "0", _
                                                                DT, "", "", objParametri_Server)
            'linea 2 
            AgronicaCoreUtility.CaricaListControl.CorpiEstranei(CType(Cmb_TipoCE_AE_2, ListControl), _
                                                                True, "", "0", _
                                                                DT, "", "", objParametri_Server)
            AgronicaCoreUtility.CaricaListControl.CorpiEstranei(CType(Cmb_TipoCE_CO_2, ListControl), _
                                                                True, "", "0", _
                                                                DT, "", "", objParametri_Server)
            AgronicaCoreUtility.CaricaListControl.CorpiEstranei(CType(Cmb_TipoCE_CM_2, ListControl), _
                                                                True, "", "0", _
                                                                DT, "", "", objParametri_Server)
            Return True
    ...
    Private Function SalvaTutto() As Boolean
        ...
        Dim DT As DataTable
        DT = objAgroXml.DtForXml_Genera_MovimentiDettagli()
        ...
        If AlmenoUnCorpoEstraneo = False Then
            QTA = 0
            ' scompongo 
            Prod_Cod = 0
    ...
    Private Sub ImgBtn_Ins_AE_1_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImgBtn_Ins_AE_1.Click
        Dim indice_Pericolosita As Integer
        If VerificaQta(Txt_N_AE_1, Cmb_TipoCE_AE_1) = True Then
    ...
    Private Sub ImgBtn_Ins_AE_2_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImgBtn_Ins_AE_2.Click
        Dim indice_Pericolosita As Integer
        If VerificaQta(Txt_N_AE_2, Cmb_TipoCE_AE_2) = True Then
    ...
    Private Sub ImgBtn_Ins_CO_1_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImgBtn_Ins_CO_1.Click
        Dim indice_Pericolosita As Integer
        If VerificaQta(Txt_N_CO_1, Cmb_TipoCE_CO_1) = True Then
    ...
    Private Sub ImgBtn_Ins_CO_2_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImgBtn_Ins_CO_2.Click
        Dim indice_Pericolosita As Integer
        If VerificaQta(Txt_N_CO_2, Cmb_TipoCE_CO_2) = True Then
    ...
    Private Sub ImgBtn_Ins_CM_1_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImgBtn_Ins_CM_1.Click
        Dim indice_Pericolosita As Integer
        If VerificaQta(Txt_N_CM_1, Cmb_TipoCE_CM_1) = True Then
    ...
    Private Sub ImgBtn_Ins_CM_2_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImgBtn_Ins_CM_2.Click
        Dim indice_Pericolosita As Integer
        If VerificaQta(Txt_N_CM_2, Cmb_TipoCE_CM_2) = True Then
