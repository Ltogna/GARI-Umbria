...
Public Class MenuBS_Anagrafica
    ...
    Private Shared Function EliminaContatto(Piva As String, Sa_Cod As Integer, Cod_Contatto As String, ByRef Msg As String, ByRef EseguitaOperazione As Boolean, objParametri_Server As AgronicaCoreParametri, objParametri_Agenda As ParametriAgenda)
        ...
        If Not isGIAS Then
            ...
            If Dt.Rows.Count <> 0 OrElse esistenzaSquadre Then
                ...
                Else
                    Msg = String.Format(AgronicaAgenda_2010.MenuBS_Anagrafica_EliminaContatto_MovimentiCollegatiCancellareRegistrazioni, Rag_Soc, vbCrLf)
                End If
            ...
            Else
                ...
                If dtAltriRiferimenti.Rows.Count > 0 Then
                    ...
                    Msg = String.Format(AgronicaAgenda_2010.MenuBS_Anagrafica_EliminaContatto_CancellareRegistrazioni,
        ...
        Else
            ...
            Msg = AgronicaAgenda_2010.MenuBS_Anagrafica_EliminaContatto_ImpresaNonCancellabile
    ...
    Public Shared Function CaricaAzienda() As RispostaStandard
        ...
        Try
            ...
            l.Add(New ColonneNome("piva", AgronicaAgenda_2010.PartitaIVA, "string"))
...
#End Region
    ...
    Public Shared Function CaricaStalle() As RispostaStandard
        ...
        Try
            ...
            If permessoBDN_R Then
                l.Add(New ColonneNome("BDN_Codice_Azienda", AgronicaAgenda_2010.CodiceAziendaBDN, "string"))
            End If
