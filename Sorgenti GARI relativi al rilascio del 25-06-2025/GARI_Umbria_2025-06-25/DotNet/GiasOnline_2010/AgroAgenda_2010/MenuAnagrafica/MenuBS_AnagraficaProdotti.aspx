                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12">
                                                ...
                                                <div class="form-horizontal">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <label class="input-group-addon alert-info" id="lbl_filtro_reg" for="ddl_Regolamento">Regolamento:</label>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <label class="input-group-addon alert-info" id="lbl_filtro_visibilita" for="ddl_Visibilita">Visibilità:</label>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <label class="input-group-addon alert-info" id="lbl_filtro_valorizzati" for="ddl_Valorizzati">Valorizzati:</label>
