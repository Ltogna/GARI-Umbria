...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Qs_Tipo_Ricetta = enum_TipoRicetta.PianoDistribuzioneConcimi AndAlso
            Qs_Data_Inizio = AgronicaCoreDataProvider.CostantiPersonalizzate.AGRODATAINIZIO AndAlso
            Qs_Data_Fine = AgronicaCoreDataProvider.CostantiPersonalizzate.AGRODATAFINE
           ) Then
            Dim objImpost As New AgronicaCoreUtentiDAL.Utenti_Impostazioni_Read
            Dim DataInizio, DataFine As Date
            objImpost.AnnataAgraria(Now.Today, DataInizio, DataFine, objParametri_Utenti)
        ...
        If Qs_Data_Inizio = CStr(AGRODATAINIZIO) Or
           Qs_Data_Fine = CStr(AGRODATAFINE) Or
        ...
        Select Case CInt(Qs_Ricetta_Cod)
            ...
            Case 0
                ...
                Dim objSpecie As New AgronicaCoreUtility.CaricaListControl
                objSpecie.SpecieVegetale_Optimize(Cmb_Specie, True, "", "", 0, "", True, 0, 0, 0, "", "", objParametri_Server, objParametri_Utenti)

                If Not Qs_Veg_Cod Is Nothing AndAlso Qs_Veg_Cod <> "0" Then
                    ...
                    If Qs_Tipo_Ricetta = enum_TipoRicetta.PianoDistribuzioneConcimi Then
                        ...
                        Me.Txt_Ricetta_Des.Text = IIf(Qs_Ricetta_Des <> "", Qs_Ricetta_Des, "Piano Distribuzione " & Me.Cmb_Specie.SelectedItem.Text & " (" & Me.Txt_DataInizio.Text & ")")
                    Else
                        '  Marco Grilli, 13/04/2016 10:41:59: Il titolo della ricetta se è passato per parametro, lo metto
                        Me.Txt_Ricetta_Des.Text = IIf(Qs_Ricetta_Des <> "", Qs_Ricetta_Des, Me.Cmb_Specie.SelectedItem.Text & " (" & Me.Txt_DataInizio.Text & ")")
                    End If


                    If Not Qs_Cul_Cod Is Nothing AndAlso Qs_Cul_Cod <> "" Then
                        ...
                        If Not ArrayCulCod Is Nothing Then
                ...
                '-------------------------------------------------------------------------
                If Not Session("FiltroAgenda") Is Nothing Then
                    ...
                    If Not Qs_Data_Inizio Is Nothing AndAlso Qs_Data_Inizio <> AgronicaCoreDataProvider.CostantiPersonalizzate.AGRODATAINIZIO.ToString Then
                        Me.Txt_DataInizio.Text = Qs_Data_Inizio
                    End If

                    If Not Qs_Data_Fine Is Nothing AndAlso Qs_Data_Fine <> AgronicaCoreDataProvider.CostantiPersonalizzate.AGRODATAFINE.ToString Then
                        Me.Txt_DataFine.Text = Qs_Data_Fine
                    End If
        ...
        If Qs_Unid_Operazione <> "" Then
            ...
            If DtWebC.Rows.Count > 0 Then
                ...
                If StringaXmlOperazioni <> "" Then
                    ...
                    If Not ArrayAgende Is Nothing AndAlso ArrayAgende.Length > 0 Then
    ...
    Private Sub Carica_Ricetta(ByVal StringaXmlRicetta As String)
        ...
        Dim XML_DatiDestinazioni As System.Xml.XmlNodeList
        ...
        Dim objSpecie As New AgronicaCoreUtility.CaricaListControl
        objSpecie.SpecieVegetale_Optimize(Cmb_Specie, True, "", "", 0, "", True, Veg_Cod, 0, 0, "", "", objParametri_Server, objParametri_Utenti)
        ...
        If Not XML_DatiRicettaxCultivar Is Nothing AndAlso XML_DatiRicettaxCultivar.HasChildNodes = True Then
            ...
            For i = 0 To XMLs_Cultivar.Count - 1
                ...
                Else
                    ...
                    If i = 0 Then
                        Dim objCultivar As New AgronicaCoreUtility.CaricaListControl
                        objCultivar.Cultivar(CBL_Cultivar, False, "", "", Veg_Cod, 0, "", True, 0, 0, "", "", objParametri_Server, objParametri_Utenti)
                    End If
        ...
        If Not XML_DatiRicettaxNote Is Nothing AndAlso XML_DatiRicettaxNote.HasChildNodes = True Then
    ...
    Private Function Abilita_Disabilita_Data()
    ...
    Private Sub Carica_Impianti(Optional ByVal strFiltroImpianti As String = "", Optional ByVal DtImpianti As DataTable = Nothing)
        ...
        If Not objParametriAgenda.Impianti Is Nothing AndAlso objParametriAgenda.Impianti.Count > 0 Then
        ...
        Else
            ...
            Else
                ...
                If Not DtImpianti Is Nothing AndAlso DtImpianti.Rows.Count > 0 Then
        ...
        For i = 0 To Me.GridView_Impianti.Rows.Count - 1
            ...
            If Not (Qs_Operazione = enum_TipoOperazioneDB.Trasferimento Or Qs_Operazione = enum_TipoOperazioneDB.Scrittura) Then
                lck.Enabled = False
            End If
        Next
    ...
    Protected Sub Btn_Nuovo_Consiglio_Click(sender As Object, e As EventArgs) Handles Btn_Nuovo_Consiglio.Click
        ...
        If Not (Qs_Tipo_Ricetta = enum_TipoRicetta.Standard_Destinazioni Or Qs_Tipo_Ricetta = enum_TipoRicetta.Standard_Destinazioni_Planning) Then
        ...
        If IsDate(Txt_DataInizio.Text) = True Then
            dataOK = True
        End If
        If Txt_DataFine.Visible = True Then
            If IsDate(Txt_DataFine.Text) = True Then
                dataOK = True
            Else
                dataOK = False
            End If
        ...
        Select Case Qs_Tipo_Ricetta
            ...
            Case TipiEnumerativi.enum_TipoRicetta.Standard_Destinazioni, enum_TipoRicetta.Standard_Destinazioni_Planning
                ...
                If res = True Then
                    Response.Redirect(TargetUrl & "?unid_ricetta=" & Sicurezza.Stringa_Codifica(Unid_Ricetta, CostantiPersonalizzate.AgroKey_EncoderDecoder) &
                                                  "&operazione_ricetta=" & Sicurezza.Stringa_Codifica(Qs_Operazione, CostantiPersonalizzate.AgroKey_EncoderDecoder) &
            ...
            Case Else
                ...
                Select Case CInt(ComboOperazione.Valore_Combo)
                    ...
                    Case LAVCOD_TRATTAMENTO_ANTIPARASSITARIO, LAVCOD_TRATTAMENTO_FITOREGOLATORE, LAVCOD_CONCIA_SEME, LAVCOD_GEODISINFESTAZIONE, LAVCOD_DISERBO, LAVCOD_DISSECCAMENTO
                        ...
                        If Not Session("dtScarico") Is Nothing AndAlso CType(Session("dtScarico"), DataTable).Rows.Count > 0 Then
        ...
        Select Case Cmb_Disciplinare.SelectedValue
            ...
            Case Is <> "0" 'DPI
                ...
                If IdRcdpi > 0 Then
                    ...
                    If Cmb_Epoca.Visible = True Then
    ...
    Private Function Carica_SoglieIntervento_Avversita() As Boolean
        ...
        For i = 0 To Me.GridViewAvversita.Rows.Count - 1
            ...
            If Not DrSogliaA Is Nothing AndAlso DrSogliaA.Length > 0 Then

                Dim iSoglie As Integer
                'controllo quale era selezionato 

                Dim valoreSelezionato As String = IIf(CType(GridViewAvversita.Rows(i).Cells(3).FindControl("rbl_soglie_intervento"),
    ...
    Protected Sub ImgBtn_Cerca_Formulati_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ImgBtn_Cerca_Formulati.Click
        ...
        If ComboFormulati.TipoRichiesto = enum_TipoFormulato.Coadiuvanti Or ComboFormulati.TipoRichiesto = enum_TipoFormulato.Corroboranti_Fisiofarmaci Then
        ...
        If CellaAvversita.Visible = True Then
            ...
            Dim Av_Cod_Temp1() As String
            Dim Av_Cod_Temp2() As String
            ...
            If NumAvv <> 0 Or NumAvvGru <> 0 Then
    ...
    Private Sub BTN_ComboFormulati_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTN_ComboFormulati.Click
        ...
        Dim DoseMinTemp As Decimal = 0
        Dim DoseMaxTemp As Decimal = 0
        Dim Udm_Cod As Integer
        Dim Udm_CodTemp As Integer = 0
        ...
        If ComboFormulati.Valore_Combo <> "" Then
            ...
            If Not ArrayTmp Is Nothing Then
                FrCod = ArrayTmp(0)
            End If
                    ...
                    For i = 6 To ArrayTmp.Length - 1
                        ...
                        If Not ArrayDose Is Nothing AndAlso ArrayDose.Length > 0 Then
                            ...
                            If InStr(DoseEtichetta, DoseEtichettaTemp) = 0 Then
                                ...
                                If (RBL_Dose_Formulati.Enabled = True) Or
                                    (per_ha_hl = 2121 And RBL_Dose_Formulati.SelectedValue = "0") Or
                                    (per_ha_hl = 2123 And RBL_Dose_Formulati.SelectedValue = "1") Then
    ...
    Private Sub Imposta_VolumiAcqua(ByVal AcquaMin As Decimal,
        ...
        If AcquaMax <> 0 Or AcquaMin <> 0 Then
    ...
    Protected Sub ImgBtn_DoseInserisci_Formulati_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ImgBtn_DoseInserisci_Formulati.Click
        ...
        If ComboFormulati.Valore_Combo <> "" Then
            ...
            ArrayTmp = Split(ComboFormulati.Valore_Combo, "£")
            If Not ArrayTmpFrDes Is Nothing Then
    ...
    Private Sub Ripristina_Dati_nei_Controlli_Trattamento(ByVal Xml_Operazione As String)
        ...
        Dim Piva As String = ""
        If Not ViewState("Piva") Is Nothing Then
            Piva = ViewState("Piva")
        End If
        ...
        AgronicaCoreUtility.CaricaListControl.Note_Intervento(CBL_Consigli_Difesa,
                                                        False, "", "",
                                                         0, -1,
                                                         "", "",
                                                         objParametri_Server)
        ...
        If XML_Ricetta_Operazione.HasChildNodes Then
            ...
            If Not xDatiRicettaxNote Is Nothing Then

                xListaRicettaxNote = xDatiRicettaxNote.GetElementsByTagName("RicettaxNote_2")

                If Not xListaRicettaxNote Is Nothing Then
                    ...
                    Select Case Cau_Mov
                        ...
                        Case "", AgronicaCoreDataProvider.CostantiPersonalizzate.CAU_TRATTAMENTO
                            ...
                            If i = 0 Then
                                ...
                                If Not XMLs_RicettaDestinazione Is Nothing AndAlso XMLs_RicettaDestinazione.Count > 0 Then
                ...
                If True Then
                    ...
                    For c = 1 To Cmb_Disciplinare.Items.Count - 1
                        ...
                        If Dpi_Cod = frm_CodDisciplinare Then
                            ...
                            If (IdRcdpi = frm_IdRcdpi Or frm_IdRcdpi = 0) And Flag_PubblicoPrivato = frm_DisciplinarePP Then
        ...
        If Not frm_Piva Is Nothing AndAlso frm_Piva.Length > 0 Then
    ...
    Private Sub Ripristina_Dati_nei_Controlli_Concimazione(ByVal Xml_Operazione As String)
        ...
        AgronicaCoreUtility.CaricaListControl.Note_Intervento(CBL_Consigli_Concimazione,
                                                        False, "", "",
                                                         0, -1,
                                                         "", "",
                                                         objParametri_Server)
        ...
        If XML_Ricetta_Operazione.HasChildNodes Then
            ...
            If Not XML_DatiRicetta_Dettagli_Tecnici Is Nothing Then
                ...
                If Not XMLs_Ricetta_Dettaglio_Tecnico Is Nothing Then
    ...
    Private Sub Ripristina_Dati_nei_Controlli_Lavorazione(ByVal Xml_Operazione As String)
        ...
        AgronicaCoreUtility.CaricaListControl.Note_Intervento(CBL_Consigli_Lavorazioni,
                                                        False, "", "",
                                                         0, -1,
                                                         "", "",
                                                         objParametri_Server)
    ...
    Private Sub Ripristina_Dati_nei_Controlli_Irrigazione(ByVal Xml_Operazione As String)
        ...
        AgronicaCoreUtility.CaricaListControl.Note_Intervento(CBL_Consigli_Irrigazione,
                                                        False, "", "",
                                                         0, -1,
                                                         "", "",
                                                         objParametri_Server)
    ...
    Private Sub Ripristina_Dati_nei_Controlli_RilieviAvvAus(ByVal Xml_Operazione As String)
        ...
        AgronicaCoreUtility.CaricaListControl.Note_Intervento(CBL_Consigli_Trappole,
                                                        False, "", "",
                                                         0, -1,
                                                         "", "",
                                                         objParametri_Server)
            ...
            If Not XML_DatiRicetta_Dettagli Is Nothing Then
                ...
                For i = 0 To XMLs_Ricetta_Dettaglio.Count - 1
                    ...
                    Select Case Cau_Mov
                        ...
                        Case "", AgronicaCoreDataProvider.CostantiPersonalizzate.CAU_TRATTAMENTO, CAU_RILIEVO_CAMPO
        ...
        clc.TrappolexSpecieVegetalixAvversita(CType(Me.cmb_Trappola, ListControl),
                                                            True, "", "0",
                                                            CInt(Me.Cmb_Specie.SelectedItem.Value),
                                                            0,
                                                            frm_UsoTrappola,
            ...
            Case "Info"
                ...
                Select Case Qs_Tipo_Ricetta
                    ...
                    Case enum_TipoRicetta.Standard_Destinazioni, enum_TipoRicetta.Standard_Destinazioni_Planning
                        ...
                        If res = True Then
                            Response.Redirect(TargetUrl & "?unid_ricetta=" & Sicurezza.Stringa_Codifica(Unid_Ricetta, CostantiPersonalizzate.AgroKey_EncoderDecoder) &
                                                           "&unid_ricetta_operazione=" & Sicurezza.Stringa_Codifica(Unid_Ricetta_Operazione, CostantiPersonalizzate.AgroKey_EncoderDecoder) &
                                                           "&operazione_ricetta=" & Sicurezza.Stringa_Codifica(Qs_Operazione, CostantiPersonalizzate.AgroKey_EncoderDecoder) &
                                                           "&r=" & Sicurezza.Stringa_Codifica(Qs_Ricetta_Cod, CostantiPersonalizzate.AgroKey_EncoderDecoder))
    ...
    Protected Sub cmb_Avversita_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmb_Avversita.SelectedIndexChanged
        ...
        If Me.cmb_Avversita.SelectedItem.Value = "" Or Me.cmb_Avversita.SelectedItem.Value = "0" Or Me.cmb_Avversita.SelectedItem.Value = "-1" Then
...
#Region "Salvataggio Ricetta"
    ...
    Private Function Salva_Ricetta() As Integer
        ...
        If CInt(Qs_Operazione) <> enum_TipoOperazioneDB.Cancellazione Then
            ...
            'controllo di avrene selezionata almeno una!
            If Me.RBL_Cultivar.SelectedValue <> "0" Then

                For i = 0 To Me.CBL_Cultivar.Items.Count - 1
                    If CBL_Cultivar.Items(i).Selected = True Then
                        AlmenoUna = True
                        Exit For
                    End If
                Next
    ...
    Private Function XML_GeneraStringa_Ricetta() As String
        ...
        If Not Dt_Operazioni Is Nothing Then
        ...
        If Chk_RicettaPubblica.Checked = True Then
            Piva = ""
            Sa_Cod = 0
        Else
        ...
        For i = 0 To Me.CBL_Note.Items.Count - 1
            If CBL_Note.Items(i).Selected = True Then
        ...
        If Not Array_Note Is Nothing Then
    ...
    Private Function XML_GeneraStringa_Ricetta_Concimazione() As String
        ...
        For i = 0 To Me.CBL_Consigli_Concimazione.Items.Count - 1
            If CBL_Consigli_Concimazione.Items(i).Selected = True Then
    ...
    Private Function XML_GeneraStringa_Ricetta_Irrigazione() As String
        ...
        Dim XML_DatiRicettaxNote As XmlElement
        Dim XML_DatiRicettaDettagliTecnici As XmlElement
        Dim XML_RicettaDettaglioTecnico As XmlElement
        Dim XML_RicettaDettaglioTecnico2 As XmlElement
        Dim XML_DatiRicettaDettagli As XmlElement
        Dim XML_DatiRicettaDettagli2 As XmlElement
        Dim XML_RicettaDettaglio As XmlElement
        ...
        For i = 0 To Me.CBL_Consigli_Irrigazione.Items.Count - 1
            If CBL_Consigli_Irrigazione.Items(i).Selected = True Then
                strNote = objXml.XML_RicettaxNote_2(enum_TipoOperazioneDB.Scrittura,
                                                           CStr(Session("ASG_SuperUser_CodFiscale")),
                                                           0,
                                                           0,
    ...
    Private Function XML_GeneraStringa_Ricetta_Lavorazioni() As String
        ...
        Select Case CInt(ComboOperazione.Valore_Combo)
            Case LAVCOD_SEMINA, LAVCOD_SOVESCIO, LAVCOD_TRAPIANTO, LAVCOD_SOD_SEDDING
                ...
                If Not DtTipologia Is Nothing AndAlso DtTipologia.Rows.Count > 0 Then
        ...
        For i = 0 To Me.CBL_Consigli_Lavorazioni.Items.Count - 1
            If CBL_Consigli_Lavorazioni.Items(i).Selected = True Then
                strNote = objXml.XML_RicettaxNote_2(enum_TipoOperazioneDB.Scrittura,
                                                           CStr(Session("ASG_SuperUser_CodFiscale")),
                                                           0,
                                                           0,
    ...
    Private Function XML_GeneraStringa_Ricetta_RilievoAvvCampo() As String
        ...
        For i = 0 To Me.CBL_Consigli_Trappole.Items.Count - 1
            If CBL_Consigli_Trappole.Items(i).Selected = True Then
                strNote = objXml.XML_RicettaxNote_2(enum_TipoOperazioneDB.Scrittura,
                                                           CStr(Session("ASG_SuperUser_CodFiscale")),
                                                           0,
                                                           0,
    ...
    Private Function XML_GeneraStringa_Ricetta_Trattamento() As String
        ...
        If Cmb_Disciplinare.SelectedValue <> "" Then
            ...
            If Me.Cmb_Disciplinare.SelectedValue <> "0" And Me.Cmb_Epoca.Items.Count > 0 Then
        ...
        For i = 0 To GridView_Dosi_Difesa.Rows.Count - 1
            ...
            If Not (strAv_Cod = "0" And strAv_Gru = "0") Then
        ...
        For i = 0 To Me.CBL_Consigli_Difesa.Items.Count - 1
            If CBL_Consigli_Difesa.Items(i).Selected = True Then
                strNote = objXml.XML_RicettaxNote_2(enum_TipoOperazioneDB.Scrittura,
                                                           CStr(Session("ASG_SuperUser_CodFiscale")),
                                                           0,
                                                           0,
...
#Region "Ribaltamento Operazioni su Agenda"
    ...
    Public Sub Aggiungi_Dettaglio()
        ...
        If Not Xml_Operazione Is Nothing Then
    ...
    Public Sub Salva_Operazione()
        ...
        For i = 0 To GridView_Impianti.Rows.Count - 1
            ...
            End If
        Next
        If StessaSpecie = False Then
            Messaggi.AgroMsgBox("Si possono elezionare solo Impianti di " & Me.Cmb_Specie.SelectedItem.Text & "!", Page, , Script_Panel)
            Exit Sub
        End If
        ...
        Else
            ...
            If DataInterventi < DataInizio Or DataInterventi > DataFine Then
            ...
            For i = 0 To GridView_Impianti.Rows.Count - 1
                If CType(GridView_Impianti.Rows(i).FindControl("ChkSelezionaImpianto"), CheckBox).Checked = True Then
                    ...
                    End If
                    If DataInizioImpianto > DataInterventi Or
        ...
        Try
            ...
            For n = 0 To GridView_Operazioni.Rows.Count - 1
                ...
                If CType(GridView_Operazioni.Rows(n).FindControl("ChkSelezionaOperazione"), CheckBox).Checked = True Then
                    ...
                    If Not strPiva Is Nothing AndAlso strPiva.Length > 0 Then
                        ...
                        For i = 0 To strPiva.Length - 1
                            ...
                            If Not strCentri Is Nothing AndAlso strCentri.Length > 0 Then
    ...
    Private Function Genera_Agenda_Trattamento(ByVal Lav_Cod As Integer,
        ...
        If Disciplinare = "0" Or Disciplinare = "" Then
            Dpi_Cod = "-1"
        Else
            Dim Array() As String
            Array = Split(Disciplinare, "/")
            Dpi_Cod = Array(0)
            If Not Array(4) Is Nothing Then
            ...
            If Not IsNothing(Array_AvCod) Then
                ...
                For j = 0 To UBound(Array_AvCod)
                    ...
                    If Array_Soglia_Value(j) <> "" Then
                        ...
                        If Not Soglia Is Nothing AndAlso Soglia.Length = 3 Then
