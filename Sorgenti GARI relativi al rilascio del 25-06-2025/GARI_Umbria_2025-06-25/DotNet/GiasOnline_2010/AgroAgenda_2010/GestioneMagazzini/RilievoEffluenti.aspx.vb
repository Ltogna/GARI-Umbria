...
Public Class RilievoEffluenti
    ...
    Public Shared Function LeggiGiacenzeEffluenti(
        ...
        Try
            ...
            Dim InserisciGiacenza As Boolean = False
            Dim Data_Fine_Divieto As Date = AGRODATAINIZIO
            ...
            If DtEffluenti IsNot Nothing AndAlso DtEffluenti.Rows.Count > 0 Then
                ...
                For Each dr As DataRow In DtEffluenti.Rows
                    ...
                    End If
                    If Not IsDBNull(dr.Item("Data_Inizio_Divieto")) Then
                        Effluente.Data_Inizio_Divieto = dr.Item("Data_Inizio_Divieto")
                    End If
                    If Not IsDBNull(dr.Item("Data_Fine_Divieto")) Then
                        Effluente.Data_Fine_Divieto = dr.Item("Data_Fine_Divieto")
                    End If
