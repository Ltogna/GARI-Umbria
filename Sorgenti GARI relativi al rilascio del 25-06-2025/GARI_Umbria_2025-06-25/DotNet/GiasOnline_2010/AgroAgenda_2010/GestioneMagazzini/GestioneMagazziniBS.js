...
function popolaGiacenze(IDControllo) {
    ...
    var colonneKendoGrid = [
        ...
        { field: "Pro_Cod", title: TraduzioneMultiResx(gestioneMagazziniResx, "CodiceProdotto", "Codice Prodotto"), width: 98, filterable: { multi: false, search: true } },
        { field: "Cod_Articolo", title: TraduzioneMultiResx(gestioneMagazziniResx, "CodiceArticoloAbbr", "Cod Articolo"), width: 118, filterable: { multi: false, search: true } },
...
function popolaMovimenti(IDControllo, parametri) {
    ...
    colonneKendoGrid.push(
        ...
        { field: "Des_Gruppo_Merce", title: "Gruppo Merce", width: 325, filterable: { multi: true, search: true }, hidden: true },
        { field: "Pro_Cod", title: TraduzioneMultiResx(gestioneMagazziniResx, "CodiceProdotto", "Codice Prodotto"), width: 100, filterable: { multi: false, search: true } },
        { field: "Cod_Articolo", title: TraduzioneMultiResx(gestioneMagazziniResx, "CodiceArticoloAbbr", "Cod Articolo"), width: 100, filterable: { multi: false, search: true } },
        { field: "Pro_Des", title: TraduzioneMultiResx(gestioneMagazziniResx, "Prodotto", "Prodotto"), width: 200, filterable: { multi: false, search: true } },
        ...
        { field: "Dettagli", title: TraduzioneMultiResx(gestioneMagazziniResx, "DescrizioneAttività", "Descrizione Attivita"), width: 200, filterable: { multi: false, search: true } },
...
function DelMovimento(e) {
    ...
    kendo.confirm(TraduzioneMultiResx(gestioneMagazziniResx, "ConfermaEliminazioneMovimento", "Sei sicuro di voler eliminare il movimento selezionato?"))
        .done(function (data) {
