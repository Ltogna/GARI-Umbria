...
Partial Public Class FattElettronica
    ...
    '''<summary>
    '''Controllo hdIdFatturaElettr.
    '''</summary>
    '''<remarks>
    '''Campo generato automaticamente.
    '''Per la modifica, spostare la dichiarazione di campo dal file di progettazione al file code-behind.
    '''</remarks>
    Protected WithEvents hdIdFatturaElettr As Global.System.Web.UI.HtmlControls.HtmlInputHidden

    '''<summary>
    '''Controllo hdKendo_FattureElettroniche.
    '''</summary>
    '''<remarks>
    '''Campo generato automaticamente.
    '''Per la modifica, spostare la dichiarazione di campo dal file di progettazione al file code-behind.
    '''</remarks>
    Protected WithEvents hdKendo_FattureElettroniche As Global.System.Web.UI.HtmlControls.HtmlInputHidden
End Class
