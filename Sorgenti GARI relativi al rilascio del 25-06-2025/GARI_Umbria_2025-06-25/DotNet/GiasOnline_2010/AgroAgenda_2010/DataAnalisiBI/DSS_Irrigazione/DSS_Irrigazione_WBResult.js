    ...
    $.WBResult_V2 = function (elem, header, coltura, arrIndic, persistent) {
                    ...
                    function (risposta) {
                        ...
                        if (risposta.RispostaOK) {
                            if (parseInt(risposta.RispostaStringa) > 0) {
                                ...
                                const runData = new Date(plugin.wbInput.RunData).toLocaleDateString();
        ...
        var _generateIrri2SaveObj = function (save_gias, save_if) {
            let irri = {
                ...
                RunData: plugin.wbInput.RunData
            };
            ...
            if (save_if) {
                ...
                irri.IF_key = {
                    IdPlot: plugin.wbInput.PersistData.Irri_PlotId,
                    IdCrop: plugin.wbInput.PersistData.Irri_CropId
                };
            }
