...
Namespace DSSIrrigazione
    ...
    Public Class IrrigazioneShared
        ...
        Public Function ImpiantiIrrigabili(objParametri_Server As AgronicaCoreParametri, fertiDetails As Boolean) As List(Of Centro)

            Dim objParametriAgenda As New ParametriAgenda

            Dim objRead As New AgronicaCoreAnagrafeDAL.Reg_Impianti_Read
            Dim DT As DataTable = objRead.Leggi_x_DSS_Irrigazione_V2(objParametriAgenda.Piva, fertiDetails, objParametri_Server)
