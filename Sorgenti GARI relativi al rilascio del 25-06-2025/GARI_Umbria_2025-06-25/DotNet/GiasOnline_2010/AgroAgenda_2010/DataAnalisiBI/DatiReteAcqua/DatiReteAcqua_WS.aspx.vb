...
Public Class DatiReteAcqua_WS
    ...
    Public Shared Function CalcolaConfrontoPrelieviOsservatiAttesi(ByVal piva As String,
        ...
        Try
            ...
            Dim datimeteo = New DatiMeteoXCalcoloPrelievi(linguaSession, objParametri_Server).RecuperaDatiMeteo(IIf(id_stazione = "", id_stazione_user, id_stazione), dataCalcDa, dataCalcA)
