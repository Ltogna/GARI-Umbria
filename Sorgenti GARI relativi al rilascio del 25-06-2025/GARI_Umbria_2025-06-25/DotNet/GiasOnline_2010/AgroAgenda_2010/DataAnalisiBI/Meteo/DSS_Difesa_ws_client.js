...
function elaboraModello() {
    ...
    ajaxAgronica(url_meteo_ws + "/ModelliPrevisionali_Elabora",    
        ...
        function (risposta) {
            ...
            creaOutputModello(modello.Mod_Cod, risp.Modello_Tabella1, 1);
            creaOutputModello(modello.Mod_Cod, risp.Modello_Tabella2, 2);
...
function creaOutputModello(modello, strTabellaKendo, indice) {
