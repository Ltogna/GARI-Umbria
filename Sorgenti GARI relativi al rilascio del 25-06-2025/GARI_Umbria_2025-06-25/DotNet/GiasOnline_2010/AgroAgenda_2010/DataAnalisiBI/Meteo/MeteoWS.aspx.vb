...
Public Class MeteoWS
    ...
    Private Shared Function StazioniXModelli(ByVal tipo_sorgente As Integer, ByVal stazione_cod As Integer, ByRef objParametri_Server As AgronicaCoreParametri) As List(Of _stazione_x_modelli)
    ...
    Public Shared Function LeggiStazioniXModelli(ByVal tipo_sorgente As Integer, ByVal stazione_cod As Integer) As RispostaStandard
        ...
        Try
            ...
            Dim listaStazioni = StazioniXModelli(tipo_sorgente, stazione_cod, objParametri_Server)
    ...
    Public Shared Function RegistraModelloXStazione(ByVal tipo_sorgente As Integer, ByVal stazione_cod As Integer, ByVal modello As Object) As RispostaStandard
        ...
        Try
            ...
            If bAdd Then
                ...
                Dim stazione = StazioniXModelli(tipo_sorgente, stazione_cod, objParametri_Server)
    ...
    Private Shared Function StazioniXIrriga(ByVal tipo_sorgente As Integer, ByVal stazione_cod As Integer, ByRef objParametri_Server As AgronicaCoreParametri) As List(Of _stazione_x_centri)
    ...
    Public Shared Function LeggiStazioniXIrriga(ByVal tipo_sorgente As Integer, ByVal stazione_cod As Integer) As RispostaStandard
        ...
        Try
            ...
            Dim listaStazioni = StazioniXIrriga(tipo_sorgente, stazione_cod, objParametri_Server)
        ...
        Try
            ...
            If listaIns.Any OrElse listaDel.Any Then
                ...
                If bResult Then
                    ...
                    Dim stazione = StazioniXIrriga(tipo_sorgente, stazione_cod, objParametri_Server)
