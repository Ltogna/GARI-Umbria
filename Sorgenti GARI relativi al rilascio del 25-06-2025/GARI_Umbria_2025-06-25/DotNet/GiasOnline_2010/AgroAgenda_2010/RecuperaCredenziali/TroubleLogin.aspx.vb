...
Public Class TroubleLogin
            ...
            Case 1
                ...
                If Not emailDaUsername = "" Then
                    ...
                    If dtUtenteDaEmail.Rows.Count = 1 Then
                        ...
                        Dim erroreMail = wsReimpostaPasswordInviaMail(objParametri_Super_Server, objParametri_Utenti, valSuperServer, descSuperServer, dtUtentiDett)
                        If erroreMail = "" Then
    ...
    Public Shared Function wsRecuperaUsername(ByVal email As String, ByVal valSuperServer As String) As RispostaStandard
        ...
        Select Case dtUtenteDaEmail.Rows.Count
            ...
            Case 1
                ...
                PersonalizzazioniMail(objParametri_Super_Server, swOggetto, mailLogo)
    ...
    Protected Shared Function wsReimpostaPasswordInviaMail(ByRef objParametri_Super_Server As AgronicaCoreParametri,
    ...
    Private Shared Sub PersonalizzazioniMail(ByRef objParametri_Super_Server As AgronicaCoreParametri, ByRef mailSWOggetto As String, ByRef mailLogo As String)
        ...
        Dim personalizzazioniRegioneUmbria = handleConfigSiti.Leggi_Valore(0, "personalizzazioniRegioneUmbria", "", "", objParametri_Super_Server) 'IN SVILUPPO È IMPOSTATA SUL DB_SERVER

        'Dim AgroWebConfig As New AgroWebConfig()
        'Dim personalizzazioniRegioneUmbria As String = AgroWebConfig._Hash_Chiavi("personalizzazioniregioneumbria")

        mailSWOggetto = "Gias Agronica"
        Dim nomeLogo = "Logo_Gias_Login.png"

        If personalizzazioniRegioneUmbria <> "" Then
            nomeLogo = String.Format("logo_gari_{0}.png", personalizzazioniRegioneUmbria)
            mailSWOggetto = "GARI"
        End If
        ...
        mailLogo = String.Format("<img src='{0}/agronica/AB_Immagini/logo/{1}' /><br/><br/>", linkGiasBase, nomeLogo)
