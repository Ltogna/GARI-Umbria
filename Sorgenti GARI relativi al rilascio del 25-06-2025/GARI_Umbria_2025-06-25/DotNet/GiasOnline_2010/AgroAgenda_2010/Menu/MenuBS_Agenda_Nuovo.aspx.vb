...
#Region "Utility"
        ...
        Select Case tipo_operazione
            ...
            Case "6b" 'CREAZIONE RICETTA DA OPERAZIONI
                ...
                TargetUrl = "../Ricette/Ricette_Edit.aspx?r=" & Stringa_Codifica(0, AgroKey_EncoderDecoder, objParametri_Server) &
                            ...
                            "&tipo_ricetta=" & Stringa_Codifica(TipiEnumerativi.enum_TipoRicetta.Standard_Destinazioni, AgroKey_EncoderDecoder, objParametri_Server)
    ...
    Public Shared Function Gestione_Operazione(ByVal lav_cod As String, ByVal tipo_operazione As String, ByVal specie As String, ByVal impianti As String) As RispostaStandard
        ...
        Select Case tipo_operazione
            ...
            Case "21" 'IMPOSTAZIONE UTENTI
                ...
                Dim DT2 As DataTable = Utenti_Permessi_R.Leggi(objParametri_Utenti.UtenteUsername, 5, AgronicaCoreDataProvider.TipiEnumerativi.enum_Security_Attivita.Gest_UtentiImpostazioni, enum_Security_Operazione.Lettura, 0, "", "", objParametri_Utenti)
                ...
                Dim strJS As String = AgronicaCoreGestioneRichieste.RedirectGestione.ApriPopUp_SitoProfilazione_PassandoDirettamenteIParametri(
                                   Enum_SiteRedirector.Sito_AgronicaAgenda_2010,
            ...
            Case "22" 'PROFILAZIONE IMPRESA
                ...
                Dim Utenti_Permessi_R As New AgronicaCoreUtentiDAL.Utenti_Permessi_R
                Dim DT2 As DataTable = Utenti_Permessi_R.Leggi(objParametri_Utenti.UtenteUsername, 5, AgronicaCoreDataProvider.TipiEnumerativi.enum_Security_Attivita.ProfilazioneImpresa, enum_Security_Operazione.Lettura, 0, "", "", objParametri_Utenti)
                If DT2.Rows.Count = 0 Then
                    r.RispostaOK = False
            ...
            Case "24" 'PIANO CONCIMAZIONE
                ...
                TargetUrl = AgronicaCoreGestioneRichieste.RedirectGestione.IndirizzoCompleto_SitoPianoConcimazione_PassandoDirettamente_ParametriConcimazione_2017(
                    Enum_SiteRedirector.Sito_AgronicaAgenda_2010, objConcimazione)

            Case "25" 'GESTIONE UTENTI

                Dim Utenti_Permessi_R As New AgronicaCoreUtentiDAL.Utenti_Permessi_R
                Dim DT2 As DataTable = Utenti_Permessi_R.Leggi(objParametri_Utenti.UtenteUsername, 5, AgronicaCoreDataProvider.TipiEnumerativi.enum_Security_Attivita.Gest_UtentiPermessi, enum_Security_Operazione.Lettura, 0, "", "", objParametri_Utenti)
                If DT2.Rows.Count = 0 Then
                    r.RispostaOK = False
            ...
            Case "30" 'Torna al menu precedente
                ...
                objParametriAgenda.SitoOrigine = Enum_SiteRedirector.Sito_AgronicaAgenda_2010
                objParametriAgenda.PaginaSitoOrigine = enum_PagineAgenda_2010.Menu_BS
                TargetUrl = AgronicaCoreModello.Utility_Operazioni.Link_GiasOnline_STR(enum_PagineGiasOnline.Menu_principale, objParametriAgenda)
            ...
            Case "33" ' Cartografia Aziendale
                ...
                TargetUrl = AgronicaCoreGestioneRichieste.RedirectGestione.IndirizzoCompleto_SitoOnline2010_PassandoDirettamenteIParametri(
                                    Enum_SiteRedirector.Sito_AgronicaAgenda_2010,
            ...
            Case "37" ' PUA ZOO
                ...
                Dim script As String = AgronicaCoreGestioneRichieste.RedirectGestione.ApriPopUp_Sito_AgronicaPUA_PassandoDirettamente_Parametri(
                                 TipiEnumerativi.Enum_SiteRedirector.Sito_AgronicaAgenda_2010, enum_AuditPuaTipo.PUA,
            ...
            Case "44" 'Gestione Pratiche e Servizi
                ...
                ElseIf UtentiAbilitatoWorkflowOLD Then
                    ...
                    strJS = AgronicaCoreGestioneRichieste.RedirectGestione.ApriPopUp_SitoProfilazione_PassandoDirettamenteIParametri(
                   Enum_SiteRedirector.Sito_AgronicaAgenda_2010,
    ...
    Private Sub ModificaFinestreTemp(ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri)
...
#Region "Carica DDL"
    ...
    Public Shared Function Carica_Specie(ByVal data_inizio As String, ByVal data_fine As String) As String
        ...
        clc.TutteSpecieColtivate_3_Data_Da_A(cmb_finalita,
                                                        True, Resources.AgronicaAgenda_2010.TutteLeSpecie, "-1",
                                                        objParametriAgenda.Piva,
...
#Region "Nuova Operazione"
    ...
    Public Shared Function NuovaOperazioneAgenda(ByVal lavcod As Integer, Veg_Cod As String) As String
        ...
        objParametriAgenda.PaginaSitoOrigine = enum_PagineAgenda_2010.Menu_BS
        objParametriAgenda.SitoOrigine = Enum_SiteRedirector.Sito_GiasOnline_2010
        ...
        Select Case objParametriAgenda.Lav_Cod
            Case LAVCOD_FATTURA_RICEVUTA, LAVCOD_BOLLA_RICEVUTA
                ...
                Dim DocumentoRicevutoLight = SeDocumentoRicevutoLight(OpUtil)
    ...
    Public Shared Function NuovaOperazioneRicettaAgenda(ByVal lavcod As Integer) As String
        ...
        Dim permesso As Boolean = controlloPermessi(enum_Security_Attivita.Gest_Ricette, enum_TipoOperazioneDB.Modifica) 'Nella fuzione sopra covertiva 1 in 2
        If permesso = False Then
            ' Messaggi.AgroMsgBox("Non si hanno i permessi per questa operazione su questo gruppo di operazioni", Page, , Nothing)
            Return "error"
        End If
    ...
    Public Shared Function NuovaOperazioneBrogliaccioAgenda(ByVal lavcod As Integer) As String
        ...
        'Dim permesso As Boolean = AgronicaCoreModello.Utility_Operazioni.PermessiOpContabiliEMagazzino(lavcod, "1", objParametri_Server, objParametri_Utenti, HttpContext.Current.Session)
        Dim permesso As Boolean = controlloPermessi(enum_Security_Attivita.Brogliaccio, enum_TipoOperazioneDB.Modifica) 'Nella fuzione sopra covertiva 1 in 2
        If permesso = False Then
            ' Messaggi.AgroMsgBox("Non si hanno i permessi per questa operazione su questo gruppo di operazioni", Page, , Nothing)
            Return "error"
        End If
...
#Region "Caricamento Tabelle"
    ...
    Public Shared Function CaricaTutto(ByVal data_inizio As String, ByVal data_fine As String, ByVal filtro As String) As RispostaStandard
        ...
        If (IsDate(data_inizio) = False) Then
            data_inizio = AGRODATAINIZIO
        End If

        If (IsDate(data_fine) = False) Then
            ...
            Try
                ...
                If blocco_flag = 1 Then
                    If Not {LAVCOD_VENDITA_ANIMALI, LAVCOD_MACELLAZIONE_ANIMALI, LAVCOD_TRASFERIMENTO_ANIMALI}.Contains(lav_cod) Then
                        Return Resources.AgronicaAgenda_2010.ImpossibileModificareOperazioneBlocc
                    End If
                End If
    ...
    Public Shared Function elimina_operazione(ByVal righe_selezionate As String) As RispostaStandard
        ...
        Try
            ...
            For Each riga As SelezionaMenuAgenda_Nuovo In operazioni
                ...
                res = AgronicaCoreModello.OperazioneAgenda_Temp.Operazione_Agenda_Utility.Cancella_Operazione_E_Collegate(objParametriAgenda, objParametri_Server, messaggio, True)
    ...
    Public Shared Function elimina_operazione_multipla(ByVal strChiaviComposite As String, proseguiInCasoDiAlert As Boolean) As RispostaStandard
        ...
        Else
            ...
            For Each chiaveComposita As String In listaChiaviComposite
                ...
                If msgErr.Trim() <> "" Then
                    If OUT_ErroreBloccante = True Then
...
#Region "Ricette"
    ...
    Private Shared Function XML_GeneraStringa_Ricetta(piva As String, objParametri_Server As AgronicaCoreParametri) As String
        ...
        Call Calcola_BaseCode_TopCode(frm_BaseCode, frm_TopCode, HttpContext.Current.Session("ASG_ProgressivoGIAS"))
    ...
    Public Shared Function Ricette_Cancella(ricetta_cod As Integer, ricetta_operazione_cod As Integer, in_uso As Integer, isBrogliaccio As Boolean) As RispostaStandard
        ...
        Else
            ...
            If permesso = False Then
                r.RispostaOK = True
                r.Errore = Resources.AgronicaAgenda_2010.OperazioneNonCancellataWarning & "<br>" & "<br>" & Gias.MancanzaPermessiCancellazioneTipoOperazione
                Return r
            End If
