            ...
            If Not DtRisultati Is Nothing AndAlso DtRisultati.Rows.Count > 0 Then
                ...
                For i = 0 To DtRisultati.Rows.Count - 1
                    ...
                    If AcquaUdm_Cod <> 0 Then
                        objUDMMetaschema.UdmDes_from_UdmCod(AcquaUdm_Cod, AcquaUdm_Sim, objParametri_Server)
                    End If
                    ...
                    If Limite_Udm_Cod <> 0 Then
                        LimiteUdm_Sim = objUDMMetaschema.UdmDes_from_UdmCod(DtRisultati.Rows(i).Item("udm_cod_limite"), "", objParametri_Server)
                    End If
