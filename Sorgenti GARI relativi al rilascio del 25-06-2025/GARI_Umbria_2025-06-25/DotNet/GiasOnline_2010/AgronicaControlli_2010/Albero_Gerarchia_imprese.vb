...
Public Class Albero_Gerarchia_Imprese
    ...
    Private Function GetPive()
        ...
        'FiltroxUtente = objUtentiProf.Leggi_FiltroUtenteSQL(HttpContext.Current.Session("ASG_objParametri_Utenti").UtenteUsername, _
        '                                                        0, _
        '                                                        "", "", _
        '                                                        HttpContext.Current.Session("ASG_objParametri_Utenti"))
        ...
        Dt_Imprese = classFiltrone.CreaDTFiltrone(HttpContext.Current.Session("ASG_objParametri_Server"), _
                                                    xFiltroAggiuntivo, _
                                                    enum_TipoSelect_FiltroneSuperNova.Imprese, _
                                                    "", _
                                                    ClassJoin)
