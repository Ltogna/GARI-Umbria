...
Public Class AlberoAnagrafica2017
    ...
    Public Function GetNodesAlberoAnagrafeGetJsonData(
        ...
        Dim versioneSql As Integer =
            xLeggiVersioneSql.VersioneSqlServer_anno(objParametri_Server)
        ...
        If cfg.LetturaViaSQLJson And versioneSql >= 2017 Then
    ...
    Public Sub CaricaInfoDentroACentro(
        ...
        If cfg.Flag_Fabbricati = True Then
            CaricaNodoFabbricati(cfg, results, Id, PathRoot, data_Inizio, data_Fine)
        End If
...
#End Region
    ...
    Public Sub CaricaNodoFabbricati(
        ...
        If cfg.Flag_CheckBox Then
            ...
            If Not cfg.CheckBoxes.Flag_CheckBoxFabbricati Then
...
#End Region
                    ...
                    If cfg.Flag_CheckBox Then
                        ...
                        If Not cfg.CheckBoxes.Flag_CheckBoxCampioni Then
                            ...
                            Dim campioneNode = New AjaxTreeNodeJsonObject(
                                Chiave,
                                "{Campione} " & DR_CampioniXDettagli(j).Item("Analisi_Campione_Des"),
    ...
    Public Function CaricaAlberoCentriDropdown(piva As String, objPServer As AgronicaCoreParametri, Optional insertDefault As Boolean = False) As DataTable
        ...
        If insertDefault Then
            ...
            row("sa_cod") = "0"
            row("sa_nome") = "Visualizzazione di tutti i Centri Aziendali"
    ...
    Public Sub CaricaAppezzamenti(
        ...
        If Not String.IsNullOrEmpty(xSementiero) Then
            xSementiero = " AND T1.Codice_Fiscale_Tecnico = '" & xSementiero & "' "
        End If

        If cfg.FlagModalitaSementieri Then
            xSementiero = " AND T1.Codice_Fiscale_Tecnico = '" & cfg.PivaPadre & "' "
        End If
        ...
        For i = 0 To DT_Appezzamenti.Rows.Count - 1
            ...
            If cfg.Flag_Esplodi_Tutto = True Then
                ...
                CaricaImpianti(cfg, child, objParametri_Server, xChiave, PathRoot, data_Inizio, data_Fine, xSementiero)
    ...
    Public Sub CaricaImpianti(
        ...
        If cfg.FlagModalitaSementieri Then
            xSementiero = " Reg_Impianti.Codice_Fiscale_Tecnico = '" & cfg.PivaPadre & "' "
        End If
        ...
        For Each r In DT_Ricette.Rows
            ...
            Select Case TipoRicetta
                Case enum_TipoRicetta.Standard_Destinazioni
                    ...
                    End If
                    If wAnag = "300" Then
                        DescrizioneNodo &= " (Ordini di lavoro / Ricette) "
                    Else
                        DescrizioneNodo &= " (Brogliaccio) "
                    End If

                Case enum_TipoRicetta.PianoDistribuzioneConcimi
                    DescrizioneNodo &= " (Piano Distribuzione)"

                Case enum_TipoRicetta.PUA
                    DescrizioneNodo &= " (PUA Zootecnico)"
