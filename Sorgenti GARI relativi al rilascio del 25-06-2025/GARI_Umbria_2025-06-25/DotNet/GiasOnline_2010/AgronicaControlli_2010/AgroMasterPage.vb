...
Public Class AgroMasterPage
    ...
    Private Sub Testata()
        ...
        Select Case _paginaOspite
            ...
            Case 1 'master
                ...
                Dim logoAgronica = ""
                If personalizzazioniRegioneUmbria <> "" Then
                    logoAgronica = "logo_ru_small_" & personalizzazioniRegioneUmbria & ".png"
                Else
                    logoAgronica = IIf(flag_MenuBS_2017, "logo_gias_small.png", "logo_small.png")
                End If

                Dim panelLogoAgronica As Panel = PanelLogoGenera("LogoAgronica", _LinkGiasBase & "agronica/AB_Immagini/logo/" & logoAgronica, "margin: 5px;", "col-xs-pull-5")
    ...
    Public Sub SetPersonalizzazioniRegioneUmbria()
        LeggiPersonalizzazioniRegioneUmbria()
    End Sub
