...
Public Class STD_Formulati
    ...
    Public Function LeggiFormulati(tipoAttivita As attivita.Attivita.Tipo_Attivita,
        ...
        If lavorazione IsNot Nothing AndAlso lavorazione.primaryKey IsNot Nothing Then
            strTipiRichiesti = GetTipiRichiesti(lavorazione.primaryKey.codice)
        End If
    ...
    Private Function GetTipiRichiesti(Lav_Cod As String) As String

        Dim TipiRichiesti As New List(Of Integer)

        Select Case Lav_Cod
            Case LAVCOD_TRATTAMENTO_ANTIPARASSITARIO
                TipiRichiesti.Add(enum_TipoFormulato.Antiparassitari)
                TipiRichiesti.Add(enum_TipoFormulato.Coadiuvanti)
                TipiRichiesti.Add(enum_TipoFormulato.Corroboranti_Fisiofarmaci)
            Case LAVCOD_CONCIA_SEME
                TipiRichiesti.Add(enum_TipoFormulato.Concianti)
                TipiRichiesti.Add(enum_TipoFormulato.Coadiuvanti)
            Case LAVCOD_DISSECCAMENTO
                TipiRichiesti.Add(enum_TipoFormulato.Disseccanti)
                TipiRichiesti.Add(enum_TipoFormulato.Coadiuvanti)
            Case LAVCOD_GEODISINFESTAZIONE
                TipiRichiesti.Add(enum_TipoFormulato.Geodisinfestanti)
                TipiRichiesti.Add(enum_TipoFormulato.Coadiuvanti)
            Case LAVCOD_TRATTAMENTO_FITOREGOLATORE
                TipiRichiesti.Add(enum_TipoFormulato.Fitoregolatori)
                TipiRichiesti.Add(enum_TipoFormulato.Coadiuvanti)
                TipiRichiesti.Add(enum_TipoFormulato.Corroboranti_Fisiofarmaci)
            Case LAVCOD_DISERBO
                TipiRichiesti.Add(enum_TipoFormulato.Diserbanti)
                TipiRichiesti.Add(enum_TipoFormulato.Coadiuvanti)
            Case LAVCOD_CONFUSIONE_SESSUALE
                TipiRichiesti.Add(enum_TipoFormulato.ConfusioneSessuale)
                TipiRichiesti.Add(enum_TipoFormulato.Coadiuvanti)
                TipiRichiesti.Add(enum_TipoFormulato.Corroboranti_Fisiofarmaci)
            Case LAVCOD_DISORIENTAMENTO_SESSUALE
                TipiRichiesti.Add(enum_TipoFormulato.DisorientamentoSessuale)
                TipiRichiesti.Add(enum_TipoFormulato.Coadiuvanti)
                TipiRichiesti.Add(enum_TipoFormulato.Corroboranti_Fisiofarmaci)
            Case LAVCOD_CONFUSIONE_DISORIENTAMENTO_SESSUALE
                TipiRichiesti.Add(enum_TipoFormulato.ConfusioneDisorientamentoSessuale)
            Case LAVCOD_TRATTAMENTO_POST_RACCOLTA
                TipiRichiesti.Add(enum_TipoFormulato.Tutti)
        End Select
