...
namespace CalcoloPianoConcimazioneVariabile
{
    public class CalcoloPianoConcimazioneVariabile
    {
         ...
         * . poichè non è possibile dedurre dall'immagine quale sia la banda dell'infrarosso vicino si suppone che la banda
         ...
         *   è l'unico tipoi di layer che espone pubblicamente il nome del file relativo al raster caricato
         */
        ...
        private static void CalcoloMediaStdDEV(RasterData pData, GisSharpBlog.NetTopologySuite.Geometries.Geometry NTSPolygon, SharpMap.Map Mappa, out double VIstd_Media, out double stdDEV)
        {
            SharpMap.Geometries.Point WCSPoint;
        ...
        private static OutputData CalcoloPianoConcimazione(double Media, double stdDev, double QMA, double QMAB, double percMin, double percMax, RasterData pData, GisSharpBlog.NetTopologySuite.Geometries.Geometry NTSPolygon, SharpMap.Map Mappa)
        {
            SharpMap.Geometries.Point WCSPoint;
            GisSharpBlog.NetTopologySuite.Geometries.Geometry NTSPoint;
            int i, j, index;
        ...
        private static void CalcolaMinMax(double Media, double stdDev, RasterData pData, GisSharpBlog.NetTopologySuite.Geometries.Geometry NTSPolygon, SharpMap.Map Mappa, out double VIStd_min, out double VIStd_max)
        {
            VIStd_min = 0;
            VIStd_max = 0;
