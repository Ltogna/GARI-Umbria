        ...
        Public Overrides Function ProiettaPunto( _
            ...
            If _fromCS Is Nothing Then
                If tbCSFrom_Text.StartsWith("PROJCS") Then
                    _fromCS = DirectCast(ProjNet.Converters.WellKnownText.CoordinateSystemWktReader.Parse(tbCSFrom_Text), IProjectedCoordinateSystem)
                Else
                    _fromCS = DirectCast(ProjNet.Converters.WellKnownText.CoordinateSystemWktReader.Parse(tbCSFrom_Text), ICoordinateSystem)
                End If
            End If
            ...
            Dim trans As ICoordinateTransformation = ctfac.CreateFromCoordinateSystems(_fromCS, _toCS)
            Dim planGeo As ICoordinateTransformation = ctfac.CreateFromCoordinateSystems(_toCS, _toCSGEO)
