...
Public Class UMA_Richieste_R
    ...
    Public Function ControlloMacrousiBio(ByVal richiesta_cod As Integer, ByVal anno As Integer,
        ...
        Try
            ...
            stb.AppendLine(" rrt.Avanzamento_Richiesta = " + IIf(rendicontazione, "1", "0") + " And p.anno = '" + anno.ToString + "') as x ")
            stb.AppendLine(" on x.Piva = r.Piva and x.Gruppo_Colturale_UMA = r.Gruppo_Colturale_UMA and ")
            stb.AppendLine(" x.Programmazione_Cod = r.Programmazione_Cod And x.Regolamento_Cod <> r.Regolamento_Cod ")
    ...
    Public Function EstraiLegamiRichiestaxAppezzamento(ByVal piva As String, ByVal richiesta_Cod As Integer,
        ...
        Try
            ...
            stb.AppendLine(" OUTER APPLY (SELECT TOP 1 * FROM Codifica_SpecieVegetali_Agea_2015_2020 ci WHERE ci.Occupazione_Cod = ric.Occupazione_Agea AND ci.Destinazione_Cod = ric.Destinazione_Agea AND ci.Qualita_Cod = ric.Qualita_Agea AND ci.Uso_Cod = ric.Uso_Agea AND ci.Cul_Cod = ric.Cul_Cod_Agea AND ci.Macrouso_UMA_Cod IS NOT NULL AND ci.Macrouso_UMA_Des IS NOT NULL) a  ")
    ...
    Public Function TrovaColtureAppezzamentiSenzaFascicolo(ByVal piva As String, ByVal richiesta_Cod As Integer, ByRef objParametri As AgronicaCoreParametri,
        ...
        Try
            ...
            stb.AppendLine("                     LEFT OUTER JOIN ZonexParticelle z On axp.prov = z.PROV And axp.Com = z.COM And axp.Sezione = z.SEZIONE And axp.Foglio = z.FOGLIO And axp.Numero = z.NUMERO And axp.Subalterno = z.SUBALTERNO And z.Zona_Cod In (-46, -47)")
            ...
            stb.AppendLine($"                    where ric.id_cod = 1362 ")
            If richiesta_Cod > 0 AndAlso anno = 0 Then
            ...
            If particelle Then
                stb.AppendLine("    , axp.COM, axp.PROV, axp.SEZIONE, axp.FOGLIO, axp.SUBALTERNO, axp.NUMERO ")
            End If
            ...
            stb.AppendLine(" OUTER APPLY (Select TOP 1 * FROM Codifica_SpecieVegetali_Agea_2015_2020 ci WHERE ci.Occupazione_Cod = ric.Occupazione_Agea And ci.Destinazione_Cod = ric.Destinazione_Agea And ci.Qualita_Cod = ric.Qualita_Agea And ci.Uso_Cod = ric.Uso_Agea And ci.Macrouso_UMA_Cod Is Not NULL And ci.Macrouso_UMA_Des Is Not NULL) b ")
            stb.AppendLine(" OUTER APPLY (Select TOP 1 * FROM Codifica_SpecieVegetali_Agea_2015_2020 ci WHERE ci.Occupazione_Cod = ric.Occupazione_Agea And ci.Destinazione_Cod = ric.Destinazione_Agea And ci.Macrouso_UMA_Cod Is Not NULL And ci.Macrouso_UMA_Des Is Not NULL) c ")
            stb.AppendLine(" OUTER APPLY (Select TOP 1 * FROM Codifica_SpecieVegetali_Agea_2015_2020 ci WHERE ci.Occupazione_Cod = ric.Occupazione_Agea And ci.Macrouso_UMA_Cod Is Not NULL And ci.Macrouso_UMA_Des Is Not NULL) d ) AS x ")
