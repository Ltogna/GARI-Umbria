...
Public Class UMA_Richieste_Testata_R
    ...
    Public Function Leggi_Elenco_Con_Indirizzi(ByVal piva As String,
        ...
        Try
            ...
            If piveVisibili.Length > 0 Then
                stb.AppendLine(" AND t.Piva IN ('" & piveVisibili & "')  ")
            End If
    ...
    Public Shared Sub AppendCteProvECom(stb As StringBuilder, prov As String, com As String, primaCte As Boolean)
        If primaCte Then
            stb.Append(" WITH ")
        Else
            stb.Append(" , ")
        ...
        If (com <> "0-1" AndAlso com <> "") Then
            stb.AppendLine(" And ISTAT.COM = '" + com + "' ")
        End If

        If (prov <> "0-1") Then
            stb.AppendLine(" AND ISTAT.PROV = '" + prov + "' ")
        End If
