    ...
    Public Function LeggiUF(ByVal occupazione_Cod As String,
        ...
        Try
            ...
            If occupazione_Cod <> "" Then
                strSql.AppendLine("AND UMA_UF_Colture.Occupazione_Cod = '" & occupazione_Cod + "' ")
            End If
            If destinazione_Cod <> "" Then
                strSql.AppendLine("AND UMA_UF_Colture.Destinazione_Cod = '" & destinazione_Cod + "' ")
            End If
            If uso_Cod <> "" Then
                strSql.AppendLine("AND UMA_UF_Colture.Uso_Cod = '" & uso_Cod + "' ")
            End If
            If qualita_Cod <> "" Then
                strSql.AppendLine("AND UMA_UF_Colture.Qualita_Cod = '" & qualita_Cod + "' ")
            End If
