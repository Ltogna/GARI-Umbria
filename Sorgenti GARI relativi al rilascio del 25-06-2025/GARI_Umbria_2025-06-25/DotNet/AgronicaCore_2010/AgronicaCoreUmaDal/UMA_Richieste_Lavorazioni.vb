...
Public Class UMA_Richieste_Lavorazioni_R
    ...
    Public Function Leggi_Per_Controllo_Incrociato(ByVal piva As String,
        ...
        Try
            ...
            stb.AppendLine("  AND p.Anno = '" & anno & "' ")
            ...
            If avanzamento = 1 Then
                ...
                If isTerzista Then
                    ...
                    stb.AppendLine(" AND t.Piva != " & IIf(pivaChiamante <> "", "'" & pivaChiamante & "'", "(Select piva From UMA_Richieste_Testata Where Richiesta_Cod = " & richiesta_Cod.ToString & ")") & " ")
            ...
            Else
                ...
                If isTerzista Then
                    ...
                    stb.AppendLine(" AND (t.Piva != " & IIf(pivaChiamante <> "", "'" & pivaChiamante & "'", "(Select piva From UMA_Richieste_Testata Where Richiesta_Cod = " & richiesta_Cod.ToString & ")") & " OR ")
                    stb.AppendLine(" NOT ( t.Piva = " & IIf(pivaChiamante <> "", "'" & pivaChiamante & "'", "(Select piva From UMA_Richieste_Testata Where Richiesta_Cod = " & richiesta_Cod.ToString & ")") & " AND t.Richiesta_Integrativa = " & If(integrativa, 1, 0).ToString & " )) ")
                ...
                Else
                    ...
                    Else
                        ...
                        stb.AppendLine(" AND (t.Tipo_Richiesta = -1 OR (t.Piva = '" & piva & "' AND t.Richiesta_Cod != " & richiesta_Cod & ")) ")
    ...
    Public Function Controllo_Lavorazioni_Da_Terzista_Rendicontazioni(ByVal piva As String, ByVal anno As Integer,
        ...
        Try
            ...
            stb.AppendLine(" t.Tipo_Richiesta = -1 and l.Piva = '" & piva & "' AND ")
