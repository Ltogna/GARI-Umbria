...
Public Class UMA_Richieste_Allevamenti_UF_R
    ...
    Public Function LeggiColtureUF(ByVal piva As String,
        ...
        Try
            ...
            If piva <> "" Then
                strSql.AppendLine("And UMA_Richieste_Allevamenti_UF.Piva = '" & piva & "'")
            End If
    ...
    Public Function EstraiMacrousoUmaDaAgea(ByVal Occupazione_Cod As String,
        ...
        Try
            ...
            If Occupazione_Cod <> "" Then
                strSql.AppendLine("AND Occupazione_Cod = '" & Occupazione_Cod & "' ")
            End If
            If Destinazione_Cod <> "" Then
                strSql.AppendLine("AND Destinazione_Cod = '" & Destinazione_Cod & "' ")
            End If
            If Uso_Cod <> "" Then
                strSql.AppendLine("AND Uso_Cod = '" & Uso_Cod & "' ")
            End If
            If Qualita_Cod <> "" Then
                strSql.AppendLine("AND Qualita_Cod = '" & Qualita_Cod & "' ")
            End If
