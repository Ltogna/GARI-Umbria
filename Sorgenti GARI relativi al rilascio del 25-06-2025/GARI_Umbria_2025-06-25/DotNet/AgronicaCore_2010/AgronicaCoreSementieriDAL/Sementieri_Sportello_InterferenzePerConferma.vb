...
Public Class Sementieri_Sportello_InterferenzePerConferma_R
    ...
    Public Function Leggi(ByVal Entita_Cod As Integer,
        ...
        Try
            ...
            stb.AppendLine()
            stb.AppendLine("	, ISNULL(Propietario_Layer.Descrizione, '') AS PropietarioLayer ")
            stb.AppendLine("	, ISNULL(Interferente_Layer.Descrizione, '') AS InterferenteLayer ")
            stb.AppendLine()
            ...
            stb.AppendLine("LEFT JOIN Layers_Configurazione Propietario_Layer		    ON Propietario_Reg_Impianti.Codice_Fiscale_Tecnico = Propietario_Layer.CodiceCollegato ")
            ...
            stb.AppendLine("LEFT JOIN Layers_Configurazione	Interferente_Layer		    On Interferente_Reg_Impianti.Codice_Fiscale_Tecnico = Interferente_Layer.CodiceCollegato ")
    ...
    Public Function LeggiAttiviPerCodiceFiscaleTecnico(id_specie As Integer, Codice_Fiscale_Tecnico As String, DataInizioSportello As Date, DataFineSportello As Date, Accoda_Mail As Boolean, ByRef objParametri_server As AgronicaCoreDataProvider.AgronicaCoreParametri) As DataTable
        ...
        Try
            ...
            Sql.AppendLine("	, layer = COALESCE(layer.Descrizione, '') ")
            ...
            Sql.AppendLine("LEFT JOIN Layers_Configurazione	layer		ON layer.CodiceCollegato = impi.Codice_Fiscale_Tecnico ")
            Sql.AppendLine()
    ...
    Public Function LeggiNonAttiviAttiviPerSportello(id_specie As Integer, DataInizioSportello As Date, DataFineSportello As Date, ByRef objParametri_server As AgronicaCoreDataProvider.AgronicaCoreParametri) As DataTable
