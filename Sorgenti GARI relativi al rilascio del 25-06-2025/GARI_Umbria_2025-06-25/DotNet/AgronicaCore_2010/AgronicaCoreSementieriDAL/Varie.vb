...
#If False Then
            ...
            stb.AppendLine("      Layers_Configurazione.Descrizione AS Referente_RagSoc, ")
            ...
            stb.AppendLine("      Layers_Configurazione.idLayer AS Layer, GIS_Entita.Entita_Cod, GruppoVarietale.Grva_Des  ")
            ...
            stb.AppendLine("    LEFT Join ")
            stb.AppendLine("        Layers_Configurazione ON Reg_Impianti.Codice_Fiscale_Tecnico = Layers_Configurazione.CodiceCollegato ")
            stb.AppendLine("    LEFT Join ")
...
#End If
            ...
            sql.AppendLine("	, Referente_RagSoc = lconf.Descrizione ")
            ...
            sql.AppendLine("	, Layer = lconf.idLayer ")
            ...
            sql.AppendLine("INNER JOIN Layers_Configurazione lconf ON lconf.CodiceCollegato = rimp.Codice_Fiscale_Tecnico ")
    ...
    Public Function Leggi_Filtrone( _
                            ByVal preventivo_1_Effettivo_2 As Integer, _
                            ByVal Lista_Referenti As String, _
                            ByVal Lista_Regioni As String, _
                            ByVal Lista_Provincie As String, _
                            ByVal Lista_Comuni As String, _
                            ByVal Lista_SpecieVegetali As String, _
                            ByVal Lista_Tipologie As String, _
                            ByVal Flag_Inizio_Precedente1_Successivo2 As Integer, _
                            ByVal Data_Inizio As Date, _
                            ByVal Flag_Fine_Precedente1_Successivo2 As Integer, _
        ...
        Try
            ...
            If preventivo_1_Effettivo_2 = 2 Then
                ...
                If Lista_Comuni <> "" Then
                    ...
                    For i = 0 To vComuni.GetLength(0) - 1
                        ...
                        stb.AppendLine(" ((ISTAT.PROV = '" & cProvincia & "') AND (ISTAT.COM = '" & cComune & "'))  ")
            ...
            Else
                ...
                stb.Append("                       Layers_Configurazione.Descrizione AS Referente_RagSoc, ImpreseF.rag_soc AS RagioneSociale, Cultivar.Cul_Cod, Cultivar.Cul_Des, SpecieVegetali.Veg_Cod,  " & vbCrLf)
                ...
                stb.Append("                       Layers_Configurazione.idLayer AS Layer, GIS_Entita.Entita_Cod, GruppoVarietale.Grva_Des " & vbCrLf)
                ...
                stb.Append("                       Layers_Configurazione ON Programmazione_Entita.Codice_Fiscale_Tecnico = Layers_Configurazione.CodiceCollegato LEFT JOIN " & vbCrLf)
