...
Public Class Sementieri_Sportello_LOG_R
    ...
    Public Function Leggi(ByVal Sementieri_Sportello_Configurazione_cod As Integer, ByVal Entita_cod As Integer, ByRef objParametri_server As AgronicaCoreDataProvider.AgronicaCoreParametri) As DataTable
        ...
        Try
            ...
            If nuovaquery Then
                ...
                stb.AppendLine("	, LayerDesc = COALESCE(layer.Descrizione, '') ")
                ...
                stb.AppendLine("LEFT JOIN Layers_Configurazione layer ON layer.CodiceCollegato  = rimp.Codice_Fiscale_Tecnico ")
                stb.AppendLine()
                ...
                'stb.AppendLine("	, ISNULL(LConf.Descrizione, '') as LayerDesc ")
                ...
                'stb.AppendLine("LEFT JOIN Layers_Configurazione LConf       ON Imp.Codice_Fiscale_Tecnico = LConf.CodiceCollegato ")
