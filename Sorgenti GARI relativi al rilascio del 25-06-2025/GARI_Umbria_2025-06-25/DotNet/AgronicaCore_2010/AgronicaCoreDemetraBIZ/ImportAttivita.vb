...
Public Class ImportAttivita
    ...
    Public Shared Function GetListaAttivitaAmmissibili(ByVal tipo As enum_Dati_App) As List(Of Integer)
        ...
        Select Case tipo
            Case enum_Dati_App.AttivitaDemetra
                lstLavCod.AddRange({
                    162, 'Altre Lavorazioni
                    8, 'Aratura
                    18, 'Diserbo
                    14, 'Distribuzione Concime
                    21, 'Erpicatura
                    25, 'Falciatura erbai
                    26, 'Fertirrigazione
                    31, 'Frangizollatura
                    ...
                    75, 'Trinciatura
                    125, 'Rilievo Produzione e Data raccolta'
                    120, 'Asportazione organi infetti                
                    123, 'Concimazione Fogliare
                    172, 'Confusione / Disorientamento Sessuale
                    47, 'Minimum tillage
                    168 'Pirodiserbo
                })
    ...
    Public Sub ImportAttivitaMulti(tipo As enum_Dati_App, cuaa As String, attivitaMulti As List(Of AgronicaCoreDTOStd.InData.Demetra.Attivita), ByRef errorMessage As String, objParametri_Super_Server As AgronicaCoreDataProvider.AgronicaCoreParametri, objParametri_Server As AgronicaCoreDataProvider.AgronicaCoreParametri, objParametri_Utenti As AgronicaCoreDataProvider.AgronicaCoreParametri, user_Agent As String)
        ...
        Try
            ...
            For Each attivitaDemetra In attivitaMulti
                ...
                If Not String.IsNullOrEmpty(attivitaDemetra.codice_esterno) Then
                    errorMessage = String.Format(My.Resources.AgronicaCoreDemetraBIZ.AttivitaNonModificabile, attivitaDemetra.codice, attivitaDemetra.codice_esterno)
                    Exit Sub
                End If
                ...
                If isFirst Then
                    ...
                    unid = objAppHelper.Leggi_GUID_APP(codice, tipo, objParametri_Server)
                    ...
                    Else
                        ...
                        If rif.Length > 0 AndAlso rif(0) <> "" Then
                            ...
                            If Id_Agenda > 0 Then
                                errorMessage = String.Format(My.Resources.AgronicaCoreDemetraBIZ.AttivitaNonModificabile, attivitaDemetra.codice, Id_Agenda)
                                Exit Sub
                            End If
    ...
    Private Function MappaAttivitaDemetraToAttivita(tipo As enum_Dati_App, piva As String, attivitaDemetra As AgronicaCoreDTOStd.InData.Demetra.Attivita, codiceRaccoglitore As Integer, ByRef errorMessage As String, objParametri_Server As AgronicaCoreDataProvider.AgronicaCoreParametri) As AgronicaCoreModelsSTD.attivita.Attivita
        ...
        attivita.inizio = attivitaDemetra.data
