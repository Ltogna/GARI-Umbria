...
Public Class ExtractLog
    ...
    Public Function ExtractLog(ByVal configServizio As AgronicaCoreVarieDAL.Configurazione_Servizio,
        ...
        If urlColdirettiLogger <> "" Then
            ...
            If Tipo_Esportazione.Contains(enum_Esportazioni_Sistema_Cod.Demetra_Export_LavoratoriQDC) Or Tipo_Esportazione.Count = 0 Then
            ...
            Do Until dtIsEmpty 'Estriamo 500 record alla volta, finchè non ci sono più righe
                Try
                    ...
                    If dataTableResult.Rows.Count > 0 Then
                        ...
                        'Se devo inviare log di improt Attività, mi estraggo tutti i cuaa
                        If Tipo_Esportazione.Contains(enum_Esportazioni_Sistema_Cod.Demetra_Import_Attivita) Or Tipo_Esportazione.Count = 0 Then
                        ...
                        For Each row As DataRow In dataTableResult.Rows
                            ...
                            Dim Data_Ora_Invio = row("Data_Ora_Invio")
