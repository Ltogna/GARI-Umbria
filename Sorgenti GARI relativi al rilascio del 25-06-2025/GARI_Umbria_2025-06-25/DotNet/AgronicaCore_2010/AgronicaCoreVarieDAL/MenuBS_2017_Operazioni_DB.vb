...
Public Class MenuBS_2017_Operazioni_DB_R
    ...
    Public Function LeggiUltimeAziendeSelezionate(
        ...
        Try
            ...
            Stb.AppendLine(" SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED;")
            Stb.AppendLine("if exists(select * from " & NomeDB_Utenti & ".dbo.utenti_profili")
            ...
            Stb.AppendLine("SELECT i.rag_soc, u.piva FROM " & NomeDB_Utenti & ".dbo.Utenti_Navigazione_Aziende u")
            Stb.AppendLine("INNER JOIN " & NomeDB_Server & ".dbo.Imprese i")
            Stb.AppendLine("ON u.piva = i.piva ")
            Stb.AppendLine("WHERE u.UserName = '" & objParametri_Utenti.UtenteUsername & "'")
