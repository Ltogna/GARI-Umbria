...
Public Class PUA_Effluenti
    ...
    Public Function Effluenti(ByVal Input As PUA_Effluenti_input,
                              ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri
                              ) As PUA_Effluenti_output
        ...
        Try
            ...
            Dim dt As DataTable = objCore.Leggi(Input.Eff_Cod, Input.Regolamento_Cod,
                                                objParametri)
            ...
            If Not IsNothing(Input.Includi_Efficienza_Rif) AndAlso Input.Includi_Efficienza_Rif = True Then
                ...
                dtEffRif = objEffRif.Leggi(-1, 0, Input.Regolamento_Cod,
                                                    objParametri)
            End If
