...
#End Region
    ...
    Public Function MostraInterferenzeGlobali(ByVal utente As String,
        ...
        Dim dt As DataTable = objR.Leggi(0, Not isSuperUser, CodiceFiscaleTecnico, SoloProprietario, id_specie, AccodaMail, objParametri_Server)
    ...
    Public Function MostraInterferenzeGlobali_New(id_specie As Integer, codice_fiscale_tecnico As String, AccodaMail As Boolean, DataInizioSportello As Date, DataFineSportello As Date, objParametri_Server As AgronicaCoreParametri) As String

        Dim objR As New AgronicaCoreSementieriDAL.Sementieri_Sportello_InterferenzePerConferma_R

        Dim dt As DataTable = objR.LeggiAttiviPerCodiceFiscaleTecnico(id_specie, codice_fiscale_tecnico, DataInizioSportello, DataFineSportello, AccodaMail, objParametri_Server)
        ...
        If isSuperuser Then
            ...
            dt_na = objR.LeggiNonAttiviAttiviPerSportello(id_specie, DataInizioSportello, DataFineSportello, objParametri_Server)
        End If
