        ...
        Try
            ...
            If (Cod_Conto = 0 OrElse Cod_Conto = Cod_Conto_Pat_DepositiBancariPostali) AndAlso Lista_CodRisum = "" Then
                ...
                If Flag_AggiungiContoPadre_CreditiDebitiBanche Then
                    ...
                    Stb_Globale.AppendLine(" ( ")
                    Stb_Globale.AppendLine(" SELECT 'SP_' + '" & Id_Riclassificazione_DepositiBancariPostali & "' AS CodiceSplitGruppo, ")
                    ...
                    Stb_Globale.AppendLine(" '" & Conto_Pat_Descr_DepositiBancariPostali & "' AS Conto_Pat_Descr, 1 AS Flag_UE,   ")
                    Stb_Globale.AppendLine(Stb_SelectSaldiIniz2a.ToString)
                    Stb_Globale.AppendLine(" '" & Id_Riclassificazione_DepositiBancariPostali & "' AS Id_Riclassificazione, 'D' AS Dare_Avere,  ") '--RicXConti_Pat.Imputabile,
                ...
                Stb_Globale.AppendLine(" SELECT 'SP_' + '" & Id_Riclassificazione_DepositiBancariPostali & "' + '_B' + CONVERT(varchar(500), Liquidita.Cod_Liquidita) AS CodiceSplitGruppo, ")
                ...
                Stb_Globale.AppendLine(" '" & Conto_Pat_Descr_DepositiBancariPostali & "' + ' - ' + Istituto_Des + ' ' +  Nazione + Cifre_Controllo +  Cin +  Abi + Cab + Numero AS Conto_Pat_Descr, 2 AS Flag_UE,  ")
                Stb_Globale.AppendLine(Stb_SelectSaldiIniz2a.ToString)
                Stb_Globale.AppendLine(" '" & Id_Riclassificazione_DepositiBancariPostali & "' AS Id_Riclassificazione, 'D' AS Dare_Avere,  ") '--RicXConti_Pat.Imputabile,
                Stb_Globale.AppendLine(Stb_SelectSaldiIniz2b.ToString)
            ...
            If Cod_Conto = 0 OrElse Cod_Conto = Cod_Conto_Pat_CreditiVersoClienti OrElse Lista_CodRisum <> "" Then
                ...
                If Flag_AggiungiContoPadre_CreditiDebitiBanche Then
                    ...
                    Stb_Globale.AppendLine(" ( ")
                    Stb_Globale.AppendLine(" SELECT 'SP_' + '" & Id_Riclassificazione_CreditiVersoClienti & "'  AS CodiceSplitGruppo, ")
                    Stb_Globale.AppendLine(Stb_SelectSaldiIniz1.ToString)
                    '§§§ gestione codifica piano dei conti
                    Stb_Globale.AppendLine(" " & CStr(Cod_Conto_Pat_CreditiVersoClienti) & " AS Cod_Conto_Pat, '" & Agro_SQL_SaveText(CStr(Piva)) & "' AS piva_conti,  ")
                    Stb_Globale.AppendLine(" '" & Conto_Pat_Descr_CreditiVersoClienti & "' AS Conto_Pat_Descr, 1 AS Flag_UE,  ")
                    Stb_Globale.AppendLine(Stb_SelectSaldiIniz2a.ToString)
                    Stb_Globale.AppendLine(" '" & Id_Riclassificazione_CreditiVersoClienti & "' AS Id_Riclassificazione, 'D' AS Dare_Avere,  ")
                    Stb_Globale.AppendLine(Stb_SelectSaldiIniz2b.ToString)
                    Stb_Globale.AppendLine(" 0 AS Dare, 0 AS Avere, ")
                    Stb_Globale.AppendLine(Stb_SelectSaldiIniz3.ToString)
                    Stb_Globale.AppendLine(" ) ")
                ...
                Stb_Globale.AppendLine(" SELECT 'SP_' + '" & Id_Riclassificazione_CreditiVersoClienti & "' + '_C' + CONVERT(varchar(500), Risorse_Umane.Cod_RisUm) AS CodiceSplitGruppo, ")
                ...
                Stb_Globale.AppendLine(" '" & Conto_Pat_Descr_CreditiVersoClienti & "' + ' - ' + Contatti.Rag_Soc + Contatti.Cognome + ' ' + Contatti.Nome AS Conto_Pat_Descr, 2 AS Flag_UE,   ")
                Stb_Globale.AppendLine(Stb_SelectSaldiIniz2a.ToString)
                Stb_Globale.AppendLine(" '" & Id_Riclassificazione_CreditiVersoClienti & "' AS Id_Riclassificazione, 'D' AS Dare_Avere,  ") '--RicXConti_Pat.Imputabile,
                Stb_Globale.AppendLine(Stb_SelectSaldiIniz2b.ToString)
                Stb_Globale.AppendLine(Stb_SaldiIniziRisUmCred.ToString)
                Stb_Globale.AppendLine(Stb_SelectSaldiIniz3.ToString)
            ...
            If Cod_Conto = 0 OrElse Cod_Conto = Cod_Conto_Pat_DebitiVersoFornitori OrElse Lista_CodRisum <> "" Then
                ...
                If Flag_AggiungiContoPadre_CreditiDebitiBanche Then
                    ...
                    Stb_Globale.AppendLine(" ( ")
                    Stb_Globale.AppendLine(" SELECT 'SP_' + '" & Id_Riclassificazione_DebitiVersoFornitori & "' AS CodiceSplitGruppo, ")
                    Stb_Globale.AppendLine(Stb_SelectSaldiIniz1.ToString)
                    '§§§ gestione codifica piano dei conti
                    ...
                    Stb_Globale.AppendLine(" '" & Conto_Pat_Descr_DebitiVersoFornitori & "'  AS Conto_Pat_Descr, 1 AS Flag_UE,  ")
                    Stb_Globale.AppendLine(Stb_SelectSaldiIniz2a.ToString)
                    Stb_Globale.AppendLine(" '" & Id_Riclassificazione_DebitiVersoFornitori & "' AS Id_Riclassificazione, 'A' AS Dare_Avere,  ")
                    Stb_Globale.AppendLine(Stb_SelectSaldiIniz2b.ToString)
                    Stb_Globale.AppendLine(" 0 AS Dare, 0 AS Avere, ")
                    Stb_Globale.AppendLine(Stb_SelectSaldiIniz3.ToString)
                    Stb_Globale.AppendLine(" ) ")
                ...
                Stb_Globale.AppendLine(" ( ")
                'Stb_Globale.AppendLine(" SELECT 'SP_' + Id_Riclassificazione + '_C' + CONVERT(varchar(500), Risorse_Umane.Cod_RisUm) AS CodiceSplitGruppo, ")
                Stb_Globale.AppendLine(" SELECT 'SP_' + '" & Id_Riclassificazione_DebitiVersoFornitori & "' + '_C' + CONVERT(varchar(500), Risorse_Umane.Cod_RisUm) AS CodiceSplitGruppo, ")
                ...
                'Stb_Globale.AppendLine(Stb_SelectPartDoppiaRifContatto.ToString)
                Stb_Globale.AppendLine(" '" & Conto_Pat_Descr_DebitiVersoFornitori & "' + ' - ' + Contatti.Rag_Soc + Contatti.Cognome + ' ' + Contatti.Nome AS Conto_Pat_Descr, 2 AS Flag_UE,   ")
                Stb_Globale.AppendLine(Stb_SelectSaldiIniz2a.ToString)
                Stb_Globale.AppendLine(" '" & Id_Riclassificazione_DebitiVersoFornitori & "' AS Id_Riclassificazione, 'A' AS Dare_Avere,  ") '--RicXConti_Pat.Imputabile,
                Stb_Globale.AppendLine(Stb_SelectSaldiIniz2b.ToString)
                Stb_Globale.AppendLine(Stb_SaldiIniziRisUmDeb.ToString)
                Stb_Globale.AppendLine(Stb_SelectSaldiIniz3.ToString)
            ...
            If (Cod_Conto = 0 OrElse Cod_Conto = Cod_Conto_Pat_DenaroValoriInCassa) AndAlso Lista_CodRisum = "" Then
                ...
                If Flag_AggiungiContoPadre_CreditiDebitiBanche Then
                    ...
                    Stb_Globale.AppendLine(" ( ")
                    Stb_Globale.AppendLine(" SELECT 'SP_' + '" & Id_Riclassificazione_DenaroValoriInCassa & "' AS CodiceSplitGruppo, ")
                    Stb_Globale.AppendLine(Stb_SelectSaldiIniz1.ToString)
                    Stb_Globale.AppendLine(" " & CStr(Cod_Conto_Pat_DenaroValoriInCassa) & " AS Cod_Conto_Pat, '" & Agro_SQL_SaveText(CStr(Piva)) & "' AS piva_conti,  ")
                    Stb_Globale.AppendLine(" '" & Conto_Pat_Descr_DenaroValoriInCassa & "' AS Conto_Pat_Descr, 1 AS Flag_UE,   ")
                    Stb_Globale.AppendLine(Stb_SelectSaldiIniz2a.ToString)
                    Stb_Globale.AppendLine(" '" & Id_Riclassificazione_DenaroValoriInCassa & "' AS Id_Riclassificazione, 'D' AS Dare_Avere,  ") '--RicXConti_Pat.Imputabile,
                    Stb_Globale.AppendLine(Stb_SelectSaldiIniz2b.ToString)
                    Stb_Globale.AppendLine(" 0 AS Dare, 0 AS Avere, ")
                    Stb_Globale.AppendLine(Stb_SelectSaldiIniz3.ToString)
                    Stb_Globale.AppendLine(" ) ")
                ...
                Stb_Globale.AppendLine(" ( ")
                Stb_Globale.AppendLine(" SELECT 'SP_' + '" & Id_Riclassificazione_DenaroValoriInCassa & "' + '_B' + CONVERT(varchar(500), Liquidita.Cod_Liquidita) AS CodiceSplitGruppo, ")
                ...
                'Stb_Globale.AppendLine(Stb_SelectPartDoppiaRifBanche.ToString)
                Stb_Globale.AppendLine(" '" & Conto_Pat_Descr_DenaroValoriInCassa & "' + ' - ' + Istituto_Des + ' ' +  Nazione + Cifre_Controllo +  Cin +  Abi + Cab + Numero AS Conto_Pat_Descr, 1 AS Flag_UE,   ")
                Stb_Globale.AppendLine(Stb_SelectSaldiIniz2a.ToString)
                Stb_Globale.AppendLine(" '" & Id_Riclassificazione_DenaroValoriInCassa & "' AS Id_Riclassificazione, 'D' AS Dare_Avere,  ") '--RicXConti_Pat.Imputabile,
                Stb_Globale.AppendLine(Stb_SelectSaldiIniz2b.ToString)
                Stb_Globale.AppendLine(Stb_SaldiInizialiLIQ.ToString)
    ...
    Public Function PianoContiEconomici_Confronto_LeggiDS(ByRef DataSet2Fill As DataSet,
        ...
        Try
            ...
            If FiltroAggiuntivo1 <> "" Then
                stbQ.AppendLine(FiltroAggiuntivo1)
            End If
            ...
            If FiltroAggiuntivo2 <> "" Then
                stbQ.AppendLine(FiltroAggiuntivo2)
            End If
            ...
            If FiltroAggiuntivo3 <> "" Then
                stbQ.AppendLine(FiltroAggiuntivo3)
            End If
