    ...
    Public Function Report_Carichi_Scarichi(ByVal piva As String,
        ...
        Try
            ...
            If dataMovAl <> AGRODATAFINE Then
                StrSQL.AppendLine(" AND Data_Movimento <= " & Agro_SQL_SaveDate(dataMovAl) & "")
            End If
            ...
            StrSQL.AppendLine(" On c.Id_agenda = ip.id_agenda And c.piva = ip.piva And c.sa_cod = ip.sa_cod And c.Appezza = ip.appezza And c.Id_Reg = ip.id_reg AND c.Progetto_Cod = ip.cod_progetto ")
            StrSQL.AppendLine(" ) , ")
