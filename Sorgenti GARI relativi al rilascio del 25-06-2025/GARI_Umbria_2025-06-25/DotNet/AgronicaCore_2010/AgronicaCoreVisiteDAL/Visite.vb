...
Public Class Visite_R
    ...
    Public Function LeggiDettagliVisite(
        ...
        Try
            ...
            If isSuperUser = False Then
                StrSQL.AppendLine(" INNER JOIN ContattiXUtentiGias cug ON cug.piva = c.piva AND cug.cod_contatto = c.Cod_contatto AND (cug.username = " & Agro_SQL_SaveText_NULL(objParametri_Server.UtenteUsername) & " OR cug.username IN( '" & String.Join("','", usernames) & "')) ")
            End If
    ...
    Public Function LeggiDettagliVisiteNew(
        ...
        Try
            ...
            StrSQL.AppendLine(" CASE a.Stato_Cod WHEN 401 THEN 'Eseguita' ELSE 'Da eseguire' END AS 'Stato_Visita', a.DaRemoto, ")
            ...
            If isSuperUser = False Or usernameFilter <> "" Then
                ...
                Else
                    ...
                    If usernames IsNot Nothing AndAlso usernames.Count > 0 Then
                        StrSQL.AppendLine(" Or cug.username In( '" & String.Join("','", usernames) & "') ")
                    End If
                End If
                StrSQL.AppendLine(" ) ")
            End If
            ...
            StrSQL.AppendLine(" CASE a.Stato_Cod WHEN 401 THEN 'Eseguita' ELSE 'Da eseguire' END, ")
    ...
    Public Function LeggiDettagliVisiteNew_DettaglioRilievo(
        ...
        Try
            ...
            StrSQL.AppendLine(" ISNULL(Rilievi_con_visite_cte.APP_NOME, '') AS APP_NOME, ")
