        ...
        Try
            Select Case xSelezioneVariabile
                Case enumSelezioneVariabile.Selezione_TabellaCompleta
                    ...
                    StrSQL.Append(" WHERE Alert_Indice.PivaSuperUser = '" & pivaSuperUser & "' ")
    ...
    Public Function LeggiTipologieBloccate(ByVal piva As String,
        ...
        Try
            ...
            If pivaSuperUser <> "" Then
                StrSQL.Append(" And Alert_EntitaxIndici.PivaSuperUser = '" & pivaSuperUser & "' ")
            End If
        ...
        Try
            ...
            Select Case TipoCampo
                ...
                Case 1 'Valori
                    ...
                    StrSQL.Append(" And Alert_Indice_Dettagli.PivaSuperUser = '" & pivaSuperUser & "' ")
                    'Controllo validità
                ...
                Case 2 'Elenco
                    ...
                    Select Case Elenco_Tipo
                        ...
                        Case 2 'Contatti Gias
                            ...
                            StrSQL.Append(" Where (Contatti.Piva = '" & Piva & "' Or Sa_Cod = -1) ")
                        ...
                        Case 3 'Rapporti Contabili

                            StrSQL.Append(" SELECT Distinct Contatti.Cod_Contatto as Valore_Cod, (Contatti.Cognome + ' ' + Contatti.Nome + Contatti.Rag_Soc ) as Valore_Des ")
                            StrSQL.Append(" FROM  Contatti, Risorse_Umane ")
                            StrSQL.Append(" Where (Contatti.Piva = '" & Piva & "' Or Contatti.Sa_Cod = -1) ")
                        ...
                        Case 5 'Macchine
                            ...
                            StrSQL.Append(" SELECT Distinct Parco_Macchine.Mac_Cod as Valore_Cod, Parco_Macchine.Mac_Des as Valore_Des ")
                            StrSQL.Append(" FROM  Parco_Macchine ")
                            StrSQL.Append(" Where (Parco_Macchine.Piva = '" & Piva & "' Or Parco_Macchine.Sa_Cod = -1) ")
...
Public Class Alert_Indice_W
    ...
    Public Function Modifica(ByVal piva As String,
        ...
        Try
            ...
            If pivaSuperUser <> "" Then
                StrSQL.AppendLine(" AND PivaSuperUser = '" & pivaSuperUser & "'")
            End If
