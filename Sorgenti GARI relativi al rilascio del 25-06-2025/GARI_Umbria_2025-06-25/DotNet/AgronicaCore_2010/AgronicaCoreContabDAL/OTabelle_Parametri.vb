    ...
    Public Function LeggiValoriParametriQualitativi(
        ...
        Using GiasContext As New Gias_DeveloperServer_Entities(EFConnString)
           ...
           Where
                ...
                (Not TabellaID_Imballaggi.Contains(Tabella_ID) OrElse ((Not tabelleParametri.Mat_Cod_Generazione_Link Is Nothing AndAlso tabelleParametri.Mat_Cod_Generazione_Link <> 0) OrElse (Not _ogen_anag_log_group Is Nothing AndAlso _ogen_anag_log_group.Mat_Cod <> 0)))
           Order By
           ...
           Select New With {
               ...
               .mat_cod = If(tabelleParametri.Mat_Cod_Generazione_Link Is Nothing OrElse tabelleParametri.Mat_Cod_Generazione_Link = 0, If(_ogen_anag_log_group.Mat_Cod = 0, 0, _ogen_anag_log_group.Mat_Cod), tabelleParametri.Mat_Cod_Generazione_Link),
...
#End Region
    ...
    Private Function VerificaRigaParametroCancellazioneValida(parametro As OTabelle_Parametri, ByRef objParametri As AgronicaCoreParametri) As String
        ...
        If parametro.Mat_Cod_Generazione_Link.HasValue AndAlso parametro.Mat_Cod_Generazione_Link.Value > 0 Then
        ...
        Select Case tipoCod
            Case 3 'tipo dato numerico => verifica valòri min/max
                ...
                ElseIf Not String.IsNullOrEmpty(valoreMinimo) AndAlso Not String.IsNullOrEmpty(valoreMaximo) Then
                    ...
                    If result AndAlso (valoreMinimo > valoreMaximo) Then
                        If Not String.IsNullOrEmpty(messaggio) Then
                            messaggio += "<br />"
                        End If
