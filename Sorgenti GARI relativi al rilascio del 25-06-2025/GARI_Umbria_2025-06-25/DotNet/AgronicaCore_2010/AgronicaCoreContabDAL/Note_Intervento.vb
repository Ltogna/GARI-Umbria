        ...
        Try
            ...
            Select Case xSelezioneVariabile
                ...
                Case enumSelezioneVariabile.Selezione_TabellaDatiMinimi
                    ...
                    StrSQL.AppendLine(" INNER Join  Note_Intervento_Gruppi ON Note_Intervento.PivaSuperUser = Note_Intervento_Gruppi.PivaSuperUser AND ")
                    StrSQL.AppendLine("     Note_Intervento.NotaGruppo_Cod = Note_Intervento_Gruppi.NotaGruppo_Cod INNER JOIN ")
                    StrSQL.AppendLine("     Note_Intervento_UtilizzoxGruppi ON Note_Intervento_Gruppi.PivaSuperUser = Note_Intervento_UtilizzoxGruppi.PivaSuperUser AND ")
                    StrSQL.AppendLine("     Note_Intervento_Gruppi.NotaGruppo_Cod = Note_Intervento_UtilizzoxGruppi.NotaGruppo_Cod ")
