...
Public Class Parco_Macchine_R
    ...
    Public Function Leggi_Parco_Macchine(ByVal macCod As Integer,
        ...
        '----- Descrizione
        Dim nomeRoutine As String = "Parco_Macchine_R.Leggi()"
    ...
    Public Function Leggi_Caratteristica(ByVal Mac_Car_Cod As Integer, ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri) As String
    ...
    Public Function Leggi(ByVal Piva As String,
        ...
        Try
            ...
            strSql.AppendLine("    INNER JOIN Imprese ON Imprese.Piva = Parco_Macchine.Piva")
            strSql.AppendLine("")
            strSql.AppendLine("    LEFT JOIN Ditte D ON D.Ditta_cod = Parco_Macchine.Ditta_Cod")
            strSql.AppendLine("")
            strSql.AppendLine("    LEFT JOIN Codifica_Macchine_Agea agea ON Parco_Macchine.Agea_Cod = agea.AGEA_Cod")

            strSql.AppendLine("")
            strSql.AppendLine("    LEFT JOIN Parco_Macchine_Codici pcm ON Parco_Macchine.Mac_Cod = pcm.Mac_cod")
    ...
    Public Function LeggiMacchine_xCostiAccessori(ByVal Piva As String,
        ...
        Try
            ...
            If visualizzaMacchineImportate = False Then
                strSql.AppendLine(" AND    PM.Mac_Cod_Origine = 0 ")
            End If
            strSql.AppendLine(" AND    UtentiXImprese.[USER] = '" & Agro_SQL_SaveText(objParametri.PivaSuperUser) & "' ")
            ...
            Select Case xSelezioneVariabile
                ...
                Case enumSelezioneVariabile.Selezione_JoinDescrizioni
                    ...
                    If Flag_AncheImportatati <> True Then
                        strSql.AppendLine(" AND  Parco_Macchine.Mac_Cod_Origine = " & Agro_SQL_SaveNum(0) & " ")
...
#Region "Movimenti Macchina"
    ...
    Public Function LeggiMovimentiMacchina(ByVal Piva As String,
        ...
        Try
            ...
            strSql.AppendLine(String.Format("WHERE Movimenti.CAU_MOV = {0}", Agro_SQL_SaveNum(CostantiPersonalizzate.CAU_IMPUTAZIONE_PARCOMACCHINE)))
            strSql.AppendLine(String.Format("    AND Movimenti_Dettagli.Elem_Cod = {0}", Agro_SQL_SaveNum(CostantiPersonalizzate.MACCHINE)))
            strSql.AppendLine(String.Format("    AND Movimenti_dettagli.Mat_Cod = {0}", Agro_SQL_SaveNum(Mac_Cod)))
    ...
    Public Function RecipesCentres(ByVal Mac_Cod As Integer,
        ...
        Try
            ...
            strSql.AppendLine(String.Format("        AND rdet.CAU_MOV = {0}", Agro_SQL_SaveNum(CostantiPersonalizzate.CAU_IMPUTAZIONE_PARCOMACCHINE)))
            strSql.AppendLine(String.Format("        AND rdet.Elem_Cod = {0}", Agro_SQL_SaveNum(CostantiPersonalizzate.MACCHINE)))
            strSql.AppendLine(String.Format("        AND rdet.Mat_Cod = {0}", Agro_SQL_SaveNum(Mac_Cod)))
            strSql.AppendLine("    )")
