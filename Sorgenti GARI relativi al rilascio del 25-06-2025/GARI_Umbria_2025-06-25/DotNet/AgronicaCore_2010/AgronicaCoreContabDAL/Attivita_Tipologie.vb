...
Public Class Attivita_Tipologie_R
    ...
    Public Function Leggi(ByVal Piva As String,
        ...
        Try
            ...
            StrSQL.Length = 0
            StrSQL.Append(" SELECT i.rag_soc, agt.*, CASE WHEN agt.Sa_Cod = 0 THEN 'No' ELSE 'Sì' END AS Sa_Cod_Desc, CASE WHEN agt.ID_Tipologia_Attivita = 1 THEN 'Prima'  ")
            StrSQL.Append(" WHEN agt.ID_Tipologia_Attivita = 2 THEN 'Seconda' ELSE 'Terza' END As ID_Tipologia_Desc ")
