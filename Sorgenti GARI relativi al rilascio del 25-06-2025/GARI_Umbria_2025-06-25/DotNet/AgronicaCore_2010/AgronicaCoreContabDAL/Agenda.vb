...
Public Class Agenda_R
        ...
        Try
            ...
            Select Case xSelezioneVariabile
                ...
                Case enumSelezioneVariabile.Selezione_TabellaDatiMinimi
                    ...
                    strSql.Length = 0
                    strSql.AppendLine(" Select * From Agenda ")
                    ...
                    Else
                        ...
                        Select Case TipoG2G
                            Case 1 'seleziona i nuovi dati.
                                ...
                                strSql.AppendLine(" select 1 from g2g_recode_agenda rr where rr.FromPiva = Agenda.piva and rr.FromSa_cod = Agenda.Sa_cod and  rr.FromId_Agenda = Agenda.id_agenda ")
                                strSql.AppendLine(" ) ")
    ...
    Public Function Leggi_con_Movimenti_xStatistiche(ByVal FiltroData_Operazione1_Registrazione2 As Integer,
        ...
        Try
            ...
            If Username <> "" Then
                strSql.Append(" AND   Agenda.Username_Creazione='" & Username & "'")
            End If
    ...
    Public Function Leggi_NumOperazioni_xStatistiche_DistinctPiva(ByVal FiltroData_Operazione1_Registrazione2 As Integer,
        ...
        Try
            ...
            If Username <> "" Then
                strSql.Append("     AND   PUA_Testata.Username_Creazione='" & Username & "'")
            End If
            ...
            If Username <> "" Then
                strSql.Append("     AND   PianoConcimazione_Dettagli.Username_Creazione='" & Username & "'")
            End If
    ...
    Public Function Leggi_NumOperazioni_xStatistiche_DistinctPiva_New(ByVal FiltroData_Operazione1_Registrazione2 As Integer,
        ...
        Try
            ...
            strSql.AppendLine(" select imp.piva, imp.Num_Operazioni_Campagna, imp.Num_Operazioni_Magazzino, imp.Num_PUA, imp.Num_PianiConcimazione, ")
            If Dettagli_QDC Then
    ...
    Public Function Leggi_NumOperazioni_xStatistiche_DistinctPivaVegCod(ByVal FiltroData_Operazione1_Registrazione2 As Integer,
        ...
        Try
            ...
            If Username <> "" Then
                strSql.Append("     AND   Movimenti.Username_Creazione='" & Username & "'")
            End If
    ...
    Public Function Leggi_xStatistiche_OperazioniCampagna_Utenti(ByVal FiltroData_Operazione1_Registrazione2 As Integer,
        ...
        Try
            ...
            If Username <> "" Then
                strSql.Append("     AND   m.Username_Creazione='" & Username & "'")
            End If
