        ...
        Try
            ...
            Select Case xSelezioneVariabile
                ...
                Case enumSelezioneVariabile.Selezione_JoinDescrizioni
                    ...
                    strSql.AppendLine(" FROM  Movimenti_Dettagli ")
                    strSql.AppendLine(" INNER JOIN Imprese ON Movimenti_Dettagli.Piva = Imprese.Piva ")
                    strSql.AppendLine(" INNER JOIN Agenda ON Movimenti_Dettagli.Piva = Agenda.Piva AND Movimenti_Dettagli.Id_Agenda = Agenda.Id_Agenda ")
                    strSql.AppendLine(" INNER JOIN Movimenti ON Movimenti_Dettagli.Piva = Movimenti.Piva AND Movimenti_Dettagli.Id_Agenda = Movimenti.Id_Agenda  ")
                ...
                Case enumSelezioneVariabile.Selezione_JoinCompleta
                    ...
                    strSql.AppendLine(" FROM  Agenda , Movimenti , Movimenti_Dettagli , Imprese ")
