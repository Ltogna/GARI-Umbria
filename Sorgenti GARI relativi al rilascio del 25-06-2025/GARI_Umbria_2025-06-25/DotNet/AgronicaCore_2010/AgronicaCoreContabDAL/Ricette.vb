...
Public Class Ricette_R
    ...
    Public Function LeggiRicetteDettagliAPP(ByVal piva As String, ByVal elem_cod As Integer, ByVal pro_cod As Integer, ByVal descrizione As String, ByVal codifica As Boolean, objParametri_Server As AgronicaCoreDataProvider.AgronicaCoreParametri) As List(Of AgronicaCoreEntityFramework_POCO.APP_Ricette_Dettagli)
        ...
        Using giasContext As New Gias_DeveloperServer_Entities(efConnString)
            ...
            rval = (From rd In giasContext.APP_Ricette_Dettagli
                    ...
                    Where (piva = "" OrElse r.Piva = piva) AndAlso (elem_cod = 0 OrElse rd.Elem_Cod = elem_cod) AndAlso (pro_cod = 0 OrElse rd.Pro_Cod = pro_cod) AndAlso (descrizione = "" OrElse rd.Descrizione.Contains(descrizione)) AndAlso If(codifica, rd.Codice_Extra = "" AndAlso rd.Descrizione <> "", True)
                    Select rd).ToList()
    ...
    Public Function LeggiXDestinazione(
        ...
        Dim NomeRoutine As String = "AgronicaCoreContabDAL.Ricette_Read.Leggi()"
    ...
    '##############################################################################################
    Public Function LeggiFertilizzazioniPUA(
    ...
    Public Function Leggi_xGriglia(
        ...
        Try
            ...
            StrSQL.AppendLine(" SELECT R.Ricetta_Cod, R.Piva, IMP.rag_soc, R.Ricetta_Des, R.Ricetta_Des_Long, R.Data_Creazione, R.Ricetta_Numero, R.Note, R.Validita_Inizio, R.Validita_Fine, SP.Veg_Des")
    ...
    Public Function Leggi_xMenuAgenda(
        ...
        Try
            ...
            StrSQL.AppendLine(" SELECT ")
            StrSQL.AppendLine("     r.piva, r.Sa_Cod, ISNULL(ca.sa_nome,'') AS sa_nome, r.Ricetta_Cod, r.Ricetta_Numero, r.Ricetta_Des, r.Tipo_Ricetta, ISNULL(r.veg_cod, 0) As veg_cod_r, ")
...
Public Class Ricette_W
    ...
    Public Function Update_Origine(
                           ByVal Ricetta_Cod As Int32,
