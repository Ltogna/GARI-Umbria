...
Public Class Giacenze_R
    ...
    Public Function Leggi_ValoreMedioPonderato(ByVal PIVA As String,
        ...
        Try
            ...
            strSql.AppendLine("         Where Piva = '" & PIVA & "' And Lav_Cod In (1000, 1001) )")
            ...
            strSql.AppendLine(" AND Movimenti.Data_Movimento >= '" & Dal_Data_Verifica & "' ")
            strSql.AppendLine(" AND Movimenti.Data_Movimento <= '" & Al_Data_Verifica & "' ")
