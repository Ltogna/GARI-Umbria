...
Public Class CDG_DAL_R
    ...
    Public Function Trova_Impianti(ByVal piva As String,
        ...
        Try
            ...
            If split = -1 Then
                strSql.AppendLine(" And Not exists (Select * From Agenda, movimenti, mov_destinazioni ")
    ...
    Public Function Trova_Distinte_Per_Impianto(ByVal piva As String,
        ...
        Try
            ...
            If id_agenda_cdg = 0 AndAlso valoreSpalmabile <> 0 Then
                ...
                strSql.Append(" Where " & TabellaPrefisso & "Reg_Impianti.Piva = '" & kPiva & "'")
    ...
    Public Function Leggi_Impianti(ByVal piva As String,
        ...
        Try
            ...
            strSql.Append(" And Not Exists (Select * From Reg_Impianti_Codici AS Reg_Impianti_Distinta ")
        ...
        Try
            ...
            Select Case iavanti
                ...
                Case 2 'Prossimo
                    ...
                    strSql.Append(" And Not Exists (Select * From Mov_Dettagli_Riferimenti Where Piva = Movimenti_Dettagli.Piva ")
    ...
    Public Function VerificaCorrettezzaAgendaRaccoglitore(ByVal piva As String,
        ...
        Try
            ...
            VerificaCorrettezzaAgendaRaccoglitore = -1 'Inizializzazione
            ...
            If dt.Rows.Count > 0 Then
                ...
                If dt.Rows(0).Item("Lav_Cod") >= 3000 And dt.Rows(0).Item("Lav_Cod") < 4000 Then
                    ...
                    'Operazione Zoo
                    VerificaCorrettezzaAgendaRaccoglitore = 0
                ...
                Else
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        VerificaCorrettezzaAgendaRaccoglitore = IIf(IsNumeric(dt.Rows(0).Item("Raccoglitore_Cod")), dt.Rows(0).Item("Raccoglitore_Cod"), 0)
        ...
        Catch ex As Exception
            messaggioErrore = ex.Message
            Scrivi_LOG(objParametri, nomeRoutine, messaggioErrore)
            VerificaCorrettezzaAgendaRaccoglitore = False
            Throw New Exception("" & nomeRoutine & " : " & messaggioErrore)
        End Try


        Return VerificaCorrettezzaAgendaRaccoglitore
    ...
    Public Function Ricerca_Scarico_Tempi(ByVal piva As String,
        ...
        ''Filtro le distinte chiuse
        'strSql.AppendLine(" AND Not Exists (SELECT * FROM Reg_Impianti_Codici AS Reg_Impianti_Distinta ")
            ...
            Dim TestataElem =
               ...
               Join Stalla In GiasContext.Stalla
                 On Stalla.PIVA Equals CI.PIVA And
                    Stalla.STA_NUM Equals CI.STA_NUM
               Where
              (CI.PIVA.Equals(piva)) AndAlso
              ...
              .Raggruppamento_Des = CI.Raggruppamento_Des & " (" & Stalla.STA_DES & ")"
              }
    ...
    Public Function Ipno_Lettura_Agenda_Senza_CDG(ByVal PIVA As String,
        ...
        Try
            ...
            strSql.Append(" Select distinct Agenda.Id_Agenda, Agenda.Lav_Cod, Agenda.Des_Lib, Movimenti.Data_Movimento, IsNull(Attivita.Id_Attivita, 0) as xId_Attivita, IsNull(Attivita.[Desc], '') as xAttivita_Des, Raccoglitore_Cod, Rag_Soc ")
            strSql.Append("From Imprese, Movimenti, Agenda ")

            strSql.Append(" Left Outer Join Attivita On Attivita.Id_Attivita = Agenda.Id_Attivita ")
            strSql.Append(" Where Movimenti.Data_Movimento <= " & Agro_SQL_SaveDate(FinestraTemp_Fine) & " ")
            strSql.Append(" And Movimenti.Data_Movimento >= " & Agro_SQL_SaveDate(FinestraTemp_Inizio) & " ")
            strSql.Append(" And Agenda.Piva = '" & Agro_SQL_SaveText(PIVA) & "' ")
            strSql.Append(" AND Agenda.piva = Movimenti.piva ")
            strSql.Append(" AND Agenda.id_agenda = Movimenti.id_agenda ")
            strSql.Append(" AND Agenda.Piva = Imprese.Piva ")
            ...
            If Not bForzato Then
                ...
                strSql.Append(" And (Cau_Mov In ('7350', '6852', '3700', '3750')  And (Not Exists (Select * From Mov_Dettagli_Riferimenti Where Piva = Agenda.Piva And Id_Agenda = Agenda.Id_Agenda And Lav_Cod_Rif = 4500 )) ")


                '2 Condizione Alternativa:
                'Operazioni che hanno una vecchia imputazione in cdg
                strSql.Append(" Or Exists(Select * From Mov_Dettagli_Riferimenti Where Piva = Agenda.Piva And Id_Agenda = Agenda.Id_Agenda And Lav_Cod_Rif = 4500 ")
                strSql.Append(" And Agenda.Data_Modifica > Mov_Dettagli_Riferimenti.Data_Creazione and Abs(datediff(second, Agenda.Data_Modifica, Mov_Dettagli_Riferimenti.Data_Creazione  )) > 1 )) ")


            End If


            strSql.Append(" And  Agenda.Id_Agenda Not In (Select Id_Agenda From Cdg_Testata Where Vecchio_Tipo_Inser_Dati != 0 And Budget = 0)  ")

            'Altre operazioni del raccoglitore da byapssare
            strSql.Append(" And isnull(Agenda.Stato_Export_2, 0) <> -1 ")
            ...
            strSql.Append(" ORDER BY  Agenda.Id_Agenda Asc, Movimenti.Data_Movimento ASC ")
    ...
    Public Function Leggi_Zoo_Dettagli(ByVal piva As String,
        ...
        Dim myList = Nothing
        Select Case Lav_Cod
            Case LAVCOD_NASCITA_ANIMALI, LAVCOD_INCREMENTO_CONSISTENZE_ZOO, LAVCOD_DECREMENTO_CONSISTENZE_ZOO, LAVCOD_ACQUISTO_ANIMALI, LAVCOD_VENDITA_ANIMALI, LAVCOD_TRASFERIMENTO_ANIMALI, LAVCOD_MACELLAZIONE_ANIMALI
    ...
    Public Function Leggi_Zoo_Dettagli_Ipno(ByVal piva As String,
        ...
        Using GiasContext As New Gias_DeveloperServer_Entities(EFConnString)
            ...
            Select Case Lav_Cod
                ...
                Case Else 'Incremento/Decremento/Pesatura
            ...
            If leggixSquadreCdG Then
                ...
                Dim Persone_Tecnici =
                 (From ru In GiasContext.Risorse_Umane
                  ...
                  Join rc In GiasContext.Rapporti_Contabili On rc.Cod_Rapporto Equals ru.Cod_Rapporto
                  Where (ru.Piva.Equals(piva) OrElse (c.Sa_Cod = -1)) AndAlso (ru.Piva = c.Piva OrElse (c.Sa_Cod = -1)) AndAlso
                      ru.Cod_Rapporto = COD_TECNICO AndAlso
...
Public Class CDG_DAL_W
    ...
    Public Function Batch_Delete(ByVal piva As String, ByVal strFiltro As String, ByVal bForzato As Boolean, ByRef objParametri As AgronicaCoreParametri) As String
        ...
        Try
            ...
            StrFiltroSQL.AppendLine(" (Select Id_Agenda_Rif from Agenda (NOLOCK) Inner Join mov_dettagli_Riferimenti (NOLOCK) ")
            ...
            If DT.Rows.Count > 0 Then
                ...
                'Cancellazione Dettagli
                StrSQL.Length = 0
                StrSQL.AppendLine(" Delete From Cdg_Dettagli Where Id_Cdg in (select Id_Cdg From CDG_Testata Where Tab_Imputazione = 'EREDITA' And Budget = 0 And Piva = '" & Agro_SQL_SaveText(piva) & "' ")
                ...
                StrSQL.Length = 0
                StrSQL.AppendLine(" Delete From Cdg_Testata Where Tab_Imputazione = 'EREDITA' And Budget = 0 And Piva = '" & Agro_SQL_SaveText(piva) & "' And Id_Agenda In ")
                StrSQL.Append(Agro_SQL_Save_Clausola_IN(strElenco))
    ...
    Public Function Elimina_Squadra_Attivita(ByVal piva As String, ByVal ID_Squadra As Integer, ByRef objParametri As AgronicaCoreParametri) As String
    ...
    Public Function Scrivi_Squadra_Attivita(ByVal piva As String, ByVal riga As String, ByRef objParametri As AgronicaCoreParametri) As String
            ...
            Using scope As New TransactionScope()
                ...
                Using GiasContext As New Gias_DeveloperServer_Entities(EFConnString)
                    ...
                    If objSquadra.ID_Squadra > 0 Then
                        Dim Squadra = (From s In GiasContext.SquadreXAttivita Where s.ID_Squadra = objSquadra.ID_Squadra Select s).FirstOrDefault()
                    ...
                    Else
                        Dim Squadra = Gias_EF_Utility.CopyEntity(GiasContext, objSquadra, Nothing)
                        Squadra.Piva_SuperUser = objParametri.PivaSuperUser
                        Squadra.Piva = piva
