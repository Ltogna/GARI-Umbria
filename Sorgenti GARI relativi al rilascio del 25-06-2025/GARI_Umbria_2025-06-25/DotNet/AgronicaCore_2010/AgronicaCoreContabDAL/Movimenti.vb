...
Public Class Movimenti_R
        ...
        Try
            ...
            Select Case xSelezioneVariabile
                ...
                Case enumSelezioneVariabile.Selezione_JoinDescrizioni
                    ...
                    strSql.AppendLine(" FROM  Movimenti ")
                    strSql.AppendLine(" INNER JOIN Imprese ON Movimenti.Piva = Imprese.Piva ")
                    strSql.AppendLine(" INNER JOIN Agenda ON Movimenti.Piva = Agenda.Piva AND Movimenti.Id_Agenda = Agenda.Id_Agenda ")
                    strSql.AppendLine(" WHERE Movimenti.Validita_inizio <= " & Agro_SQL_SaveDate(objParametri.FinestraTemporaleFine) & " ")
                    strSql.AppendLine(" AND   Movimenti.Validita_Fine >= " & Agro_SQL_SaveDate(objParametri.FinestraTemporaleInizio) & " ")
    ...
    Public Function Ottieni_Validita_Rilievi_Fasi_Fenologiche_per_Impianti(ByVal Piva As String,
        ...
        Try
            ...
            strSql.AppendLine(" INNER JOIN Mov_Dettaglio_Tecnico ON Movimenti_dettagli.PIVA = Mov_Dettaglio_Tecnico.Piva AND Movimenti_dettagli.Sa_Cod = Mov_Dettaglio_Tecnico.Sa_Cod AND Movimenti_dettagli.Id_Agenda = Mov_Dettaglio_Tecnico.Id_Agenda AND")
            ...
            strSql.AppendLine(" INNER JOIN SpecieVegetaliXStadiCrescita ON Mov_Dettaglio_Tecnico.FF_Classe = SpecieVegetaliXStadiCrescita.Cod_SS")
            strSql.AppendLine(" INNER JOIN Stadi_Crescita_BBCH ON Stadi_Crescita_BBCH.ID_BBCH = SpecieVegetaliXStadiCrescita.ID_BBCH ")

            If IDTestataTemp > 0 Then
                strSql.AppendLine("INNER JOIN __tmp_Agenda agnFiltro  ")
