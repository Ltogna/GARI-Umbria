...
Public Class MisuraXDR_R
    ...
    Public Function MisuraXDanniRaccolta(ByVal Input As MisuraXDanniRaccolta_input,
        ...
        Dim Dt As DataTable = objCore.Leggi_WS(Input.Veg_Cod, Input.Dr_Cod, Input.SoloVisibili,
                                               Input.strFiltro, Input.strOrdinamento, objParametri,
                                               Input.Personalizzate, Input.Piva_Superuser, NoSpecie, Input.FiltraSpecie, Input.joinPersonalizzate)
