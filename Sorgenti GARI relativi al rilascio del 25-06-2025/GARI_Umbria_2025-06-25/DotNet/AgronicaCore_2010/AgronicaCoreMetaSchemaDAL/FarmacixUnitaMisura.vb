...
Public Class FarmacixUnitaMisura
	...
	Public Function Leggi(ByRef Farm_Cod As Integer,
						  ...
						  Optional ByVal xSelezioneVariabile As enumSelezioneVariabile = enumSelezioneVariabile.Selezione_TabellaDatiMinimi) As DataTable
			...
			Select Case xSelezioneVariabile
				Case enumSelezioneVariabile.Selezione_TabellaDatiMinimi
					stb.AppendLine("SELECT Farm_Cod, Udm_Cod, [Default], QtaxUnita ").
						AppendLine("FROM [dbo].[FarmacixUnitaMisura] ").
