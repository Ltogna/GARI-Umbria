    ...
    Public Function MapSpecieAgeaToVegCod(
        ...
        Try
            ...
            Dim createSpeciesFilter = Function(x As SpecieAgea) As String
                                          Return "( Cul_Cod_Agea = '" & x.Cul_Cod_Agea &
                                           "' AND Uso_Cod = '" & x.Uso_Cod_Agea &
                                           "' AND Occupazione_Cod = '" & x.Occupazione_Cod_Agea &
                                           "' AND Destinazione_Cod = '" & x.Destinazione_Cod_Agea &
                                           "' AND Qualita_Cod = '" & x.Qualita_Cod_Agea & "' )"
                                      End Function
