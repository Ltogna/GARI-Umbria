                  ...
                  AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_JoinDescrizioni,
                    ...
                    Select Case TipoRichiesto
                        ...
                        Case 0  'Tutti i formulati
                            ...
                            StrSQL.Append(" And  ClassificazioniFormulati.CLASS_COD IN  (101,102,103,104,105,106,107,108,109,110,300,610,611,  200,201,202,203,  400,401,402,403,404,405,407,408,409,411,412,413,414,415,418,  608,  603,  607, 606, 500,501,502,503,504,505,506) ")
                ...
                Case AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta
                    ...
                    Select Case TipoRichiesto
                        ...
                        Case enum_TipoFormulato.Tutti  'Tutti i formulati
                            ...
                            '(30/04/2015 fede) modifica filtro Tutti per escludere le trappole 
                            StrSQL.Append(" And  ClassificazioniFormulati.CLASS_COD IN  (101,102,103,104,105,106,107,108,109,110,300,610,611,  200,201,202,203,  400,401,402,403,404,405,407,408,409,411,412,413,414,415,418,  608,  603,  607,  500,501,502,503,504,505,506,606,   614,615) ")
                ...
                Case AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta
                    ...
                    Select Case TipoRichiesto
                        ...
                        Case enum_TipoFormulato.Tutti  'Tutti i formulati
                            ...
                            '(30/04/2015 fede) modifica filtro Tutti per escludere le trappole 
                            StrSQL.AppendLine(" AND ClassificazioniFormulati.CLASS_COD IN (101,102,103,104,105,106,107,108,109,110,300,610,611,200,201,202,203,400,401,402,403,404,405,407,408,409,411,412,413,414,415,418,608,603,607,500,501,502,503,504,505,506,606,614,615) ")
