    ...
    Public Sub Logga_Solo_DB(
        ...
        Try
            ...
            If cfg IsNot Nothing Then
                If cfg.LivelloLOG = enum_Livello_Log_Applicazioni.LogFileEmailEDB OrElse cfg.LivelloLOG = enum_Livello_Log_Applicazioni.LogSoloSuEmailEDB Then
                    ...
                    If Not Debugger.IsAttached Then
                        ThreadPool.QueueUserWorkItem(Sub() PreparaScritturaSuDb(oggetto, objParametri)) 'ComponiESpedisciMail(cfg, subject, MessaggioErrore))
                    End If
    ...
    Public Sub Logga(ByVal NomeRoutine As String,
        ...
        Try
            ...
            Else
                ...
                If cfg.LivelloLOG = enum_Livello_Log_Applicazioni.LogFileEmailEDB OrElse cfg.LivelloLOG = enum_Livello_Log_Applicazioni.LogSoloSuFile Then
                    ' Loggo su file
                    If objParametri IsNot Nothing Then
                        'MyBase.Scrivi_LOG(objParametri.LogDirectory,
                        '                  objParametri.LogFileName,
                ...
                If cfg.LivelloLOG = enum_Livello_Log_Applicazioni.LogFileEmailEDB OrElse cfg.LivelloLOG = enum_Livello_Log_Applicazioni.LogSoloSuEmailEDB Then
                    ...
                    If Not Debugger.IsAttached Then
                        ...
                        ThreadPool.QueueUserWorkItem(Sub() ComponiESpedisciMail(cfg, subject, sb.ToString))
                ...
                If cfg.LivelloLOG = enum_Livello_Log_Applicazioni.LogFileEmailEDB OrElse cfg.LivelloLOG = enum_Livello_Log_Applicazioni.LogSoloSuEmailEDB OrElse
                    cfg.LivelloLOG = enum_Livello_Log_Applicazioni.LogSoloDB Then
                    ...
                    If Not Debugger.IsAttached Then
                        ...
                        Dim subject = "**** ERRORE DI PARAMETRIZZAZIONE NEL DATAPROVIDER O SQL INJECTION RILEVATA ****"
                        ThreadPool.QueueUserWorkItem(Sub() PreparaScritturaSuDb(oggetto, objParametri))
    ...
    Private Sub PreparaScritturaSuDb(ByVal oggettoLog As DbLogClass, ByRef objParametri As AgronicaCoreParametri)
        ...
        SyncLock (dbLocker)
            ...
            If Not IsNothing(objParametri.StringaConnessione) AndAlso hashDict.Sum(Function(x) x.Value.occorrenze) >= lepi Then
                ...
                dbCnn.Open()
                Using sqlBulkCopy As New SqlBulkCopy(dbCnn, Nothing, objParametri.objTransazione)
