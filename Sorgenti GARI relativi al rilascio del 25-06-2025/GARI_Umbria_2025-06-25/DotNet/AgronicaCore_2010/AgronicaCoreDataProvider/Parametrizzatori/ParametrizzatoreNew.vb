...
#Region "Agro_SQL_Save_xFiltroAggiuntivo"
    Public Function Agro_SQL_Save_xFiltroAggiuntivo(ByVal filtro As String,
        ...
        Catch ex As UnauthorizedAccessException
            ...
            If DataProviderFactory.Instance.LanciaEccezioneSuInjection Then
                Throw ex
            Else
                If Debugger.IsAttached Then
    ...
    Private Function Agro_SQL_Save_xFiltroAggiuntivo_Con_Parametri(ByVal filtro As String,
        ...
        If queryLiteral.Count > 1900 Then
...
#Region "ControllaInjection"
    ...
    Private Function ControllaInjection(ByVal query As String,
        ...
        If (query.Contains(";") OrElse query.Contains("--") OrElse query.Contains("/*") OrElse query.Contains("@@")) Then

            Throw New UnauthorizedAccessException(errore & "Utilizzo di ; / di commenti relativamente sospetti o System Function")
