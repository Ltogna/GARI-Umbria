...
Public Class UtilityProvider
    ...
    Public Shared Function Agro_XML_GetInteger(
        ...
        If ElementoXml.HasAttribute(NomeAttributo) = True Then
    ...
    Public Shared Function Page_ModalDialog_Script(ByVal Path_NomePaginaAspx As String,
        ...
        Dim StrWindowOpen As String
        StrWindowOpen = "<script language='javascript'> " &
                            " a = window.showModalDialog(" &
                            Chr(34) & Path_NomePaginaAspx &
                            "" & QueryString & Chr(34) & "," &
                            Chr(34) & Chr(34) & "," &
                            Chr(34) & "dialogWidth:" & CStr(Pagina_Width) & "px; " &
                            "dialogHeight:" & CStr(Pagina_Height) & "px; " &
                            "status:" & Status & "; " &
                            "center:" & Center & "; " &
                            "edge:" & Edge & "; " &
                            "menubar:" & Menubar & "; " &
                            "resizable:" & Resizable & "; " &
                            "scroll:" & Scrollbars & "; " &
                            "dialogTop:" & CStr(Pagina_Top) & "; " &
                            "dialogLeft:" & CStr(Pagina_Left) & "; " &
                            Chr(34) & ") " &
                            vbCrLf & " document.all(" & Chr(34) & TextBox & Chr(34) & ").value = a" &
                            vbCrLf & " document.getElementById(" & Chr(34) & NomeForm & Chr(34) & ").submit()" &
                            "</script>"
        Return StrWindowOpen
    End Function
