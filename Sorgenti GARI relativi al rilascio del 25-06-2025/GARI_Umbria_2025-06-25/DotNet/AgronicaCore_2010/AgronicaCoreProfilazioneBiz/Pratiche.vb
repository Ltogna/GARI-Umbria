            ...
            For Each drPratiche In DtPratiche.Rows
                ...
                If {enum_Servizi.QStandard,
                    ...
                    Workflow_di_attivazione_aziende_GIAS(
                        ...
                        drPratiche("piva"), drPratiche("utente"),
                        praticheAccodate)
                ...
                Else
                    ...
                    praticheAccodate.Add(New Pratiche_ServiziStati With {.ServizioCod = 0, .StatoCod = 0, .Descrizione = "{" &
                                        ...
                                        " ""Utente"": """ & AgronicaCoreUtility.jSon.Escape(CStr(drPratiche("utente"))) & """" &
                                        "}", .Piva = drPratiche("piva"), .Utente = drPratiche("utente")
                                        }
                                    )
                End If
...
Public Class Pratiche_W
    ...
    Public Function Elimina_Pratica(Pratica_Cod As Integer, objParametri_Server As AgronicaCoreParametri, ByRef Messaggio_Errore As String) As Boolean
