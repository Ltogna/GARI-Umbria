...
Public Class CheckBundle
    ...
    Public Sub CheckPlot(ByVal plot As Plot)
        ...
        If Not BypassCheck(ErrorType.PlotsNotMapped) Then
            ...
            If Not String.IsNullOrEmpty(plot.plotDescription) AndAlso
                (String.IsNullOrEmpty(plot.islandId) OrElse String.IsNullOrEmpty(plot.plotId) OrElse
                String.IsNullOrEmpty(plot.pcgId) OrElse String.IsNullOrEmpty(plot.plantationId) OrElse
                String.IsNullOrEmpty(plot.codiBarrScheVali)) Then

                If Not PlotsError.Contains(plot.plotDescription) Then
                    PlotsError.Add(plot.plotDescription)
                End If
