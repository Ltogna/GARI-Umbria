...
Public Class PUA_Testata_R
    ...
    Public Function Leggi_xGriglia(ByVal Piva As String,
        ...
        Try
            ...
            StrSQL.AppendLine("SELECT PT.PUA_Cod AS PC_Testata_Cod,'PUA ' + CONVERT(varchar(4),PT.PUA_Anno) AS PC_Testata_Des, PT.PUA_Tipo AS PC_Tipo, PT.validita_inizio,PT.Validita_Fine, PT.Regolamento_Cod,0 AS PC_Elaborazione_Cod, PT.piva AS PC_Dettagli_PIVA, IMP.rag_soc, ")
    ...
    Public Function Leggi_xStatistiche_PUA_Utenti(ByVal FiltroData_Operazione1_Registrazione2 As Integer,
        ...
        Try
            ...
            If Username <> "" Then
                strSql.Append("     AND   p.Username_Creazione='" & Username & "'")
            End If
