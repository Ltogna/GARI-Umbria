...
Public Class Filtrone
    ...
    Public Function CreaStringaQueryPerDTFiltrone(
        ...
        Dim versioneSql As Integer = DataProviderFactory.Instance.Provider().VersioneSqlServer_anno(objParametri)
...
#End Region
    ...
    Public Shared Function DT_to_Json_Azienda(ByVal dt As DataTable,
        ...
        Dim versioneSql As Integer = DataProviderFactory.Instance.Provider().VersioneSqlServer_anno(objParametri_Server)

        Dim mapCoopReferente As New Dictionary(Of String, String)
        For Each row In dt.Rows
            GetImpreseReferenti(dt, row, mapCoopReferente, dt.Rows.IndexOf(row), versioneSql, objParametri_Server)
        Next
        ...
        For i = Num_Impianti - 1 To 0 Step -1
            ...
            If Not IsDBNull(dt.Rows(i).Item("appezza")) AndAlso Not IsDBNull(dt.Rows(i).Item("id_reg")) Then
                ...
                If Not Impianto_Duplicato Then
                    ...
                    GetImpreseReferenti(dt, dt.Rows(i), mapCoopReferente, If(isFirst, 0, 1), versioneSql, objParametri_Server)
                    isFirst = False
    ...
    Private Shared Sub GetImpreseReferenti(ByRef dt As DataTable, ByRef row As DataRow, ByRef mapCoopReferente As Dictionary(Of String, String), currentRowIndex As Integer, versioneSql As Integer, ByVal objParametri_Server As AgronicaCoreParametri)
        Dim sql2017 As Boolean = True
        If versioneSql >= 2017 Then
            sql2017 = True
        Else
