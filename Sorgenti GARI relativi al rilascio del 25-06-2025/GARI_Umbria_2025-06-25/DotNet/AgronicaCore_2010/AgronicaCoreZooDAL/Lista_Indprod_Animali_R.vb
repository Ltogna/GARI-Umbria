...
Public Class Lista_Indprod_Animali_R
	...
	Public Function LeggiRisorseZootecniche(ByVal Gen_Cod As Long,
		...
		Try
			...
			StrSQL.AppendLine(" FROM Lista_Specie_Animali s ")
			StrSQL.AppendLine(" INNER JOIN Lista_Generi_Animali g ON s.GEN_COD = g.GEN_COD ")
			StrSQL.AppendLine(" LEFT JOIN Lista_IndirizziProd_Animali i on s.GEN_COD = i.GEN_COD and s.SPE_COD = i.SPE_COD ")
