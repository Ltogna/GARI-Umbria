...
Public Class DPI_Verifica
    ...
    Public Function Verifica_DifesaDiserbo(ByRef objParametri_Server As AgronicaCoreParametri,
                                               ...
                                               ByVal VerificaSoloControlliImpostazioniUtente As Boolean) As List(Of rispostaStandard(Of AgronicaCoreDpiBIZ.Verifica_Disciplinare_Intervento))
                    ...
                    If Dt_Trattamenti_Impianti IsNot Nothing AndAlso Dt_Trattamenti_Impianti.Rows.Count > 0 Then
                        ...
                        If DrTrattamentiImpianto IsNot Nothing AndAlso DrTrattamentiImpianto.Length > 0 Then
                            ...
                            For iTra = 0 To DrTrattamentiImpianto.Length - 1
                                ...
                                If Data > CDate(DrTrattamentiImpianto(iTra).Item("Data_Movimento")) Then 'And
                                    ...
                                    If Pro_Cod_Test <> 0 Then
                                        ...
                                        If Dt_Carenze IsNot Nothing Then
                                            ...
                                            If For_Veg_Cod = 0 Then
                                                DrCarenza = Dt_Carenze.Select("fr_cod=" & Pro_Cod_Test & " AND validita_inizio<='" & Data & "' AND validita_fine>='" & Data & "'" & strFiltroProtetto)
                                            Else
                                                DrCarenza = Dt_Carenze.Select("fr_cod=" & Pro_Cod_Test & " AND for_veg_cod=" & For_Veg_Cod & " AND validita_inizio<='" & Data & "' AND validita_fine>='" & Data & "'" & strFiltroProtetto)
                                            End If
                                        ...
                                        If Carenza <> -1 AndAlso Carenza <> 0 Then
                                            ...
                                            DataTest = DateAdd("d", Carenza + 1, CDate(DrTrattamentiImpianto(iTra).Item("Data_Movimento")))
                                            ...
                                            If DataTest > Data_Trattamento Then
                                                ...
                                                If isFromVerificaCarenzaRaccoltaQdCNG Then
                                                    Descrizione = "distribuito il " & DrTrattamentiImpianto(iTra).Item("Data_Movimento") & " (Carenza: " & Carenza & " gg)"
                                                Else
                                                    Descrizione = " (Carenza: " & Carenza & " gg) in data " & DrTrattamentiImpianto(iTra).Item("Data_Movimento")
                                                End If
    ...
    Public Function XmlFINALE(ByVal DatiVerifica As String,
        ...
        Dim UTENTE_COD_BLOCCA_RACCOLTA_CARENZA_NON_RISPETTATA As String = "ND"
                ...
                For i = 0 To Dt_Impostazioni.Rows.Count - 1
                    Select Case CInt(Dt_Impostazioni.Rows(i).Item("Impostazione_Cod"))
                        ...
                        Case enum_Impostazioni_Utenti.UTENTE_COD_BLOCCA_DOSEMASSIMA_ANNO_ETICHETTA_SALVATAGGIO
                            UTENTE_COD_BLOCCA_DOSEMASSIMA_ANNO_ETICHETTA_SALVATAGGIO = Dt_Impostazioni.Rows(i).Item("Impostazione_Valore_1")
                        Case enum_Impostazioni_Utenti.UTENTE_COD_BLOCCA_RACCOLTA_CARENZA_NON_RISPETTATA
                            UTENTE_COD_BLOCCA_RACCOLTA_CARENZA_NON_RISPETTATA = Dt_Impostazioni.Rows(i).Item("Impostazione_Valore_1")
                        Case enum_Impostazioni_Utenti.UTENTE_COD_BLOCCA_PRODOTTO_RELAZIONE_FORMULATO_SALVATAGGIO
                            UTENTE_COD_BLOCCA_PRODOTTO_RELAZIONE_FORMULATO_SALVATAGGIO = Dt_Impostazioni.Rows(i).Item("Impostazione_Valore_1")
                        Case enum_Impostazioni_Utenti.UTENTE_COD_BLOCCA_PRODOTTO_ETA_IMPIANTO_SALVATAGGIO
                            UTENTE_COD_BLOCCA_PRODOTTO_ETA_IMPIANTO_SALVATAGGIO = Dt_Impostazioni.Rows(i).Item("Impostazione_Valore_1")
                        ...
                        Do While i_DatoNonConforme < xNonConformi.Count
                            ...
                            Select Case Lav_Cod
                                ...
                                Case LAVCOD_RACCOLTA
                                    ...
                                    Select Case UTENTE_COD_BLOCCA_RACCOLTA_CARENZA_NON_RISPETTATA
                                        ...
                                        Case "1", "2" 'blocco, warning (verifica singole impostazioni)
                                            ...
                                            '    End If
                                                ...
                                                Case enTipoErrCode_Verifica.DoseEccessivaEtichetta_Anno
                                                    If UTENTE_COD_BLOCCA_DOSEMASSIMA_ANNO_ETICHETTA_SALVATAGGIO <> "1" Then
                                                        InserisciErrore = False
                                                    End If
                                                ...
                                                Case enTipoErrCode_Verifica.ProdottoVincolatoFormulato
                                                    If UTENTE_COD_BLOCCA_PRODOTTO_RELAZIONE_FORMULATO_SALVATAGGIO <> "1" Then
                                                        InserisciErrore = False
                                                    End If

                                                Case enTipoErrCode_Verifica.ProdottoNonUtilizzabileXDisciplinarexStatoImpianto
                                                    If UTENTE_COD_BLOCCA_PRODOTTO_ETA_IMPIANTO_SALVATAGGIO <> "1" Then
                                                        InserisciErrore = False
                                                    End If

                                                Case enTipoErrCode_Verifica.MixPolveruentiENon
                                                    If UTENTE_COD_BLOCCA_MIX_POLVERULENTI_NONPOLVERULENTI_SALVATAGGIO <> "1" Then
                                                        InserisciErrore = False
                                                    End If
                                    ...
                                    Case "1", "2", "ND" 'blocco, warning (verifica singole impostazioni)
                                        ...
                                        Select Case Warning_Code
                                                ...
                                                Else
                                                    ...
                                                    If IDTestataTemp > 0 Then
                                                        ...
                                                        If Max_Interventi_xProdotto_Globali > 0 Then
                                                            If Str_FiltroAggiuntivo.Length > 0 Then
                                                                Str_FiltroAggiuntivo.Append(" AND (Movimenti_dettagli.doseetichetta_value like '" & Agro_SQL_SaveText(For_Veg_Av_Dos_Cod.ToString) & "$%' " &
                                                                    "      OR  Movimenti_dettagli.doseetichetta_value like '<br>" & Agro_SQL_SaveText(For_Veg_Av_Dos_Cod.ToString) & "$%') ")
                                                            Else
                                                                Str_FiltroAggiuntivo.Append(" (Movimenti_dettagli.doseetichetta_value like '" & Agro_SQL_SaveText(For_Veg_Av_Dos_Cod.ToString) & "$%' " &
                                                                    "      OR  Movimenti_dettagli.doseetichetta_value like '<br>" & Agro_SQL_SaveText(For_Veg_Av_Dos_Cod.ToString) & "$%') ")
                                                            End If
                                            ...
                                            Case enTipoWarning_Verifica.Dose_MaxAnno_GPAI
                                                ...
                                                If UTENTE_COD_BLOCCA_DOSEDPIDISERBOANNOMAX_SALVATAGGIO = "ND" OrElse UTENTE_COD_BLOCCA_DOSEDPIDISERBOANNOMAX_SALVATAGGIO = "0" Then
                                                    InserisciWarning = False
                                                Else
                                            ...
                                            Case enTipoWarning_Verifica.Dose_MaxAnno
                                                ...
                                                If UTENTE_COD_BLOCCA_DOSEMASSIMA_ANNO_ETICHETTA_SALVATAGGIO = "ND" OrElse UTENTE_COD_BLOCCA_DOSEMASSIMA_ANNO_ETICHETTA_SALVATAGGIO = "0" Then
                                                    InserisciWarning = False
                                                Else
    ...
    Public Sub Analizza_RisultatoVerifica(ByVal Xml_Risultato_Verifica As String,
        ...
        Select Case CInt(Lav_Cod)
            Case LAVCOD_TRATTAMENTO_ANTIPARASSITARIO,
                 LAVCOD_GEODISINFESTAZIONE,
                 LAVCOD_CONFUSIONE_DISORIENTAMENTO_SESSUALE 'todo corretto?
                ...
                If Disciplinare_cod <> 0 Then
                    ...
                    Select Case Lav_Cod
                        ...
                        Case Else
                            ...
                            Select Case Lav_Cod
                                Case LAVCOD_GEODISINFESTAZIONE, LAVCOD_TRATTAMENTO_ANTIPARASSITARIO, LAVCOD_CONFUSIONE_DISORIENTAMENTO_SESSUALE
    ...
    Public Sub Crea_DT_RisultatiVerificheMagazzino(ByRef DT_RisultatiVerifiche As DataTable)
