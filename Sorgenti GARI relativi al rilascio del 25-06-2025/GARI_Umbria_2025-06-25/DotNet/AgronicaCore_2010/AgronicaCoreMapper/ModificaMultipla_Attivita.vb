        ...
        For Each attivita In lista_Attivita
            ...
            Select Case Tipo_Modifica
                ...
                Case enum_ModificaMultiplaOperazioni.AggiungiMagazzino
                    ...
                    Dim Impostazione_Valore_1 As String = CInt(objUtentiImpostazioni.LeggiConDefault(enum_Impostazioni_Utenti.UTENTE_COD_BLOCCA_SE_SUPERA_GIACENZE, Username_1Utente_o_2SuperUser:=1, "0", objParametri_Utenti))
