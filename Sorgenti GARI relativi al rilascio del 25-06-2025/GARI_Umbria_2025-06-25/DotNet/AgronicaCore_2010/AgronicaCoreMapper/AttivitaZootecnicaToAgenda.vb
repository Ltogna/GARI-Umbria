...
Public Class AttivitaZootecnicaToAgenda
    ...
    Public Function ScriviAttivitaZootecnicaToAgenda(ByVal attivita As Attivita,
...
#End Region
                    ...
                    Case LAVCOD_SPOSTAMENTI_ZOO
                        ...
                        Dim listaCapi As List(Of String) = (From dr In dt.Rows Select CStr(dr("Raggruppamento_Cod") & "_" & dr("Cod_Animale"))).ToList
    ...
    ''' <returns></returns>
    Public Function ScriviAgendaFromRicettaZootecnica(ByVal attivitaRicetta As Attivita,
    ...
    Public Function AggiornaAttivitaZootecnica(ByVal attivita As Attivita,
    ...
    ''' <summary>
    ''' Scrive le righe necessare di Movimenti per l'operazione di Trattamento Zoo
    ''' </summary>
    ...
    Public Sub ScriviTrattamentoFromAttivitaZoo(ByVal attivita As Attivita,
        ...
        Dim objFarmaci_R As New AgronicaCoreMetaSchemaDAL.Farmaci
        Dim unitaMisura_R As New AgronicaCoreMetaSchemaDAL.UnitaMisura_R
        ...
        For Each prod In attivita.risorse
            If prod.classType.Equals(costanti.ClassType.DettaglioRegistroSomministrazioni) Then
                ...
                If Not IsNothing(dtFarmaco) AndAlso dtFarmaco.Rows.Count > 0 Then
                    ...
                    movDett_ScaricoFarmCapo.Elem_Cod = FARMACI
                    ...
                    For Each cdc In attivita.centriDiCosto
                        If cdc.classType.Equals(costanti.ClassType.CapoAnimaleCDC) Then
                            ...
                            Dim qtaCapo As Decimal = convQta * percSomm
                        ...
                        End If
                    Next
                Else Throw New Exception(FarmacoNonConfiguratoGIAS)
                End If

            ElseIf prod.classType.Equals(costanti.ClassType.RisorsaProdotto) Then
                Dim somministrazione As risorse.RisorsaProdotto = CType(prod, risorse.RisorsaProdotto)
                Dim dettSomministrazione As dettagli.DettaglioRegistroSomministrazioni = New dettagli.DettaglioRegistroSomministrazioni
                Dim effettuaScaricoMagazzino As Boolean = False
                    ...
                    If Not IsNothing(dtFarmaco) AndAlso dtFarmaco.Rows.Count > 0 Then
                        ...
                        Dim giacenzaFarm As Decimal =
                            giacenzeProd_R.Verifica_Giacenza((Date.Now).Date, magazzino.primaryKey.centroAziendalePK.partitaIva,
                                                             magazzino.primaryKey.centroAziendalePK.codice, 0, FARMACI,
    ...
    Private Function getRegScoNumero(ByRef GiasContext As Gias_DeveloperServer_Entities)
