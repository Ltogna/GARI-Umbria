...
Public Class DSS_Impianti_Aziendali_Agronica_Stazioni_Meteo
    ...
    Public Function AccodaImpiantiConDatoGisSenzaOrigineAssociata(ByVal objParametri_Server As AgronicaCoreParametri, ByVal objParametri_Utenti As AgronicaCoreParametri) As RispostaStandard
    ...
    Private Function LetturaStazioneAssociataViaWS(objParametri_Server As AgronicaCoreParametri, objMeteo As AgronicaCoreWebService.MeteoNT, impianto As DataRow) As Boolean
    ...
    Private Function LetturaStazioneChiamaWS(
        ...
        objParametri_Server As AgronicaCoreParametri, objMeteo As AgronicaCoreWebService.MeteoNT, impianto As DataRow) As DataTable
