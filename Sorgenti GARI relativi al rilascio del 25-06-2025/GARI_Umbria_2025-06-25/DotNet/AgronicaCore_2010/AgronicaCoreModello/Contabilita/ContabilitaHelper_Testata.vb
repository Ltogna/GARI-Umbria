...
Public Class ContabilitaHelper_Testata
                        ...
                        Else
                            ...
                            If xRisp = True Then
                                ...
                                Select Case True
                                    ...
                                    Case UtilityHelper.IsFattura(objContabTestata.LavCod)
    ...
    Private Function GeneraTestataContabilita(ByRef objContabTestata As Contabilita_Testata,
        ...
        Try
            ...
            'Prima di generare il movimento principale cfreo il pagamento in modo da avere la data di scadenza
            Select Case objContabTestata.LavCod

                Case 1001 ' Fatture Emesse
        ...
        Try
            ...
            If risModificabilitaData IsNot Nothing AndAlso risModificabilitaData.MsgError = "" Then
                ...
                If xRisp = True AndAlso UtilityHelper.IsAccettazione(lavCod) Then
                    ...
                    If risModificabilitaData.PivaProduttore <> "" AndAlso risModificabilitaData.AgendeProduttore.Count > 0
