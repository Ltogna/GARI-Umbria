...
Namespace OperazioneAgenda_Temp
    ...
    Public Class Agenda_Operazione_Helper
        ...
        Public Function Genera_Agenda_Da_OperazioneRicetta(ByVal ricettaTipo As Integer,
            ...
            'ricavo i cau_mov distint x creare i movimenti in agenda poi
            For det = 0 To xmLsRicettaDettaglio.Count - 1
                ...
                If hashCauMov.ContainsKey(cauMov) = False Then
            ...
            For Each key In hashCauMov.Keys
                ...
                For dett = 0 To xmLsRicettaDettTmp.Count - 1
                    ...
                    For dest = 0 To xmLsRicettaDestinazione.Count - 1
                        ...
                        If Not IsNothing(dtRegImp) Then
                            If dtRegImp.Rows.Count <> 0 Then
        ...
        Public Function Scrivi(ByRef Agenda As Operazione_Agenda,
            ...
            Try
                ...
                If Agenda.Data > CDate(Now) AndAlso documentoPrevisionale = False Then
                ...
                If True Then
                    ...
                    If scriviRiferimenti And Not IsNothing(Agenda.Agenda_Riferimenti) Then
        ...
        Public Function Cancella(ByVal piva As String,
            ...
            Try
                ...
                'Grilli 26/07/2019 Messo perché nell'XML di creazione dell'agenda il dato non c'è e quindi in caso di modifica perderemmo l'informazione
                If CancellaOperazioneSingolaNoCorrelate = False AndAlso dt.Rows.Count > 0 Then
                    '---------------------------
                    'ZOO
                        ...
                        Case LAVCOD_MORTE_ANIMALI, LAVCOD_MACELLAZIONE_ANIMALI, LAVCOD_DECREMENTO_CONSISTENZE_ZOO, LAVCOD_VENDITA_ANIMALI, LAVCOD_TRASFERIMENTO_ANIMALI
                            ...
                            Using scope As New TransactionScope()
                                Try
                                    ...
                                    For Each mov_an In Movimenti_Animali
                                        ZooBIZ.Riapri_Validita_Animale_Fine(mov_an.PIVA, mov_an.Cod_Progetto, GiasContext, objParametri)
                                        ZooBIZ.Aggiorna_Causale_Morte(mov_an.PIVA, mov_an.Cod_Progetto, 0, GiasContext, objParametri)
                                        ZooBIZ.Aggiorna_Patologia_Capo(mov_an.PIVA, mov_an.Cod_Progetto, 0, GiasContext, objParametri)
                                        ZooBIZ.Aggiorna_Note_Capo(mov_an.PIVA, mov_an.Cod_Progetto, "", GiasContext, objParametri)
                                    Next
                        ...
                        Case LAVCOD_SPOSTAMENTI_ZOO
                            ...
                            Using scope As New TransactionScope()
                                Try
                                    ...
                                    Dim DestinazioniFlagBDN As List(Of Integer)
                ...
                ''AGENDA LOG 
                ''---------------------------
                If logCancellazione AndAlso dt.Rows.Count > 0 Then
        ...
        Private Function CancellaDocumentiAllegati(ByVal Id_Agenda As Integer,
            ...
            'Lettura Id_Alert_Entita da If_Agendaù
            ...
            Try
                ...
                If dt_Entita.Rows.Count > 0 And Id_Agenda <> 0 Then
                ...
                Select Case Agenda.Movimenti(i).Cau_Mov
                    ...
                    Case CAU_TRATTAMENTO
                        ...
                        stringaXml = XML_Agenda_MovimentoDettaglioTecnico(
                                ...
                                piva:=Agenda.Piva,
                                saCod:=Agenda.Sa_Cod,
                                qtaRil:=Agenda.Movimenti(i).Movimenti_Dettagli_Tecnici(jj).Qta_Ril,
                                avCod:=0,
                                avGru:=0,
