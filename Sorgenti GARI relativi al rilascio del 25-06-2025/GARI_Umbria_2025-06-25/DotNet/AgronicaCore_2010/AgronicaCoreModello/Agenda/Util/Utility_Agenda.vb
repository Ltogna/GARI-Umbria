    ...
    Public Shared Function GetInfoOperazione(ByVal lav_cod As Integer, ByVal tipoAttivita As Attivita.Tipo_Attivita) As InfoOperazione
        ...
        With InfoOperazione
            ...
            Select Case lav_cod
                ...
                Case LAVCOD_REINNESCO_TRAPPOLE  '--- REINNESCO TRAPPOLE
...
#Region "Controlli Impostazioni Utente"
    Public Shared Sub getSeverityDaValoreImpostazione_0Warning_1WarningBloccante(ByRef severity As Integer,
        ...
        ValoreImpostazione = CInt(objUtentiImpostazioni.LeggiConDefault(enumImpostazioni, Username_1Utente_o_2SuperUser:=1, "0", objParametri_Utenti))
...
#End Region
    ...
    Public Shared Function eseguiCheckDPI(InfoOperazione As InfoOperazione, attivita As Attivita) As Boolean
        ...
        If (InfoOperazione.IsTrattamento AndAlso
            ...
            InfoOperazione.TipoCentroDiCosto = centri_di_costo.Tipo.Esercizio) OrElse
            (InfoOperazione.IsFertilizzazione = True) AndAlso Not isInsettiUtiliTrappole(InfoOperazione) Then
            Return True
        Else
            Return False
        End If
