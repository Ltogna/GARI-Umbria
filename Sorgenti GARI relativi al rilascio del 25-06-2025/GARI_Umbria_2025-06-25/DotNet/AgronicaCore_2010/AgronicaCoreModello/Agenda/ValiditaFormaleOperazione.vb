...
#Region "UTILITY"
    ...
    Private Function ciSonoTrattamentiDiserbi(PIVA As String,
        ...
        Dim strFiltroLavCod As String = "Lav_Cod IN (" & LAVCOD_TRATTAMENTO_ANTIPARASSITARIO & "," & LAVCOD_CONCIA_SEME & "," & LAVCOD_DISSECCAMENTO & "," & LAVCOD_GEODISINFESTAZIONE & "," & LAVCOD_TRATTAMENTO_FITOREGOLATORE & "," & LAVCOD_DISERBO & "," & LAVCOD_CONFUSIONE_DISORIENTAMENTO_SESSUALE & ")"
