...
Public Class AppHelper
    ...
    Public IMPORTAZIONI_DEFAULT = New Dictionary(Of enum_Dati_App, enum_Import_App) From {
        {enum_Dati_App.Attivita, enum_Import_App.Nessuno},
    ...
    Public Function Leggi_Riferimento_APP(ByVal ID As String, ByRef Tipo As String, objParametri_Server As AgronicaCoreParametri) As String
    ...
    Public Function Leggi_GUID_APP(ByVal Codice As String, ByVal Tipo As String, objParametri_Server As AgronicaCoreParametri) As String
    ...
    Public Function Aggiorna_Dati_APP(ByVal ID As String, ByVal Tipo As String,
                                      ...
                                      Optional ByVal User_Agent As String = "") As Boolean

        Dim appDatiScrivi As New AgronicaCoreContabDAL.APP_Dati_W
        Return appDatiScrivi.Aggiorna_DatiAPP(ID, Tipo, Errori, Riferimento, Cancellato, Importazione, objParametri_server, User_Agent)
    ...
    Public Function Aggiorna_Agenda_Dati_APP(ByVal IdAgenda As Integer,
        ...
        If dt.Rows.Count > 0 Then
            ...
            If Not String.IsNullOrEmpty(APP_Ricetta_Operazione_ID) Then
                Dim appDatiScrivi As New AgronicaCoreContabDAL.APP_Dati_W
                esito = appDatiScrivi.Aggiorna_Riferimento_DatiAPP(APP_Ricetta_Operazione_ID, IdAgenda & "|" & Ricetta_Cod, objParametri_server)
            End If
