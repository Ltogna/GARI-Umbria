...
Public Class Alert_W
    ...
    Public Function Cancella_Allegato(ByVal ID_Elenco As Integer,
        ...
        Try
            ...
            objLog.Scrivi(ID_Alert_Log, "DELETE: " & Descrizione_scadenza, AGRODATAINIZIO, AGRODATAFINE, objParametri)
    ...
    Public Function Scrivi_Allegato(ByVal ID_Tipologia As Integer,
        ...
        Try
            ...
            Dim objLog As New AgronicaCoreScadenziario.Alert_Log_W
            Dim ID_Alert_Log As Integer = objSeq.NuovoId_Tabella("Alert_Log", 0, 2000000000, objParametri)
            objLog.Scrivi(ID_Alert_Log, "ADD: " & Descrizione_scadenza, AGRODATAINIZIO, AGRODATAFINE, objParametri)
    ...
    Public Function Scrivi(ByVal ID_Tipologia As Integer,
        ...
        Try
            ...
            Dim objLog As New AgronicaCoreScadenziario.Alert_Log_W
            Dim ID_Alert_Log As Integer = objSeq.NuovoId_Tabella("Alert_Log", 0, 2000000000, objParametri)
            objLog.Scrivi(ID_Alert_Log, "ADD: " & Descrizione_scadenza & "_Nome_Allegato_" & Nome_Allegato & "_ID_Elenco_" & id_Elenco & "_Flag_Salvataggio_su_FS_Completato_" & Flag_Salvataggio_su_FS_Completato,
    ...
    Public Function Modifica(ByVal ID_Tipologia As Integer,
        ...
        Try
            ...
            Dim objLog As New AgronicaCoreScadenziario.Alert_Log_W
            Dim ID_Alert_Log As Integer = objSeq.NuovoId_Tabella("Alert_Log", 0, 2000000000, objParametri)
            objLog.Scrivi(ID_Alert_Log, "EDIT: " & Descrizione_scadenza & "_Nome_Allegato_" & Nome_Allegato & "_ID_Elenco_" & ID_Elenco & "_Flag_Salvataggio_su_FS_Completato_" & Flag_Salvataggio_su_FS_Completato,
                          AGRODATAINIZIO, AGRODATAFINE, objParametri)
    ...
    Public Function ModificaOld(ByVal ID_Tipologia As Integer,
        ...
        Try
            ...
            Dim objLog As New AgronicaCoreScadenziario.Alert_Log_W
            Dim ID_Alert_Log As Integer = objSeq.NuovoId_Tabella("Alert_Log", 0, 2000000000, objParametri)
            objLog.Scrivi(ID_Alert_Log, "EDIT: " & Descrizione_scadenza, AGRODATAINIZIO, AGRODATAFINE, objParametri)
    ...
    Public Function Cancella(ByVal ID_Elenco As Integer,
        ...
        Try
            ...
            Dim objLog As New AgronicaCoreScadenziario.Alert_Log_W
            objLog.Scrivi(ID_Alert_Log, "DELETE: " & Descrizione_scadenza & "_ID_Elenco_" & ID_Elenco, AGRODATAINIZIO, AGRODATAFINE, objParametri)
        ...
        Try
            ...
            Select Case TipoOperazione
                ...
                Case enum_TipoOperazioneDB.Scrittura
                    ...
                    'Salvataggio Indice
                    objIndice.Scrivi(piva, id_indice, titoloindice, chkobbligatorio, chkindice_speciale, tipocampo, tipodato, elenco_tipo, elenco_cod, elenco_val, validita_inizio, validita_fine, objParametri)
                ...
                Case enum_TipoOperazioneDB.Modifica
                    ...
                    'Modifica Indice
                    objIndice.Modifica("", id_indice, titoloindice, chkobbligatorio, chkindice_speciale, tipocampo, tipodato, elenco_tipo, elenco_cod, elenco_val, validita_inizio, validita_fine, objParametri)
