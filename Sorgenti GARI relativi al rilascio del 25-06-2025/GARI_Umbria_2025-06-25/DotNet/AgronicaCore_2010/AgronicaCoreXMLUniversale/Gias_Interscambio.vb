...
#Region "INTERSCAMBIO Tipo 2 (Aboca)"
    ...
    Public Function Leggi_LogDettaglioExport(ByVal NomeFile As String,
        ...
        Try
            ...
            If TipoRisorsa <> "" Then
                stb.AppendLine(" AND Upper(TipoRisorsa) = '" & UCase(TipoRisorsa) & "' ")
            End If
            ...
            If filtroCategorieAltroInterscambio <> "" Then
                ...
                If prefissoFito IsNot Nothing Then
                    ...
                    If prefissoFito <> "" Then
                        'Se c'è prefisso
                        stb.AppendLine("                       inter.[Cod_Prodotto_" & suffissoColonnaAltro & "] LIKE '" & prefissoFito & "%' ")
                        stb.AppendLine("                       AND ISNUMERIC(SUBSTRING(inter.[Cod_Prodotto_" & suffissoColonnaAltro & "], LEN('" & prefissoFito & "') + 1, LEN(inter.[Cod_Prodotto_" & suffissoColonnaAltro & "]) - LEN('" & prefissoFito & "'))) = 1 ")
                    Else
