...
Public Class PDC_Analisi_R
    ...
    Public Function LeggiAnalisixUtente(ByVal xFiltroAggiuntivo As String,
        ...
        Try
            ...
            StrSQL.AppendLine("     PDC_Analisi.PDC_Stato_Validazione, PDC_Analisi.Cod_Risum, PDC_Analisi.Analisi_Tipologia_Cod, REPLACE(PDC_Analisi.Altre_Molecole,'___',', ') AS Altre_Molecole, ")
    ...
    Public Function LeggiAnalisixMailZoo(ID_PDC_Testata As Integer,
        ...
        Try
            ...
            stb.AppendLine(" LEFT JOIN Fabbricati ON PDC_Testata.PivaOwner = Fabbricati.Piva AND PDC_Testata.Sa_CodOwner = Fabbricati.Sa_Cod AND PDC_Testata.Fabbricato_CodOwner = Fabbricati.Fabbricato_Cod	")
...
#Region "Scrivi"
    ...
    Public Function Scrivi(ByVal ID_PDC_Testata As Integer,
        ...
        Try
            ...
            StrSQL.AppendLine("         Analisi_Tipologia_Tipo, Altre_Molecole_Cod, PDC_Stato_Validazione ")
