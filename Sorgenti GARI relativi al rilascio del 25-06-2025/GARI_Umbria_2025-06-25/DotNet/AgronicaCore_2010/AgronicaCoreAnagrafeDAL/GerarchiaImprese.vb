...
Public Class GerarchiaImprese_R
    ...
    Public Function Ricava_Stringa_PivePadre(ByVal Figlio As String,
        ...
        Dim NomeRoutine As String = "AnagrafeCoreAnagrafeDAL.GerarchiaImprese_R.Ricava_Stringa_PivePadre()"
    ...
    Public Function Ricava_Stringa_PivePadre_Ricorsivo(ByVal Figlio As String,
        ...
        Dim NomeRoutine As String = "AnagrafeCoreAnagrafeDAL.GerarchiaImprese_R.Ricava_Stringa_PivePadre_Ricorsivo()"
    ...
    Public Function Numero_Cooperative(ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri) As Integer
        ...
        Dt = Leggi("", 2, AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaDatiMinimi, "", "", objParametri)
    ...
    Public Sub LeggiFigliNodoGerarchiaImprese(ByVal Nodo As String,
        ...
        DT = Leggi(CStr(Nodo), 0, AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta, "", "", objParametri)
    ...
    Public Sub LeggiFigliNodoGerarchiaImprese_conDettagli(ByVal Piva As String,
        ...
        DT = Leggi(CStr(Piva), 0, AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_JoinCompleta, "", "", objParametri)
    ...
    Function LeggiPadre(piva As String, objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri, ByRef Rag_Soc_Padre As String) As String
        Dim dt As DataTable = Leggi("", 0, AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta,
    ...
    Public Function LeggiGerarchiaDaCapostipiti(
        ...
        Try
            ...
            Select Case selezioneVariabile
                ...
                Case Else
                    StrSQL.AppendLine(" SELECT gerarchia.*, imprese.* ")
                    StrSQL.AppendLine(" FROM (SELECT DISTINCT * FROM imprese_figlie) gerarchia ")
                    StrSQL.AppendLine(" LEFT JOIN imprese ON imprese.piva = gerarchia.Figlio ")
...
Public Class GerarchiaImprese_W
    ...
    Public Function Cancella(
        ...
        Try
            ...
            '---------------------------------------------
            If objParametri_server.FlagCancellazioneLogica = AgronicaCoreDataProvider.AgronicaCoreParametri.enumCancellazioneLogica.CancellazioneLogica Then
