...
Public Class CentriAziendali_Read
        ...
        Try
            Select Case xSelezioneVariabile
                ...
                Case AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_JoinDescrizioni
                    StrSQL.Length = 0
                    StrSQL.AppendLine(" SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED;")
                    StrSQL.Append(" SELECT (Centri_Aziendali.piva + '_' +  cast(Centri_Aziendali.sa_cod as nvarchar(10))) as chiave,    Centri_Aziendali.*, Imprese.Rag_Soc, CentrixIndirizzi.Tipo_Indirizzo, ")
                    ...
                    StrSQL.Append("                         WHERE   Centri_Aziendali_Codici.piva = Centri_Aziendali.piva AND Centri_Aziendali_Codici.SA_COD = Centri_Aziendali.sa_cod AND Centri_Aziendali_Codici.id_cod = " + CStr(enum_CodiciAnagrafe.TitoloPossesso) + "), '1') AS Titolo_Possesso ")
                    StrSQL.Append("  ,(select [User] from utenti where CODICE_FISCALE = imprese.Username_Modifica ) as utente_modifica ")
                    StrSQL.Append(" FROM  Centri_Aziendali ")
                    StrSQL.Append(" INNER JOIN Imprese  ON Imprese.PIVA = Centri_Aziendali.PIVA ")
                    StrSQL.Append(" INNER JOIN CentrixIndirizzi  ON CentrixIndirizzi.PIVA = Centri_Aziendali.PIVA AND CentrixIndirizzi.sa_cod = Centri_Aziendali.sa_cod ")
                    StrSQL.Append(" INNER JOIN Indirizzi ON Indirizzi.cod_indirizzo = CentrixIndirizzi.cod_indirizzo ")
    ...
    Public Function Leggi_CentriXImprese(piva As String,
        ...
        Try
            ...
            If piva <> "" Then
                StrSQL.AppendLine(" WHERE Imprese.Piva = '" & piva & "' ")
...
Public Class CentriAziendali_Write
    ...
    Private Function AggiornaUtentiProfili(ByRef objParametri_server As AgronicaCoreDataProvider.AgronicaCoreParametri,
        ...
        Try
            ...
            Dim strFiltro As String = " (Descrizione_2 like '%GerarchiaImprese.Padre = ''" & PivaPadre & "''%' OR Descrizione_2 like '%GerarchiaImprese.Padre = ''" & Piva & "''%' OR Descrizione_2 like '%Imprese.piva = ''" & Piva & "''%') "
