...
Optional ByVal BZ_VegNatNonColt As Decimal = -1,
    ...
    Public Function Appezza_Blocca(ByVal Piva As String,
        ...
        Try
            ...
            strSql.AppendLine(" WHERE  Piva = '" & Trim(Piva) & "'")
...
Public Class Appezzamento_Read
    ...
    Public Function LeggiAppezzamentiConCatastoSovrapposto(ByVal Piva As String,
        ...
        Try
            ...
            stb.AppendLine("  ")
            stb.AppendLine(" set @piva = '" & Piva & "' ")
            stb.AppendLine(" set @sa_cod = 	 " & Sa_Cod)
            stb.AppendLine(" set @appezza =  " & Appezza)
            stb.AppendLine("  ")
    ...
    Public Function LeggiConCodiceCliente(ByVal Piva As String,
        ...
        Try
            ...
            stb.AppendLine("         And ac.id_cod = " & id_cod_cliente_2000)
        ...
        Try
            Select Case xSelezioneVariabile
                ...
                Case enumSelezioneVariabile.Selezione_TabellaDatiMinimi
                    ...
                    If Sa_Cod <> 0 Then
                        StrSQL.Append(" AND Appezzamento.sa_Cod = " & Sa_Cod & " ")
                    End If

                    If Appezza <> 0 Then
                        StrSQL.Append(" AND Appezzamento.Appezza = " & Appezza & " ")
                    End If
                ...
                Case enumSelezioneVariabile.Selezione_TabellaCompleta
                    ...
                    If Sa_Cod <> 0 Then
                        StrSQL.AppendLine("     AND Appezzamento.sa_Cod = " & Sa_Cod & " ")
                    End If

                    If Appezza <> 0 Then
                        StrSQL.AppendLine("     AND Appezzamento.Appezza = " & Appezza & " ")
                    End If
    ...
    Public Function Leggi_x_GUID(ByVal GUID As String,
        ...
        Try
            ...
            If GUID <> "" Then
                StrSQL.AppendLine("     AND Appezzamento.Via_Stringa = '" & GUID & "' ")
            End If
    ...
    Public Function Leggi_x_anagrafica(ByVal Piva As String,
        ...
        Try
            ...
            If Campo_Cod <> 0 Then
                StrSQL.AppendLine(" AND Appezzamento.Campo_Cod = " & Campo_Cod & " ")
            End If
        ...
        Try
            Select Case xSelezioneVariabile
                ...
                Case enumSelezioneVariabile.Selezione_JoinCompleta
                    ...
                    If Sa_Cod <> 0 Then
                        stb.AppendLine(" AND Appezzamento.sa_Cod = " & Sa_Cod & " ")
                    End If

                    If CampoCod <> 0 Then
                        stb.AppendLine(" AND Appezzamento.Campo_Cod = " & CampoCod & " ")
                    End If
    ...
    Public Function Recupera_Superfici_Campo(ByVal Piva As String,
        ...
        Try
            ...
            StrSQL.Append(" WHERE   (Appezzamento.PIVA = '" & Piva & "')  ")
            StrSQL.Append(" AND     (Appezzamento.SA_COD = " & Sa_Cod & ")  ")
            StrSQL.Append(" AND     (Appezzamento.Campo_Cod = " & Campo_Cod & ") ")
        ...
        Try
            ...
            StrSQL.Append(" WHERE   (CampiXParticelle.PIVA = '" & Piva & "')  ")
            StrSQL.Append(" AND     (CampiXParticelle.SA_COD = " & Sa_Cod & ")  ")
            StrSQL.Append(" AND     (CampiXParticelle.Campo_Cod = " & Campo_Cod & ") ")
        ...
        Try
            Select Case xSelezioneVariabile
                ...
                Case enumSelezioneVariabile.Selezione_JoinDescrizioni
                    ...
                    '---------------------------------------------
                    StrSQL.Length = 0
                    StrSQL.Append(" SELECT Appezzamento.Piva, Appezzamento.Sa_Cod, Appezzamento.Appezza, Appezzamento.App_Nome, ")
                    StrSQL.Append(" Appezzamento.Sup_App, Appezzamento.Validita_Inizio as Validita_Inizio_Appezzamento,Appezzamento.Validita_Fine as Validita_Fine_Appezzamento, ")
                    StrSQL.Append(" Reg_Impianti.Id_Reg ,  Reg_Impianti.Sup_Imp ,Reg_Impianti.Validita_Inizio as Validita_Inizio_Impianti,Reg_Impianti.Validita_Fine as Validita_Fine_Impianti,  Cultivar.Cul_Des, SpecieVegetali.Veg_Des   FROM Appezzamento ")
                    StrSQL.Append(" INNER JOIN Reg_Impianti ON (Appezzamento.Piva = Reg_Impianti.Piva and Appezzamento.Sa_Cod = Reg_Impianti.Sa_Cod and Appezzamento.Appezza = Reg_Impianti.Appezza) ")
                    ...
                    If xOrderBy <> "" Then
                        StrSQL.Append(" ORDER BY " & Agro_SQL_Save_xOrderBy(xOrderBy, objParametri))
                    Else
                        StrSQL.Append(" ORDER BY  Veg_des, Cul_Des, Validita_Inizio_Impianti ")
                    End If
    ...
    Public Function LeggiSuperficieAppezzamentoBio(ByVal Piva As String,
        ...
        Try
            ...
            If Piva <> "" Then
                StrSQL.Append(" AND  Appezzamento.Piva = '" & Trim(Piva) & "'")
            End If

            If Numero_Appezza_Bio <> "" Then
                StrSQL.Append(" AND  Val_Cod = '" & Trim(Numero_Appezza_Bio) & "'")
            End If
    ...
    Public Function LeggiDaCampoconCatasto(ByVal Piva As String,
        ...
        Try
            ...
            If CampoCod <> 0 Then
                StrSQL.Append(" AND Appezzamento.Campo_Cod = " & CampoCod & " ")
            End If
    ...
    Public Function LeggixReportPianoColturale(ByVal Padre As String,
        ...
        Try
            ...
            If Padre <> "" Then
                ...
                filtroPivaPadre = "'" & Padre & "'"

                If includiAziendeFiglie = 1 Then

                    StrSQL.AppendLine(" select figlio from GerarchiaImprese where padre = '" & Padre & "'")
                    '-------------------------------------------------------------------------------
    ...
    Public Function LeggiPerAggiornamentoPendenza(ByRef objParametri As AgronicaCoreParametri) As DataTable
        ...
        Try
            ...
            StrSQL.Length = 0
            StrSQL.AppendLine(" SELECT Appezzamento.Piva, Appezzamento.Sa_Cod, Appezzamento.Appezza, e.Entita_Cod ")
            StrSQL.AppendLine(" FROM  Appezzamento ")
            ...
            StrSQL.AppendLine(" WHERE Appezzamento.Validita_inizio <= " & Agro_SQL_SaveDate(Date.Now) & " ")
