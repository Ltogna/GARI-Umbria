...
#Region "Funzioni private"
    ...
    Private Function LeggiScalare_Centro_Azienda_SuperUser(ByVal piva As String,
        ...
        Try
            ...
            Dim dtGuida = LeggiGuidaImpostazioneCod(impostazione_cod, objParametri_Server)
            ...
            If Not String.IsNullOrWhiteSpace(piva) Then
                ...
                ElseIf flagAziendaCentro AndAlso flagAzienda Then
                    ...
                    strImpostazione_Valore = LeggiScalare_Centro_Azienda(piva, sa_cod, impostazione_cod, objParametri_Server)
                ElseIf flagAzienda Then
                    Dim tuttiICentri = 0
                    strImpostazione_Valore = LeggiScalare_Centro_Azienda(piva, tuttiICentri, impostazione_cod, objParametri_Server)
                End If
            ...
            If flagSuperUser AndAlso String.IsNullOrEmpty(strImpostazione_Valore) Then
                ...
                Dim dt = objUtente.Leggi(impostazione_cod, 2, enumSelezioneVariabile.Selezione_TabellaCompleta, "", "", objParametri_Utenti)
