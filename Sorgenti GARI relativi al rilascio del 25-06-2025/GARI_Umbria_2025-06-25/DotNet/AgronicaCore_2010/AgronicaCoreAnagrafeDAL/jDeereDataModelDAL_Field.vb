    ...
    Public Function LeggiConSincronizzazioneAppezzamenti(
        ...
        Try
            ...
            If xFiltroAggiuntivoJohnDeere <> "" Then
                Stb.Append(" AND " & xFiltroAggiuntivoJohnDeere)
            End If


            If xOrderByJohnDeere <> "" Then
                Stb.Append(" ORDER BY " & xOrderByJohnDeere)
            End If
            ...
            Stb.AppendLine("     select * ")
            Stb.AppendLine("     from jDeereDataModel_EntitaGIAS JDG ")
            Stb.AppendLine("     where JDG.piva = '" & piva & "' ")

            If sa_Cod <> 0 Then
                Stb.AppendLine(" and JDG.sa_cod = " & sa_Cod & " ")
            End If

            If appezza <> 0 Then
                Stb.AppendLine(" and JDG.appezza = " & appezza & " ")
            End If
            ...
            If xFiltroAggiuntivoJohnDeere2 <> "" Then
                Stb.Append(" AND " & xFiltroAggiuntivoJohnDeere2)
            End If


            If xOrderByJohnDeere2 <> "" Then
                Stb.Append(" ORDER BY " & xOrderByJohnDeere2)
            End If
