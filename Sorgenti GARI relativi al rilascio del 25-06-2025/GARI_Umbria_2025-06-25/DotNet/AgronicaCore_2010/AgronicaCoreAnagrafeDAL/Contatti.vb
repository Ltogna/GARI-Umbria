...
Public Class Contatti_R
    ...
    Public Function LeggiVivaioPrenotazionePiante(
        ...
        Try
            ...
            stb.AppendLine("  AND    ( (Contatti.Sa_Cod = -1)           OR  (Contatti.Piva = '" & Piva & "')          )  AND     (Rapporti_Contabili.Cod_Rapporto = -17)    ")
    ...
    Public Function Contatti_Contatto_Leggi(ByVal Piva As String,
        ...
        Try
            ...
            If FlagIndirizzi Then
                ...
                StbSQL.Append("          FROM        ACCDAA_ANAG_T005_TabellaCodiciPaesiTerziISO3166 ")
                ...
                StbSQL.Append(" , cast(( ISNULL ((SELECT TOP 1   Descrizione  ")
                StbSQL.Append("          FROM        ACCDAA_ANAG_T004_TabellaCodiciStatiMembri ")
    ...
    Public Function leggi_x_anagrafica2(ByVal Piva As String,
        ...
        Try
            ...
            StbSQL.Append(" Risorse_Umane.Validita_Inizio, Risorse_Umane.Validita_Fine, Risorse_Umane.Settore_Des, Rapporti_Contabili.Rapporto_Des, " & vbCrLf)
