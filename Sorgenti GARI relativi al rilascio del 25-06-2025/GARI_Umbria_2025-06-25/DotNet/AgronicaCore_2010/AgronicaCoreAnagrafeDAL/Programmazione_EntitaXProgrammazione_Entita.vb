...
Public Class Programmazione_EntitaXProgrammazione_Entita_W
    ...
    Public Function CancellaPerEntitaFrom(
        ...
        Try
            ...
            Stb.Append(" WHERE ")
            Stb.Append("       [Piva_SuperUser_From] = '" & Piva_SuperUser_From & "' " & vbCrLf)
            Stb.Append("   AND [TipoRelazione] = " & TipoRelazione & " " & vbCrLf)
            Stb.Append("   AND [Programmazione_Entita_Cod_From] =  " & Programmazione_Entita_Cod_From & vbCrLf)
            '---------------------------------------------
