...
Public Class AlberoAnagraficaFaster_R
    ...
    Public Function LeggiViaJsonSQL(
        ...
        Try
            ...
            JsonTestata("Utente", testoUtente, AgronicaCoreDataProvider.Albero.Albero_Icone.IconaUtente, Stb)

            Stb.AppendLine("  , ( ")
            Stb.AppendLine("  select  ")

            JsonDettaglio(-1, "'{Impresa} : ' + i.rag_soc", "''", "'" & AgronicaCoreDataProvider.Albero.Albero_Icone.IconaImpresa & "'", QImpresa, Stb)
