...
Public Class EFReg_Impianti
    ...
    Public Shared Function Impianto_Scrivi_EF(ByVal dati_impianto As AgronicaCoreModelsSTD.anagrafiche.Impianto,
        ...
        'Lavez - 27/05/2025 - Log verboso
        If LogVerbose Then
            logprovder.Scrivi_LOG(objParametriServer, nomeRoutine, "Dopo di CentroExist e prima di AppezzamentoExist", False)
        End If
    ...
    Public Shared Sub ScriviModificaEliminaDestinazioneUsoxImpianto(ByVal piva As String,
    ...
    Public Shared Sub ScriviModificaEliminaxImpianto(ByVal piva As String,
                                                     ByVal saCod As Integer,
                                                     ByVal appezza As Integer,
                                                     ByVal idReg As Integer,
                                                     ByVal idCod As Integer,
