    ...
    Private Sub LeggiAppezzamenti_Da_ParticelleGIS_GetQuery(
        ...
        If LeggiDettagliKendoGrid Then
            ...
            If TipoQuery <> enum_ParticelleAppezza_TipoQuery.ParticelleSenzaRiparto Then
                ...
                stb.AppendLine("")
                stb.AppendLine("	ISNULL(")
                stb.AppendLine("		CASE WHEN MetodoProd.val_Cod = " & enum_MetodoProduzione.Biologico & " THEN 'Biologico' ELSE")
                stb.AppendLine("			CASE WHEN MetodoProd.val_Cod = " & enum_MetodoProduzione.InConversione & " THEN 'In Conversione' ELSE")
                stb.AppendLine("				CASE WHEN MetodoProd.val_Cod = " & enum_MetodoProduzione.Convenzionale & " THEN 'Integrato' ELSE")
                stb.AppendLine("					NULL")
                stb.AppendLine("				END")
                stb.AppendLine("			END")
                stb.AppendLine("		END, ''")
        ...
        If LeggiDettagliKendoGrid Then
            ...
            If TipoQuery <> enum_ParticelleAppezza_TipoQuery.ParticelleSenzaRiparto Then
                ...
                stb.AppendLine($"		AND cacDettalioSpeciePersonalizzato.Argomento_Cod = {Agro_SQL_SaveNum(enum_CAC_Codifica_InfoAggiuntive_ArgomentoCod.DettaglioSpeciePersonalizzato)}")
