...
Public Class Programmazione_Particelle_R
    ...
    '################################################################################
    Public Function Programmazione_Particelle_Leggi(
                                                ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri,
                                                ByVal Piva As String,
        ...
        Try
            ...
            StrSQL.AppendLine(" SELECT DISTINCT Programmazione_Particelle.*, ")
            StrSQL.AppendLine("         ISNULL(ISTAT.COMUNI_PROV,'') AS Prov_Des, ISNULL(ISTAT.LOCALITA,'') AS Com_Des, ")
            ...
            StrSQL.AppendLine(" FROM Programmazione_Particelle INNER JOIN")
            StrSQL.AppendLine(" ISTAT ON Programmazione_Particelle.Prov = ISTAT.PROV AND Programmazione_Particelle.Com = ISTAT.COM INNER JOIN")
            StrSQL.AppendLine(" ImpreseXParticelle ON Programmazione_Particelle.Prov = ImpreseXParticelle.PROV AND ")
            StrSQL.AppendLine(" Programmazione_Particelle.Com = ImpreseXParticelle.COM AND Programmazione_Particelle.Sezione = ImpreseXParticelle.SEZIONE AND ")
            StrSQL.AppendLine(" Programmazione_Particelle.Foglio = ImpreseXParticelle.FOGLIO AND Programmazione_Particelle.Numero = ImpreseXParticelle.NUMERO AND ")
            StrSQL.AppendLine(" Programmazione_Particelle.Subalterno = ImpreseXParticelle.SUBALTERNO ")

            StrSQL.AppendLine(" INNER JOIN ParticelleCatastali ON Programmazione_Particelle.Prov = ParticelleCatastali.PROV AND ")
            StrSQL.AppendLine(" Programmazione_Particelle.Com = ParticelleCatastali.COM AND Programmazione_Particelle.Sezione = ParticelleCatastali.SEZIONE AND ")
            StrSQL.AppendLine(" Programmazione_Particelle.Foglio = ParticelleCatastali.FOGLIO AND Programmazione_Particelle.Numero = ParticelleCatastali.NUMERO AND ")
            StrSQL.AppendLine(" Programmazione_Particelle.Subalterno = ParticelleCatastali.SUBALTERNO ")
