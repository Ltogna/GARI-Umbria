...
Public Class Zoo_Animali
    ...
    Public Sub Scrivi(ByRef zooAnimale As AgronicaCoreEntityFramework_POCO.Zoo_Animali,
        ...
        Try
            ...
            Dim log = objLogAnagrafeW.CreaLogAnagrafeEF(enum_TipoEntita_Des.ZooAnimali,
                                                        zooAnimale.PIVA, CStr(zooAnimale.sa_cod),
                                                        CStr(zooAnimale.Cod_Progetto), Nothing,
                                                        Nothing, Nothing,
    ...
    Public Function Leggi_Giacenze(Piva As String,
                                   ...
                                   Optional ByVal leggiUltimaPesata As Boolean = False) As DataTable
        ...
        Try
            ...
            stb.Length = 0
            Dim agn_TT = CreaAgn_TT(Piva, Sa_Cod, STA_NUM, Cod_Animale, Data, objParametri, bAll, Filtro_Visibilita_Utente, listCod_Animali, filtraGiacenze1, IDTestataTemp)
            stb.AppendLine(agn_TT)
            Dim giac_TT = CreaGiac_TT(Piva, Sa_Cod, STA_NUM, filtraGiacenze1, mostraAnomalie)
            ...
            If mostraPesate Then
                ...
                stb.AppendLine("  , ROUND(((DATEDIFF(day, COALESCE(min_pesate_ct.Data_Peso, CONVERT(datetime, '1900-01-01 00:00:00.000', 120)), " & Agro_SQL_SaveDate(Data, False) & ")) * Zoo_Animali.Incremento_Teorico) + min_pesate_ct.Qta, 2) AS Incremento_Teorico_Calcolato ")
            End If
            If mostraAnomalie Then
                stb.AppendLine("   , COALESCE(anomalie_ct.Anomalie, '') as Anomalie ")
                stb.AppendLine("   , COALESCE(anomalie_ct.Anomalie_Str, '') as Anomalie_Str ")
    ...
    Private Function crea_trattamenti_cte(Piva As String,
        ...
        stb.AppendLine(" 	AND CAST(Agenda.Validita_Fine as Date) <= " & Agro_SQL_SaveDate(Data) & " ")
    ...
    Public Function Leggi_Stazionamento_Capi(Piva As String,
        ...
        Try
            ...
            stb.AppendLine("   , DATEDIFF(day, Zoo_Animali.Validita_Inizio, " & Agro_SQL_SaveDate(Data, False) & ") as giorni_stalla ")
    ...
    Public Function OttieniDatiNogmo(ByVal listCod_Animali As List(Of String), ByRef objParametri As AgronicaCoreParametri) As DataTable
        ...
        Try
            ...
            stb.AppendLine("	SELECT Contatti.Cod_Contatto, Contatti.Rag_Soc, Contatti.Nome, Contatti.Cognome, ISTAT.LOCALITA, Indirizzi.frz_des, Rubrica.numero ")
            ...
            stb.AppendLine("    co.Rag_Soc, co.Nome, co.Cognome, co.numero, co.frz_des, co.LOCALITA ")
    ...
    Public Function Leggi_Somministrazioni_Sincro(ByVal Piva As String,
        ...
        Try
            ...
            stb.AppendLine("SELECT rzxa.Id_Ricetta, rzxa.Id_RigaRicetta, rzxa.Id_Agenda, ").
                ...
                AppendLine("    rz.Gruppo_Ricetta, rz.ProtocolloCodice AS Prot_Numero, rz.Id_Protocollo, ").
                AppendLine("    rza.Numero_Somm, rza.Note, ").
            ...
            stb.AppendLine("WHERE 1=1 ").
                ...
                AppendLine("    AND rz.TipoCodice = '" & Agro_SQL_SaveText(enum_TipoPrescrizione.Da_Protocollo_GIAS) & "' ")
