...
Public Class ParticelleCatastali_R
        ...
        Try
            ...
            Select Case xSelezioneVariabile
                ...
                Case enumSelezioneVariabile.Selezione_TabellaCompleta
                    ...
                    Stb.AppendLine($"    , case when appXp.{NomeCampoArea}  is null then 0 else -1*(100 - round( ( (")
    ...
    Public Function Anagrafica_Particelle_Leggi_Per_Centri(ByVal ListaCentri As List(Of (String, Integer)),
        ...
        Try
            ...
            StrSQL.AppendLine(" SELECT IXP.PROV,    ")
    ...
    Public Function InserisciParticelleDaGIS(
        ...
        Try
            ...
            If AgronicaCoreDataProvider.Agro_Sequenze.CheckAllowAppSettingsFlagUseSequence() Then
                Stb.Append("    dense_rank() over (order by Entita.entita_cod) + isnull( (SELECT current_value FROM sys.sequences WHERE name = 'Sequence_particelleCatastali'), 0)  as PART_COD   " & vbCrLf)
            Else
            ...
            Stb.Append("    ,cast(g.poligono_Geoentity.STArea()/@Conversione as int) as Ettari " & vbCrLf)
            Stb.Append("    ,substring(cast(abs(cast(g.poligono_Geoentity.STArea()/@Conversione as int) - g.poligono_Geoentity.STArea()/@Conversione) as varchar(100)), 3,2) as Are " & vbCrLf)
            Stb.Append("    ,substring(cast(abs(cast(g.poligono_Geoentity.STArea()/@Conversione as int) - g.poligono_Geoentity.STArea()/@Conversione) as varchar(100)), 5,2) as Centiare " & vbCrLf)
