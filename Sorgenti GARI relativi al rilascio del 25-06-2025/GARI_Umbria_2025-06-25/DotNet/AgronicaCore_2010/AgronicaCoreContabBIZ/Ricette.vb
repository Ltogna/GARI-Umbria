                ...
                Try
                    ...
                    For Each elem As APP_Ricette_Operazioni In listaOperazioniApp_filtrata
                        ...
                        esito = ro_W.Scrivi(Ricetta_Cod, Ricetta_Operazione_Cod, elem.Lav_Cod, elem.Ricetta_Operazione_Des, elem.Note,
                                                ...
                                                elem.W_Anagrafica_Stati_Cod, elem.Ricetta_Operazione_Cod_RIF, elem.ID, elem.Invia_App, Raccoglitore_Cod:=Raccoglitore_Cod)
                    ...
                    For Each elem As APP_Ricette_Dettaglio_Tecnico In listaTecnicoApp_filtrata
                        ...
                        esito = rtec_W.Scrivi(Ricetta_Cod, Ricetta_Operazione_Cod, Ricetta_Dettaglio_Cod, 0, Ricetta_Tecnico_Cod, elem.Qta_Ril, elem.Av_Cod,
                                                   ...
                                                   0, 0, 0, 0, "", 0,
                                                   1, "", elem.Piezo1, elem.piezo2, elem.piezo3, elem.piezo4,
