            ...
            If dt.Rows.Count < 3 Then
                ...
                If dt.Rows.Count < 3 Then
                    ...
                    If primoAssente Then
                        ...
                        dtRow.Item("Tipologia_Attivita_Desc") = "Gruppo Attivita 1"
                        dt.Rows.Add(dtRow)
                    End If
                    If secondoAssente Then
                        dtRow = dt.NewRow
                        dtRow.Item("Tipologia_Attivita") = 2
                        dtRow.Item("Tipologia_Attivita_Desc") = "Gruppo Attivita 2"
                        dt.Rows.Add(dtRow)
                    End If
                    If terzoAssente Then
                        dtRow = dt.NewRow
                        dtRow.Item("Tipologia_Attivita") = 3
                        dtRow.Item("Tipologia_Attivita_Desc") = "Gruppo Attivita 3"
                        dt.Rows.Add(dtRow)
                    End If
