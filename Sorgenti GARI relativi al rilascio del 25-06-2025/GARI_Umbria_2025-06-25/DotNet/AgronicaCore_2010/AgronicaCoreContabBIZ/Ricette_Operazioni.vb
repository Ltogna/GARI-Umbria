        ...
        If XML_DatiNote IsNot Nothing Then
            ...
            For i = 0 To XMLs_Note.Count - 1
                ...
                strRicetta = objXml.XML_RicettaxNote_2(enum_TipoOperazioneDB.Scrittura,
                                          ...
                                          XML_Nota.GetAttribute("validita_fine"))
            ...
            Select Case Cau_Mov
                ...
                Case CAU_LAVORAZIONE,
                    ...
                    strOperazione = objXml.XML_Ricetta_Operazione(CInt(enum_TipoOperazioneDB.Scrittura),
                                                                  ...
                                                                  invia_app,
                                                                  Invia_HubIoT,
                                                                  Data_Creazione, Username_Creazione)
...
Public Class Ricette_Operazioni_W
    ...
    Public Function Update_APP_Ricetta_Operazione_ID(Ricetta_Cod As Integer,
        ...
        xRisp = objW.Update_APP_Ricetta_Operazione_ID(Ricetta_Cod, APP_Ricetta_Operazione_ID, objParametri_Server)
