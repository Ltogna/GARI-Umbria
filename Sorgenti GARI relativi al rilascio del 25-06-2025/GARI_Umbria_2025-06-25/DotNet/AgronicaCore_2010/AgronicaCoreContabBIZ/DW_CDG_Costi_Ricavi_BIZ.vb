...
Public Class DW_CDG_Costi_Ricavi_BIZ
    ...
    Public Function Leggi_Tabellone_DW(ByVal _aziende As String,
        ...
        c = New ColonneNome("Mezzo_Des", "UdM", "string")
        c._Filtrabile = True
        c._FiltrabileConCheck = True
        c._Display = True
        l.Add(c)
        ...
        c = New ColonneNome("Ordine_Attivita", "Ordine attivita", "string")
        c._Editabile = False
        c._Filtrabile = True
        c._FiltrabileConCheck = True
        c._Display = False
        ...
        c = New ColonneNome("Piva_Padre", "Partita Iva azienda principale", "string")
        c._Editabile = False
        c._Filtrabile = True
        c._FiltrabileConCheck = True
        c._Display = False
        ...
        c = New ColonneNome("Azienda_Padre", "Azienda principale", "string")
        c._Editabile = False
        c._Filtrabile = True
        c._FiltrabileConCheck = True
        c._Display = False
        ...
        If Not String.IsNullOrEmpty(_aziende) Then
            ...
            For Each piva In Aziende
                If msgErrore <> "" Then
                    msgErrore &= "<br/>"
                End If
                msgErrore &= scrivi_BIZ.AllineaCosti_BombardinoMultiploVisite(piva, objParametri_Server)
            Next
        End If
        ...
        Try
            ...
            If tipoCdG = enum_TipoCdG.NuovoTipo Then
                ...
                If budget = 0 And EseguiMotorino Then
                    ...
                    scrivi_BIZ.AllineaCosti_BombardinoMultiploVisite(piva, objParametri_Server)
                End If
                ...
                Select Case id_report
                    ...
                    Case 1
                        ...
                        If dr_search.Length <> 0 Then
                            ...
                            Filtro_Piva = Filtro_Piva & IIf(Filtro_Piva = "", "", ", ") & "'" & _azienda & "'"
                        ...
                        For Each dr As DataRow In dtCostiRicavi.Rows
                            ...
                            If InStr(Filtro_Piva, "'" & Piva & "'") = 0 Then
                                ...
                                Filtro_Piva = Filtro_Piva & IIf(Filtro_Piva = "", "", ", ") & "'" & Piva & "'"
