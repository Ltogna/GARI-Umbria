...
#Region "Ultime Aziende Selezionate, Scrittura e Lettura"
    ...
    Public Function aggiornaAttivitaNavigazioneAziende(ByVal InData As Object) As rispostaStandard(Of String)
        ...
        Dim objParametri_SuperServer As AgronicaCoreDataProvider.AgronicaCoreParametri = objParametri.Super_Server
        Dim objParametri_Server As AgronicaCoreDataProvider.AgronicaCoreParametri = objParametri.Server
        Dim objParametri_Utenti As AgronicaCoreDataProvider.AgronicaCoreParametri = objParametri.Utenti
        ...
        Try
            ...
            Dim dtUtenteImpostazione = impostazioniUtentiRead.Leggi(TipiEnumerativi.enum_Impostazioni_Utenti.UTENTE_MENU_NUMERO_ULTIME_AZIENDE_SELEZIONATE_DA_VISUALIZZARE, 1, AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta, "", "", objParametri_Utenti)


            If (Not IsNothing(dtUtenteImpostazione) And (dtUtenteImpostazione.Rows.Count > 0)) Then
            ...
            Else
                ...
                impostazioniUtentiWrite.Scrivi(TipiEnumerativi.enum_Impostazioni_Utenti.UTENTE_MENU_NUMERO_ULTIME_AZIENDE_SELEZIONATE_DA_VISUALIZZARE,
    ...
    Public Function ultimeAziendeSelezionate(ByVal InData As Object) As rispostaStandard(Of List(Of Impresa))
        ...
        Try
            ...
            rispostaDati = dati.Select(Function(azienda) New Impresa With {.ragioneSociale = azienda.Item("rag_soc"), .partitaIva = azienda.Item("piva")}).ToList()
    ...
    Public Function aggiornaNumeroDiOperazioniAzienda(ByVal InData As Object) As rispostaStandard(Of String)
        ...
        Try
            ...
            letturaPreferiti.Cancella(TipiEnumerativi.enum_Impostazioni_Utenti.UTENTE_MENU_NUMERO_ULTIME_AZIENDE_SELEZIONATE_DA_VISUALIZZARE,
                                                       "",
                                                       objParametri_Utenti)

            letturaPreferiti.Scrivi(TipiEnumerativi.enum_Impostazioni_Utenti.UTENTE_MENU_NUMERO_ULTIME_AZIENDE_SELEZIONATE_DA_VISUALIZZARE,
...
#Region "Preferiti"
    ...
    Public Function aggiornaPreferiti(ByVal InData As Object) As rispostaStandard(Of String)
        ...
        Try
            ...
            letturaPreferiti.Cancella(TipiEnumerativi.enum_Impostazioni_Utenti.UTENTE_LINK_PREFERITE_MENUBS2017,
                                                       "",
                                                       objParametri_Utenti)

            letturaPreferiti.Scrivi(TipiEnumerativi.enum_Impostazioni_Utenti.UTENTE_LINK_PREFERITE_MENUBS2017,
                                                       stringaPreferiti,
                                                       "",
                                                       "",
                                                       "",
...
#Region "alberoMenu"
    ...
    Public Function LeggiAlberoMenu(ByVal InData As Object) As rispostaStandard(Of AlberoMenu)
        ...
        Try
            ...
            Dim dtPreferiti = letturaPreferiti.Leggi(TipiEnumerativi.enum_Impostazioni_Utenti.UTENTE_LINK_PREFERITE_MENUBS2017, 1, AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta, "", "", objParametri_Utenti)
            ...
            Dim dtPresetIniziale = letturaPreferiti.Leggi(TipiEnumerativi.enum_Impostazioni_Utenti.UTENTE_LINK_PREFERITE_MENUBS2017, 2, AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta, "", "", objParametri_Utenti)
            Dim menuPresetIniziale As New List(Of String)
            If (Not IsNothing(dtPresetIniziale) And (dtPresetIniziale.Rows.Count > 0)) Then
...
#Region "ottieni Informazioni Assistenza/Utente"
    ...
    Public Function ottieniInformazioneUtente(ByVal InData As Object) As rispostaStandard(Of Utente)
        ...
        Try
            ...
            If objParametri_Server.FinestraTemporaleInizio = AGRODATAINIZIO And objParametri_Server.FinestraTemporaleFine = AGRODATAFINE Then
