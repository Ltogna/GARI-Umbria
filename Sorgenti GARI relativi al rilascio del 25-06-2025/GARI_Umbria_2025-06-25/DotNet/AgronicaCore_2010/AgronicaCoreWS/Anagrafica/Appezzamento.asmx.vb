            ...
            If esitoPositivoScritturaAppezzamento Then
                ...
                If iData.InData.flag_cancellazione = False Then
                    ...
                    Dim obj_Appezzamento = objAppezzamento.Leggi_Appezzamento_Anagrafica(
                        iData.InData.primaryKey.centroAziendalePK.partitaIva,
                        iData.InData.primaryKey.centroAziendalePK.codice,
                        iData.InData.primaryKey.codice,
                        0,
                        True,
                        True,
                        True,
...
#End Region
    ...
    Private Sub Valorizzazione_Geojson_NodeInfo_Appezzamento(
        ByRef obj_Appezzamento As AgronicaCoreModelsSTD.anagrafiche.Appezzamento,
        ByVal iData As CoreWS_Generic(Of AgronicaCoreModelsSTD.anagrafiche.Appezzamento),
