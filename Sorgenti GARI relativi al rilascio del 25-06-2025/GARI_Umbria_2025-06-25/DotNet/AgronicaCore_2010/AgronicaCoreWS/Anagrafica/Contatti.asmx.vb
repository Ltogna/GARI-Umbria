...
Public Class Contatti
    ...
    <WebMethod()>
    <Script.Services.ScriptMethod()>
    Public Function Leggi_Contatti_APP(ByVal piva As String,
        ...
        Try
            ...
            xFiltroAggiuntivo += CStr(enum_Rapporti_Contabili_Standard.Dipendente)
            xFiltroAggiuntivo += ", "
            xFiltroAggiuntivo += CStr(enum_Rapporti_Contabili_Standard.Avventizio)
            xFiltroAggiuntivo += ")"
