...
Public Class Prodotti
    ...
    Public Function RicercaProdottiSenzaGiacenza_APP(ByVal objP_super_server As String,
        ...
        Return RicercaProdottiSenzaGiacenza(
            ...
            Elem_Cod, FiltroDescrizioneProdotto, Elenco_Specie, "", "IT")
...
#Region "Metodi normali"
        ...
        Select Case Elem_Cod
            ...
            Case FERTILIZZANTI, FORMULATI, INSETTI, TRAPPOLE, INNESCHI, SERVIZI, CostantiPersonalizzate.FARMACI
                ...
                CercaProdottiBancheDati(Dt_Categorie,
                                        ...
                                        FiltroCodiceProdotto,
                                        FiltroCodiceTrappola,
                                        ListaGruppiMercePerCategoria, inibisciVisibilitaGruppiMerce, Stato_Cod, w_veg_cod)
    ...
    Private Sub CercaProdottiBancheDati(ByVal Dt_Categorie As DataTable,
        ...
        'ma che hanno le loro classificazioni specifiche CLASS_COD IN (602,613,617).
        'Se invece devo caricare solo i formulati sull'APP escludo quelli con il CLASS_COD delle trappole

        Dim TipoRichiestoTabellaFormulato As Integer = 0

        If xGiasApp Then
            If Elem_Cod = TRAPPOLE Then
                Elem_Cod = FORMULATI
                TipoRichiestoTabellaFormulato = enum_TipoFormulato.InstallazioneTrappoleCattureMassa
    ...
    Private Sub ImpostaDatatableProdotti(ByRef dtProdotti As DataTable,
        ...
        For Each row In dtProdotti.Rows
            ...
            If CInt(row("sa_cod").ToString()) = -1 Then
                row("visibilita") = "Pubblico"
            Else
                row("visibilita") = "Privato"
            End If


            'Ottengo il Reg_Des
            Dim Reg_Cod = CInt(row("Reg_Cod").ToString())
            row("Reg_Des") = "Convenzionale (Reg. Nessuno)"


            If Reg_Cod = enum_Cod_Regolamento.Regolamento_bio Then
                row("Reg_Des") = "Biologico (Reg.CE 834/07 (Ex.Reg.CE 2092/91))"
            End If
            ...
            If Not dt_GruppoVarietale Is Nothing Then
                ...
                If Not TrovatoGruppoVarietale Is Nothing AndAlso TrovatoGruppoVarietale.Count = 1 Then
                    ...
                    If CInt(row("GRVA_COD_VEG").ToString()) < 0 Then
                        row("GRVA_COD_VEG_DES") = CStr(TrovatoGruppoVarietale(0)("Grva_Des") & " -- Ibrido")
                    Else
            ...
            row("EAN") = ""
            row("Barcode") = ""
            row("Produzione_Propria_Des") = "Prodotto Commercializzato"
            row("Peso_Netto") = 0
            ...
            If Not TrovatoProdotto_Extra_Privata Is Nothing AndAlso TrovatoProdotto_Extra_Privata.Count = 1 Then
                ...
                ElseIf CInt(TrovatoProdotto_Extra_Privata(0)("Produzione_Propria").ToString()) = enum_Tipo_Produzione.Produzione_Propria Then
                    row("Produzione_Propria_Des") = "Produzione Propria"
                End If
        ...
        l.Add(New ColonneNome("Cod_Articolo", "Codice", "string") With {._hidden = False, ._FiltrabileConCheck = True})

        l.Add(New ColonneNome("Prodotto_Cod", "Codice", "string") With {._hidden = True})
        l.Add(New ColonneNome("Prodotto_Des", "Descrizione", "string") With {._hidden = False, ._FiltrabileConCheck = True})

        l.Add(New ColonneNome("veg_cod", "veg_cod", "number") With {._hidden = True})
        l.Add(New ColonneNome("Veg_Des", "Specie", "string") With {._hidden = False, ._FiltrabileConCheck = True})

        l.Add(New ColonneNome("Cul_cod", "cul_cod", "number") With {._hidden = True})
        l.Add(New ColonneNome("Cul_Des", "Varietà", "string") With {._hidden = False, ._FiltrabileConCheck = True})

        l.Add(New ColonneNome("GRVA_COD_VEG", "GRVA_COD_VEG", "number") With {._hidden = True})
        l.Add(New ColonneNome("GRVA_COD_VEG_DES", "Tipologia Varietale", "string") With {._hidden = False, ._FiltrabileConCheck = True})

        l.Add(New ColonneNome("Sem_Cod", "Sem_Cod", "number") With {._hidden = True})
        l.Add(New ColonneNome("Sem_Des", "Tipologia Semente", "string") With {._hidden = False, ._FiltrabileConCheck = True})

        l.Add(New ColonneNome("Reg_Cod", "Reg_Cod", "number") With {._hidden = True})
        l.Add(New ColonneNome("Reg_Des", "Regolamento", "string") With {._hidden = False, ._FiltrabileConCheck = True})

        l.Add(New ColonneNome("sa_cod", "sa_cod", "number") With {._hidden = True})
        l.Add(New ColonneNome("visibilita", "Visibilità", "string") With {._hidden = False, ._FiltrabileConCheck = True})

        l.Add(New ColonneNome("Cat_Cod", "Cat_Cod", "number") With {._hidden = True})
        l.Add(New ColonneNome("Cat_Des", "Categoria Commerciale", "string") With {._hidden = False, ._FiltrabileConCheck = True})

        l.Add(New ColonneNome("Rag_Soc_Proprietaria", "Azienda Creazione", "string") With {._hidden = False, ._FiltrabileConCheck = True})

        l.Add(New ColonneNome("Data_Creazione", "Data Creazione", "date") With {._hidden = False, ._FiltrabileConCheck = False, ._formatNr = "{0:dd/MM/yyyy}"})

        l.Add(New ColonneNome("Data_Modifica", "Data Modifica", "date") With {._hidden = False, ._FiltrabileConCheck = False, ._formatNr = "{0:dd/MM/yyyy}"})

        l.Add(New ColonneNome("Utente_Creazione", "Utente Creazione", "string") With {._hidden = False, ._FiltrabileConCheck = True})

        l.Add(New ColonneNome("Utente_Modifica", "Utente Modifica", "string") With {._hidden = False, ._FiltrabileConCheck = True})
        ...
        l.Add(New ColonneNome("Produzione_Propria_Des", "Produzione Propria", "string") With {._hidden = False, ._Display = False, ._FiltrabileConCheck = True})

        l.Add(New ColonneNome("Peso_Netto", "Peso Netto", "number") With {._hidden = False, ._Display = False, ._FiltrabileConCheck = False, ._formatNr = "n6"})

        l.Add(New ColonneNome("Peso_Sgocciolato", "Peso Sgocciolato", "number") With {._hidden = False, ._Display = False, ._FiltrabileConCheck = False, ._formatNr = "n6"})

        l.Add(New ColonneNome("Tara", "Tara", "number") With {._hidden = False, ._Display = False, ._FiltrabileConCheck = False, ._formatNr = "n6"})

        l.Add(New ColonneNome("Peso_Egalizzato", "Peso_Egalizzato", "number") With {._hidden = True})
        l.Add(New ColonneNome("Peso_Egalizzato_Des", "Peso Egalizzato", "string") With {._hidden = False, ._Display = False, ._FiltrabileConCheck = True})

        l.Add(New ColonneNome("Immagine_Des", "Immagine", "string") With {._hidden = False, ._Display = False, ._FiltrabileConCheck = True})

        l.Add(New ColonneNome("Cod_Iva", "Cod_Iva", "number") With {._hidden = True})
        l.Add(New ColonneNome("Cod_Iva_Des", "Aliquota Iva", "string") With {._hidden = False, ._FiltrabileConCheck = True})

        l.Add(New ColonneNome("Codice_Esterno", "Codice Esterno", "string") With {._hidden = False, ._FiltrabileConCheck = True})
        ...
        If dtProdotti.Columns.Contains("Cod_TecnologiaSementi") Then
            l.Add(New ColonneNome("Cod_TecnologiaSementi_Des", "Tecnologia Sementi", "string") With {._hidden = False, ._Display = False, ._FiltrabileConCheck = True})
        End If
        If dtProdotti.Columns.Contains("Germinabilita") Then
            l.Add(New ColonneNome("Germinabilita_Des", "Germinabilità", "string") With {._hidden = False, ._Display = False, ._FiltrabileConCheck = True})
        End If
    End Sub
    ...
    Public Function Crea_Prodotti(InData As Object) As RispostaStandard
        ...
        Try
            ...
            Dim created = objGias.Crea_MateriaPrima_Specie_Varieta_Regolamento(objParametri_data.varieta, entrambiRegolamenti,
                    ...
                    objParametri_data.creaSemente, objParametri_data.creaTrasformatoVegetale)
