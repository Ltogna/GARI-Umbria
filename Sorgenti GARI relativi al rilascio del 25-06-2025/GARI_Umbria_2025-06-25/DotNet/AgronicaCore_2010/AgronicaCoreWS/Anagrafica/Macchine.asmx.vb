...
Public Class Macchine
    ...
    Public Function Leggi_Macchine_APP(ByVal piva As String,
        ...
        Dim risp As New List(Of AgronicaCoreContabObject.Impianto)
        ...
        Try
            ...
            Dim xFiltroAggiuntivo As String = " (Visibile_ctrl_gestione = 1) "

            Dim DTMacchine As DataTable = Nothing

            If Not String.IsNullOrEmpty(piva) Then
                ' Solo macchine di un'azienda specifica
                xFiltroAggiuntivo += " And Parco_Macchine.Sa_Cod != -1 "
                DTMacchine = ParcoMacchine.Leggi(
                                            piva,
                                            0,
                                            False,
                                           "",
            ...
            Else
                ' Tutte le macchine comuni tranne quelle di un'azienda specifica (lo ottengo passando una Piva che non esiste + flag pubblico
                DTMacchine = ParcoMacchine.Leggi(
                                            "99999999999",
                                            0,
                                            True,
