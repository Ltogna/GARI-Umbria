...
Public Class Utenti_Tipologie
    ...
    Public Function CopiaTipologia_NG(InData As CoreWS_Generic(Of CopyProfileObj)) As RispostaStandard
        ...
        Try
            ...
            '----- Scrivo un nuovo profilo nella tabella Utenti_Tipologie
            objUtentiBIZ.Scrivi_Tipologie({newProfile}, params)
            '----- Copio i permessi dalla tabella Utenti_TipologiexPermessi
            objUtentiBIZ.Copia_TipologiePermessi(original, newProfile, params.ObjParametri_Utenti)
            If InData.InData.AlsoCopySettings Then
                settingsWriter.CopiaImpostazioni({newProfile.codice.ToString}, original.codice.ToString, params.ObjParametri_Utenti)
            End If
