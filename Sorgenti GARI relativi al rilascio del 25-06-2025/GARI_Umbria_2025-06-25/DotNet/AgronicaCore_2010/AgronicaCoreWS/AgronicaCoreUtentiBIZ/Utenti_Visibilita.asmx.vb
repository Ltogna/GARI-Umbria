...
Public Class Utenti_Visibilita
    ...
    <Script.Services.ScriptMethod()>
    <WebMethod(EnableSession:=True)>
    Public Function CopiaVisibilitaUtenti(InData As CoreWS_Generic(Of CopiaImpostazioniObj)) As RispostaStandard
        Dim res As New RispostaStandard
        ...
        Try
            objUtentiBIZ.CopiaVisibilitaUtenti(InData.InData.Base, InData.InData.Template, obj_Utenti)
            res.RispostaOK = True
        Catch ex As Exception
            res.RispostaOK = False
            res.Errore = "Errore durante l'operazione: " & Gestione_Eccezioni.MessaggioCompletoDataEccezione(ex, False)
