...
Public Class SincroDatiApp
    ...
    Public Function ScriviAttivita(InData As Object) As RispostaStandard
        ...
        Try
            ...
            Dim unid As String = attivita.guid
            Dim cancellato As Boolean = attivita.cancellato
            ...
            If ricettaOperazione IsNot Nothing Then
                ...
                codice = ricettaOperazione.Ricetta_Operazione_Cod
                ...
                If tipoDatiApp = enum_Dati_App.Attivita AndAlso stato = enum_WWorflow_WAnagraficaStati.Esecuzione_ed_avanzamento_delle_ricette_Da_Eseguire Then
            ...
            ElseIf attivita.Attivita.Count > 0 Then
                ...
                codice = attivitaCdG.Id_Cdg_Generale
            ...
            objSincroHelper.SincroDatiApp(unid, tipoDatiApp, dati, riferimento, aggiornamento, cancellato, importazione, piva, codice, importazione, importAgenda, posizione, userAgent:=objRequest.objP.user_Agent)
    ...
    Public Function ScriviRilievo(InData As Object) As RispostaStandard
        ...
        Try
            ...
            objSincroHelper.SincroDatiApp(unid, tipoDatiApp, dati, riferimento, aggiornamento, cancellato, importazione, piva, codice, importazione, agenda:="NG", userAgent:=objRequest.objP.user_Agent)
    ...
    Public Function ScriviVisite(InData As Object) As RispostaStandard
        ...
        Try
            ...
            objSincroHelper.SincroDatiApp(unid, enum_Dati_App.Visite, dati, riferimento, aggiornamento, cancellato, importazione, piva, codice, importazione, "", posizione, userAgent:=objRequest.objP.user_Agent)
    ...
    Public Function ScriviDocumenti(InData As Object) As RispostaStandard
        ...
        Try
            ...
            objSincroHelper.SincroDatiApp(unid, enum_Dati_App.Documenti, dati, riferimento, aggiornamento, cancellato, importazione, piva, codice, userAgent:=objRequest.objP.user_Agent)
                    ...
                    For Each allegato In documento.Documenti
                        ...
                        If bEsito Then
                            ...
                            If Trim(errorMessage) = "" Then
                                ...
                                bEsito = objSincroHelper.SincroDatiApp(unid, enum_Dati_App.Documenti, dati, riferimento, False, False, importazione, piva, codice, userAgent:=objRequest.objP.user_Agent)
    ...
    Public Function ScriviMovimenti(InData As Object) As RispostaStandard
        ...
        Try
            ...
            For Each movimento In movimenti
                ...
                objSincroHelper.SincroDatiApp(unid, enum_Dati_App.Movimenti, dati, riferimento, aggiornamento, cancellato, importazione, piva, codice, importazione, userAgent:=objRequest.objP.user_Agent)
    ...
    Public Function ScriviAcquisto(InData As Object) As RispostaStandard
        ...
        Try
            ...
            objSincroHelper.SincroDatiApp(unid, enum_Dati_App.Acquisti, dati, riferimento, aggiornamento, cancellato, importazione, piva, codice, importazione, userAgent:=objRequest.objP.user_Agent)
    ...
    Public Function ScriviManutenzioni(InData As Object) As RispostaStandard
        ...
        Try
            ...
            For Each manutenzione In manutenzioni
                ...
                objSincroHelper.SincroDatiApp(unid, enum_Dati_App.Manutenzioni, dati, riferimento, aggiornamento, cancellato, importazione, piva, codice, userAgent:=objRequest.objP.user_Agent)
