...
Public Class Alert
    ...
    Public Function Carica_DatiApp(ByVal objP_server As String,
        ...
        Try
            ...
            Dim dtApp As DataTable = App_Documento_R.LeggiApp_Documenti(True, "", "", objParametri_Server)
                    ...
                    If bFS Then
                        ...
                        If fileByteArray IsNot Nothing AndAlso fileByteArray.Count > 0 Then
                            ...
                            If Risultato AndAlso Not ElencoFileDaEliminareDaFS.Contains(File_Name) Then
                                ...
                                'N.B. non li elimino direttamente il questo ciclo perchè è capitato che un Allegati_Documenti_Cod sia associato a più Alert_Elenco,
