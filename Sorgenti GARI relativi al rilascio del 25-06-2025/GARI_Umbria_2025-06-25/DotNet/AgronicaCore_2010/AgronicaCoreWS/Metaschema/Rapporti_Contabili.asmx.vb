...
Public Class Rapporti_Contabili
    ...
    <WebMethod(EnableSession:=True)>
    <Script.Services.ScriptMethod()>
    Public Function GetRapportiContabCodDescr(objP_server As String) As RispostaStandard
        ...
        Try
            ...
            Dim rapportiContabili As IEnumerable(Of AgronicaCoreModelsSTD.baseClass.BaseCodeDescrStr) = objR.Contatti_RapportiContabili_Leggi(
