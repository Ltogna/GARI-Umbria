...
Public Class Avversita
    ...
    <WebMethod()>
    <Script.Services.ScriptMethod()>
    Public Function Leggi_AvversitaTrappole_QdC(InData As Object) As rispostaStandard(Of List(Of AgronicaCoreModelsSTD.metaschema.avversita.AvversitaGruppo))
        ...
        Try
            ...
            Dim AvversitaBiz As New AgronicaControlli_2010.STD_Avversita
            Dim avversitaList = AvversitaBiz.LeggiAvversitaTrappole(objParametri_Avversita.tipoAttivita,
                                                                    objParametri_Avversita.lavorazione,
                                                                    objParametri_Avversita.impianti,
                                                                    objParametri_Avversita.specie,
                                                                    objParametri_Avversita.dettaglioTrattamento,
