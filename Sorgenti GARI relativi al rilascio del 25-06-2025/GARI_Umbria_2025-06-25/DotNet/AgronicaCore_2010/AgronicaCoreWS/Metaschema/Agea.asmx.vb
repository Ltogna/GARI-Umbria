...
#Region "Esportazione QdC"
    ...
    Public Function MapAttivitaToAgea(InData As CoreWS_Generic(Of ExportQdCtoAgea)) As rispostaStandard(Of String)
        ...
        Try
            ...
            Dim bundle_Id = obj.MapAttivitatoAgea(InData.InData.impresa.partitaIva, InData.InData.impresa.CUAA, InData.InData.anno, InData.InData.impresa.ragioneSociale,
