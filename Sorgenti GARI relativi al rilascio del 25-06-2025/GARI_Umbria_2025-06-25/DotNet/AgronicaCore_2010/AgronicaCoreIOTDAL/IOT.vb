        ...
        Try
            ...
            Select Case TipoSorgente
                ...
                Case enum_IoT_Tiposorgente.Aziendali
                    ...
                    sql.AppendLine("				WHERE PIVA_Superuser = '" & piva_superuser & "' AND PIVA = '" & Agro_SQL_SaveText(piva) & "' ")
                    sql.AppendLine()
                    sql.AppendLine("				UNION ")
                    sql.AppendLine()
                    sql.AppendLine("				SELECT Id_Dispositivo, DescrizioneAggiuntiva, Proprietario, Anonima ")
                    sql.AppendLine("				FROM IoT_VisibilitaDispositivi ")
                    sql.AppendLine("				WHERE PIVA_Superuser = '" & piva_superuser & "' AND PIVA = '*' ")
                    sql.AppendLine("		    ) TBL1 ")
            ...
            Else
                ...
                If TipoSorgente = enum_IoT_Tiposorgente.Aziendali OrElse
                    ...
                    _sql.AppendLine()
                    _sql.AppendLine()
                    _sql.AppendLine("SELECT Id_dispositivo, Sensori = STRING_AGG(Sensore, '" & Separatore & "') ")
                    _sql.AppendLine("FROM ( ")
