...
Public Class ModelliPrevisionaliXpiva_OperazioniAutorizzate_W
    ...
    Public Function RiportaModelliDatoPacchettoCommerciale(
        ...
        Try
            ...
            Stb.AppendLine(" select s.mod_cod, '" & Piva_SuperUser & " ' as piva_SuperUser, '" & Agro_SQL_SaveText(piva) & "' as piva, 1 as tipo_Visibilita, S.DescrizioneAggiuntiva, " & Agro_SQL_SaveDate(scadenza) & " as scadenza  ")
            ...
            Stb.AppendLine("      And s.Piva_SuperUser = '" & Piva_SuperUser & "' ")
