    ...
    Public Function CreaStringaQueryPerDTFiltrone(ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri,
        ...
        Select Case TipoSelect
            ...
            Case enum_TipoSelect_FiltroneSuperNova.Imprese_APP
                ...
                stb.AppendLine(" SELECT DISTINCT dbo.Imprese.PIVA as chiave, dbo.Imprese.PIVA, dbo.Imprese.rag_soc, Lista_Province.PROVINCIA, Indirizzi.CAP, Indirizzi.Stato, Istat.Localita, Imprese.TipoImpresaGerarchia, Imprese.Validita_Inizio, Imprese.Validita_Fine, IC_Cuaa.val_cod AS CodiceCuaa, ")
        ...
        If FiltroVisibilita AndAlso DtImpreseVisibili IsNot Nothing AndAlso DtImpreseVisibili.Rows.Count > 0 Then
            Select Case TipoSelect
                Case enum_TipoSelect_FiltroneSuperNova.Appezzamenti
                    StrJOIN.AppendLine(" INNER JOIN Utenti_Visibilita_Appoggio Utenti_Visibilita_Appoggio_I " & IIf(noLock, " (NOLOCK) ", "") & " ON Appezzamento.Piva = Utenti_Visibilita_Appoggio_I.Piva AND Utenti_Visibilita_Appoggio_I.Entita_Cod = 1 ")
                Case enum_TipoSelect_FiltroneSuperNova.Impianti
                    StrJOIN.AppendLine(" INNER JOIN Utenti_Visibilita_Appoggio Utenti_Visibilita_Appoggio_I " & IIf(noLock, " (NOLOCK) ", "") & " ON Reg_Impianti.Piva = Utenti_Visibilita_Appoggio_I.Piva AND Utenti_Visibilita_Appoggio_I.Entita_Cod = 1  ")
                Case enum_TipoSelect_FiltroneSuperNova.Esercizi
                    StrJOIN.AppendLine(" INNER JOIN Utenti_Visibilita_Appoggio Utenti_Visibilita_Appoggio_I " & IIf(noLock, " (NOLOCK) ", "") & " ON Imprese_Progetti.Piva = Utenti_Visibilita_Appoggio_I.Piva AND Utenti_Visibilita_Appoggio_I.Entita_Cod = 1  ")
                Case enum_TipoSelect_FiltroneSuperNova.Imprese, enum_TipoSelect_FiltroneSuperNova.Imprese_APP
                    StrJOIN.AppendLine(" INNER JOIN Utenti_Visibilita_Appoggio Utenti_Visibilita_Appoggio_I " & IIf(noLock, " (NOLOCK) ", "") & " ON Imprese.Piva = Utenti_Visibilita_Appoggio_I.Piva AND Utenti_Visibilita_Appoggio_I.Entita_Cod = 1  ")
                Case enum_TipoSelect_FiltroneSuperNova.Movimenti
                    StrJOIN.AppendLine(" INNER JOIN Utenti_Visibilita_Appoggio Utenti_Visibilita_Appoggio_I " & IIf(noLock, " (NOLOCK) ", "") & " ON Agenda.Piva = Utenti_Visibilita_Appoggio_I.Piva AND Utenti_Visibilita_Appoggio_I.Entita_Cod = 1 ")
            End Select
        End If
        ...
        If FiltroVisibilita AndAlso DtCentriVisibili IsNot Nothing AndAlso DtCentriVisibili.Rows.Count > 0 Then
            Select Case TipoSelect
                Case enum_TipoSelect_FiltroneSuperNova.Appezzamenti
                    StrJOIN.AppendLine(" INNER JOIN Utenti_Visibilita_Appoggio Utenti_Visibilita_Appoggio_C " & IIf(noLock, " (NOLOCK) ", "") & " ON Appezzamento.Piva = Utenti_Visibilita_Appoggio_C.Piva AND Appezzamento.Sa_Cod = Utenti_Visibilita_Appoggio_C.Sa_Cod AND Utenti_Visibilita_Appoggio_C.Entita_Cod = 2 ")
                Case enum_TipoSelect_FiltroneSuperNova.Impianti
                    StrJOIN.AppendLine(" INNER JOIN Utenti_Visibilita_Appoggio Utenti_Visibilita_Appoggio_C " & IIf(noLock, " (NOLOCK) ", "") & " ON Reg_Impianti.Piva = Utenti_Visibilita_Appoggio_C.Piva AND Reg_Impianti.Sa_Cod = Utenti_Visibilita_Appoggio_C.Sa_Cod AND Utenti_Visibilita_Appoggio_C.Entita_Cod = 2 ")
                Case enum_TipoSelect_FiltroneSuperNova.Esercizi
                    StrJOIN.AppendLine(" INNER JOIN Utenti_Visibilita_Appoggio Utenti_Visibilita_Appoggio_C " & IIf(noLock, " (NOLOCK) ", "") & " ON Imprese_Progetti.Piva = Utenti_Visibilita_Appoggio_C.Piva AND Imprese_Progetti.Sa_Cod = Utenti_Visibilita_Appoggio_C.Sa_Cod AND Utenti_Visibilita_Appoggio_C.Entita_Cod = 2 ")
                Case enum_TipoSelect_FiltroneSuperNova.CentriAziendali
                    StrJOIN.AppendLine(" INNER JOIN Utenti_Visibilita_Appoggio Utenti_Visibilita_Appoggio_C " & IIf(noLock, " (NOLOCK) ", "") & " ON Centri_Aziendali.Piva = Utenti_Visibilita_Appoggio_C.Piva AND Centri_Aziendali.Sa_Cod = Utenti_Visibilita_Appoggio_C.Sa_Cod AND Utenti_Visibilita_Appoggio_C.Entita_Cod = 2 ")
                    'Case enum_TipoSelect_FiltroneSuperNova.Movimenti
        ...
        If Ordinamento = "" Then
            ...
            Select Case TipoSelect
                ...
                Case 1
                    ...
                    stb.Append(" GROUP BY dbo.Imprese.PIVA, dbo.Imprese.rag_soc, GerarchiaImprese.Foglia, GerarchiaImprese.Livello, GerarchiaImprese.Padre, GerarchiaImprese.Figlio, Imprese.TipoImpresaGerarchia    " + vbCrLf)
