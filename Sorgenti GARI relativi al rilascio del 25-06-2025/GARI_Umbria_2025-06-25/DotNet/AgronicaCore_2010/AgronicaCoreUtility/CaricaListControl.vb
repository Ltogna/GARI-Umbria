...
Public Class CaricaListControl
    ...
    Public Shared Sub ImpreseConFiltroUtente(ByRef Controllo As ListControl,
        ...
        Dim filtroSQL = objUtentiProf.LeggiImpreseFiltroUtenteSQL(objParametri_Utenti.UtenteUsername,
        ...
        If Not filtroSQL.Contains(pivaFittizia) AndAlso Not IsNothing(Dt_Imprese) AndAlso Dt_Imprese.Rows.Count <> 0 Then
            ...
            For i = 0 To Dt_Imprese.Rows.Count - 1
                ...
                If bInsertCodiceSocio Then
                    ...
                    x_Des = Trim(Left(Dt_Imprese.Rows(i).Item("Rag_Soc"), 65)) & " (" & If(Not IsDBNull(CodiceSocio) AndAlso CodiceSocio <> "", Gias.CodiceSocio & ": " & Dt_Imprese.Rows(i).Item("CodiceSocio") & " - ", "") & Gias.PartitaIvaAbbr & ": " & x_Cod & ")"
                Else
    ...
    Public Sub Macchinari_2(ByRef Controllo As ListControl,
        ...
        If Piva <> "" Then
            StbSQL.Append(" AND Parco_Macchine.Piva = '" & Agro_SQL_SaveText(Piva) & "' ")
        End If
    ...
    Public Shared Sub Produttori(ByRef Controllo As ListControl,
        ...
        If dt.Rows.Count > 0 Then
            ...
            'Inserisco i record trovati
            For i = 0 To dt.Rows.Count - 1
                Controllo.Items.Add(New ListItem(dt.Rows(i).Item("RagSoc_Figlio"),
    ...
    Public Shared Sub MetodoProduzione(ByRef Controllo As ListControl,
        ...
        Controllo.Items.Add(New ListItem("Convenzionale", CStr(enum_MetodoProduzione.Convenzionale)))
