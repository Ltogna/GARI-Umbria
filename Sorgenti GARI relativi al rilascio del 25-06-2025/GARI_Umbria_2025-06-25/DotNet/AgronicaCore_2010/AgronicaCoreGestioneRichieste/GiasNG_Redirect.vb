...
Public Class GiasNG_Redirect
            ...
            If XmlDoc.HasChildNodes Then
                ...
                If Not XML_Parametri Is Nothing Then
                    ...
                    If objP_Agenda.Piva <> "" Then
                        warmResponse.impresa_impostazioni = Get_Imprese_Impostazioni(objP_Agenda.Piva, IIf(objP_Agenda.Sa_Cod = 0, SACOD_NOFILTRO, objP_Agenda.Sa_Cod),
                                                                                     objParametri_Server)
                    End If
    ...
    Public Function Get_Utente_Permessi(objParametri_Utenti As AgronicaCoreDataProvider.AgronicaCoreParametri) As Utente
        ...
        If up.Username <> "" Then
            ...
            Dim dt_permessi = objUtenti_Permessi.Leggi(up.Username, 5, 0, 9999, 0, "", "", objParametri_Utenti)
            up.Permessi = Popola_UtentePermessi(dt_permessi)

            Dim dt_impostazioni = objUtenti_Impostazioni.Leggi(0, 1,
                                                               AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta,
                                                               "", "", objParametri_Utenti)
            up.Impostazioni = Popola_UtenteImpostazioni(dt_impostazioni)

            If objParametri_Utenti.UtenteUsername.ToUpper <> objParametri_Utenti.SuperUserUsername.ToUpper Then

                Dim dt_impostazioni_SuperUserUsername = objUtenti_Impostazioni.Leggi(0, 2,
                                                   AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta,
                                                   "", "", objParametri_Utenti)
                up.Impostazioni_SuperUser = Popola_UtenteImpostazioni(dt_impostazioni_SuperUserUsername)

            Else

                up.Impostazioni_SuperUser = up.Impostazioni
    ...
    Public Function PassaggioSitoStampe_2010(ByRef objParametri_Super_Server As AgronicaCoreDataProvider.AgronicaCoreParametri,
                                        ByRef objParametri_Server As AgronicaCoreDataProvider.AgronicaCoreParametri,
                                        ByRef objParametri_Utenti As AgronicaCoreDataProvider.AgronicaCoreParametri,
                                        ByVal VariabiliInSessione As VariabiliInSessione_NG,
                                        ByRef objAgendaNG As AgronicaCoreGestioneRichieste.Parametri_ObjParametriAgenda_NG,
    ...
    Public Function PassaggioSitoAgronicaDomandaIrrigua(ByRef objParametri_Super_Server As AgronicaCoreDataProvider.AgronicaCoreParametri,
        ...
        Dim ObjParametriDomanda = New ParametriDomandaIrrigua() With {
            .PaginaProvenienza = objAgendaNG.Pagina_Provenienza,
    ...
    Public Function GestioneStampe(ByRef objParametri_Super_Server As AgronicaCoreDataProvider.AgronicaCoreParametri,
                                   ByRef objParametri_Server As AgronicaCoreDataProvider.AgronicaCoreParametri,
                                   ByRef objParametri_Utenti As AgronicaCoreDataProvider.AgronicaCoreParametri,
                                   ByVal Report As Integer,
                                   ByVal VariabiliInSessione As VariabiliInSessione_NG,
                                   ByRef objAgendaNG As AgronicaCoreGestioneRichieste.Parametri_ObjParametriAgenda_NG,
                                   ByVal ParametriAggiuntivi As List(Of AgronicaCoreGestioneRichieste.ParametriAggiuntivi_QueryString)) As String
    ...
    Public Function CaricaParametriAgenda_NG(XML_AgroWebConfig As System.Xml.XmlElement,
        ...
        If XML_AgroWebConfig.HasAttribute("impianti") AndAlso Not IsNothing(XML_AgroWebConfig.GetAttribute("impianti")) AndAlso Not String.IsNullOrEmpty(XML_AgroWebConfig.GetAttribute("impianti")) Then
            objP_Agenda.Impianti = JsonConvert.DeserializeObject(Of List(Of AgronicaCoreGestioneRichieste.ImpiantiAgendaNG))(XML_AgroWebConfig.GetAttribute("impianti").ToString())
        End If
        ...
        If objP_Agenda.Piva <> "" And objP_Agenda.RagSoc = "" Then
    ...
    Public Function Componi_QueryStringFiltrino(ByVal ParametriAggiuntivi As List(Of AgronicaCoreGestioneRichieste.ParametriAggiuntivi_QueryString), ByVal AggiungiSoloParametriAggiuntivi As Boolean) As String
