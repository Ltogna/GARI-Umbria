...
Public Class Inizializzatore
    ...
    Public Sub Inizializza_Sito_Specifico_Con_Superserver_GiasOnLine(
        ...
        Catch ex1 As AgronicaCoreDataProvider.AgroEccezioni_LoginFallito_Exception
            Throw ex1
    ...
    Public Sub Inizializza_Sito_Specifico_Con_Superserver_GiasOnLine(
        ...
        If risp <> "" Then
            ...
            Throw New AgronicaCoreDataProvider.AgroEccezioni_LoginFallito_Exception(Gias.AutenticazioneFallita & ". " & risp)
        Else
    ...
    Public Sub Inizializza_Sito_Specifico_Da_Stringa_Passaggio(ByVal StringaConnessione_Super_Server As String,
        ...
        'lo faccio subito perchè ho bisogno della stringa connessione server per webconfig
    ...
    Public Function Crea_Stringa_Connessione_Super_Server_Da_Config_GiasOnLine(
        ...
        '<add key="Super_Server_Server" value="CROMO\SQL2008"/>
        '<add key="Super_Server_DB" value="GIAS_Super_Server"/>
        '<add key="Super_Server_UserId" value="agronauta"/>
        ...
        If Super_Server_Server = "" Then
            Super_Server_Server = "CROMO\SQL2008"
        End If
