...
#Region "proprietà"
    ...
    Public Property GoogleMaps() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("googlemaps")) = True Then
    ...
    Public Property googlemaps_jsapi() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("googlemaps_jsapi")) = True Then
    ...
    Public Property LinkWS_Importa_GIAS() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkWS_Importa_GIAS")) = True Then
    ...
    Public Property user_smtp() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("user_smtp")) = True Then
    ...
    Public Property password_smtp() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("password_smtp")) = True Then
    ...
    Public Property Path_Directory_Loghi_Cliente() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Path_Directory_Loghi_Cliente")) = True Then
    ...
    Public Property Codici_Analisi_PDC_x_Fruttagel() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Codici_Analisi_PDC_x_Fruttagel")) = True Then
    ...
    Public Property LinkGiasOnline_2010() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkGiasOnline_2010")) = True Then
    ...
    Public Property WS_Timeout As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("WS_Timeout")) = True Then
    ...
    Public Property Analisi2010() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("Analisi2010")) = True Then
    ...
    Public Property Agenda2010() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Agenda2010")) = True Then
    ...
    Public Property Stampe2010() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("Stampe2010")) = True Then
    ...
    Public Property enumStampe2010() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("enumStampe2010")) = True Then
    ...
    Public Property LinkGiasOnline() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkGiasOnline")) = True Then
    ...
    Public Property StarGate_Versione() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("StarGate_Versione")) = True Then
    ...
    Public Property StarGate_Connessione() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("StarGate_Connessione")) = True Then
    ...
    Public Property StarGate_ConsentiGateBypass() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("StarGate_ConsentiGateBypass")) = True Then
    ...
    Public Property StarGate_LinkBypassBloccato() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("StarGate_LinkBypassBloccato")) = True Then
    ...
    Public Property StarGate_CodicePredefinito() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("StarGate_CodicePredefinito")) = True Then
    ...
    Public Property StarGate_PathFileINI() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("StarGate_PathFileINI")) = True Then
    ...
    Public Property StarGate_Whynot() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("StarGate_Whynot")) = True Then
    ...
    Public Property GestioneAllegati_Repository() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GestioneAllegati_Repository")) = True Then
    ...
    Public Property GestioneImportazioni_Repository() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GestioneImportazioni_Repository")) = True Then
    ...
    Public Property GestioneEsportazioni_Repository() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GestioneEsportazioni_Repository")) = True Then
    ...
    Public Property GestioneCartografia_Repository() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GestioneCartografia_Repository")) = True Then
    ...
    Public Property LinkManualeGiasOnline() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkManualeGiasOnline")) = True Then
    ...
    Public Property LinkAgronicaStampe() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaStampe")) = True Then
    ...
    Public Property LinkAgronicaStampe_2010() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaStampe_2010")) = True Then
    ...
    Public Property LinkAgronicaLabControlloQualita() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaLabControlloQualita")) = True Then
    ...
    Public Property LinkPianoConcimazione() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkPianoConcimazione")) = True Then
    ...
    Public Property LinkPianoConcimazione_2017() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkPianoConcimazione_2017")) = True Then
    ...
    Public Property LinkAgronicaBio() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaBio")) = True Then
    ...
    Public Property LinkAgronicaView() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaView")) = True Then
    ...
    Public Property LinkAgronicaAnalisi() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaAnalisi")) = True Then
    ...
    Public Property LinkAgronicaAnalisi_2010() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaAnalisi_2010")) = True Then
    ...
    Public Property LinkAgronicaAudit() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaAudit")) = True Then
    ...
    Public Property LinkAgronicaSicurezzaLavoro() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaSicurezzaLavoro")) = True Then
    ...
    Public Property LinkAgronicaPua() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaPua")) = True Then
    ...
    Public Property LinkAgronicaPlanning() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaPlanning")) = True Then
    ...
    Public Property LinkAgronicaProfilazione() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaProfilazione")) = True Then
    ...
    Public Property LinkAgronicaManutenzione() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaManutenzione")) = True Then
    ...
    Public Property LinkAgronicaPianiCampionamento() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaPianiCampionamento")) = True Then
    ...
    Public Property LinkAgronicaPianiSemina() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaPianiSemina")) = True Then
    ...
    Public Property LinkAgronicaMeteo() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaMeteo")) = True Then
    ...
    Public Property LinkSementieri() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkSementieri")) = True Then
    ...
    Public Property LinkAgronicaAgenda2010() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaAgenda2010")) = True Then
    ...
    Public Property LinkAgronicaSincronizzatore() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaSincronizzatore")) = True Then
    ...
    Public Property LinkCartografiaMappe() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkCartografiaMappe")) = True Then
    ...
    Public Property LinkProfitosan() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkProfitosan")) = True Then
    ...
    Public Property LinkProfitosan_WS() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkProfitosan_WS")) = True Then
    ...
    Public Property LinkProfitosan_2023() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkProfitosan_2023")) = True Then
    ...
    Public Property DescrizioneServer() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("DescrizioneServer")) = True Then
    ...
    Public Property Connessione_ONLINE_Server() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Connessione_ONLINE_Server")) = True Then
    ...
    Public Property Connessione_ONLINE_Utenti() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Connessione_ONLINE_Utenti")) = True Then
    ...
    Public Property Connessione_ONLINE_DPI() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Connessione_ONLINE_DPI")) = True Then
    ...
    Public Property LinkVisualizzatoreDPI() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("LinkVisualizzatoreDPI")) = True Then
    ...
    Public Property GiasOnline_WS_Disciplinari_AgroWS_Disciplinari() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GiasOnline_WS_Disciplinari_AgroWS_Disciplinari")) = True Then
    ...
    Public Property GiasOnline_WS_Fitofarmaci_AgroWS_Fitofarmaci() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GiasOnline_WS_Fitofarmaci_AgroWS_Fitofarmaci")) = True Then
    ...
    Public Property GiasOnline_WS_CapitolatoCliente_AgroWS_CapitolatoCliente() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GiasOnline_WS_CapitolatoCliente_AgroWS_CapitolatoCliente")) = True Then
    ...
    Public Property GiasOnline_WS_Prodotti_Demetra() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GiasOnline_WS_Prodotti_Demetra")) = True Then
    ...
    Public Property GiasOnline_WS_Meteo_Meteo() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GiasOnline_WS_Meteo_Meteo")) = True Then
    ...
    Public Property GiasOnline_WS_Disciplinari_AgroWS_Disciplinari_2() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GiasOnline_WS_Disciplinari_AgroWS_Disciplinari_2")) = True Then
    ...
    Public Property GiasOnline_WS_Fitofarmaci_AgroWS_Fitofarmaci_2() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GiasOnline_WS_Fitofarmaci_AgroWS_Fitofarmaci_2")) = True Then
    ...
    Public Property GiasOnline_WS_CapitolatoCliente_AgroWS_CapitolatoCliente_2() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GiasOnline_WS_CapitolatoCliente_AgroWS_CapitolatoCliente_2")) = True Then
    ...
    Public Property GiasOnline_WS_Meteo_Meteo_2() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GiasOnline_WS_Meteo_Meteo_2")) = True Then
    ...
    Public Property GiasOnline_WS_Fertilizzanti_IAgroAPI_Fertilizzanti() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GiasOnline_WS_Fertilizzanti_IAgroAPI_Fertilizzanti")) = True Then
    ...
    Public Property GiasOnline_WS_Fertilizzanti_IAgroAPI_Fertilizzanti_2() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GiasOnline_WS_Fertilizzanti_IAgroAPI_Fertilizzanti_2")) = True Then
    ...
    Public Property GiasOnline_WS_SpecieVegetali_IAgroAPI_SpecieVegetali() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GiasOnline_WS_SpecieVegetali_IAgroAPI_SpecieVegetali")) = True Then
    ...
    Public Property GiasOnline_WS_SpecieVegetali_IAgroAPI_SpecieVegetali_2() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GiasOnline_WS_SpecieVegetali_IAgroAPI_SpecieVegetali_2")) = True Then
    ...
    Public Property GiasOnline_WS_PianoConcimazione_AgroAPI_PianoConcimazione() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GiasOnline_WS_PianoConcimazione_AgroAPI_PianoConcimazione")) = True Then
    ...
    Public Property GiasOnline_WS_PianoConcimazione_AgroAPI_PianoConcimazione_2() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GiasOnline_WS_PianoConcimazione_AgroAPI_PianoConcimazione_2")) = True Then
    ...
    Public Property Flag_WS_Fitofarmaci_Remoto() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Flag_WS_Fitofarmaci_Remoto")) = True Then
    ...
    Public Property Flag_DisciplinareAttivo() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Flag_DisciplinareAttivo")) = True Then
    ...
    Public Property Flag_DisciplinarePrivato() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Flag_DisciplinarePrivato")) = True Then
    ...
    Public Property Flag_SoglieAttive() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Flag_SoglieAttive")) = True Then
    ...
    Public Property Flag_GestioneAnalisiAttivo() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Flag_GestioneAnalisiAttivo")) = True Then
    ...
    Public Property Flag_Mirror() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Flag_Mirror")) = True Then
    ...
    Public Property LivelloEspansoAlberoImprese() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LivelloEspansoAlberoImprese")) = True Then
    ...
    Public Property EspandiNodoCatasto() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("EspandiNodoCatasto")) = True Then
    ...
    Public Property ColoreNodoScadutoAlberoImprese() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("ColoreNodoScadutoAlberoImprese")) = True Then
    ...
    Public Property ColoreNodoBloccatoAlberoImprese() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("ColoreNodoBloccatoAlberoImprese")) = True Then
    ...
    Public Property DettagliAppezzamentiAlberoImprese() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("DettagliAppezzamentiAlberoImprese")) = True Then
    ...
    Public Property DettagliImpiantiAlberoImprese() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("DettagliImpiantiAlberoImprese")) = True Then
    ...
    Public Property IconaCentroConCartografiaAlberoImprese() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("IconaCentroConCartografiaAlberoImprese")) = True Then
    ...
    Public Property AgendaVisualizzazioneDefault() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("AgendaVisualizzazioneDefault")) = True Then
    ...
    Public Property AttivaStampePersonalizzate() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("AttivaStampePersonalizzate")) = True Then
    ...
    Public Property Prefix4SP() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Prefix4SP")) = True Then
    ...
    Public Property SitoRichiesto() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("SitoRichiesto")) = True Then
    ...
    Public Property Cartografia_NomeMappaBase() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Cartografia_NomeMappaBase")) = True Then
    ...
    Public Property Cartografia_SoloMappeUtente() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Cartografia_SoloMappeUtente")) = True Then
    ...
    Public Property Cartografia_LarghezzaMappaMillimetri() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Cartografia_LarghezzaMappaMillimetri")) = True Then
    ...
    Public Property GiasOnline_WS_Mappe_Gias_Service() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("GiasOnline_WS_Mappe_Gias_Service")) = True Then
    ...
    Public Property WebServiceMappe_RepositoryGIS() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("WebServiceMappe_RepositoryGIS")) = True Then
    ...
    Public Property WebService_GiasAlarm() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("WebService_GiasAlarm")) = True Then
    ...
    Public Property Fuso() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Fuso")) = True Then
    ...
    Public Property Ritaglio_Servizio() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Ritaglio_Servizio")) = True Then
    ...
    Public Property Ritaglio_Sito() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Ritaglio_Sito")) = True Then
    ...
    Public Property VersioneCodifica() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("VersioneCodifica")) = True Then
    ...
    Public Property Versione_Pwd() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Versione_Pwd")) = True Then
    ...
    Public Property StarterKit_Pwd() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("StarterKit_Pwd")) = True Then
    ...
    Public Property Flag_Messaggio() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Flag_Messaggio")) = True Then
    ...
    Public Property Tunnel_Pwd() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Tunnel_Pwd")) = True Then
    ...
    Public Property AgronicaCore_Flag_CancellazioneLogica() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("AgronicaCore_Flag_CancellazioneLogica")) = True Then
    ...
    Public Property AgronicaCore_Flag_Visibilita() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("AgronicaCore_Flag_Visibilita")) = True Then
    ...
    Public Property AgronicaCore_DirectoryLOG() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("AgronicaCore_DirectoryLOG")) = True Then
    ...
    Public Property AgronicaCore_FileNameLOG() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("AgronicaCore_FileNameLOG")) = True Then
    ...
    Public Property PathDirectoryLOG() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("PathDirectoryLOG")) = True Then
    ...
    Public Property LinkAgronicaCheckCOOP() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaCheckCOOP")) = True Then
    ...
    Public Property LinkAgronicaGlobalGap() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaGlobalGap")) = True Then
    ...
    Public Property TabelleTemp_Mode() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("TabelleTemp_Mode")) = True Then
    ...
    Public Property Str_TabelleTemp_RegolaConfronto() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("Str_TabelleTemp_RegolaConfronto")) = True Then
    ...
    Public Property MailAssistenza() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("MailAssistenza")) = True Then
    ...
    Public Property MailBancheDati() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("MailBancheDati")) = True Then
    ...
    Public Property LinkGiasOnline_Root() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkGiasOnline_Root")) = True Then
    ...
    Public Property LinkAgronicaGiasNG() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaGiasNG")) = True Then
    ...
    Public Property LinkAgronicaUMA() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaUMA")) = True Then
    ...
    Public Property LinkAgronicaDomandaIrrigua() As String
        ...
        Set(ByVal value As String)
            ...
            If _Hash_Chiavi.ContainsKey(LCase("LinkAgronicaDomandaIrrigua")) = True Then
    ...
    Public Property Nome_Codice_Griglia() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("Nome_Codice_Griglia")) = True Then
    ...
    Public Property ClientSMTP() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("ClientSMTP")) = True Then
    ...
    Public Property PathFileTemporanei() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("PathFileTemporanei")) = True Then
    ...
    Public Property NomeStampante() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("NomeStampante")) = True Then
    ...
    Public Property Mode_AgroWinSrvc_PrintUtility_PtP() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("Mode_AgroWinSrvc_PrintUtility_PtP")) = True Then
    ...
    Public Property PathDati_AgroWinSrvc_PrintUtility() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("PathDati_AgroWinSrvc_PrintUtility")) = True Then
    ...
    Public Property PathComandi_AgroWinSrvc_PrintUtility() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("PathComandi_AgroWinSrvc_PrintUtility")) = True Then
    ...
    Public Property Lista_Stampanti() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("Lista_Stampanti")) = True Then
    ...
    Public Property FiltroneBootstrap() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("FiltroneBootstrap")) = True Then
    ...
    Public Property FiltroGruppiUtente() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("FiltroGruppiUtente")) = True Then
    ...
    Public Property ConnessioneMaps_Server() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("ConnessioneMaps_Server")) = True Then
    ...
    Public Property deltaE() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("deltaE")) = True Then
    ...
    Public Property deltaN() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("deltaN")) = True Then
    ...
    Public Property LinkGiasBase() As String
        ...
        End Get
        Set(ByVal value As String)
            If _Hash_Chiavi.ContainsKey(LCase("LinkGiasBase")) = True Then
...
#End Region
    ...
    Public Sub New(ByRef objParametri_SuperServer As AgronicaCoreDataProvider.AgronicaCoreParametri,
    ...
    Function impostaDaDB(ByRef objParametri_SuperServer As AgronicaCoreDataProvider.AgronicaCoreParametri,
                    ByRef objParametri_Server As AgronicaCoreDataProvider.AgronicaCoreParametri)
    ...
    Private Sub LeggiXML(ByVal STR As String, ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri)
        ...
        For i = 0 To array_key.Length - 1
            ...
            If Not XmlTxt Is Nothing AndAlso XmlTxt.HasAttribute(array_key(i)) = True Then
    ...
    Public Function GeneraXML() As String
        ...
        Dim i As Integer
        For i = 0 To array_key.Length - 1
            If _Hash_Chiavi.ContainsKey(array_key(i)) = True Then
