...
#End Region
    ...
    Public Function FattoriCorrettivi_ConFinalitaGias_Leggi(ByVal Input As AgronicaCorePianoConcimazioneBIZ.PianoConcimazione_FattoriCorrettivi_input) As AgronicaCorePianoConcimazioneBIZ.PianoConcimazione_FattoriCorrettivi_output
    ...
    Public Function Regolamenti(ByVal Input As AgronicaCorePianoConcimazioneBIZ.PianoConcimazione_Regolamenti_input) As AgronicaCorePianoConcimazioneBIZ.PianoConcimazione_Regolamenti_output
