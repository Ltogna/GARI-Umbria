        ...
        If Importa Then
            ...
            For Each dr As DataRow In Dt.Rows
                ...
                If CInt(dr.Item("Anno")) >= 2014 Then
                    ...
                    strsql &= "            ," & IIf(IsDBNull(dr.Item("Sostanza_E1")), "NULL", "'" & dr.Item("Sostanza_E1") & "'") & " "
                    strsql &= "            ," & IIf(IsDBNull(dr.Item("Sostanza_E2")), "NULL", "'" & dr.Item("Sostanza_E2") & "'") & " "
                    strsql &= "            ," & IIf(IsDBNull(dr.Item("Sostanza_E3")), "NULL", "'" & dr.Item("Sostanza_E3") & "'") & " "
                    strsql &= "            ," & IIf(IsDBNull(dr.Item("Sostanza_E4")), "NULL", "'" & dr.Item("Sostanza_E4") & "'") & " "
                    strsql &= "            ," & IIf(IsDBNull(dr.Item("Sostanza_E5")), "NULL", "'" & dr.Item("Sostanza_E5") & "'") & " "
                    strsql &= "            ," & IIf(IsDBNull(dr.Item("Sostanza_E6")), "NULL", "'" & dr.Item("Sostanza_E6") & "'") & " "
                    strsql &= "            ," & IIf(IsDBNull(dr.Item("Caratteristica_1")), "NULL", "'" & dr.Item("Caratteristica_1") & "'") & " "
                    strsql &= "            ," & IIf(IsDBNull(dr.Item("Caratteristica_2")), "NULL", "'" & dr.Item("Caratteristica_2") & "'") & " "
