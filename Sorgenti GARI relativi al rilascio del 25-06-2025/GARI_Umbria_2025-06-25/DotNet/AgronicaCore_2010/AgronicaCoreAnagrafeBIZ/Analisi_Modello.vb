...
Public Class Analisi_Modello_Utility
    ...
    Public Function Link_Pagina_AnalisiTerrenoNG(Piva As String,
        ...
        Try
            ...
            Return RedirectGestione.IndirizzoCompleto_SitoGiasNG_PassandoDirettamente_ParametriAgenda_NG(Enum_SiteRedirector.Sito_PianoConcimazione_2017, objAgenda)
