    ...
    Public Function Leggi_Appezzamento_Anagrafica(ByVal Piva As String,
        ...
        If Piva <> "" AndAlso Sa_Cod <> 0 AndAlso Appezza <> 0 Then
            ...
            If DTAppezzamenti.Rows.Count > 0 Then
                ...
                appezzamento.metodo_Produzione = New AgronicaCoreModelsSTD.metaschema.MetodoProduzione(enum_MetodoProduzione.Convenzionale) With {.descrizione = Gias.Integrato}
                            ...
                            Select Case DTCodici.Rows(i).Item("id_cod")
                                ...
                                Case enum_CodiciAnagrafe.MetodoDiProduzione
                                    ...
                                    Select Case DTCodici.Rows(i).Item("val_cod")
                                        Case enum_MetodoProduzione.Convenzionale, enum_MetodoProduzione.InConversione, enum_MetodoProduzione.Biologico
                                            appezzamento.metodo_Produzione = objMetodoProduzione.Leggi(DTCodici.Rows(i).Item("val_cod"), objParametri_Server)
                                        Case Else
                                            appezzamento.metodo_Produzione = objMetodoProduzione.Leggi(enum_MetodoProduzione.Convenzionale, objParametri_Server)
                                    End Select
    ...
    Public Function Leggi_Appezzamenti_APP(piva As String,
        ...
        For Each row In dtImpianti.Rows
            ...
            If Not repository.ContainsKey(chiave_appezzamento) Then
                ...
                Dim dtCodici = objCodici.Leggi(row.Item("Piva"), row.Item("Sa_Cod"), row.Item("appezza"), 0, "",
                                               enumSelezioneVariabile.Selezione_TabellaDatiMinimi,
...
Public Class Appezzamento_W
    ...
    Public Function Appezzamento_ScriviModifica(ByRef DatiAppezzamento As AgronicaCoreModelsSTD.anagrafiche.Appezzamento,
        ...
        Try
            ...
            If Not DatiAppezzamento.flag_cancellazione Then
                ...
                If LogVerbose Then
                    Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di Internal_Appezzamento_ScriviModifica", False)
                End If
                ...
                'Lavez - 27/05/2025 - Log verboso
                If LogVerbose Then
                    Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di Internal_Appezzamento_ScriviModifica", False)
                End If
            ...
            Else
                'Lavez - 27/05/2025 - Log verboso
                If LogVerbose Then
                    Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di Internal_Appezzamento_Cancellazione", False)
                End If
                ...
                'Lavez - 27/05/2025 - Log verboso
                If LogVerbose Then
                    Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di Internal_Appezzamento_Cancellazione", False)
                End If
    ...
    Private Sub Internal_Appezzamento_Cancellazione(
        ...
        If appezzamentoDB IsNot Nothing Then
            ...
            If leggiMacchineAssociate Then
                ...
                objAxPW.Delete(objParametri_Server, objParametri_Utenti, Piva, Sa_Cod, Appezza, giasContext:=GiasContext)
            End If
    ...
    Private Sub Internal_Appezzamento_ScriviModifica(ByRef DatiAppezzamento As AgronicaCoreModelsSTD.anagrafiche.Appezzamento,
        ...
        'Lavez - 27/05/2025 - Log verboso
        If LogVerbose Then
            Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di Codice_Univoco_Appezzamento", False)
        End If
        ...
        'Lavez - 27/05/2025 - Log verboso
        If LogVerbose Then
            Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di Codice_Univoco_Appezzamento", False)
        End If
        ...
        If DatiAppezzamento.campoPK IsNot Nothing AndAlso DatiAppezzamento.campoPK.codice > 0 AndAlso Not AggiornaSoloValidita Then
            ...
            'Lavez - 27/05/2025 - Log verboso
            If LogVerbose Then
                Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di Controllo date campo", False)
            End If
            ControlloDateCampo(DatiAppezzamento, objParametri_Server)
            'Lavez - 27/05/2025 - Log verboso
            If LogVerbose Then
                Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di Controllo date campo", False)
            End If
        End If
        ...
        If DatiAppezzamento.primaryKey.codice = 0 Then
            ...
            'Lavez - 27/05/2025 - Log verboso
            If LogVerbose Then
                Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di Internal_Scrivi_Appezzamento", False)
            End If
            ...
            'Lavez - 27/05/2025 - Log verboso
            If LogVerbose Then
                Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di Internal_Scrivi_Appezzamento", False)
            End If
        ...
        Else
            'Lavez - 27/05/2025 - Log verboso
            If LogVerbose Then
                Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di Internal_Modifica_Appezzamento", False)
            End If
            ...
            'Lavez - 27/05/2025 - Log verboso
            If LogVerbose Then
                Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di Internal_Modifica_Appezzamento", False)
            End If
        End If
        ...
        If Not AggiornaSoloValidita Then
            ...
            Else
                'Lavez - 27/05/2025 - Log verboso
                If LogVerbose Then
                    Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di Internal_ScriviModificaElimina_AppezzamentoCodici", False)
                End If
                ...
                'Lavez - 27/05/2025 - Log verboso
                If LogVerbose Then
                    Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di Internal_ScriviModificaElimina_AppezzamentoCodici", False)
                End If
                ...
                If (DatiAppezzamento.catastoAppezzamento IsNot Nothing) Then
                    'Lavez - 27/05/2025 - Log verboso
                    If LogVerbose Then
                        Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di Internal_Scrivi_CatastoAppezzamento", False)
                    End If
                    ...
                    'Lavez - 27/05/2025 - Log verboso
                    If LogVerbose Then
                        Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di Internal_Scrivi_CatastoAppezzamento", False)
                    End If
                End If
                ...
                If DatiAppezzamento.cartografia IsNot Nothing AndAlso DatiAppezzamento.cartografia <> "" Then
                    'Lavez - 27/05/2025 - Log verboso
                    If LogVerbose Then
                        Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di Internal_ScriviModifica_GIS_Entita_ElementiGrafici_Appezzamento", False)
                    End If
                    ...
                    'Lavez - 27/05/2025 - Log verboso
                    If LogVerbose Then
                        Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di Internal_ScriviModifica_GIS_Entita_ElementiGrafici_Appezzamento", False)
                    End If
        ...
        If (DatiAppezzamento.impianti IsNot Nothing) Then
            ...
            'Lavez - 27/05/2025 - Log verboso
            If LogVerbose Then
                Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di eliminaImpianti", False)
            End If
            ...
            'Lavez - 27/05/2025 - Log verboso
            If LogVerbose Then
                Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di eliminaImpianti", False)
            End If
            ...
            For Each imp As AgronicaCoreModelsSTD.anagrafiche.Impianto In DatiAppezzamento.impianti
                ...
                If Not AggiornaSoloValidita Then
                    ...
                    If imp.primaryKey.codice = 0 AndAlso (String.IsNullOrEmpty(imp.codiceImpianto) OrElse String.IsNullOrWhiteSpace(imp.codiceImpianto)) Then
                        Static Dim piva As String = imp.primaryKey.appezzamentoPK.centroAziendalePK.partitaIva
                        Static Dim year As Integer = imp.validita.inizio.Year

                        'Lavez - 27/05/2025 - Log verboso
                        If LogVerbose Then
                            Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di lettura algoritmo e progressivo", False)
                        End If
                        ...
                        'Lavez - 27/05/2025 - Log verboso
                        If LogVerbose Then
                            Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di lettura algoritmo e progressivo", False)
                        End If
                    ...
                    'Lavez - 27/05/2025 - Log verboso
                    If LogVerbose Then
                        Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di lettura Codice_Univoco_Impianto", False)
                    End If
                    ...
                    'Lavez - 27/05/2025 - Log verboso
                    If LogVerbose Then
                        Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di lettura Codice_Univoco_Impianto", False)
                    End If
                    ...
                    If DTRiferimentoImpianto.Rows.Count > 0 AndAlso DTRiferimentoImpianto.Rows(0)("Impostazione_Valore_1").trim = "1" Then
                        If Not String.IsNullOrEmpty(imp.codiceImpianto) Then
                            ...
                            'Lavez - 27/05/2025 - Log verboso
                            If LogVerbose Then
                                Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di lettura check codice impianto già utilizzato", False)
                            End If
                ...
                If imp.primaryKey.codice = 0 Then
                    ...
                    'Lavez - 27/05/2025 - Log verboso
                    If LogVerbose Then
                        Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di Internal_Scrivi_Impianti_da_Appezzamento", False)
                    End If
                    ...
                    'Lavez - 27/05/2025 - Log verboso
                    If LogVerbose Then
                        Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di Internal_Scrivi_Impianti_da_Appezzamento", False)
                    End If
                ...
                Else
                    'Lavez - 27/05/2025 - Log verboso
                    If LogVerbose Then
                        Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di Internal_Modifica_Impianti_da_Appezzamento", False)
                    End If
                    ...
                    'Lavez - 27/05/2025 - Log verboso
                    If LogVerbose Then
                        Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di Internal_Modifica_Impianti_da_Appezzamento", False)
                    End If
                ...
                If Not AggiornaSoloValidita Then
                    If impianto IsNot Nothing Then
                        'Lavez - 27/05/2025 - Log verboso
                        If LogVerbose Then
                            Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di Internal_ScriviModificaElimina_ImpiantiCodici_da_Appezzamento", False)
                        End If
                        ...
                        'Lavez - 27/05/2025 - Log verboso
                        If LogVerbose Then
                            Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di Internal_ScriviModificaElimina_ImpiantiCodici_da_Appezzamento", False)
                        End If

                        If imp.cartografia IsNot Nothing AndAlso imp.cartografia <> "" Then
                            'Lavez - 27/05/2025 - Log verboso
                            If LogVerbose Then
                                Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di Internal_ScriviModifica_GIS_Entita_ElementiGrafici_ImpiantoAppezzamento", False)
                            End If
                            ...
                            'Lavez - 27/05/2025 - Log verboso
                            If LogVerbose Then
                                Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di Internal_ScriviModifica_GIS_Entita_ElementiGrafici_ImpiantoAppezzamento", False)
                            End If
                    ...
                    If Not IsNothing(ParametriSementieri) AndAlso Not IsNothing(ParametriSementieri.DatiPassaggio) Then
                        ...
                        Internal_ScriviModifica_Interferenze_Sementieri(
                            ...
                            impianto,
                            imp.cartografia,
                            (DatiAppezzamento.primaryKey.codice = 0),
                            Cultivar.Veg_Cod,
                            GISentita.Entita_Cod,
                            objParametri_Server,
                            GiasContext,
                    ...
                    If Not IsNothing(imp.utilizzoTerreno) AndAlso imp.utilizzoTerreno.classType = "Varieta" Then
                        ...
                        'Lavez - 27/05/2025 - Log verboso
                        If LogVerbose Then
                            Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di Crea_MateriaPrima_Specie_Varieta_Regolamento", False)
                        End If
                    End If
                ...
                If (imp.esercizi IsNot Nothing) Then
                    ...
                    'Lavez - 27/05/2025 - Log verboso
                    If LogVerbose Then
                        Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di eliminaEsercizi", False)
                    End If
                    imp = eliminaEsercizi(
                        imp,
                        objParametri_Server,
                    ...
                    'Lavez - 27/05/2025 - Log verboso
                    If LogVerbose Then
                        Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di eliminaEsercizi", False)
                    End If
                    For Each ese As AgronicaCoreModelsSTD.anagrafiche.Esercizio In imp.esercizi
                        ...
                        If Not AggiornaSoloValidita Then
                            ...
                            If DTRiferimentoProgetto.Rows.Count > 0 AndAlso DTRiferimentoProgetto.Rows(0)("Impostazione_Valore_1").trim = "1" Then
                                ...
                                If Not String.IsNullOrEmpty(ese.lotto) Then
                                    ...
                                    'Lavez - 27/05/2025 - Log verboso
                                    If LogVerbose Then
                                        Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di Lotto già utilizzato", False)
                                    End If
                                    ...
                                    'Lavez - 27/05/2025 - Log verboso
                                    If LogVerbose Then
                                        Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di Lotto già utilizzato", False)
                                    End If
                        ...
                        If ese.codice = 0 Then
                            ...
                            'Lavez - 27/05/2025 - Log verboso
                            If LogVerbose Then
                                Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di Internal_Scrivi_Esercizi_da_Impianto_Appezzamento", False)
                            End If
                            ...
                            'Lavez - 27/05/2025 - Log verboso
                            If LogVerbose Then
                                Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di Internal_Scrivi_Esercizi_da_Impianto_Appezzamento", False)
                            End If
                        ...
                        Else
                            ...
                            'Lavez - 27/05/2025 - Log verboso
                            If LogVerbose Then
                                Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di Internal_Modifica_Esercizi_da_Impianto_Appezzamento", False)
                            End If
                            ...
                            'Lavez - 27/05/2025 - Log verboso
                            If LogVerbose Then
                                Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di Internal_Modifica_Esercizi_da_Impianto_Appezzamento", False)
                            End If
                        End If
                        ...
                        If Not AggiornaSoloValidita Then
                            ...
                            Else
                                ...
                                'Lavez - 27/05/2025 - Log verboso
                                If LogVerbose Then
                                    Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di Internal_ScriviModificaElimina_EserciziCodici_da_Impianto_Appezzamento", False)
                                End If
                                'Scrittura\aggiornamento\eliminazione codici
                                Internal_ScriviModificaElimina_EserciziCodici_da_Impianto_Appezzamento(
                                    ese,
                                    objParametri_Server,
                                    username,
                                    GiasContext,
                                ...
                                'Lavez - 27/05/2025 - Log verboso
                                If LogVerbose Then
                                    Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di Internal_ScriviModificaElimina_EserciziCodici_da_Impianto_Appezzamento e prima di UpdateLinkedContributes", False)
                                End If
                                ...
                                'Lavez - 27/05/2025 - Log verboso
                                If LogVerbose Then
                                    Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di UpdateLinkedContributes", False)
                                End If
                            End If
                        End If
        ...
        If Not AggiornaSoloValidita Then
            'Lavez - 27/05/2025 - Log verboso
            If LogVerbose Then
                Scrivi_LOG(objParametri_Server, nomeRoutine, "Prima di GeneraGMapJPG", False)
            End If
            ...
            'Lavez - 27/05/2025 - Log verboso
            If LogVerbose Then
                Scrivi_LOG(objParametri_Server, nomeRoutine, "Dopo di GeneraGMapJPG", False)
            End If
        End If
    ...
    Private Sub Internal_Modifica_Interferenze_Sementieri(ByVal ParametriSementieri As SementieriParametrizzazione,
        ...
        Try
            ...
            If ParametriSementieri.DatiPassaggio.ToString.Split("|")(5) = 1 Then
                ...
                Interferenze.GeneraDescrizione_Casella_Conflitto(entita_cod, objParametri)
    ...
    Private Shared Function dtInterferenze_from_poligono(ByVal ParametriSementieri As SementieriParametrizzazione,
        ...
        gmlPol = converter.Trasforma(wkt, False, False, False, 0)
    ...
    Private Function Internal_Scrivi_Appezzamento(ByRef app As AgronicaCoreModelsSTD.anagrafiche.Appezzamento,
        ...
        'Lavez - 27/05/2025 - Log verboso
        If LogVerbose Then
            Scrivi_LOG(objParametri, nomeRoutine, "Prima di recupero lingue", False)
        End If

        Dim leggiLingua As New AgronicaCoreUtentiDAL.Lingue_Read
        Dim dtLingua As DataTable = leggiLingua.Leggi_datoCODGIAS(objParametri.Lingua_Cod, enumSelezioneVariabile.Selezione_TabellaCompleta, "", "", objParametri_utenti)
        'Lavez - 27/05/2025 - Log verboso
        If LogVerbose Then
            Scrivi_LOG(objParametri, nomeRoutine, "Dopo di recupero lingue", False)
        End If
        Dim linguaCodiceISO As String = dtLingua.Rows(0)("CodiceISO")
        Threading.Thread.CurrentThread.CurrentUICulture = New Globalization.CultureInfo(linguaCodiceISO)
        ...
        'Lavez - 27/05/2025 - Log verboso
        If LogVerbose Then
            Scrivi_LOG(objParametri, nomeRoutine, "Dopo assegnaizone lingue culture", False)
        End If
    ...
    Private Sub Internal_ScriviModificaElimina_AppezzamentoCodici(ByRef DatiAppezzamento As AgronicaCoreModelsSTD.anagrafiche.Appezzamento,
                                                                  ByRef objParametri As AgronicaCoreParametri,
                                                                  ByVal username As String,
                                                                  Optional ByRef GiasContext As Gias_DeveloperServer_Entities = Nothing,
                                                                  Optional ByVal NewTransaction As Boolean = True)
        ...
        Try
            ...
            If (DatiAppezzamento.metodo_Produzione Is Nothing) Then
                ...
                Else
                    DatiAppezzamento.metodo_Produzione = New AgronicaCoreModelsSTD.metaschema.MetodoProduzione(enum_MetodoProduzione.Convenzionale)
                End If
            End If
    ...
    Private Sub Internal_ScriviModificaElimina_ImpiantiCodici_da_Appezzamento(ByRef impianto As AgronicaCoreModelsSTD.anagrafiche.Impianto,
                                                                              ByRef objParametri As AgronicaCoreParametri,
                                                                              ByVal username As String,
                                                                              Optional ByRef GiasContext As Gias_DeveloperServer_Entities = Nothing,
                                                                              Optional ByVal NewTransaction As Boolean = True)
        ...
        Try
            ...
            If impianto.utilizzoTerreno IsNot Nothing Then
                If (impianto.utilizzoTerreno.classType = ClassType.DestinazioneUso) Then
                    AgronicaCoreAnagrafeDAL.EFReg_Impianti.ScriviModificaEliminaDestinazioneUsoxImpianto(impianto.primaryKey.appezzamentoPK.centroAziendalePK.partitaIva,
    ...
    Private Sub Internal_ScriviModificaElimina_EserciziCodici_da_Impianto_Appezzamento(ByRef ese As AgronicaCoreModelsSTD.anagrafiche.Esercizio,
                                                                                        ByRef objParametri As AgronicaCoreParametri,
                                                                                        ByVal username As String,
                                                                                        Optional ByRef GiasContext As Gias_DeveloperServer_Entities = Nothing,
                                                                                       Optional ByVal NewTransaction As Boolean = True)
        ...
        Try
            ...
            If (ese.certificazioneProdotto IsNot Nothing) Then
                If (ese.certificazioneProdotto.codice IsNot Nothing) Then
                    ...
                    Dim imp = AgronicaCoreAnagrafeDAL.EFReg_Impianti.Leggi_Reg_Impianti_Codici(GiasContext, piva, sa_cod, appezza, idReg, progetto_cod, id_cod)
                    ...
                    If Not IsNothing(imp) Then
                        ...
                        AgronicaCoreAnagrafeDAL.EFReg_Impianti.ScriviModificaEliminaxProgetto(piva,
                                                                                              sa_cod,
                                                                                              appezza,
                                                                                              idReg,
                                                                                               progetto_cod,
    ...
    Private Sub Verifica_MetodoProduzione(ByRef appezzamento As AgronicaCoreModelsSTD.anagrafiche.Appezzamento,
        ...
        If appezzamento.metodo_Produzione IsNot Nothing AndAlso appezzamento.metodo_Produzione.codice = enum_MetodoProduzione.Biologico Then
