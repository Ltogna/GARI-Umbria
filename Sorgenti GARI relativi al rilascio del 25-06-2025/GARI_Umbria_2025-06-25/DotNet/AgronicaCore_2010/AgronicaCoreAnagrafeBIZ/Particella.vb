...
Public Class Particella_W
                        ...
                        Do While i_Possesso < xParticellaPossessi.Count
                            ...
                            Select Case CInt(xParticellaPossesso.GetAttribute("TipoOperazioneDB"))
                                ...
                                Case "1"    'SALVA -------------------------------------------------------
                                    ...
                                    Dim dtExist = objImpresexParticelle2_R.Leggi(0,
                                                                   CStr(xParticella.GetAttribute("piva")),
                                                                   CInt(xParticella.GetAttribute("sa_cod")),
                                                                   0,
                                                                   CStr(xParticella.GetAttribute("prov")),
                                                                   ...
                                                                   " Validita_Inizio = " & Agro_SQL_SaveDate(CDate(xParticellaPossesso.GetAttribute("validita_inizio")), False) & " AND Validita_Fine = " & Agro_SQL_SaveDate(CDate(xParticellaPossesso.GetAttribute("validita_fine")), False) & " ",
                                                                   "",
                                                                   objParametri)
    ...
    Public Sub Particella_Elimina(ByVal Particella As AgronicaCoreModelsSTD.anagrafiche.CatastoCentroAziendale,
        ...
        Try
            ...
            Dim objImpreseXParticelle As New AgronicaCoreAnagrafeDAL.ImpresexParticelle2_R
            Dim part_ImpreseXParticellePivaSaCod = objImpreseXParticelle.Leggi(0, "", 0, 0,
            ...
            Dim part_CampiXParticellePivaSaCod = objCampiXParticelle.Leggi(PivaRiferimento,
                                                                  SaCodRiferimento,
                                                                  0,
                                                                  Particella.particella.primaryKey.Prov,
                                                                  Particella.particella.primaryKey.Com,
            ...
            Dim part_AppezzamentiXParticellePivaSaCod = objAppezzamentiXParticelle.AppezzamentixParticelle_Leggi(PivaRiferimento,
                                                                                                        SaCodRiferimento,
                                                                                                        0,
                                                                                                        Particella.particella.primaryKey.Prov,
                                                                                                        Particella.particella.primaryKey.Com,
