...
Public Class Contatti_W
                    ...
                    Select Case OpeDB_Contatto
                        ...
                        Case "2"    'MODIFICA -------------------------------------------------------
                            ...
                            objContatti.Modifica(
                                                ...
                                                ChkFittizio:=chkFittizio, Nome_Breve:=nomeBreve
                                            )
    ...
    Public Function EliminaContatto(Piva As String, Sa_Cod As Integer, Cod_Contatto As String, ByRef EseguitaOperazione As Boolean, objParametri_Server As AgronicaCoreParametri) As String
        ...
        Dim Rag_Soc As String = ""
        Dim Descrizione As String = ""
        Dim StringaXML, strDummy As String
        Dim Cod_RisUm As Integer
        Dim isGIAS As Boolean
        ...
        If Not isGIAS Then
            ...
            If Dt.Rows.Count <> 0 OrElse esistenzaSquadre Then
                ...
                Else
                    Msg = String.Format("Esistono In archivio movimenti collegati al contatto {0}.{1}{1}Cancellare tutte le registrazioni prima di richiederne l'eliminazione.", Rag_Soc, vbCrLf)
                End If
            Else
                ...
                If dtAltriRiferimenti.Rows.Count > 0 Then
                    ...
                    Msg = String.Format("Il contatto è utilizzato nelle seguenti imprese: {0}{1}{0}Cancellare tutte le registrazioni prima di richiederne l'eliminazione.",
            ...
            If possoEliminare Then
                ...
                Dim objContattiCancella As New AgronicaCoreAnagrafeBIZ.Contatti_W
            ...
            If Not possoEliminare Then
                EseguitaOperazione = False
            End If
        Else
            Msg = "Il Contatto è un'impresa e non si può cancellare"
            EseguitaOperazione = False
        End If
