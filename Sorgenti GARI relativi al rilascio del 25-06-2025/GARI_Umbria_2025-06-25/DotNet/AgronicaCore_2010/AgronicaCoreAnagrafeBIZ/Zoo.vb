...
Public Class Zoo
    ...
    Public Function Scrivi_Modifica_Zoo_Animali(ByVal Zoo_Animali As AgronicaCoreEntityFramework_POCO.Zoo_Animali,
                                                ...
                                                Optional ByVal Edit_in_Griglia As Boolean = False) As RispostaStandard
        ...
        Try
            ...
            If Not IsNothing(Zoo_Animali_Anomalie) AndAlso Zoo_Animali_Anomalie.Count > 0 Then
                For Each anomalia In Zoo_Animali_Anomalie
                    ...
                    Else
                        Dim anomalie = From an In GiasContext.Zoo_AnimalixAnomalie
                                       Where an.Piva = anomalia.Piva AndAlso an.Sa_Cod = anomalia.Sa_Cod AndAlso an.Cod_Animale = anomalia.Cod_Animale Select an
    ...
    Private Function AnimaliMovimentati_Next(Piva As String, ID_Agenda As Integer, GiasContext As Gias_DeveloperServer_Entities, objParametri_Server As AgronicaCoreDataProvider.AgronicaCoreParametri) As Boolean
    ...
    Public Function AnimaliMovimentati_Next_List(Piva As String, ID_Agenda As Integer, objParametri_Server As AgronicaCoreDataProvider.AgronicaCoreParametri) As List(Of String)
        ...
        Try
            ...
            For Each Mov_animale In dtMovimenti_Animali.Rows
                ...
                If Animale_Movimentato(Mov_animale("PIVA"), Mov_animale("Cod_Progetto"), Mov_animale("Data_Movimento"), objParametri_Server) Then
                    listAnimaliMovimentati.Add(Mov_animale("Matricola"))
                End If
    ...
    Public Sub Aggiorna_Validita_Animale(Piva As String,
        ...
        obj_Animale.Scrivi_Modifica_Zoo_Animali(Animale, Animale_Distinte, Animale_Stati_Accrescimento, objParametri_Server)
    ...
    Public Function Aggiorna_CapoAnimale(ByVal Capo As CapoAnimale,
                                         ByRef GiasContext As Gias_DeveloperServer_Entities,
                                         ByRef objParametriServer As AgronicaCoreParametri,
                                         Optional ByVal Cod_Gruppo As Integer = 0) As Boolean
        ...
        If Cod_Gruppo <> 0 Then
            ...
            If Gruppo IsNot Nothing AndAlso Gruppo.Flag_BDN = 1 Then
                Animale.Validato = If(Capo.validato, 1, 0)
            End If
    ...
    Public Sub Riapri_Validita_Animale_Fine(Piva As String,
        ...
        obj_Animale.Scrivi_Modifica_Zoo_Animali(Animale, Animale_Distinte, Animale_Stati_Accrescimento, objParametri_Server, GiasContext, False)
    ...
    Public Function Animali_Movimentati(Piva As String, Cod_Progetto_list As List(Of Integer), Data As DateTime, ByRef objParametri_Server As AgronicaCoreParametri) As List(Of Integer?)
        ...
        If Movimenti_Dettagli_List.Count > 0 Then
            Dim movDetCodProgetti As List(Of Integer?) = (From a In Movimenti_Dettagli_List Select a.Movimenti_Dettagli.Cod_Progetto).Distinct().ToList()
            If movDetCodProgetti.Count > 0 Then
                list_AnimaliMovimentati.AddRange(movDetCodProgetti)
            End If
        End If
        ...
        If Movimenti_Dettagli_List.Count > 0 Then
            Dim movDestCodProgetti As List(Of Integer?) = (From a In Mov_Destinazioni_List Select a.Movimenti_Dettagli.Cod_Progetto).Distinct().ToList()
            ...
            If cod_progettoMancanti.Count > 0 Then
                list_AnimaliMovimentati.AddRange(cod_progettoMancanti)
            End If
        End If
    ...
    Public Function Converti_Animale_DT(ByVal obj_CapoAnimale As anagrafiche.CapoAnimale,
                                        ...
                                        Optional ByRef GiasContext As AgronicaCoreEntityFramework.Gias_DeveloperServer_Entities = Nothing,
                                        Optional OpenNewTransaction As Boolean = True) As String
        Dim r As New RispostaStandard
        ...
        If obj_CapoAnimale.flagCancellazione = False Then
            ...
            If modifica Then
                ...
                r = Scrivi_Modifica_Zoo_Animali(Zoo_Animali, Zoo_Animali_Distinte.ToArray, Zoo_Animali_StatiAccr.ToArray,
                                                objParametri_Server, GiasContext, OpenNewTransaction)
    ...
    Public Function LeggiStabulazioneCategoria(
        ...
        Dim objDAL As New AgronicaCoreZooDAL.Lista_tipi_stalla_R
