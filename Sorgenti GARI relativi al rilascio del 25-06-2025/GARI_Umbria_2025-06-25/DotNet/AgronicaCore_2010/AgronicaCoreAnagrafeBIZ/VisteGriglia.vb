...
Public Class VisteGrigliaBizService
    ...
    Public Function CaricaViste(visteChiave As ChiaveVista, objP_utenti As String) As rispostaStandard(Of List(Of Vista))
        ...
        Try
            ...
            Dim dt As DataTable = visteDataLayer.CaricaViste("", "", utentiDBContext)
            ...
            If Not IsNothing(dt) AndAlso dt.Rows.Count > 0 Then
                ...
                If visteChiave.GridId.Split("|").Length = 2 Then
                    dr = dt.Select("(NomeUtente = '" & visteChiave.NomeUtente & "' And (GridId = '" & visteChiave.GridId & "' Or GridId = '" & visteChiave.GridId.Split("|")(0) & "')) Or ((GridId = '" & visteChiave.GridId & "' Or GridId = '" & visteChiave.GridId.Split("|")(0) & "') And FlagPubblica=1)")
                Else
                    dr = dt.Select("NomeUtente = '" & visteChiave.NomeUtente & "' And GridId = '" & visteChiave.GridId.Split("|")(0) & "'")
                End If
