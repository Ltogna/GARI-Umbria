...
Public Class Utility_KeyTranslator_W
    ...
    Public Function UtilityCambioCFUtente(ByVal Codice_Fiscale_Old As String, ByVal Codice_Fiscale_New As String, ByVal Flag_Azienda_Persona As Integer, ByVal objParametri_Server As AgronicaCoreParametri, objParametri_Utenti As AgronicaCoreParametri) As RispostaStandard
        ...
        Try
            ...
            obj_QueryParametrizzata.Modifica_Parametrizzata("UtentixCodFisc", "CodFisc", Codice_Fiscale_New, "Where CodFisc = '" & Codice_Fiscale_Old & "'", objParametri_Utenti, True, True, n_record)
            ...
            If ProcediConQuerySuUsernameCreazioneModifica Then
                ...
                obj_QueryParametrizzata.Modifica_Parametrizzata("Agenda", "Blocco_Username", Codice_Fiscale_New, "Where Blocco_Username = '" & Codice_Fiscale_Old & "'", objParametri_Server, True, True, n_record)

                NumeroRecordModificati += n_record

                n_record = 0

                obj_QueryParametrizzata.Modifica_Parametrizzata("Agronica_Log_Agenda", "Utente", Codice_Fiscale_New, "Where Utente = '" & Codice_Fiscale_Old & "'", objParametri_Server, False, True, n_record)

                NumeroRecordModificati += n_record

                n_record = 0

                obj_QueryParametrizzata.Modifica_Parametrizzata("Agronica_Log_Anagrafe", "Utente", Codice_Fiscale_New, "Where Utente = '" & Codice_Fiscale_Old & "'",objParametri_Server, False, True, n_record)

                NumeroRecordModificati += n_record

                n_record = 0

                obj_QueryParametrizzata.Modifica_Parametrizzata("Agronica_Log_Pua", "Utente", Codice_Fiscale_New, "Where Utente = '" & Codice_Fiscale_Old & "'", objParametri_Server, False, True, n_record)

                NumeroRecordModificati += n_record

                n_record = 0

                obj_QueryParametrizzata.Modifica_Parametrizzata("Agronica_Log_Ricette", "Utente", Codice_Fiscale_New, "Where Utente = '" & Codice_Fiscale_Old & "'", objParametri_Server, False, True, n_record)

                NumeroRecordModificati += n_record

                n_record = 0

                obj_QueryParametrizzata.Modifica_Parametrizzata("Appezzamento", "Blk_Fine_Username", Codice_Fiscale_New, "Where Blk_Fine_Username = '" & Codice_Fiscale_Old & "'", objParametri_Server, True, True, n_record)

                NumeroRecordModificati += n_record

                n_record = 0

                obj_QueryParametrizzata.Modifica_Parametrizzata("Appezzamento", "Blk_Inizio_Username", Codice_Fiscale_New, "Where Blk_Inizio_Username = '" & Codice_Fiscale_Old & "'", objParametri_Server, True, True, n_record)

                NumeroRecordModificati += n_record

                n_record = 0

                obj_QueryParametrizzata.Modifica_Parametrizzata("PianoConcimazione_Testata", "Blocco_Username", Codice_Fiscale_New, "Where Blocco_Username = '" & Codice_Fiscale_Old & "'", objParametri_Server, True, True, n_record)

                NumeroRecordModificati += n_record

                n_record = 0

                obj_QueryParametrizzata.Modifica_Parametrizzata("PUA_Testata", "Blocco_Username", Codice_Fiscale_New, "Where Blocco_Username = '" & Codice_Fiscale_Old & "'", objParametri_Server, True, True, n_record)

                NumeroRecordModificati += n_record

                n_record = 0

                obj_QueryParametrizzata.Modifica_Parametrizzata("Ricette", "Blocco_Username", Codice_Fiscale_New, "Where Blocco_Username = '" & Codice_Fiscale_Old & "'", objParametri_Server, True, True, n_record)
                        ...
                        If Not IsNothing(TrovataColonna) AndAlso TrovataColonna.Length > 0 Then
                            ...
                            If Not IsNothing(DT_Filtrato) Then
                                ...
                                For Each rowTabella In DT_Filtrato.Rows
                                    ...
                                    obj_QueryParametrizzata.Modifica_Parametrizzata(rowTabella("Nome_Tabella"), colonna, Codice_Fiscale_New, "Where " & colonna & " = '" & Codice_Fiscale_Old & "'", objParametri, CBool(rowTabella("Flag_DataModifica").ToString()), True, n_record)
