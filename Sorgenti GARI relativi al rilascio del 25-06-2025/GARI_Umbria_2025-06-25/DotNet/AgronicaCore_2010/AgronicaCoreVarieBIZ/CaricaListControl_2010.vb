                ...
                Select Case Elem_Cod
                    ...
                    Case SERVIZI
                        ...
                        If Not String.IsNullOrEmpty(RicercaTesto) Then
                            filtroAggiuntivo = String.Format(" DESCR LIKE '%{0}%' ", RicercaTesto)
                        End If
                    ...
                    Select Case Elem_Cod
                        ...
                        Case FORMULATI
                            ...
                            Try
                                ...
                                ' Modifica per fare in modo che vengano considerati anche i prodotti
                                Dim tipoRichiestoPassato = ""
                                If Not String.IsNullOrEmpty(xFiltroAggiuntivoGiasAPP) Then
                                    tipoRichiestoPassato = CStr(TipoRichiesto)
                                End If
