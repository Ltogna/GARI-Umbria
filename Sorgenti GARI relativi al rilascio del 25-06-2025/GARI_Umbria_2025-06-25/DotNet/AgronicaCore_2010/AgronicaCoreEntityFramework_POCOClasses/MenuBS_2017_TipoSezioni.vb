...
Partial Public Class MenuBS_2017_TipoSezioni

    'Simple Properties
    <DataMember()>
    Public Property IDTipoSezione As Integer
    <DataMember()>
    Public Property TipoSezione_DES As String
    <DataMember()>
    ...
    <DataMember()>
    Public Overridable Property MenuBS_2017_Sezioni As ICollection(Of MenuBS_2017_Sezioni) = New HashSet(Of MenuBS_2017_Sezioni)
