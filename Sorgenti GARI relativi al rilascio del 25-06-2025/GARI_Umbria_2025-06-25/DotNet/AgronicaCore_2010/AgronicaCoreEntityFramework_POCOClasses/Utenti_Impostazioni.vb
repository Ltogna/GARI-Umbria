...
Partial Public Class Utenti_Impostazioni
    ...
    <DataMember()>
    Public Property Impostazione_Valore_1 As String
    <DataMember()>
    Public Property Impostazione_Valore_2 As String
    <DataMember()>
    Public Property Impostazione_Valore_3 As String
    <DataMember()>
    Public Property Impostazione_Valore_4 As String
    <DataMember()>
