...
Public Class VerificheQuantitative_R
    ...
    Public Function LeggiColonneDataTabella( _
        ...
        Try
            ...
            If nomeTabella <> "" Then
                stb.Append(" and t.name = '" & nomeTabella & "' " & vbCrLf)
            Else
    ...
    Public Function VerificaDB(
        ...
        Try
            ...
            stb.Append("  " & vbCrLf)
            stb.Append(" set @DbNameOrigine = '" & dbOrigine & "' " & vbCrLf)
            stb.Append(" set @DbNameDestinazione = '" & dbDestinazione & "' " & vbCrLf)
            stb.Append("  " & vbCrLf)
            stb.Append("  " & vbCrLf)
            ...
            For Each idtVerifiche In dtVerifiche.Rows
                ...
                stb.Append("  , '" & idtVerifiche("nome_tabella") & "' as nome " & vbCrLf)
...
Public Class VerificheQuantitative_W
    ...
    Public Function AggiornaColonneVisibili(
        ...
        Try
            ...
            StrSQL.Append(" WHERE   nome_tabella ='" & Tabella & "'")
