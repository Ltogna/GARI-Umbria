    ...
    Public Function Verifica(
        ...
        Try
            ...
            If NomeColonnaPiva <> "" AndAlso PIVA_da_filtrare <> "" Then
                stb.Append(" And " & NomeColonnaPiva & " = '" & PIVA_da_filtrare & "' " & vbCrLf)
            End If
            If CondizioneTabellaDa <> "" Then
                stb.Append("                     '" & CondizioneTabellaDa & "'     " & vbCrLf)
            End If
            ...
            If CondizioneTabellaA <> "" Then
                stb.Append("                     '" & CondizioneTabellaA & "'     " & vbCrLf)
            End If
            ...
            stb.Append("          '" & NomeDatabaseDa & "' + '.dbo.'+ '" & NomeTabella & "' as TabellaDa " & vbCrLf)
            stb.Append("        , '" & NomeDatabaseA & "' + '.dbo.'+ '" & NomeTabella & "' as TabellaA " & vbCrLf)
            ...
            stb.Append("            where t.name = '" & NomeTabella & "' " & vbCrLf)
            stb.Append("            and col.name not in ( " & vbCrLf)
            stb.Append("                " & ColonneDaEscludere & "  " & vbCrLf)
            stb.Append("            ) " & vbCrLf)
