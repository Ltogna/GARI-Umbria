...
Public Class Utenti_Permessi_R
    ...
    Public Function Controlla_Permessi_Utente(ByVal UserName As String,
        ...
        Try
            ...
            StrSQL.AppendLine($"    AND Validita_inizio <= {Agro_SQL_SaveDate(DataOraControllo)}")
            StrSQL.AppendLine($"    AND Validita_Fine >= {Agro_SQL_SaveDate(DataOraControllo)}")
    ...
    Public Function LeggiCliente_Permessi(
        ...
        Try
            ...
            If Not String.IsNullOrWhiteSpace(UserName) Then
                StrSQL.AppendLine(" AND UserName = '" & Replace(UserName, "'", "''") & "' ")
            End If
