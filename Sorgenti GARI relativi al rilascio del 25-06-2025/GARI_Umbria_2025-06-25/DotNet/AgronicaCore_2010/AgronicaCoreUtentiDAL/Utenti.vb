...
Public Class Utenti_Read
    ...
    Public Function Leggi_X_Sincronizzazione_Uuenti_Visibilita_Appoggio(ByRef objParametri As AgronicaCoreParametri) As DataTable
        ...
        Try
            ...
            StrSQL.Length = 0
            StrSQL.AppendLine(" SELECT u.UserName , up.Utente, up.Descrizione_1, up.Descrizione_2, up.Data_Modifica, up.DataUltimoRiportoUtentiVisibilitaAppoggio ")
            StrSQL.AppendLine(" From utenti u ")
            StrSQL.AppendLine(" inner Join Utenti_Profili up ")
            StrSQL.AppendLine(" On u.UserName = up.Utente ")
            StrSQL.AppendLine(" WHERE")
            StrSQL.AppendLine(" up.Id_Servizio = 5 ")
            StrSQL.AppendLine(" And ")
            StrSQL.AppendLine(" ( up.DataUltimoRiportoUtentiVisibilitaAppoggio Is null ")
            StrSQL.AppendLine(" Or ")
            StrSQL.AppendLine(" (up.DataUltimoRiportoUtentiVisibilitaAppoggio Is Not null And up.dataUltimoRiportoUtentiVisibilitaAppoggio < up.Data_Modifica)) ")
...
Public Class Utenti_Write
    ...
    Public Function ModificaLockTentativi(ByVal UserName As String,
        ...
        Try
            ...
            StrSQL.AppendLine("SET @username =  '" & Replace(UserName, "'", "''") & "'")
