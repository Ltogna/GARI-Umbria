...
Public Class Utenti_TipologiexPermessi_R
    ...
    Public Function Leggi_Gerarchia_Permessi(ByRef objParametri_Server As AgronicaCoreDataProvider.AgronicaCoreParametri,
        ...
        Try
            ...
            StrSQL.AppendLine("   SELECT uat.id_attivita, uat.Attivita_Des, uatp.Id_Attivita as ID_Attivita_Padre, uatp.Attivita_Des as Attivita_Padre ")
            ...
            StrSQL.AppendLine("     WHERE #Permessi.attivita != 0 ")
            ...
            StrSQL.AppendLine("     WHERE #NonAssegnatiConPadri.Id_Attivita != 0 ")
            StrSQL.AppendLine(" ) ")
