...
namespace AgronicaNetCore.Anagrafe.DAL.DataLayer.Programmazione
{
    public class Programmazione : BaseDALAnagrafe, IProgrammazione
    {
        ...
        public async Task<DataTable?> GetPlanningPerConfrontoCatastoAsync(string partitaIva, int programmazioneCod, AgronicaCoreParametri objParametri, bool origine = true, bool ShowCatasto = false, bool showVarieta = false)
        {
            var strSql = "";
