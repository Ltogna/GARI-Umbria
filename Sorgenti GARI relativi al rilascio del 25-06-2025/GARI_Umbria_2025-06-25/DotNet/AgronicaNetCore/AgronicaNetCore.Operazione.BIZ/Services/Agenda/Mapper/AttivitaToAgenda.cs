...
namespace AgronicaNetCore.Operazione.BIZ.Services.Agenda.Mapper
{
    public class AttivitaToAgenda : BaseServiceOperazioneBIZ, IAttivitaToAgenda
    {
        ...
        private AgronicaCoreParametri _server;
        ...
        private bool isRilievoSenzaImpianti()
        {
            ...
            string[] keyList = _attivita.job.primaryKey.codice.Split('|');
            bool isRilievoMaturitaODanni = keyList.Cast<int>()
                .Any(x => x == LAV_COD.LAVCOD_RILIEVO_INDICI_MATURITA || x == LAV_COD.LAVCOD_DANNI_RACCOLTA);
        ...
        public async Task<OperazioneAgenda> MapAttivitaToAgenda(Attivita attivita, AgronicaCoreParametri objParametriServer)
        {
            _attivita = attivita;
