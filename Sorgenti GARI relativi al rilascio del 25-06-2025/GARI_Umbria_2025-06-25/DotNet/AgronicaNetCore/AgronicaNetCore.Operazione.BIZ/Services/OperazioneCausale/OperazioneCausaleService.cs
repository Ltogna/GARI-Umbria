...
public class OperazioneCausaleService : BaseServiceOperazioneBIZ, IOperazioneCausaleService
{
    ...
    public async Task<DataTable> OperazioneCausale_LeggiAsync(LeggiOperazione leggiOperazione, AgronicaCoreParametri objParametriServer, AgronicaCoreParametri objParametriUtente)
    {
        DataTable dt;
        try
        {
    ...
    public async Task<DataTable> Leggi_CausaleDes_From_CausaleId_Async(int id, AgronicaCoreParametri objParametriServer, AgronicaCoreParametri objParametriUtente)
    {
        DataTable dt;
        try
        {
    ...
    public async Task<bool> OperazioneCausale_ScriviModificaAsync(OperazioneCausale_In body, AgronicaCoreParametri objParametriServer, AgronicaCoreParametri objParametriUtente)
    {
    ...
    public async Task<bool> OperazioneCausale_CancellaAsync(int id, int lavCod, AgronicaCoreParametri objParams) 
    {
        var result = await _operazioneCausaleDal.CancellaAsync(id, lavCod, objParams);
        return result;
    }
}
