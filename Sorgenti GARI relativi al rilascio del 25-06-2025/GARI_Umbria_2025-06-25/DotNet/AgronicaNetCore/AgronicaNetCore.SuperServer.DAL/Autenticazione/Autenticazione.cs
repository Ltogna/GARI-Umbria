...
namespace AgronicaNetCore.SuperServer.DAL.Autenticazione
{
    public class Autenticazione : BaseDALSuperServer, IAutenticazione
    {
        ...
        public async Task<bool> AggiornaUtentiTokenJWTAsync(string idToken, AggiornaUtentiTokenJWTCampi campi, AgronicaCoreParametri objParametriSuperServer)
        {
        ...
        public async Task<DataTable> LeggiObjParametriAsync(string IdToken, AgronicaCoreParametri objParametriSuperServer)
        {
            var stbQuery = new StringBuilder();
            var parametriSql = new Dictionary<string, object>();
            DataTable result;
        ...
        public DataTable LeggiObjParametri(string IdToken, AgronicaCoreParametri objParametriSuperServer)
        {
            var stbQuery = new StringBuilder();
            var parametriSql = new Dictionary<string, object>();
            DataTable result;
        ...
        public async Task<DataTable> LeggiConRefreshTokenAsync(string refreshToken, AgronicaCoreParametri objParametriSuperServer)
        {
            var stbQuery = new StringBuilder();
            var parametriSql = new Dictionary<string, object>();
            DataTable result;
        ...
        public async Task<bool> ScriviAsync(string tokenId, string objPSuperServer, string objPServer, string objPUtenti, string codiceFiscale, string coreWSBaseUrl, string username, string pivaSuperUser, string versioneApp, string refreshToken, DateTime dataCreazione, DateTime dataFineValidita, int idDb, AgronicaCoreParametri objParametriSuperServer)
        {
            var stbQuery = new StringBuilder();
            var parametriSql = new Dictionary<string, object>();
            bool result = false;
