...
namespace AgronicaNetCore.Widgets.DAL.DataLayer.WidgetsStatistiche.WidgetsStatistiche
{
    public class WidgetsStatistiche : BaseDALWidgets, IWidgetsStatistiche
    {
        ...
        public async Task<DataTable?> GetGeneralStatisticsAsync(int year, string country, AgronicaCoreParametri objParametri)
        {
            var parSql = new Dictionary<string, object>();
            DataTable? result;
            ...
            try
            {
                if (string.IsNullOrEmpty(country))
                    throw new Exception("Specificare un country");

                if (year == 0) throw new Exception("Selezionare un anno per cui estrarre le statistiche");
                ...
                string? strSql = @"
                            ...
                            FROM Reg_Impianti r
                            INNER JOIN Imprese i ON i.PIVA = r.PIVA
                            INNER JOIN ImpresexIndirizzi ei ON i.piva=ei.piva
                            INNER JOIN Indirizzi ind ON ind.cod_indirizzo = ei.cod_indirizzo
                            WHERE Stato = @country
                            AND YEAR(i.Validita_Inizio) <= @year AND YEAR(i.Validita_Fine) >= @year
...
";
        ...
        public async Task<DataTable?> GetMappedFarmersAsync(int year, string country, AgronicaCoreParametri objParametri)
        {
            var parSql = new Dictionary<string, object>();
            DataTable? result;
...
";
        ...
        public async Task<DataTable?> GetMovedMappedFarmersPriorWeekAsync(int year, string country, AgronicaCoreParametri objParametri)
        {
            var parSql = new Dictionary<string, object>();
            DataTable? result;
        ...
        public async Task<DataTable?> GetMovedMappedFarmersCampaignBeginAsync(int year, string country, DateTime campaignBegin, DateTime campaignEnd, AgronicaCoreParametri objParametri)
        {
            var parSql = new Dictionary<string, object>();
            DataTable? result;
...
";
        ...
        public async Task<DataTable?> GetCropMapAsync(int year, string country, AgronicaCoreParametri objParametri)
        {
            var parSql = new Dictionary<string, object>();
            DataTable? result;
            ...
            try
            {
                ...
                string? strSql = @"
                            ...
                            -- @Top5Species
                            ; WITH cte_Country AS (
	                            SELECT DISTINCT i.PIVA FROM Imprese i 
	                            INNER JOIN ImpresexIndirizzi ei ON i.piva=ei.piva
	                            INNER JOIN Indirizzi ind ON ind.cod_indirizzo = ei.cod_indirizzo
        ...
        public async Task<DataTable?> GetFarmersHarvestSowingDataAsync(int year, string country, AgronicaCoreParametri objParametri)
        {
            var parSql = new Dictionary<string, object>();
            DataTable? result;
        ...
        public async Task<DataTable?> GetPlotsHarvestSowingDataAsync(int year, string country, AgronicaCoreParametri objParametri)
        {
            var parSql = new Dictionary<string, object>();
            DataTable? result;
        ...
        public async Task<DataTable?> GetTargetHAAsync(int year, string country, AgronicaCoreParametri objParametri)
        {
            var parSql = new Dictionary<string, object>();
            DataTable? result;
            try
        ...
        public async Task<DataTable?> GetFarmerxRegionxRangeAsync(int year, string country, AgronicaCoreParametri objParametri)
        {
            var parSql = new Dictionary<string, object>();
            DataTable? result;
            try
