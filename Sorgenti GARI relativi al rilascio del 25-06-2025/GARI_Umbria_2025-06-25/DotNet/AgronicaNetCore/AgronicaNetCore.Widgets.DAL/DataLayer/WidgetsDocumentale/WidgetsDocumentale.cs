...
namespace AgronicaNetCore.Widgets.DAL.DataLayer.WidgetsDocumentale.WidgetsDocumentale
{
    public class WidgetsDocumentale : BaseDALWidgets, IWidgetsDocumentale
    {
        ...
        public async Task<DataTable?> GetDocumentRecapAsync(DateTime timeStart, bool useWorkflow, bool userVisibility, AgronicaCoreParametri objParametriServer, AgronicaCoreParametri objParametriUser)
        {
            ...
            try
            {
                string UserDBName = GetDBName(objParametriUser);
        ...
        private async Task<DataTable> GetCategTipologiaDocumentiXUtentiAsync(AgronicaCoreParametri objParametriServer)
        {
            var parSql = new Dictionary<string, object>();
            DataTable result;
            var stbQuery = new StringBuilder();
        ...
        private async Task<DataTable> GetHierarchyxChildAsync(AgronicaCoreParametri objParametriServer)
        {
            var parSql = new Dictionary<string, object>();
            DataTable result;
            var stbQuery = new StringBuilder();
