...
namespace AgronicaNetCore.Operazione.DAL.DataLayer.Agronica_Log_Agenda
{
    public class Agronica_Log_Agenda : BaseDALOperazione, IAgronica_Log_Agenda
    {
        ...
        public async Task<bool> CreateAsync(WriteLogAgenda dtoLogAgenda, AgronicaCoreParametri objP)
        {
        ...
        public async Task<bool> UpdateAsync(WriteLogAgenda dtoLogAgenda, AgronicaCoreParametri objP)
        {
        ...
        public async Task<bool> DeleteAsync(int Id, string Piva, int Id_Agenda, AgronicaCoreParametri objP)
        {
            if (Id == 0)
                throw new Exception("ID non valorizzato.");
