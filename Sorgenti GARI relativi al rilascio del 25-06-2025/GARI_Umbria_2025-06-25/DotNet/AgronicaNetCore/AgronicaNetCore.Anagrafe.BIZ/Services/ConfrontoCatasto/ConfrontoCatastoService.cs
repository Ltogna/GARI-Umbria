...
namespace AgronicaNetCore.Anagrafe.BIZ.Services.ConfrontoCatasto
{
    public class ConfrontoCatastoService : BaseServiceAnagrafeBIZ, IConfrontoCatastoService
    {
        ...
        public async Task<DataTable?> GetConfrontoCatastoAsync(ParametriTipoConfronto tipoConfronto, AgronicaCoreParametri objParametri)
        {
            DataTable? res = null;
            try
            {
                switch ((enum_TipoConfrontoCatasto)tipoConfronto.tipoConfronto)
                {
                    case enum_TipoConfrontoCatasto.Planning_PianoColturale:
                        res = await ElaboraConfrontoPlanning_PianoColturaleAsync(tipoConfronto, objParametri);
                        break;
        ...
        private async Task<DataTable?> ElaboraConfrontoPlanning_PianoColturaleAsync(ParametriTipoConfronto parametriConfronto, AgronicaCoreParametri objParametri)
        {
            try
            {
