...
public class SpecieVegetaliDefault : BaseDALSpecieVegetaliDefault, ISpecieVegetaliDefault
{
        ...
        string additionalFilter, AgronicaCoreParametri objParams)
    {
        ...
        try
        {
            var result = await GetDataProvider(objParams).ExecuteReadAsync(stbQuery.ToString(), sqlParams);
    ...
    public async Task<bool> ScriviAsync(int id, string piva, int vegCod, int culCod, int codice, string valore, int nCiclo,
        DateTime dtInizio, DateTime dtFine, AgronicaCoreParametri objParams)
    {
    ...
    public async Task<bool> CancellaAsync(string piva, int vegCod, int culCod, string additionalFilter, AgronicaCoreParametri objParams)
    {
