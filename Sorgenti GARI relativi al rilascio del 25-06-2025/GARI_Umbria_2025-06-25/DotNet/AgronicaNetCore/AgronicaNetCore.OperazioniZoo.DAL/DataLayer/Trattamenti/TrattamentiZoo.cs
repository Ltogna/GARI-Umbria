...
namespace AgronicaNetCore.OperazioniZoo.DAL.DataLayer.Trattamenti
{
    public class TrattamentiZoo : BaseDALOperazioniZoo, ITrattamentiZoo
    {
        ...
        public async Task<bool> ScriviAgendaAsync(string Piva, int Sa_Cod, int Sta_Num, int Id_Agenda, DateTime inizio, DateTime fine, AgronicaCoreParametri objP)
        {
            ...
            expandoObj.TryAdd("@usernameOp", objP.UsernameOperazione);
        ...
        public async Task<bool> ScriviAgroLogAgendaAsync(int idAgenda, string piva, int saCod, DateTime inizio, int tipoOp, AgronicaCoreParametri objP)
        {
            var stbQuery = new StringBuilder();
        ...
        public async Task<bool> ScriviMovimentiAsync(string piva, int idAgenda, DateTime inizio, DateTime registrazione, AgronicaCoreParametri objP)
        {
            var stbQuery = new StringBuilder();
