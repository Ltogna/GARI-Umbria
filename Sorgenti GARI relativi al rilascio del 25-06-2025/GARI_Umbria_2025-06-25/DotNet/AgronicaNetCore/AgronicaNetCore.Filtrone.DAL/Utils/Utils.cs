...
namespace AgronicaNetCore.FiltroRicerca.DAL.Utils.Utils
{
    ...
    public class Enum_DTColumns
    {
        ...
        public static readonly string[] FilterOut_Aziende = new string[]
        {
            ...
            "delega", "at_prevalente", "forma_giuridica", "forma_conduzione", "sup_totale",
            "tipoimpresagerarchia", "codesenzione",
        ...
        public static readonly string[] FilterOut_Appezzamenti = new string[]
        {
            ...
            "supbz_riduzione", "altrivitignipresenti", "agea_idschedavalidazione", "agea_identificativopianocoltivazione",
            "agea_identificativoisola", "agea_identificativoappezzamento", "agea_idappezzamentoorig", "agea_codibarrschevali"
        };
        /// <summary>
        ...
        public static readonly string[] FilterOut_Impianti = new string[]
        {
            ...
            "udm_cod_alt", "sup_alt", "agea_idcolt", "data_inizio_impianto"
        };
        /// <summary>
