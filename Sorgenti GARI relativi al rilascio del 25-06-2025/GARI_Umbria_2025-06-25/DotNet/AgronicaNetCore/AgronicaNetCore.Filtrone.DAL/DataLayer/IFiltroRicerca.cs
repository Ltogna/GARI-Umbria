...
namespace AgronicaNetCore.FiltroRicerca.DAL.DataLayer.FiltroRicerca
{
    ...
    {
        Task<CriteriRicerca_OUT> GetResultAsync(CriteriRicercaExtended criteriRicerca, ConfiguratoreFiltroRicerca configuratore, string utenti_DB_name, AgronicaCoreParametri objParametriServer, AgronicaCoreParametri objParametriUtenti);
    }
}
