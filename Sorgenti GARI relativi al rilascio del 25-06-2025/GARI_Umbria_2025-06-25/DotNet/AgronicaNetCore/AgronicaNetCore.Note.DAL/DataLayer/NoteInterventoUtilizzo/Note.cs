...
public class Note : BaseDALNote, INote
{
        ...
        AgronicaCoreParametri objParams)
    {
        ...
        sqlParams.TryAdd("@pivaSuperUser", objParams.PivaSuperUser);
    ...
    public async Task<string> LeggiNotaDesFromNotaCodAsync(int notaCod, AgronicaCoreParametri objParams)
    {
        var stbQuery = new StringBuilder();
        var sqlParams = new Dictionary<string, object>();
        ...
        try
        {
            var dt = await GetDataProvider(objParams).ExecuteReadAsync(stbQuery.ToString(), sqlParams);
    ...
    public async Task<string> LeggiNotaUtilizzoDesFromNotaUtilizzoCodAsync(int notaUtilizzoCod, AgronicaCoreParametri objParams)
    {
        var stbQuery = new StringBuilder();
        var sqlParams = new Dictionary<string, object>();
        ...
        AgronicaCoreParametri objParams)
    {
        ...
        expandoObj.TryAdd("@userNameCreazione", objParams.UsernameOperazione);
        expandoObj.TryAdd("@userNameModifica", objParams.UsernameOperazione);
        ...
        try
        {
            return await GetDataProvider(objParams).Execute_WriteAsync(sqlString, expandoObj);
        }
        catch (Exception ex)
        {
            LogError(ex.Message, objParams, ex);
    ...
    public async Task<int> NoteInterventoGruppiNewIdAsync(AgronicaCoreParametri objParams)
    {
        ...
        try
        {
            var dt = await GetDataProvider(objParams).ExecuteReadAsync(sqlString);
    ...
    public async Task<bool> CancellaGruppoNoteAsync(int gruppoNoteCod, AgronicaCoreParametri objParams)
    {
        ...
        if (objParams.FlagCancellazioneLogica == AgronicaCoreParametri.enumCancellazioneLogica.CancellazioneLogica)
        {
        ...
        try
        {
            return await GetDataProvider(objParams).Execute_WriteAsync(builder.ToString(), expandoObj);
        }
        catch (Exception ex)
        {
            LogError(ex.Message, objParams, ex);
    ...
    public async Task<int> NoteNewIdAsync(AgronicaCoreParametri objParams)
    {
        const string sqlString = @"SELECT ISNULL (
                                     (CASE(MAX(Nota_Cod) + 1 )
                                         WHEN 0 THEN 1 
    ...
    public async Task<bool> CancellaGruppoNoteUtilizzoAsync(int notaGruppoCod, int notaUtilizzoCod, AgronicaCoreParametri objParams)
    {
        var builder = new StringBuilder();
        var expandoObj = new ExpandoObject();
    ...
    public async Task<bool> ModificaVisibilitaGruppoAsync(int notaGruppoCod, bool visible, AgronicaCoreParametri objParams)
    {
        var builder = new StringBuilder();
        var expandoObj = new ExpandoObject();
    ...
    public async Task<bool> ModificaVisibilitaNotaAsync(int notaCod, bool visible, AgronicaCoreParametri objParams)
    {
        var builder = new StringBuilder();
        var expandoObj = new ExpandoObject();
