...
public partial class TmpAgenda : BaseDALUtility, ITmpAgenda
{
    ...
    public async Task<bool> ScriviAsync(int idTestataTemp, string piva, int idAgenda, int lavCod, AgronicaCoreParametri objParametriServer)
    {
    ...
    public async Task<bool> CancellaRecordDaIDTestataTempAsync(int idTestataTemp, AgronicaCoreParametri objParametriServer)
    {
