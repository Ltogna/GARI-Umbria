...
Public Class ImportatoreMassivoPlanning
    ...
    Public Function AvviaImportazione()
        ...
        Dim obj As New AGEA_UMBRIA_Utility
        ...
        Try
            ...
            If Not IsNothing(deserializedObject) Then
                ...
                deserializedObject = deserializedObject.Where(Function(z) z.Istat_provincia = "054" Or z.Istat_provincia = "055").ToList()
        ...
        For index As Integer = 0 To DTImprese.Rows.Count
            ...
            Try
                ...
                If impresaResult.Piva = "" And impresaResult.Cuaa <> "" Then
    ...
    Private Function importaDaFascicoloAGEA(impresa As ImpreseResult,
        ...
        If TipoImportFascicolo = enum_TipoImportFascicolo.ImportFascicoloAgeaRealTime Then
            ...
            Dim fascicolo_agea_rt As New Import_Agea
