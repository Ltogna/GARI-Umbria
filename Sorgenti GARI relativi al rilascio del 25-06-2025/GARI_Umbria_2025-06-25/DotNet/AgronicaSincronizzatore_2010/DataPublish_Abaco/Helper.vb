...
Public Class Helper
    ...
    Private Const CODICE_Codice_Cliente_DEMETRA As Integer = 2201
    ...
    Private Const CODICE_Codice_flag_irriguo As Integer = 1188
    ...
    Public Shared Function MapAnagraficaToImpresa(ByVal cuaa As ObjNotifica(Of CUAAObj),
        ...
        Try
            ...
            Else
                ...
                ret = xImpR.Impresa_Leggi_Anagrafica(piva, True, True, False, False, False, ObjParametriServer)
    ...
    Public Shared Function MapPCGToAppezzamentoCreazione(ByVal cuaa As ObjNotifica(Of CUAAObj),
        ...
        Try
            ...
            If appPK Is Nothing Then
                ...
                ret.metodo_Produzione = New AgronicaCoreModelsSTD.metaschema.MetodoProduzione(1)
                ret.descrizione = pcg.denominazione
                ret.flag_gps = False
                ret.rif_Appezzamento = pcg.id_appezzamento
                ret.cartografia = GetCartography(cuaa, pcg.gis.wkt, pcg.gis.sr_code, "EPSG:4326", pcg.id_appezzamento_padre, pcg.id_appezzamento, _logger, ObjParametriServer, ReplaceInvalidPolygon)
            ...
            Else
                ...
                End If
                ret = xAPPR.Leggi_Appezzamento_Anagrafica(CentroPK.partitaIva, CentroPK.codice, appPK.codice, 0, True, False, False, Date.Now, False, True, False, ObjParametriSuperServer, ObjParametriServer, ObjParametriUtenti)
            ...
            VerificaMetodoProduzioneDaDisciplinare(ret, pcg)
            ...
            Next
            If check_bio Then
                ret.metodo_Produzione = New AgronicaCoreModelsSTD.metaschema.MetodoProduzione(3)
            Else
                ret.metodo_Produzione = New AgronicaCoreModelsSTD.metaschema.MetodoProduzione(1)
            End If
            'Lavez - 27/05/2025 - Log verboso
            ...
            Select Case pcg.tipo_modifica
                ...
                Case "A"
                    ...
                    Else
                        ...
                        ret.cartografia = GetCartography(cuaa, pcg.gis.wkt, pcg.gis.sr_code, "EPSG:4326", pcg.id_appezzamento_padre, pcg.id_appezzamento, _logger, ObjParametriServer, ReplaceInvalidPolygon, LogVerbose)
                        ret.superficie = pcg.area_mq / 10000
                    ...
                    Next
                    If check_bio Then
                        ret.metodo_Produzione = New AgronicaCoreModelsSTD.metaschema.MetodoProduzione(enum_MetodoProduzione.Biologico)
                    Else
                        ret.metodo_Produzione = New AgronicaCoreModelsSTD.metaschema.MetodoProduzione(enum_MetodoProduzione.Convenzionale)
                    End If
    ...
    Private Shared Sub AggiungiNuovoImpianto(ByVal cuaa As ObjNotifica(Of CUAAObj),
        ...
        impiantoNew.codici.Add(New AgronicaCoreModelsSTD.anagrafiche.CodiciAnagrafeValori() With {
                    .codiceAnagrafe = New AgronicaCoreModelsSTD.anagrafiche.CodiceAnagrafe(CODICE_Codice_Cliente_DEMETRA),
                    .validita = New AgronicaCoreModelsSTD.anagrafiche.IntervalloTemporale(),
        ...
        If dic.protocolli IsNot Nothing AndAlso dic.protocolli.Count > 0 Then
            If CheckDisciplinare(dic.protocolli, "BIO") Then
                'esercizioNew.vincolo = New AgronicaCoreModelsSTD.metaschema.Vincolo() With {
                '                            .regolamento = New AgronicaCoreModelsSTD.metaschema.Regolamenti(4),
                '                            .disciplinare = Nothing
                '                        }
                ...
                If vincolo IsNot Nothing Then
                    ...
                    esercizioNew.regolamento = esercizioNew.vincolo.regolamento
                    esercizioNew.disciplinare = esercizioNew.vincolo.disciplinare
                End If
            Else
            ...
            End If
        Else
            esercizioNew.vincolo = Nothing
            esercizioNew.regolamento = Nothing
            esercizioNew.disciplinare = Nothing
        End If
        ...
        If dic.protocolli IsNot Nothing AndAlso dic.protocolli.Count > 0 Then
            If CheckDisciplinare(dic.protocolli, "BIO") Then
                If VincoliList IsNot Nothing Then
                    ...
                    If vincolo IsNot Nothing Then
                        'Lavez - 11/11/2024 - Fix assegnazione disciplinare BIO
                        'Impianto.esercizi(0).vincolo = New AgronicaCoreModelsSTD.metaschema.Vincolo() With {
                        '                            .regolamento = vincolo.regolamento,
                        '                            .disciplinare = vincolo.disciplinare
                        '                        }
                        ...
                        Impianto.esercizi(0).vincolo = New AgronicaCoreModelsSTD.metaschema.Vincolo() With {
                            ...
                            .disciplinare = New AgronicaCoreModelsSTD.metaschema.Disciplinare(0)
                        }
                        Impianto.esercizi(0).regolamento = Impianto.esercizi(0).vincolo.regolamento
                        Impianto.esercizi(0).disciplinare = Impianto.esercizi(0).vincolo.disciplinare
                    End If
                End If
            ...
            End If
        Else
            Impianto.esercizi(0).vincolo = Nothing
            Impianto.esercizi(0).regolamento = Nothing
            Impianto.esercizi(0).disciplinare = Nothing
        End If
