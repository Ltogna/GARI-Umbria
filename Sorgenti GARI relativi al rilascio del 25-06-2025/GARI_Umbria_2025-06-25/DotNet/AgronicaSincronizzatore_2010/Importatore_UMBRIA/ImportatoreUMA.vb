...
Public Class ImportatoreUMA
    ...
    Public Function AvviaImportazione(ByVal pathExcel As String,
                                      ...
                                      ByRef objParametri_Utenti As AgronicaCoreDataProvider.AgronicaCoreParametri) As RispostaStandard
        ...
        Try
            ...
            If errCaricamentoDatiExcel.Length = 0 AndAlso dtExcel.Rows.Count > 0 Then
                ...
                Dim handlePratiche As New Pratiche_R()
                ...
                For Each dictfascicolo In listaFascicoli
                    ...
                    If rispInsert.RispostaOK = True Then
            ...
            If errCaricamentoDatiExcel.Length = 0 AndAlso dtExcel.Rows.Count > 0 Then
                ...
                For Each drExcel As DataRow In dtExcel.Rows
                    ...
                    If drExcel.Field(Of Double)("tipo_assegnazioni") = 3 Then
                        '---------------------- CONTO PROPRIO ------------------------------------------
                        Dim praticaCP As Pratiche
                        Dim testataCP As UMA_Richieste_Testata
                        ...
                        '---------------------- CONTO TERZI -------------------------------------------
                        Dim praticaCT As Pratiche
                        Dim testataCT As UMA_Richieste_Testata
                    ...
                    Else
                        Dim praticaC As Pratiche
                        Dim testataC As UMA_Richieste_Testata
    ...
    Public Function AvviaImportazioneMacchine(ByVal pathExcel As String, ByVal directoryLog As String, ByRef objParametri_Server As AgronicaCoreParametri, ByRef objParametri_Utenti As AgronicaCoreParametri) As RispostaStandard
        ...
        Try
            ...
            If errCaricamentoDatiExcel.Length = 0 AndAlso dtExcel.Rows.Count > 0 Then
                ...
                Dim handleWriteMacchine As New AgronicaCoreContabDAL.Parco_Macchine_W()
                Dim handleImprese As New Imprese_Read()
    ...
    Private Sub Crea_DtDati_Da_Excel(ByVal StringaConnessione As String, ByRef Messaggio As String, ByRef Dt As DataTable)
        ...
        Try
            ...
            Dim MyConnection As New OleDbConnection(StringaConnessione)
            MyConnection.Open()
            ...
            Dim da As New OleDbDataAdapter("select * from [" & firstSheet & "]", MyConnection)
            da.Fill(ds, "fileXls")
            MyConnection.Close()
