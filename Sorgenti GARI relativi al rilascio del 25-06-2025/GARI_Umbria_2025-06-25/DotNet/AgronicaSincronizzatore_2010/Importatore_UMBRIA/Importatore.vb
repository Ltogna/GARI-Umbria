...
Public Class Importatore
    ...
    Public Function CreaAzienda(ByVal ASG_ProgressivoGIAS As Integer,
        ...
        Dim Fascicolo2 As AGEA_Coordinamento.ISWSRespAnagFascicolo2
        Try
        ...
        If Fascicolo_Umbria IsNot Nothing Then
            ...
            If Not Fascicolo_Umbria.sedeResidenza Is Nothing Then
            ...
            Else
                If Not Fascicolo_Umbria.recapito Is Nothing Then
            ...
            If Istat_Provincia = "" Or Istat_Provincia = "" Then
                strErr = "CUAA:" & Cuaa & " - " & "Impossibile inserire l'impresa poichè manca l'indirizzo!"
                Exit Function
            Else
                If Indirizzo = "" Then
                    Indirizzo = ","
            ...
            If ImportaSoloConConsistenze And Consistenze_Umbria.Count = 0 Then
    ...
    Public Function CreaAziendaGias(ByVal ASG_ProgressivoGIAS As String,
        ...
        If fascicolo IsNot Nothing AndAlso fascicolo.sessoPFSpecified = True AndAlso fascicolo.sessoPF IsNot Nothing Then
        ...
        If fascicolo IsNot Nothing AndAlso Not fascicolo.dataNascitaPF Is Nothing Then
            ...
            ElseIf IsNumeric(fascicolo.dataNascitaPF) Then
                Legale_Rappresentante_Data_Nascita = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(fascicolo.dataNascitaPF)).ToShortDateString
            Else
        ...
        If fascicolo IsNot Nothing AndAlso Not fascicolo.iscrizioneRea Is Nothing AndAlso fascicolo.iscrizioneRea.Length > 0 Then
        ...
        Dim bEsisteRubrica As Boolean = False
        ...
        Dim objRubrica As New AgronicaCoreAnagrafeDAL.ContattixRubrica_R
                ...
                For Each rappresentante In Soggetti.RappresentanteLegaleWS
                    ...
                    If rappresentante.SoggettoWS IsNot Nothing Then
                        ...
                        If rappresentante.SoggettoWS.Data_nasc IsNot Nothing Then
                            DataNascita = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(rappresentante.SoggettoWS.Data_nasc))
                        End If
                        Dim sesso As String = ""
        ...
        If ImportaMacchine Then
            ...
            If Not ISWSMacchine Is Nothing AndAlso
               ISWSMacchine.Count > 0 Then
                ...
                For Each ISWSMacchina In ISWSMacchine
                    ...
                    If ISWSMacchina.DataIscrizione IsNot Nothing Then
                        Validita_Inizio = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(ISWSMacchina.DataIscrizione))
                    End If

                    If ISWSMacchina.DataCessazione IsNot Nothing Then
                        Validita_Fine = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(ISWSMacchina.DataCessazione))
                    End If
        ...
        If CreaCentro = True Then
            ...
            If fascicolo IsNot Nothing AndAlso
                ...
                popolaAppezzamentiDone = False Then
    ...
    Public Function Converti_TipoMacchina(TipoMacchina As String, objParametri_Server As AgronicaCoreDataProvider.AgronicaCoreParametri) As String
    ...
    Private Sub Popola_DtAppezzamenti_daFascicolo_2(ByVal Piva As String,
        ...
        If Not fascicolo Is Nothing AndAlso
                Not fascicolo.dataValidazFascicolo Is Nothing Then
            DataScheda = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(fascicolo.dataValidazFascicolo))
        End If
        ...
        If ISWSTerritorioFS6.Count > 0 Then
            ...
            For Each ISWSTerritorio In ISWSTerritorioFS6
                ...
                If Not DrCom Is Nothing AndAlso DrCom.Length > 0 Then
                ...
                ElseIf ImportCatasto = False Then
                    If CatastoDaImportare = True Then
                        ImportCatasto = True
                        DtParticelle.Clear()
                ...
                If Not ISWSTerritorio.DataInizioConduzione Is Nothing AndAlso ISWSTerritorio.DataInizioConduzione <> "" Then
                    Inizio_Possesso = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(ISWSTerritorio.DataInizioConduzione))
                End If
                If Not ISWSTerritorio.DataFineConduzione Is Nothing AndAlso
                    ...
                    Fine_Possesso = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(ISWSTerritorio.DataFineConduzione))
                End If
                ...
                If Not ISWSTerritorio.Destinazione Is Nothing Then
                    ...
                    For Each ISWSUtilizzoTerra1 In ISWSTerritorio.Destinazione
                        ...
                        If Not (iAggregaSpecie <> 0 Or bAggregaTare) Then
                        ...
                        If ISWSUtilizzoTerra1.Dettagli IsNot Nothing Then
                            ...
                            For Each ISWSUtilizzoTerra In ISWSUtilizzoTerra1.Dettagli
                                ...
                                If Not ISWSUtilizzoTerra Is Nothing Then
                                    ...
                                    DR.Item("datepossesso") = IIf(ISWSTerritorio.DataInizioConduzione <> "19000101", "Dal " & AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(ISWSTerritorio.DataInizioConduzione), "Dal ...") &
                                                                                    IIf(ISWSTerritorio.DataFineConduzione <> "99991231", " al " & AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(ISWSTerritorio.DataFineConduzione), " al ...")
                                    supCatasto = CDbl(ISWSTerritorio.SuperficieCatastale) / 10000.0
                                    objXML.EttariAreCentiare_from_Ettari(supCatasto, Ettari, Are, Centiare)
                                    ...
                                    If Not IsNothing(ISWSUtilizzoTerra1.DataInizioUtilizzo) AndAlso ISWSUtilizzoTerra1.DataInizioUtilizzo <> "" Then
                                        data_inizio_appezzamento = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(ISWSUtilizzoTerra1.DataInizioUtilizzo))
                                    End If
                                    ...
                                    If Not IsNothing(ISWSUtilizzoTerra1.DataFineUtilizzo) AndAlso ISWSUtilizzoTerra1.DataFineUtilizzo <> "" Then
                                        data_fine_appezzamento = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(ISWSUtilizzoTerra1.DataFineUtilizzo))
                                    End If
                                    ...
                                    If Not ISWSUtilizzoTerra.SestoImpiantoTraFile Is Nothing AndAlso ISWSUtilizzoTerra.SestoImpiantoTraFile <> "" AndAlso IsNumeric(ISWSUtilizzoTerra.SestoImpiantoTraFile) Then
                                        TRA_Fila = CInt(ISWSUtilizzoTerra.SestoImpiantoTraFile)
                                    End If

                                    If Not ISWSUtilizzoTerra.SestoImpiantoSuFila Is Nothing AndAlso ISWSUtilizzoTerra.SestoImpiantoSuFila <> "" AndAlso IsNumeric(ISWSUtilizzoTerra.SestoImpiantoSuFila) Then
                                        SU_Fila = CInt(ISWSUtilizzoTerra.SestoImpiantoSuFila)
                                    End If

                                    If Not ISWSUtilizzoTerra.AnnoImpianto Is Nothing AndAlso ISWSUtilizzoTerra.AnnoImpianto <> "" AndAlso IsNumeric(ISWSUtilizzoTerra.AnnoImpianto) Then
    ...
    Private Sub Popola_DtAppezzamenti_daFascicolo_3_Parallel(ByVal Piva As String,
        ...
        'Dim objParametri_ServerCC As AgronicaCoreDataProvider.AgronicaCoreParametri = objParametri_ServerC
        'Dim objParametri_UtentiCC As AgronicaCoreDataProvider.AgronicaCoreParametri = objParametri_UtentiC
        ...
        Parallel.ForEach(ISWSTerritorioFS6,
                         ...
                         Sub(territorio As AGEA_Coordinamento.ISWSTerritorio1, state As ParallelLoopState)
                             ...
                             If Not territorio.DataInizioConduzione Is Nothing AndAlso territorio.DataInizioConduzione <> "" Then
                                 Inizio_Possesso = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(territorio.DataInizioConduzione))
                                 If Inizio_Possesso < AGRODATAINIZIO Then
                                     Inizio_Possesso = AGRODATAINIZIO
                                 End If
                             End If
                             If Not territorio.DataFineConduzione Is Nothing AndAlso
                                 ...
                                 Fine_Possesso = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(territorio.DataFineConduzione))
                             End If
                             ...
                             If Not territorio.Destinazione Is Nothing Then
                                 ...
                                 For j = 0 To territorio.Destinazione.Length - 1
                                     ...
                                     '******   UTILIZZO    **********************************************************************************
                                     '*******************************************************************************************************************
                                     If Not territorio.Destinazione(j).Dettagli Is Nothing Then
                                         ...
                                         For x = 0 To territorio.Destinazione(j).Dettagli.Length - 1
                                             ...
                                             DR.Item("inizio_possesso") = Inizio_Possesso
                                             DR.Item("fine_possesso") = Fine_Possesso
                                             DR.Item("datepossesso") = IIf(territorio.DataInizioConduzione <> "19000101", "Dal " & AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(territorio.DataInizioConduzione), "Dal ...") &
                                                                                                     IIf(territorio.DataFineConduzione <> "99991231", " al " & AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(territorio.DataFineConduzione), " al ...")
                                             supCatasto = CDbl(territorio.SuperficieCatastale) / 10000.0
                                             objXML.EttariAreCentiare_from_Ettari(supCatasto, Ettari, Are, Centiare)
                                             DR.Item("sup") = Format(supCatasto, "0.0000")
                                             supConduzione = CDbl(territorio.SuperficieCondotta) / 10000.0
    ...
    Private Sub Popola_DtAppezzamenti_daFascicolo_3(ByVal Piva As String,
        ...
        Dim dtZoneGlobal As DataTable
        Dim dtParticelleVulnerabiliGlobal As DataTable
        ...
        For Each territorio In ISWSTerritorioFS6
            ...
            If Sezione = "" Then
                DT_CentriQuery = DT_CentriQuery.Where(Function(c) c("SEZIONE").Equals("") Or c("SEZIONE").Equals("0"))
            Else
                DT_CentriQuery = DT_CentriQuery.Where(Function(c) CStr(c("SEZIONE")).ToLower.Equals(Sezione.ToLower))
            End If

            If Subalterno = "" Then
                DT_CentriQuery = DT_CentriQuery.Where(Function(c) c("SUBALTERNO").Equals("") Or c("SUBALTERNO").Equals("0"))
            Else
            ...
            If Subalterno = "" Or Subalterno = "000" Then
                strSubalterno = "0"
            Else
                strSubalterno = Subalterno
            End If
                ...
                For j = 0 To territorio.Destinazione.Length - 1
                    ...
                    If Not territorio.Destinazione(j).Dettagli Is Nothing Then
                        ...
                        For x = 0 To territorio.Destinazione(j).Dettagli.Length - 1
                            ...
                            If Sezione = "" Then
                                dtZoneQuery = dtZoneQuery.Where(Function(c) c("SEZIONE").Equals("") Or c("SEZIONE").Equals("0"))
                            Else
                                dtZoneQuery = dtZoneQuery.Where(Function(c) CStr(c("SEZIONE")).ToLower.Equals(Sezione.ToLower))
                            End If

                            If Subalterno = "" Then
                                dtZoneQuery = dtZoneQuery.Where(Function(c) c("SUBALTERNO").Equals("") Or c("SUBALTERNO").Equals("0"))
                            Else
                            ...
                            If Sezione = "" Then
                                dtVulnerabiliQuery = dtVulnerabiliQuery.Where(Function(c) c("SEZIONE").Equals("") Or c("SEZIONE").Equals("0"))
                            Else
                                dtVulnerabiliQuery = dtVulnerabiliQuery.Where(Function(c) CStr(c("SEZIONE")).ToLower.Equals(Sezione.ToLower))
                            End If

                            If Subalterno = "" Then
                                dtVulnerabiliQuery = dtVulnerabiliQuery.Where(Function(c) c("SUBALTERNO").Equals("") Or c("SUBALTERNO").Equals("0"))
                            Else
    ...
    Public Function GeneraRandom(objParametri_Server As AgronicaCoreParametri,
        ...
        Try
            ...
            While ok = False
                ...
                dt = objCont.LeggiContattoSpecifico("", str_r, 0, AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaDatiMinimi, "", "", objParametri_Server)
    ...
    Private Function CreaStringaCatasto(DTParticelle As IEnumerable(Of DataRow))
    ...
    Private Function impostaCatasto(Istat_Prov As String,
        ...
        If Not Istat_Prov Is Nothing Then
    ...
    Public Function PopolaDT_Appezzamenti(ByVal Piva As String,
    ...
    Public Function PopolaDT_Appezzamenti_ISWSRespAnagFascicolo2(ByVal Piva As String,
                                          ByRef fascicolo As String,
                                          ByVal iAggregaSpecie As Integer,
                                          ByVal bAggregaTare As Boolean,
                                          ByRef DataInizio As Date,
    ...
    Private Shared Function ImportaCatastoFascicolo(ByRef fascicolo As AGEA_Coordinamento.ISWSRespAnagFascicolo15,
                                                    ByRef ISWSTerritorioFS6 As List(Of AGEA_Coordinamento.ISWSTerritorio1),
                                                    piva As String,
                                                    cuaa As String,
        ...
        Dim InserisciImpresa As Boolean '= Chk_Importa_Aziende.Checked
        ...
        Dim XmlFascicolo As XmlElement
        ...
        Dim RichiesteConSuccesso As Integer = 0
        Dim Errate As Integer = 0
        Dim senzaSchede As Integer = 0
        Dim Importate As Integer = 0
        Dim anagrafeRisponde As Integer = 0
        Dim anagrafeErrore As Integer = 0
        Dim conSchedeList As New List(Of String)
        Dim senzaSchedeList As New List(Of String)
        Dim objConfSiti As New AgronicaCoreVarieDAL.Configurazione_Siti_R
        Dim Path_File_XLS As String
        ...
        If fascicolo Is Nothing Then
            Return ""
        End If
        If Not fascicolo.dataSottMandato Is Nothing Then
            DataInizioMandato = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(fascicolo.dataSottMandato))
        End If
        If Not fascicolo.dataAperturaFascicolo Is Nothing Then
            DataAperturaFascicolo = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(fascicolo.dataAperturaFascicolo))
        End If
        If Not fascicolo.dataChiusuraFascicolo Is Nothing Then
            DataChiusuraFascicolo = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(fascicolo.dataChiusuraFascicolo))
        End If
        Dim dataScheda As Date
        If Not fascicolo.dataSchedaValidazione Is Nothing Then
            dataScheda = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(fascicolo.dataSchedaValidazione))
        End If
        ...
        'verifico INDIRIZZO
        If Not fascicolo.sedeResidenza Is Nothing Then
        ...
        Else
            ...
            If Not fascicolo.recapito Is Nothing Then
        ...
        If Istat_Provincia = "" Or Istat_Provincia = "" Then
            'MsgOK = "CUAA:" & Cuaa & ", Scheda N° " & scheda.numeroScheda & " -  " & "Impossibile inserire l'impresa poichè manca l'indirizzo!"
            'objLog.Scrivi_LOG(objParametri_Server.LogDirectory,
            '     objParametri_Server.LogFileName,
            '     objParametri_Server.LogDescrizioneUtente,
            '     NomeRoutine,
        ...
        If aggregaCentri Then
            ...
            Else
                ...
                DtFabb = objFabb.Leggi(piva, SaCod, 0, AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaDatiMinimi,
        ...
        Else
            ...
            For Each Com In listCom
                Dim dtCom = objIstat.Leggi(Com.Split("|")(1), Com.Split("|")(0), "", "", "", AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta, "", "", objParametri_Server)
                If dtCom IsNot Nothing AndAlso dtCom.Rows.Count > 0 Then
                    ...
                    If tipoOperazione = enum_TipoOperazioneDB.Modifica Then
                        ...
                        Dt_Centri = objCentri.Leggi(piva,
                                                    0,
                                                    AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_JoinDescrizioni,
                                                    " Sa_Nome=" + AgronicaCoreDataProvider.UtilityProvider.Agro_SQL_SaveText_NULL(SaNome) + "", "",
                                                    objParametri_Server)
        ...
        If Not ISWSTerritorioFS6 Is Nothing Then
            ...
            If ISWSTerritorioFS6.Count > 0 Then
                ...
                Dim Impostazione_Valore_VerificaPossessi As String = ""
                ...
                If stringaAnagrafica <> "" Then
                    ...
                    '    ''----------------------------------------------------------
                    '    ''apro le pratiche
                    '    'If ApriPraticaRegFert = True Then
                    ...
                    '    'End If
                    '    'If ApriPraticaRegFito = True Then
    ...
    Private Shared Function ImportaCatastoFascicolo2(ByRef fascicolo As AGEA_Coordinamento.ISWSRespAnagFascicolo15,
                                                    ByRef ISWSTerritorioFS6 As List(Of AGEA_Coordinamento.ISWSTerritorio15),
                                                    piva As String,
                                                    cuaa As String,
                                                    aggregaCentri As Boolean,
    ...
    Private Shared Function ImportaCatastoFascicolo_ISWSRespAnagFascicolo2(ByRef fascicolo As AGEA_Coordinamento.ISWSRespAnagFascicolo2,
                                                    ByRef ISWSTerritorioFS6 As List(Of AGEA_Coordinamento.ISWSTerritorio1),
                                                    piva As String,
                                                    cuaa As String,
                                                    aggregaCentri As Boolean,
