...
Public Class Importatore_AGEA_UMBRIA
    ...
    Public Function avviaImportazione() As Boolean
        ...
        Dim returnBool = True
        'If False Then
        If linkWS_AGEAFS5 <> "" And username_AGEA <> "" And password_AGEA <> "" Then
            Try
    ...
    Public Function importazioneAGEAFS5() As Boolean
        ...
        Dim CUAA_Modificati As AGEA_Coordinamento.ISWSToOprResponse
                        ...
                        If fascicolo.Items(0).schedaValidazione IsNot Nothing Then
                            ...
                            If fascicolo.Items(0).Cuaa = Cuaa Then
                                ...
                                If Not fascicolo Is Nothing AndAlso
                                    Not fascicolo.Items(0).schedaValidazione Is Nothing Then

                                    dataValidazione = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(fascicolo.Items(0).dataValidazFascicolo))
                                ...
                                Dim consistenze As AGEA_Coordinamento.ISWSToOprResponse
                                ...
                                Dim macchine As AGEA_Coordinamento.ISWSToOprResponse
                                ...
                                Dim soggetti As AGEA_Coordinamento.ISWSToOprResponse
                                ...
                                Dim fascicolo20 As AGEA_Coordinamento.ISWSToOprResponse
                                ...
                                Dim consistenzeFS3 As AGEA_Coordinamento.ISWSToOprResponse
                                ...
                                Dim allevamenti As AGEA_Coordinamento.ISWSToOprResponse
    ...
    Public Function importazioneAGEAFS6() As Boolean
        ...
        Dim CUAA_Modificati As AGEA_UMBRIA_FS6.ISWSToOprResponse
            ...
            Try
                For Each anno In listaAnni
                    ...
                    For Each scheda In respSchede
                        Dim schedaCompletaT As AGEA_UMBRIA_FS6.ISWSToOprResponse
                        ...
                        If schedaCompletaT.Items.Length = 1 AndAlso schedaCompletaT.Items(0).ToString <> "" Then
                            ...
                            If ISWSScheda.Riepilogo IsNot Nothing Or ISWSScheda.PianoColtivazione IsNot Nothing Or ISWSScheda.ComposizioneTerritorio IsNot Nothing Then
                                Dim gino = 0
                            End If
                        End If
    ...
    Public Function allineamentoDatiAGEAFS5() As Boolean
        Dim import_Agea As New Import_AGEAFS5(linkWS_AGEAFS5, username_AGEA, password_AGEA)
