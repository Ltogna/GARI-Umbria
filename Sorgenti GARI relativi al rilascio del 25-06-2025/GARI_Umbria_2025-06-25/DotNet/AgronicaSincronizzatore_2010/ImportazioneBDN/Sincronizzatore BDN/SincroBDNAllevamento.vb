...
Public Class SincroBDNAllevamento
    ...
    Dim MatricoledaControllare As New List(Of String) From {"FR1542155411", "FR8938172016", "FR1542027429", "FR0330392064", "FR6370502771", "FR1222338201", "FR1828182667"}
    ...
    Public Function SincronizzaAllevamento(ByVal Piva As String,
        ...
        Try
            ...
            If IdFiscale_DetentoreConfigurato <> "" AndAlso IdFiscale_Detentore <> IdFiscale_DetentoreConfigurato Then
                Throw New GiasException("Il detentore dell'allevamento non corrisponde a quello configurato")
            End If
    ...
    Private Function ConsistenzaCapiBDN_Carico(ByVal lista_CaricoCapi As List(Of IDictionary(Of String, Object)),
        ...
        For Each ingresso In lista_DateIngresso_Stalla
            ...
            Try
                ...
                Dim lista_capoAnimaleCDC_Acquisto As New List(Of attivita.centri_di_costo.CentroDiCosto)
                Dim lista_capoAnimaleCDC_Nascita As New List(Of attivita.centri_di_costo.CentroDiCosto)
                Dim lista_capoAnimaleCDC_PrimaIscrizione As New List(Of attivita.centri_di_costo.CentroDiCosto)
                    ...
                    Try
                        ...
                        Dim movimentiCaricoDB = (From a In GiasContext.Agenda
                                                 ...
                                                 Where m.Cau_Mov = CAU_CARICO_CONSISTENZE And
                                                     ...
                                                     ragg.PIVA = Piva And
                                                     zoo.Matricola = Matricola_Capo).ToList
                ...
                If lista_capoAnimaleCDC_Acquisto.Count > 0 Then
                    ...
                    listaMatricole_Carico.AddRange((From a As attivita.centri_di_costo.CapoAnimaleCDC In lista_capoAnimaleCDC_Acquisto Select a.capoAnimale.matricola).ToList())
                    listaMatricole_CaricoxGiorno.AddRange((From a As attivita.centri_di_costo.CapoAnimaleCDC In lista_capoAnimaleCDC_Acquisto Select a.capoAnimale.matricola).ToList())
                End If

                If lista_capoAnimaleCDC_Nascita.Count > 0 Then
                    Dim objAttivita As New attivita.Attivita
                    objAttivita.fine = AGRODATAFINE
                    objAttivita.job = New attivita.Zootecnia(LAVCOD_NASCITA_ANIMALI, "")
                    objAttivita.centroAziendale = New anagrafiche.CentroAziendale With {
                            .primaryKey = New anagrafiche.CentroAziendale.PK(CentroAzienda_Cod, Piva)
                    }
                    objAttivita.inizio = CDate(ingresso)
                    ...
                    listaMatricole_Carico.AddRange((From a As attivita.centri_di_costo.CapoAnimaleCDC In lista_capoAnimaleCDC_Nascita Select a.capoAnimale.matricola).ToList())
                    listaMatricole_CaricoxGiorno.AddRange((From a As attivita.centri_di_costo.CapoAnimaleCDC In lista_capoAnimaleCDC_Nascita Select a.capoAnimale.matricola).ToList())
                End If

                If lista_capoAnimaleCDC_PrimaIscrizione.Count > 0 Then
                    Dim objAttivita As New attivita.Attivita
                    objAttivita.fine = AGRODATAFINE
                    objAttivita.job = New attivita.Zootecnia(LAVCOD_INCREMENTO_CONSISTENZE_ZOO, "")
                    objAttivita.centroAziendale = New anagrafiche.CentroAziendale With {
                            .primaryKey = New anagrafiche.CentroAziendale.PK(CentroAzienda_Cod, Piva)
                    }
                    objAttivita.inizio = CDate(ingresso)
                    ...
                    listaMatricole_Carico.AddRange((From a As attivita.centri_di_costo.CapoAnimaleCDC In lista_capoAnimaleCDC_PrimaIscrizione Select a.capoAnimale.matricola).ToList())
                    listaMatricole_CaricoxGiorno.AddRange((From a As attivita.centri_di_costo.CapoAnimaleCDC In lista_capoAnimaleCDC_PrimaIscrizione Select a.capoAnimale.matricola).ToList())
                End If
    ...
    Private Function ConsistenzaCapiBDN_Scarico(ByVal lista_ScaricoCapi As List(Of IDictionary(Of String, Object)),
        ...
        For Each uscita In lista_DateUscita_Stalla
            Try
                Dim lista_capoAnimaleCDC_Macellazione As New List(Of attivita.centri_di_costo.CentroDiCosto)
                Dim lista_capoAnimaleCDC_Morte As New List(Of attivita.centri_di_costo.CentroDiCosto)
                Dim lista_capoAnimaleCDC_Vendita As New List(Of attivita.centri_di_costo.CentroDiCosto)
                ...
                If lista_capoAnimaleCDC_Morte.Count > 0 Then
                    For Each cauMorte In listaCausaliMorte
                        Dim objAttivita As New attivita.Attivita
                        objAttivita.fine = AGRODATAFINE
                        objAttivita.job = New attivita.Zootecnia(LAVCOD_MORTE_ANIMALI, "")
                        objAttivita.centroAziendale = New anagrafiche.CentroAziendale With {
                            .primaryKey = New anagrafiche.CentroAziendale.PK(CentroAzienda_Cod, Piva)
                        }
                ...
                If lista_capoAnimaleCDC_Vendita.Count > 0 Then
                    ...
                    Dim objAttivita As New attivita.Attivita
                    objAttivita.fine = AGRODATAFINE
                    objAttivita.job = New attivita.Zootecnia(LAVCOD_VENDITA_ANIMALI, "")
                    objAttivita.centroAziendale = New anagrafiche.CentroAziendale With {
                        .primaryKey = New anagrafiche.CentroAziendale.PK(CentroAzienda_Cod, Piva)
                    }
                ...
                If lista_capoAnimaleCDC_Macellazione.Count > 0 Then
                    ...
                    Dim objAttivita As New attivita.Attivita
                    objAttivita.fine = AGRODATAFINE
                    objAttivita.job = New attivita.Zootecnia(LAVCOD_MACELLAZIONE_ANIMALI, "")
                    objAttivita.centroAziendale = New anagrafiche.CentroAziendale With {
                        .primaryKey = New anagrafiche.CentroAziendale.PK(CentroAzienda_Cod, Piva)
                    }
            ...
            For Each modello In listaModelli_Ingresso
                Try
                    ...
                    If Not IsNothing(listaMatricole_Carico_Modello4) AndAlso listaMatricole_Carico_Modello4.Count > 0 Then
                        ...
                        objAttivita.job = New attivita.Zootecnia(LAVCOD_ACQUISTO_ANIMALI, "")
                        objAttivita.centroAziendale = New anagrafiche.CentroAziendale With {
                                .primaryKey = New anagrafiche.CentroAziendale.PK(0, Piva)
                        }

                        Dim lista_capoAnimaleCDC As New List(Of attivita.centri_di_costo.CentroDiCosto)
                        ...
                        For Each mat In listaMatricole_Carico_Modello4
                            ...
                            Dim obj_CapoAnimaleCDC As CapoAnimaleCDC = SincronizzaAnimale(Piva, Sa_Cod, Sta_Num, Codice_Asl, Codice_Azienda,
                                                                                          ...
                                                                                          Motivo_Uscita, ID_Ingresso, ID_Uscita, Ingresso_Modello4_Prenotazione, Ingresso_Modello4_Numero)
                        ...
                        Dim listaParamsExtra_Attivita As New List(Of attivita.Parametri_Aggiuntivi_Attivita)
                        listaParamsExtra_Attivita.Add(New attivita.Parametri_Aggiuntivi_Attivita With {
                                                        .operazione = New attivita.Lavorazione(LAVCOD_ACQUISTO_ANIMALI),
                                                        .key = "sincro_modello4",
    ...
    Private Function SincronizzaAnimale(Piva As String, Sa_Cod As Integer, Sta_Num As Integer,
                                   ...
                                   Optional ByVal Ingresso_Modello4_Prenotazione As String = "", Optional ByVal Ingresso_Modello4_Numero As String = "") As CapoAnimaleCDC
        ...
        If obj_CapoAnimaleCDC.capoAnimale.validita.inizio <> modello.dataIngresso Then
            obj_CapoAnimaleCDC.capoAnimale.validita.inizio = modello.dataIngresso
        End If
            ...
            For Each modello In listaModelli_Uscita
                Try
                    ...
                    If Not IsNothing(listaMatricoleScarico_Modello4) AndAlso listaMatricoleScarico_Modello4.Count > 0 Then
                        ...
                        Dim objAttivita As New attivita.Attivita
                        objAttivita.fine = AGRODATAFINE
                        objAttivita.job = New attivita.Zootecnia(lav_cod, "")
                        ...
                        For Each capo In listaMatricoleScarico_Modello4
                            ...
                            Dim obj_CapoAnimaleCDC As New attivita.centri_di_costo.CapoAnimaleCDC
                            obj_CapoAnimaleCDC.codice = New attivita.centri_di_costo.CentroDiCosto.CodeType(Sa_Cod)
                        ...
                        Dim listaParamsExtra_Attivita As New List(Of attivita.Parametri_Aggiuntivi_Attivita)
                        listaParamsExtra_Attivita.Add(New attivita.Parametri_Aggiuntivi_Attivita With {
                                                        .operazione = New attivita.Lavorazione(lav_cod),
                                                        .key = "sincro_modello4",
                                                        .value = jObjModello
                                                      })
    ...
    Public Function Carica_Modello4PascoloIngresso(PrenotazioneID As String, GrSpe_Cod As String) As CaricaModelli4_Response
        ...
        Try
            ...
            If dtModello4.Columns.Contains("GIORNI_VALIDITA") Then
                objModelli4.giorniValdita = dtModello4.Rows(0).Item("GIORNI_VALIDITA")
            Else
                objModelli4.giorniValdita = ""
            End If
