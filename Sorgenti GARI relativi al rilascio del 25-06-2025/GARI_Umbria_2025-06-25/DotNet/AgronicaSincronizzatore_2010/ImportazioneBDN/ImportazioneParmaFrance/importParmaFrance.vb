...
Public Class importParmaFrance
    ...
    Public Sub Avvia_Importazione_AnagrafeExcel(ByVal PivaSelezionata As String,
        ...
        NomeFile = "Importazione_Anagrafiche_ParmaFrance" + NomeImport + "__" & Now.ToString("yyyy-MM-dd__(hh.mm.ss)") & ".txt"
        Path_File_Log = Directory_Log & "\Importazione_Anagrafiche_ParmaFrance" + NomeImport + "__" & Now.ToString("yyyy-MM-dd__(hh.mm.ss)") & ".txt"
        ...
        For Each Path_FileSoci_XLS In listaFile
            ...
            Dim objImportPC As New import_ParmaFrance(objParametriServer, objParametriUtenti)
            risultato = ""
            ...
            Dim cuaa As String = Path.GetFileNameWithoutExtension(Path_FileSoci_XLS).Split("_")(2)
            ...
            Try
                DatiImportati = objImportPC.importaCapi(PivaSelezionata, StringaConnessione,
                                                        ASG_Utente_Username, ASG_Utente_Password, ASG_ProgressivoGIAS,
                                                        CodiceChiaveCliente, Directory_Log, NomeFile,
                                                        Messaggio)
        ...
        lbl_conclusione.Visible = True
        lbl_conclusione.Text = "<h4>Import Capi UE: </h4>" + vbCrLf + risultatoFinale
