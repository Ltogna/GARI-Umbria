Public Class ScortaProdotto_Somministrazione
	Inherits VetInfoResponseModel.VetInfoData_Response

	'fornFl
	Public fornFlSostituzione As String
	Public fornFlSostituzioneDescrizione As String
	...
	Public regscoFlCampione As String
	...
	Public regscoProdottoFamigliaDenominazione As String
