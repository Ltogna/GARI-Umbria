Public Class RegistroPrescrizioni_Response
	...
	Public presStrutturaCodice As String
	Public presStrutturaDenominazione As String
	...
	Public presRigaCardinalita As String

	'Dati Protocollo
	Public protCatClassyfarmCodice As String
	Public protCatClassyfarmDescrizione As String
	Public protDiagnosiCodice As String
	Public protDiagnosiDescrizione As String
	Public protSpecieCodice As String
	Public protSpecieDescrizione As String
