...
Public Class Audit
    ...
    Public Sub ImportaAudit( _
        ...
        Dim Qs_RegolamentoCod As Integer = 1

        Dim Dr() As DataRow
        Dim ValiditaInizio As DateTime = #1/1/1900#
        Dim ValiditaFine As DateTime = #12/31/2100#

        'Dim DLL_AD As New AccessoDB_Planning.AccessoDati(Session("ASG_PathFileINI"), _
        '                                 Session("ASG_Connessione_Server"))

        'Dim strConnessione = DLL_AD.FindConnessione_Su_Ini_O_Superserver()
        ...
        Try
            ...
            ' Dim DLL_AD_Condizionalita As New AccessoDB_Condizionalita.AccessoDati(Session("ASG_PathFileINI"), Session("ASG_Connessione_Server"))
            ...
            Dim audits As DataTable = letturaAudit.Leggi( _
                0, _
                0, _
                0, _
                PivaOrigine, _
            ...
            For Each audit As DataRow In audits.Rows
                ...
                audit_Cod = ObjSequenze.NuovoId_Tabella( _
                                       "AUDIT", _
                ...
                For Each auditRisposta As DataRow In auditRisposte.Rows
                    ...
                    auditNewKey = ( _
                        ...
                        And i.oldkey_regolamento = auditOldKey.oldkey_regolamento _
                        And i.oldkey_superuser = auditOldKey.oldkey_superuser _
                        And i.oldkey_tipo = auditOldKey.oldkey_tipo _
            ...
            For Each intervista In interviste.Rows
                ...
                For Each domandaIntervista In Dt_Domande_Interviste.Rows
                    ...
                    Intervistanewkey = ( _
                        ...
                        And i.oldkey_regolamento = IntervistaoldKey.oldkey_regolamento _
                        And i.oldkey_superuser = IntervistaoldKey.oldkey_superuser _
                        And i.oldkey_tipo = IntervistaoldKey.oldkey_tipo _
