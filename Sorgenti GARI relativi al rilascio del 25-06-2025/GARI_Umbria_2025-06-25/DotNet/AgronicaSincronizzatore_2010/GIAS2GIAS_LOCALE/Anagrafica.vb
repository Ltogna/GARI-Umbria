...
#Region "Impresa"
    ...
    Private Sub G2G_Gestione_Impresa(
        ...
        Try
            ...
            Else
                Dim f As New Gias2Gias_LIB.Funzioni(objOpzioni.objParametri_Server_GIAS_ORIGINE, objOpzioni.TimeOut_Chiamata_WS)
                Dim Str_Credenziali_WS As String = f.Get_Str_Credenziali_WS(_opzioni)
    ...
    Private Function G2G_Leggi_Piva_Destinazione(ByVal Piva_Origine As String, ByVal Fittizia As Boolean) As String
        ...
        If _opzioni.CodiceImpresa_DESTINAZIONE <> 0 Then
            ...
            Dim f As New Gias2Gias_LIB.Funzioni(_opzioni.objParametri_Server_GIAS_ORIGINE, _opzioni.TimeOut_Chiamata_WS)
            Dim Str_Credenziali_WS As String = f.Get_Str_Credenziali_WS(_opzioni)
            Dim strErr As String = ""
            Dim ws As New WS_Importa_GIAS_2014.ImportaWS
            ws.Url = _opzioni.wsimportaGiasURl
    ...
    Private Sub G2G_Copia_Analisi_Condivise_Pubblico_WS(
        ...
        Try
            ...
            Try
                ...
                Dim Str_Credenziali_WS As String = _objScriviHelper.Get_Str_Credenziali_WS(_opzioni)
