...
Public Class ImportatoreFascicoli
    ...
    Private Function importaPianiColturali()
    ...
    Private Function importaISWS(ByRef myISWSResponse As pc.common.webservice.sop.agrea.it.ISWSResponse, fascicolo As String, anno As String, importaeRibalta As Boolean)
        Dim writer As New Fascicolo_W
        If myISWSResponse.codRet = "012" Then
            Dim msgOK As String
            Dim Log_Errori As New StringBuilder
            Dim Log_Import As New StringBuilder
            If Not myISWSResponse Is Nothing AndAlso Not myISWSResponse.azienda Is Nothing Then
    ...
    Public Sub IMPORTA_AGREA(ByRef myISWSResponse As pc.common.webservice.sop.agrea.it.ISWSResponse,
        ...
        Try
            ...
            If Not IsNothing(myISWSResponse) Then
                ...
                If Flag_ImportAnagrafica = True Then
                ...
                If Flag_ImportPianificazione = True Then
                ...
                Else
                    If importaERibalta = True And Programmazione_Cod <> 0 Then
    ...
    Public Function Xml_Genera_Stringone_Anagrafe(ByRef myISWSResponse As pc.common.webservice.sop.agrea.it.ISWSResponse,
        ...
        Try
            ...
            If Not myISWSResponse.domanda.dataValidazione Is Nothing Then
    ...
    Public Function Xml_Genera_Stringone_Pianificazione(ByRef myISWSResponse As pc.common.webservice.sop.agrea.it.ISWSResponse,
        ...
        If Not IsNothing(myISWSResponse.possessi) Then
            ...
            For i = 0 To myISWSResponse.possessi.Count - 1
                ...
                If IsNothing(myISWSResponse.possessi(i).sezione) Or myISWSResponse.possessi(i).sezione = "" Then
                    strSezione = "0"
                Else
                    strSezione = myISWSResponse.possessi(i).sezione
                End If

                If IsNothing(myISWSResponse.possessi(i).subalterno) Or myISWSResponse.possessi(i).subalterno = "" _
                   Or myISWSResponse.possessi(i).subalterno = "000" Then
                    strSubalterno = "0"
                Else
                        ...
                        If Not IsNothing(myISWSResponse.possessi(i).macrousi(j).utilizzi) Then
                            ...
                            For k = 0 To myISWSResponse.possessi(i).macrousi(j).utilizzi.Count - 1
                                ...
                                Else
                                    ...
                                    If Cul_Cod_Agea = "000" And myISWSResponse.possessi(i).macrousi(j).utilizzi(k).codVarieta <> "000" Then
                                ...
                                If CInt(Veg_Cod) <> 0 And CInt(Cul_Cod) = 0 Then
                                ...
                                If FiltraParticelle = False Or vett_str.Contains(lPart) Then
    ...
    Private Sub Xml_Genera_Stringone_Catasto(ByRef myISWSResponse As pc.common.webservice.sop.agrea.it.ISWSResponse,
        ...
        Dim num_ripetizioni As Integer = 0
        ...
        Try
            ...
            If Not IsNothing(myISWSResponse.possessi) Then
                ...
                'vett_str.Add("038 005  47 24 000")
                'vett_str.Add("038 005  47 36 000")
                If Not HttpContext.Current.Session("objParticelleTot") Is Nothing Then
    ...
    Private Function Converti_TitoliPossesso_Agrea(ByVal TitoloPossesso As String) As Integer
        ...
        If TitoloPossesso.StartsWith("FP") = True Then
