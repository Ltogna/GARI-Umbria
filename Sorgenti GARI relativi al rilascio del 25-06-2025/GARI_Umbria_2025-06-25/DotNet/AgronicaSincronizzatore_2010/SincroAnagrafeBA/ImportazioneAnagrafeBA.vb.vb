...
Public Class ImportazioneAnagrafeBA
    ...
    Private ID_Tabella_Id_Servizio As TipiEnumerativi.enum_Id_Servizio
    Private ID_Tabella_Tipo_Sincro As TipiEnumerativi.enum_Tipi_Servizi_Background
...
#Region "Importazione"
            ...
            For Each cuaa As DictionaryEntry In cuaas
                ...
                Try
                    ...
                    If _3_CaricaDati_WS_BA(cuaa.Value, cuaa.Key, DtPV, _
                        ...
                        'devo fare l'aggironamento solo se il fascicolo è nuovo, 
                        'leggendo la variabileretituita Azienda_Con_Fascicolo_Nuovo 
                        If Aggiorna_Solo_Se_Fascicolo_Nuovo And Azienda_Con_Fascicolo_Nuovo _
                            Or (Aggiorna_Solo_Se_Fascicolo_Nuovo = False) Then
    ...
    '    Dim TipoOperazione As Integer = TipiEnumerativi.enum_TipoOperazioneDB.Scrittura
    ...
    '                                TipoOperazione = TipiEnumerativi.enum_TipoOperazioneDB.Modifica
    '                            End If
    ...
    '                            If TipoOperazione = TipiEnumerativi.enum_TipoOperazioneDB.Modifica Then
    ...
    '                                XmlFabbricato = objXML.Xml_Pubblico_Fabbricato(TipiEnumerativi.enum_TipoOperazioneDB.Scrittura, _
    '                                                                              "0", _
    '                                                                              "Magazzino n.01", _
    '                                                                              20, _
    '                                                                              "#", "#", "#", _
    ...
    '                                                                                           Regolamento_Cod, _
    '                                                                                           TipiEnumerativi.enum_AuditPuaTipo.Audit_Condizionalita, _
    '                                                                                           Domanda_Cod, _
    '                                                                                            Descrizione, _
    '                                                                                           "", _
    '                                                                                           ObjParametri_Server)
    ...
    '                                                DR.Item("Audit_Tipo") = TipiEnumerativi.enum_AuditPuaTipo.Audit_Condizionalita
    ...
    '                                    XmlTestata = objXML.Xml_Pubblico_ProgrammazioneTestata(TipiEnumerativi.enum_TipoOperazioneDB.Scrittura, _
    '                                                       "0", _
    '                                                       PIVA, _
    '                                                       strPianificazione, _
    '                                                       strPianificazione, _
    '                                                       "Importazione " & strPianificazione, _
    '                                                       TipiEnumerativi.enum_TipoPianificazione.Pianificazione_Annuale, _
    '                                                       strValiditaInizio, _
    '                                                       strValiditaFine, _
    '                                                       XmlDocP)
    ...
    Private Function _3_CaricaDati_WS_BA(ByVal PIVA As String, _
        ...
        Try
            ...
            If Not ws_SchedeResponse Is Nothing AndAlso _
                Not ws_SchedeResponse.out Is Nothing AndAlso _
            ...
            'End If
                ...
                Dim FiltroSchede As String = " Allegati_Documenti_CatCod = " & TipiEnumerativi.enum_CategorieDocumenti.DomandaFascicolo & " AND Allegati_Documenti_Piva='" & PIVA & "' "
                ...
                If N_Schede > 0 Then
                    ...
                    If SchedaGiaPresente = False Then
                        DrScheda = Dt_Schede.NewRow
        ...
        If Dt_SchedeOrd.Rows.Count <> 0 Then
            ...
            For s = 0 To Dt_SchedeOrd.Rows.Count - 1
                ...
                Dim ModificataScheda As Boolean = False
                Dim SchedaValidazione As String = ""
                ...
                Select Case OrigineScheda
                    ...
                    Case "S"
                        ...
                        Try
                            ...
                            If RispostaWSAnagrafe = True AndAlso _
                                ...
                                If RispostaWSFascicolo = True AndAlso _
                                    ...
                                    If EsisteImpresa = False Then

                                        If Not ws_fasciResponse.out.fascicolo.fascicolo.Detentore Is Nothing Then
                                    ...
                                    Else
                                        ...
                                        If Dt_SchedeOrd.Rows(s).Item("Presente") = 1 Then
                                            ...
                                            If Dt_SchedeOrd.Rows(s).Item("strProgrammazioniCod_NONMovimentate") <> "" Then
                                                ...
                                                If Not PlanningCodNONMov Is Nothing Then
                                        ...
                                        Else
                                            ...
                                            If DataValidazione >= #1/1/2014# And s = Dt_SchedeOrd.Rows.Count - 1 Then
                                                Ribalta_Fascicolo = True
                                            End If
                                ...
                                Select Case ws_AnaResponse.output.anagrafica.codTipoAnagrafica
                                    ...
                                    Case "DI", "S"   'ditta individuale, 'società
                                        ...
                                        '    Throw New Exception("PIVA <> ws_AnaResponse.output.anagrafica.impresa.piva")
                                        'End If
                                        If PIVA = "" And ws_AnaResponse.output.anagrafica.impresa.piva <> "" Then
                                        ...
                                        If Not ws_fasciResponse Is Nothing AndAlso _
                                            ...
                                            If ws_fasciResponse.out.fascicolo.fascicolo.ISWSTerritorio1.Length > 0 Then
                                                ...
                                                XmlTestata = objXML.Xml_Pubblico_ProgrammazioneTestata(TipiEnumerativi.enum_TipoOperazioneDB.Scrittura, _
                                                                   ...
                                                                   strPianificazione, _
                                                                   "Importazione " & strPianificazione, _
                                                                    TipiEnumerativi.enum_Planning_Fonte.BluArancioAgea, _
                                                                    TipiEnumerativi.enum_TipoPianificazione.Pianificazione_Annuale, _
                                                                   strValiditaInizio, _
                                                                   strValiditaFine, _
                                                                   XmlDocP)
                        ...
                        If _4_Importa(PIVA, CUAA, Sa_Cod, DtCondizionalita, DtParticelle, SchedaValidazione, DataValidazione, DataValidazioneFine, msgImporta, strXmlPianificazione) Then
                            ...
                            If SchedaValidazionePrec <> "" And OrigineSchedaPrec = "G" Then
                                'NON MOVIMENTATO ---> CANCELLO PLANNING + RIBALTATI
                                Dim p As Integer
                            ...
                            If Ribalta_Automatico = True And Ribalta_Fascicolo = True And Programmazione_Cod <> 0 And strXmlPianificazione <> "" Then
    ...
    Private Sub _5_Crea_Stringa_Catasto(ByVal PIVA As String, _
        ...
        Dim Superficie_Old, Superficie_New As Double

        Dim TipoOperazione_Particella, TipoOperazione_Possesso, TipoOpMacrousoxParticella, TipoOpUtilizzoxParticella As TipiEnumerativi.enum_TipoOperazioneDB
        ...
        For i = 0 To DtParticelle.Rows.Count - 1
            ...
            TipoOperazione_Particella = TipiEnumerativi.enum_TipoOperazioneDB.Scrittura
            TipoOperazione_Possesso = TipiEnumerativi.enum_TipoOperazioneDB.Scrittura
            ...
            If SaCod <> 0 Then
                ...
                If Not DrParticella Is Nothing AndAlso DrParticella.Length > 0 Then
                    ...
                    For j = 0 To DrParticella.Length - 1
                        ...
                        If Inizio_Possesso < Fine_Possesso_Old And Fine_Possesso > Inizio_Possesso_Old Then
                            If Modifica_TitoloPossesso = True Then
                ...
                If ModificaParticella = True Then
                    TipoOperazione_Particella = TipiEnumerativi.enum_TipoOperazioneDB.Modifica
                End If
                If ModificaPossesso = True Then
                    TipoOperazione_Possesso = TipiEnumerativi.enum_TipoOperazioneDB.Modifica
                End If
            End If
            ...
            If strZona = "v" Then
                ...
                If InserisciZona = True Then
                    XmlZona = objXML.Xml_Pubblico_Zona(TipiEnumerativi.enum_TipoOperazioneDB.Scrittura, _
                               "-17", _
                               "0", _
                               XmlDoc)
            ...
            If Macrouso_Cod <> "" Then
                TipoOpMacrousoxParticella = TipiEnumerativi.enum_TipoOperazioneDB.Scrittura
                ...
                If SaCod <> 0 Then
                    ...
                    If Not DrParticellaM Is Nothing OrElse DrParticellaM.Length = 0 Then
                        ...
                        For m = 0 To DrParticellaM.Length - 1
                            ...
                            If Macrouso_Sup = Superficie_Old Then
                                ...
                                ElseIf Fine_Macrouso = DateAdd(DateInterval.Day, -1, Inizio_Macrouso_Old) Then
                                    ...
                                    ModificaMacrouso = True
                                ElseIf Inizio_Macrouso = Inizio_Macrouso_Old And Fine_Macrouso = Fine_Macrouso_Old Then
                                    ModificaMacrouso = True
                                ElseIf Inizio_Macrouso >= Inizio_Macrouso_Old And Inizio_Macrouso <= Fine_Macrouso_Old And _
                                    Fine_Macrouso >= Fine_Macrouso_Old Then
                                    Inizio_Macrouso = Inizio_Macrouso_Old
                                    ModificaMacrouso = True
                                ElseIf Fine_Macrouso <= Fine_Macrouso_Old And Fine_Macrouso >= Inizio_Macrouso_Old And _
                    ...
                    If ModificaMacrouso = True Then
                        TipoOpMacrousoxParticella = TipiEnumerativi.enum_TipoOperazioneDB.Modifica
                    End If
                End If

                If ModificaVecchioMacrouso Then

                    XmlMacrouso = objXML.Xml_Pubblico_Macrouso(TipiEnumerativi.enum_TipoOperazioneDB.Modifica, _
                                                          PIVA, _
                ...
                If Veg_Cod_Agea <> "" Then
                    TipoOpUtilizzoxParticella = TipiEnumerativi.enum_TipoOperazioneDB.Scrittura
                    ...
                    If SaCod <> 0 Then
                        ...
                        If ModificaUtilizzo = True Then
                            TipoOpUtilizzoxParticella = TipiEnumerativi.enum_TipoOperazioneDB.Modifica
                        End If
                    End If
                    ...
                    XmlEntita = objXML.Xml_Pubblico_ProgrammazioneEntita(TipiEnumerativi.enum_TipoOperazioneDB.Scrittura,
                                    "0",
                    ...
                    XmlParticellaP = objXML.Xml_Pubblico_ProgrammazioneParticella(TipiEnumerativi.enum_TipoOperazioneDB.Scrittura, _
                                                                                    Com, _
                                                                                    Prov, _
                                                                                    Sezione, _
                                                                                    Foglio, _
    ...
    Private Function _7_Importa_Condizionalita_Profilo(ByVal Piva As String, ByVal Dt As DataTable) As Boolean
        ...
        Try
            ...
            If Not Dt Is Nothing AndAlso Dt.Rows.Count > 0 Then
                ...
                Dt_Domande_Interviste = objAudit_Domande_Interviste.Leggi(TipiEnumerativi.enum_AuditPuaTipo.Audit_Condizionalita, _
                                                                            RegolamentoCod, _
                                                                            0, _
                                                                            "", "", _
                                                                            ObjParametri_Server)
                ...
                If Dt_Domande_Interviste.Rows.Count > 0 Then
                    ...
                    objAudit_Interviste.Scrivi(TipiEnumerativi.enum_AuditPuaTipo.Audit_Condizionalita, _
                                            RegolamentoCod, _
                                            Codice, _
                                            Piva, _
                                            ValiditaInizio, _
                    ...
                    For i = 0 To Dt_Domande_Interviste.Rows.Count - 1
                        ...
                        If strValore <> "" Then
                            ...
                            ' INSERIMENTO
                            objAuditRisposteInterviste.Scrivi(TipiEnumerativi.enum_AuditPuaTipo.Audit_Condizionalita, _
                                                                RegolamentoCod, _
                                                                Codice, _
    ...
    Private Function _4_Elimina_Ribaltati(ByVal Programmazione_Cod As Integer)
        ...
        For a = 0 To DtEntRib.Rows.Count - 1
            ...
            If Not IsNothing(DtAgenda) AndAlso DtAgenda.Rows.Count <> 0 Then
                'Throw New Exception("Impossibile eliminare l'appezzamento poichè esistono delle registrazioni ad esso associate!" & Chr(13) & _
    ...
    Private Function _8_Ribalta_Pianificazione(ByVal Programmazione_Cod As Integer, _
        ...
        Dim objXML As New AgronicaCoreXML.AnagrafeXML
        Dim objXMLPriv As New AgronicaCoreXML.XML_Anagrafe

        '----- Calcolo i valori di BaseCode e TopCode
        Call objXML.Calcola_BaseCode_TopCode(BaseCode, _
                                             TopCode, _
                                             ProgressivoGIAS)
            ...
            For i = 0 To DT_Appezzamenti.Rows.Count - 1
                ...
                If InseritoCampo = True Then
                    ...
                    For j = 0 To DT_Particelle.Rows.Count - 1
                        ...
                        objXML.EttariAreCentiare_from_Ettari(DT_Particelle.Rows(j).Item("Superficie"), Ettari, Are, Centiare)
                    ...
                    If InseritoAppezzamento = True Then
                            ...
                            If InseritoProgetto = True Then
                                ...
                                If Ribalta_Limiti = True Then
                                    ...
                                    If Not DtPV Is Nothing AndAlso DtPV.Rows.Count > 0 Then
                                        ...
                                        Dim DrPE() As DataRow
                                        If Not DtPE Is Nothing AndAlso DtPE.Rows.Count > 0 Then
                                            DrPE = DtPE.Select("Programmazione_Entita_Cod=" & Key_Entita.ToString)
                                            If Not DrPE Is Nothing AndAlso DrPE.Length > 0 Then
                                    ...
                                    If Limite <> 0 And Riduzione_N <> 0 Then
...
#Region "Util"
    ...
    '    Return Allegati_Documenti_R.EsisteDocumento_Da_Numero(SchedaValidazione, "", TipiEnumerativi.enum_CategorieDocumenti.DomandaFascicolo, Allegati_Documenti_Cod_RITORNO, ObjParametri_Server)
    ...
    Private Sub ImpostoGliAltriParametri(ByVal _Configurazione_Servizio As AgronicaCoreVarieDAL.Configurazione_Servizio)
        ...
        LinkWSImportaGIAS = Configurazione_Siti_R.Leggi_Valore(TipiEnumerativi.Enum_SiteRedirector.Sito_GiasOnline, "LinkWSImportaGIAS", "", "", ObjParametri_Server)
    ...
    Private Function ControllaPeriodoEsecuzione(ByRef msgp As String) As Boolean
        ...
        If Configurazione_Servizio_temp.Giorno_Settimana_Esecuzione <> TipiEnumerativi.enum_Giorno_Settimana.Indifferente And
