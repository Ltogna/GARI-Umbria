...
Public Class OprCFascicoloFS6_Chiamate
    ...
    Public Function LeggiSchedaValidazione(CUAA As String, IdScheda As String, ByRef pianoColturale As OprCFascicoloFS6.ISWSToOprResponse)
    ...
    Public Function LeggiSchedeCuaa(CUAA As String, Anno As Integer, ByRef territorio As OprCFascicoloFS6.ISWSToOprResponse)
    ...
    Public Function LeggiCUAA_Modificati(Giorni As Integer, ByRef territorio As OprCFascicoloFS6.ISWSToOprResponse)
