...
Public Class Import_AGEAFS5
    ...
    Public Function LeggiMacchine(CUAA As String, ByRef macchine As ISWSToOprResponse)
    ...
    Public Function LeggiSoggetti(CUAA As String, data As Date, ByRef soggetti As ISWSToOprResponse)
    ...
    Public Function LeggiVincoliAgronomici(CUAA As String, ByRef vincoli As ISWSToOprResponse)
    ...
    Public Function LeggiAllevamenti(CUAA As String, ByRef allevamenti As ISWSToOprResponse)
    ...
    Public Function LeggiPianoColturale(CUAA As String, Anno As Integer, ByRef pianoColturale As ISWSToOprResponse)
    ...
    Public Function LeggiTerritorio(CUAA As String, ByRef territorio As ISWSToOprResponse)
    ...
    Public Function LeggiCUAA_Modificati(Giorni As Integer, ByRef territorio As ISWSToOprResponse)
