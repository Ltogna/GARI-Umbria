...
Public Class OprFascicoloFS6_Chiamate
    ...
    Public Function LeggiSchedaValidazione(CUAA As String, IdScheda As String, ByRef pianoColturale As OprFascicoloFS6.ISWSToOprResponse)
    ...
    Public Function LeggiSchedeCuaa(CUAA As String, Anno As Integer, ByRef territorio As OprFascicoloFS6.ISWSToOprResponse)
    ...
    Public Function LeggiCUAA_Modificati(Giorni As Integer, ByRef territorio As OprFascicoloFS6.ISWSToOprResponse)
    ...
    Public Function AnagraficaAziendaFS6(CUAA As String, ByRef risposta As OprFascicoloFS6.ISWSToOprResponse)
