...
Public Class Import_AGEAFS6
    ...
    Public Function LeggiSchedaValidazione(CUAA As String, IdScheda As String, ByRef pianoColturale As AGEA_UMBRIA_FS6.ISWSToOprResponse)
    ...
    Public Function LeggiSchedeCuaa(CUAA As String, Anno As Integer, ByRef territorio As AGEA_UMBRIA_FS6.ISWSToOprResponse)
    ...
    Public Function LeggiCUAA_Modificati(Giorni As Integer, ByRef territorio As AGEA_UMBRIA_FS6.ISWSToOprResponse)
    ...
    Public Function AnagraficaAziendaFS6(CUAA As String, ByRef risposta As AGEA_UMBRIA_FS6.ISWSToOprResponse)
