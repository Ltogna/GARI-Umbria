...
#End Region
    ...
    Public Sub Logga(ByVal msg As String)
    ...
    Public Sub LoggaSummaryMail(ByVal tipoMail As String, ByVal msg As String)
        ...
        _objLog.Scrivi_LOG(_objParametriServer, "", msg, CustomLOGParams:=customLOGParams)
    End Sub
