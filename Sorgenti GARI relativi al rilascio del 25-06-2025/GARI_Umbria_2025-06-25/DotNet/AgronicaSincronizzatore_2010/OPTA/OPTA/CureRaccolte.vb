        ...
        If importa Then
            ...
            For Each dr As DataRow In dt.Rows
                ...
                Try
                    ...
                    strsql = "DELETE FROM [__ImportazioneCure]  where UDS=" & UDS & " AND LOCALE=" & LOCALE & " AND INIZIO='" & INIZIO & "' AND FINE='" & FINE & "' AND CODCOLTIV='" & CODCOLTIV & "'  AND NUMINIZ=" & NUMINIZ & " AND NUMFINE=" & NUMFINE & " AND CORONA='" & CORONA & "' AND " & FiltroTabella & "  "
                    dp.EseguiQuery_Scrittura(objParametri_Server, strsql, "OptaImport")
...
#Region "Cura"
    ...
    Private Function CreaSalvaCura(ByVal IDInfornaturaImportata As String, _
        ...
        strsql = "SELECT *   FROM [__ImportazioneCure]  where UDS=" & UDS & " AND LOCALE=" & LOCALE & " AND INIZIO='" & INIZIO & "' AND FINE='" & FINE & "' AND CODCOLTIV='" & CODCOLTIV & "'  AND NUMINIZ=" & NUMINIZ & " AND NUMFINE=" & NUMFINE & " AND CORONA='" & CORONA & "' AND " & FiltroTabella & "  order by cartno  "
