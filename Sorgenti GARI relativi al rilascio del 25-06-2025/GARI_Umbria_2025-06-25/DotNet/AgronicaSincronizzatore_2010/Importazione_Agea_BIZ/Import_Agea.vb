...
Public Class Import_Agea
    ...
    Public Function importa_CUAAFS7(cuaa As String,
        ...
        If ISWSRespAnagFascicolo15.Count > 0 Then
            ...
            If ISWSRespAnagFascicolo15(0).dataSchedaValidazione IsNot Nothing Then
                ...
                ElseIf IsNumeric(ISWSRespAnagFascicolo15(0).dataSchedaValidazione) Then
                    DataValidazione = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(ISWSRespAnagFascicolo15(0).dataSchedaValidazione)).ToShortDateString
                End If
            End If
    ...
    Public Function importa_CUAA(cuaa As String,
                                 ByRef MessaggioFinale As String,
                                 importa_azienda As Boolean,
                                 importa_fabbricati As Boolean,
                                 importa_conticorrenti As Boolean,
        ...
        If ISWSRespAnagFascicolo15.Count > 0 Then
            ...
            If Not fascicolo.detentore Is Nothing AndAlso PivaPadre = "" Then
            ...
            If importa_piano_colturale Then
                ...
                Dim imp As New ImportazionePcFast
                Dim numeroFascicolo As String = ""
                Dim dataFascicolo As Date = AGRODATAINIZIO
                If ISWSRespAnagFascicolo15(0).schedaValidazione IsNot Nothing Then
                ...
                If ISWSRespAnagFascicolo15(0).dataSchedaValidazione IsNot Nothing Then
                    ...
                    ElseIf IsNumeric(ISWSRespAnagFascicolo15(0).dataSchedaValidazione) Then
                        dataFascicolo = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(ISWSRespAnagFascicolo15(0).dataSchedaValidazione)).ToShortDateString
                    End If
    ...
    Private Sub SeCreaUfficioZona(ByRef MessaggioFinale As String, ASG_ProgressivoGIAS As Integer, ASG_Utente_Password As String, ByRef objParametri_Server As AgronicaCoreParametri, ByRef objParametri_Utenti As AgronicaCoreParametri, ByRef Piva_Padre As String, ByRef Sigla_Provincia As String, ByRef Istat_Provincia As String, ByRef Istat_Comune As String, ByRef strErr As String, objImpresa As Imprese_Read, ByRef Detentore_Fascicolo As String)
    ...
    Public Function CreaAziendaGias(ByVal ASG_ProgressivoGIAS As String,
        ...
        If fascicolo.sessoPFSpecified = True AndAlso fascicolo.sessoPF IsNot Nothing Then
        ...
        If Not fascicolo.dataNascitaPF Is Nothing Then
    ...
    Private Shared Sub Popola_DtAppezzamenti_daFascicolo_2(ByVal Piva As String,
        ...
        If ISWSTerritorioFS6.Count > 0 Then
            ...
            For Each ISWSTerritorio In ISWSTerritorioFS6
                ...
                If Not ISWSTerritorio.UtilizzoSuolo Is Nothing Then
                    ...
                    For Each ISWSUtilizzoTerra In ISWSTerritorio.UtilizzoSuolo
                        ...
                        If Not ISWSUtilizzoTerra Is Nothing Then
                            ...
                            If Not IsNothing(ISWSUtilizzoTerra.DataInizioUtilizzo) AndAlso ISWSUtilizzoTerra.DataInizioUtilizzo <> "" Then
                                data_inizio_appezzamento = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(ISWSUtilizzoTerra.DataInizioUtilizzo))
                            End If
                            ...
                            If Not IsNothing(ISWSUtilizzoTerra.DataFineUtilizzo) AndAlso ISWSUtilizzoTerra.DataFineUtilizzo <> "" Then
                                data_fine_appezzamento = CDate(AgronicaCoreDataProvider.Conversioni.DataGGMMYYYY_From_DataYYYYMMGG(ISWSUtilizzoTerra.DataFineUtilizzo))
                            End If
    ...
    Private Function JSON_DataTableAppezzamenti_Tabella(ByRef DT_Appezzamenti As DataTable,
        ...
        If stringaKendoRow = "" Then
            ...
            js.kendo_Rows(DT_Appezzamenti, l, strKendoRow)
