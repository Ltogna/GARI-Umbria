...
Public Class Importa_Codifiche_Agea_2015_2020
    ...
    Public Function Gestione_Codifiche_AGEA(ByVal StringaConnessione As String,
                                   ByVal Utente_Username As String,
                                   ByVal Utente_Password As String,
                                                ByVal LogDirectory As String,
                                                ByVal LogFileName As String,
        ...
        Try
                    ...
                    For Each codificaOld As Codifica_SpecieVegetali_Agea In codificheAgeaOld
                        ...
                        Dim codificaNew = (From codN As Codifica_SpecieVegetali_Agea_2015_2020 In
                                                       GiasContext.Codifica_SpecieVegetali_Agea_2015_2020 Where
                                                        codN.Veg_cod_Agea = codiceProdotto And
                                                        codN.Cul_Cod_Agea = codiceVarieta And
                                                        codN.Uso_Cod = codiceUso And
                                                        codN.Macrouso_Cod = codiceMacrouso And
                                                        codN.Occupazione_Cod = codiceOccupazione And
                                                        codN.Destinazione_Cod = codiceDestinazione And
            ...
            Dim codificheOld = GiasContext.Codifica_SpecieVegetali_Agea.Where(Function(o) codificheNewID.Contains(o.Veg_Cod_Agea) = False).ToList
    ...
    Public Function Modifica_VegCod_Id_Cod(ByVal StringaConnessione As String,
                                   ByVal Utente_Username As String,
                                   ByVal Utente_Password As String,
                                                ByVal LogDirectory As String,
                                                ByVal LogFileName As String,
