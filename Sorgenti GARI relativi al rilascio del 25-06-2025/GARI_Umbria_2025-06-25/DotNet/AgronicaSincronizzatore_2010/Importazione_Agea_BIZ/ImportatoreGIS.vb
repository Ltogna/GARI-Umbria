...
Public Class ImportatoreGIS
    ...
    Public Function Importa_DatiGIS(
        ...
        Dim gestoreGeoJson As New AgronicaSHPWrapper.GeoJson_ToAgronicaGIS2012
        ...
        If programmazione_Cod <> 0 Then
            ...
            Dim dtE As DataTable =
                xLeggiEnt.Programmazione_Entita_Leggi(programmazione_Cod, "", 0, "", Piva, sa_Cod, 0, 0, 0, 0, Validita_Inizio, Validita_Fine, -1, AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta, "", " APPEZZA ", objParametri_Server)
        ...
        For Each Path_FileSoci_XML As String In ListaFile
            ...
            For Each isola In datiDaCaricare.Elements(tns2 + "isoleAziendali")
                ...
                If Not xelemCodiceIsola Is Nothing Then
                ...
                For Each Utilizzo In isola.Elements(tns2 + "appezzamenti")
                    ...
                    If Not xelemOccupazioneDes Is Nothing Then
                    ...
                    If Not xElemMacrousoCod Is Nothing Then
                        Macrouso_Cod = xElemMacrousoCod.Value
                    End If


                    'taglio la lunghezza perchè il valore massimo in entita_des è 50 caratteri
    ...
    Private Function getPianificazione_Des_Aggiuntiva(listaFile As List(Of String), ByVal objParametri_server As AgronicaCoreDataProvider.AgronicaCoreParametri) As String
