...
Imports Export_Attivita
Imports Export_Contatti
Imports Export_Macchine
Imports GiasDuplicateResx
Imports Aggiornamento_ISCC
Imports Compliance_ISCC_Async
Imports PianoColturale_Pendenze
    ...
    Function Avvia(ByVal Configurazione_Servizio As Configurazione_Servizio,
        ...
        If Configurazione_Servizio.Id_Servizio = enum_Id_Servizio.GiasOnline Then
            ...
            Select Case Configurazione_Servizio.Tipo_Sincro
                ...
                Case enum_Tipi_Servizi_Background.Indicode_EDI_BMI_Importazione
                ...
                Case enum_Tipi_Servizi_Background.DSS_PreElaborazioneImpianti
                    ...
                    Dim servizio As New AgronicaCoreModelliPrevisionaliBIZ.GSB_PreElaborazioneModelli(Configurazione_Servizio, ObjParametri_Server, ObjParametri_Utenti)
                ...
                Case enum_Tipi_Servizi_Background.ImportazioneCAI_Giacenze
                    ...
                    Return caiGiacenze.ConvertiFileCAIGiacenzeInXML(Messaggio_di_Ritorno_Opzionale, True)

                Case enum_Tipi_Servizi_Background.ImportazioneCAI_Agenzie
                    Dim serviziRead = New Configurazione_Servizi_R
                ...
                Case enum_Tipi_Servizi_Background.ImportazioneCAI_Acquisti_Imprese
                    ...
                    Return caiGiacenze.ConvertiFileCAIAcquistiInXML(Messaggio_di_Ritorno_Opzionale, True)
                ...
                Case enum_Tipi_Servizi_Background.EsportazioneCAI_Aziende
                    ...
                    Return caiExportAziendeQdC.AvviaEsportazione(Messaggio_di_Ritorno_Opzionale, False)
