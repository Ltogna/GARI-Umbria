...
Public Class GoogleStaticMaps
    ...
    ''' <returns></returns>
    Public Function AggiornaElementoGraficoConMappaStatica(InData As GeneraMappaStaticaInData) As RispostaStandard
    ...
    Private Function GeneraMappaStaticaComeByteArray(InData As GeneraMappaStaticaInData) As Byte()
        ...
        Dim byteResponse As Byte() = restSharpHelper.ReadByteArrayFromUrlGet(urlToGet, InData.TimeoutRequestInSeconds)
