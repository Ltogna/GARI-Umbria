...
Public Class Interferenze
    ...
    Public Sub InterferenzeGestione(
        ...
        If DatiPassaggio.Split("|")(5) = 1 Then
            ...
            GeneraDescrizione_Casella_Conflitto(Entita_Cod_DaVerificare, objParametri_Server)
            'al posto di:
            ...
            dtInterferenze = dtInterferenze_from_poligono(pivaSementieroReferente, specie, tipologia,
                                                              ...
                                                              HiddenPunti, objParametri_Server)
    ...
    Public Shared Sub GeneraDescrizione_Casella_Conflitto(ByVal Entita_Cod As Integer, ByVal objParametri_Server As AgronicaCoreDataProvider.AgronicaCoreParametri)
        ...
        Dim dt = objR.Leggi(Entita_Cod, False, "", True, 0, False, objParametri_Server)
        ''Dim dr() As DataRow
