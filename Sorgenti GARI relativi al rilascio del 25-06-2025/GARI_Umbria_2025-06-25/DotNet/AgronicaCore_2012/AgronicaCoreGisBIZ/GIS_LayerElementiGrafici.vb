...
Public Class GIS_LayerElementiGrafici
    ...
    Public Function DisattivaAttributoLayer(ByVal PivaSuperUser As String,
        ...
        Dim DT = LeggiAttributoLayer(PivaSuperUser, ProgressivoDataStruct, objParametri_Server)
    ...
    Public Function AttivaAttributoLayer(ByVal PivaSuperUser As String,
        ...
        If NomeAttributo.StartsWith("^") Then
            NomeAttributo = NomeAttributo.Substring(1)
        End If
    ...
    Public Function ImpostaVisualizzazioneEtichettaLayer(ByVal PivaSuperUser As String,
        ...
        Dim prefissoEtichetta As String = "^"
        ...
        If Impostazione Then

            If Not Etichetta.StartsWith(prefissoEtichetta) Then
                Etichetta = String.Format("{0}{1}", prefissoEtichetta, Etichetta)
            End If

        Else
            Etichetta = Etichetta.Substring(1)
        End If
    ...
    Public Function LeggiAttributoLayer(ByVal PivaSuperUser As String,
        ...
        Dim NomeRoutine As String = "AgronicaCoreGisBIZ.GIS_LayerElementiGrafici.LeggiAttributoLayer()"
                ...
                For Each row In dtRead.Rows
                    ...
                    If (row("TipologiaLayer_cod") & "|" & row("LayerElementiGrafici_Cod")) <> keyLayer Then
                        item = New TipologiaLayer() With {
                                ...
                                .MostraDescrizioneAssociata = row("MostraDescrizioneAssociata"),
                                .zindex = row("zindex"),
                                ...
                                .FlagInserimento = GetPermesso(row("LayerElementiGrafici_Cod"), SementiSportelloCod, IIf(row("Flag_Inserimento") Is DBNull.Value, "", row("Flag_Inserimento")), utente_permessi_gis),
                                .FlagModifica = GetPermesso(row("LayerElementiGrafici_Cod"), SementiSportelloCod, IIf(row("Flag_Modifica") Is DBNull.Value, "", row("Flag_Modifica")), utente_permessi_gis),
                                .FlagCancellazione = GetPermesso(row("LayerElementiGrafici_Cod"), SementiSportelloCod, IIf(row("Flag_Cancellazione") Is DBNull.Value, "", row("Flag_Cancellazione")), utente_permessi_gis),
    ...
    Public Function ScriviNuovoLayerPersonalizzato(
        ScriviNuovoLayerPersonalizzatoInData As ScriviNuovoLayerPersonalizzatoInData,
        objParametri_Server As AgronicaCoreParametri
    ) As rispostaStandard(Of ScriviNuovoLayerPersonalizzatoOutData)
        ...
        Try
            ...
            Dim LayerElementoGrafico_Cod As Integer = ags.NuovoId_Tabella("GIS_LayerElementiGrafici_Personalizzati",
                                                                          1000000,
                                                                          2000000000,
                                                                          objParametri_Server)
