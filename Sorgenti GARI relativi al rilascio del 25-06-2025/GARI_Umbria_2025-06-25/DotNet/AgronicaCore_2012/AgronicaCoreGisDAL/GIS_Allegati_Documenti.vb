...
Public Class GIS_Allegati_R
    ...
    Public Function UltimoID(ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri,
        ...
        Try
            ...
            If data_upload <> "" Then
                StrSQL.AppendLine(" AND data_upload =  CONVERT(DateTime,'" & data_upload & "',121)")
            End If

            If data_creazione <> "" Then
                StrSQL.AppendLine(" AND data_creazione =  CONVERT(DateTime,'" & data_creazione & "',121)")
            End If

            If data_modifica <> "" Then
                StrSQL.AppendLine(" AND data_modifica =  CONVERT(DateTime,'" & data_modifica & "',121)")
            End If
