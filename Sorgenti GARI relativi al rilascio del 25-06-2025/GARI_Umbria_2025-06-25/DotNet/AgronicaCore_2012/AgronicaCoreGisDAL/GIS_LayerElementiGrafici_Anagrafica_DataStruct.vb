        ...
        Try
            Select Case xSelezioneVariabile
                ...
                Case AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta
                    ...
                    StrSQL.AppendLine("WHERE LayerDataStruct.Validita_inizio < " & Agro_SQL_SaveDate(objParametri.FinestraTemporaleFine) & " ")
                    StrSQL.AppendLine("AND LayerDataStruct.Validita_Fine > " & Agro_SQL_SaveDate(objParametri.FinestraTemporaleInizio) & " ")
                ...
                Case AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_JoinCompleta
                    ...
                    StrSQL.Length = 0
                    StrSQL.AppendLine("SELECT  LayerDataStruct.* ")
                    StrSQL.AppendLine("FROM GIS_LayerElementiGrafici_Anagrafica_DataStruct LayerDataStruct")
                    ...
                    StrSQL.AppendLine("    And g.Utente = '" & objParametri.UtenteUsername & "' ")
                    ...
                    StrSQL.AppendLine("AND LayerDataStruct.Validita_inizio < " & Agro_SQL_SaveDate(objParametri.FinestraTemporaleFine) & " ")
                    StrSQL.AppendLine("AND LayerDataStruct.Validita_Fine > " & Agro_SQL_SaveDate(objParametri.FinestraTemporaleInizio) & " ")
