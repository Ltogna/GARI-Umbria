    ...
    Public Function ElencoImpiantiInterferenzaSementi(
        ...
        If tResult Then
            ...
            Try
                ...
                stb.AppendLine("SET @x = '" & NewImp_PoligonoGML & "' ")
                ...
                stb.AppendLine("    Layers_Configurazione.Descrizione AS Referente, ")
                ...
                stb.AppendLine("INNER JOIN      Layers_Configurazione       ON Reg_Impianti.CODICE_FISCALE_TECNICO = Layers_Configurazione.CodiceCollegato ")
