...
#Region "Gestione della colorazione automatica"
    ...
    Private Sub LeggiXGetQuery_GeneraColoriAutomatici_InsertSTM_tiles(
        ...
        stb.Append("      '" & PivaSuperUser & "' as pivasuperuser  " & vbCrLf)
        stb.Append("    , " & xLayerElementiGrafici_Cod & " as LayerElementiGrafici_Cod  " & vbCrLf)
        stb.Append("    , '" & Utente & "' as utente  " & vbCrLf)
    ...
    ByRef stbInsert As System.Text.StringBuilder)
        ...
        stbInsert.Append("      '" & PivaSuperUser & "' as pivasuperuser  " & vbCrLf)
        stbInsert.Append("    , " & xLayerElementiGrafici_Cod & " as LayerElementiGrafici_Cod  " & vbCrLf)
        stbInsert.Append("    , '" & Utente & "' as utente  " & vbCrLf)
        ...
        Else
            stbInsert.Append("  , '" + xColore_Base + "' as colore_base " & vbCrLf)
        End If
    ...
    Private Sub LeggiXGetQuery_GeneraColoriAutomatici_InsertSTM(
        ...
        Select Case TipologiaLayer_cod
            ...
            Case enum_TipologiaLayer.SpecieVegetale
                stb.Append(", case when veg.veg_cod = " & _layerSpecialeCatasto & " then isnull( (select top 1 trasparenza from GIS_LayerElementiGrafici gg where gg.Utente = '" & Utente & "' and gg.TipologiaLayer_cod = 1 and gg.LayerElementiGrafici_Cod = 3), 0.6) else 0.6 end as Varianza " & vbCrLf)

            Case enum_TipologiaLayer.Cultivar
                stb.Append(", case when cul.cul_cod = " & _layerSpecialeCatasto & " then isnull( (select top 1 trasparenza from GIS_LayerElementiGrafici gg where gg.Utente = '" & Utente & "' and gg.TipologiaLayer_cod = 1 and gg.LayerElementiGrafici_Cod = 3), 0.6) else 0.6 end as Varianza " & vbCrLf)
...
#Region "Funzioni che colorano in automatico"
    ...
    Private Sub LeggiXGetQuery_GeneraColoriAutomatici_SpecieVegetali(ByVal PivaSuperUser As String, ByRef Utente As String, ByRef stb As System.Text.StringBuilder)
        ...
        stb1.Append("        and gl.Utente = '" & Utente & "' " & vbCrLf)
    ...
    Private Sub LeggiXGetQuery_GeneraColoriAutomatici_IndiciMaturitaTiles(
        ...
        stb1.Append("         and glt.Utente = '" & Utente & "' " & vbCrLf)
    ...
    Private Sub LeggiXGetQuery_GeneraColoriAutomatici_AvvTilesDes(
        ...
        stbFrom.Append("                                         and gl.utente = '" & Utente & "' " & vbCrLf)
        ...
        stbFrom.Append("                      and gltd.Utente = '" & Utente & "' " & vbCrLf)
    ...
    Private Sub LeggiXGetQuery_GeneraColoriAutomatici_StadiCrescita(
        ...
        stb1.AppendLine("       and gl.Utente = '" & Utente & "' ")
...
#End Region
    ...
    Public Function UpdateSuperUserOneShot(
        ...
        Try
            ...
            stb.Append("  SET    PivaSuperUser = '" & PivaSuperUser & "', Utente = '" & objParametri.SuperUserUsername & "' " & vbCrLf)
            ...
            stb.Append("    and    ii.PivaSuperUser = '" & PivaSuperUser & "' " & vbCrLf)
    ...
    Public Function RicopiaLayerDaAltroUtenteTipologia(
        ...
        Try
            ...
            '---------------------------------------------
            stb.Length = 0
            stb.AppendLine(" insert GIS_LayerElementiGrafici ")
            stb.AppendLine(" Select [PivaSuperUser], '" & Agro_SQL_SaveText(UtenteDestinazione) & "' As [Utente], [LayerElementiGrafici_Cod], [LayerElementiGrafici_Des], [Flag_Attivo], [Flag_Visibile], [Colore_Base], [Colore_Selezionato], [Colore_Primario], [Colore_Secondario], [Varianza], [TipologiaLayer_cod], [ZIndex], [Icona16], [Icona32], [inviato], [datainvio], [Data_Creazione], [Data_Modifica], [Username_Creazione], [Username_Modifica], [Validita_Inizio], [Validita_Fine], [trasparenza], [MostraDescrizioneAssociata] ")
            ...
            stb.AppendLine("     And ii.Utente = '" & UtenteDestinazione & "' ")
            stb.AppendLine(" )")
    ...
    Public Function RicopiaLayerTilesDaAltroUtenteTipologia(
        ...
        Try
            ...
            '---------------------------------------------
            stb.Length = 0
            stb.AppendLine(" insert GIS_LayerTiles ")
            stb.AppendLine(" Select [PivaSuperUser], [LayerElementiGrafici_Cod], '" & Agro_SQL_SaveText(UtenteDestinazione) & "' As [Utente],[LayerTiles_Cod], [LayerTiles_Des],  [Colore_Primario], [Colore_Secondario], [Colore_Base], [Varianza], [inviato], [datainvio], [Data_Creazione], [Data_Modifica], [Username_Creazione], [Username_Modifica], [Validita_Inizio], [Validita_Fine],  [TipologiaLayer_Cod] ")
    ...
    Public Function RicopiaLayerDaAltroUtenteTipologiaMultiplo(
        ...
        Try
            ...
            stb.AppendLine(" insert GIS_LayerElementiGrafici ")
            stb.AppendLine(" Select [PivaSuperUser], u.[UserName] As [Utente], ")
            ...
            stb.AppendLine(" From GIS_LayerElementiGrafici oo ")
            stb.AppendLine(" left join users u on 1=1 ")
            stb.AppendLine(" Where TipologiaLayer_cod = " & Agro_SQL_SaveNum(TipologiaLayer_cod))
            stb.AppendLine(" And Utente = '" & Agro_SQL_SaveText(UtenteOrigine) & "' ")
            stb.AppendLine(" And Not exists ( ")
            stb.AppendLine("     Select 1 ")
    ...
    Public Function RicopiaLayerTilesDaAltroUtenteTipologiaMultiplo(
        ...
        Try
            ...
            stb.AppendLine(" insert GIS_LayerTiles ")
            stb.AppendLine(" Select [PivaSuperUser], [LayerElementiGrafici_Cod], u.[UserName] As [Utente],  ")
            stb.AppendLine("   [LayerTiles_Cod], [LayerTiles_Des],  [Colore_Primario], [Colore_Secondario], [Colore_Base], [Varianza], ")
            stb.AppendLine("    oo.[inviato], oo.[datainvio], oo.[Data_Creazione], oo.[Data_Modifica], oo.[Username_Creazione], oo.[Username_Modifica], oo.[Validita_Inizio], oo.[Validita_Fine], ")
            stb.AppendLine("   [TipologiaLayer_Cod] ")
            stb.AppendLine(" From GIS_LayerTiles oo ")
            stb.AppendLine(" left join users u on 1=1 ")
            stb.AppendLine(" Where TipologiaLayer_cod = " & Agro_SQL_SaveNum(TipologiaLayer_cod))
            stb.AppendLine(" And Utente = '" & Agro_SQL_SaveText(UtenteOrigine) & "' ")
    ...
    Public Function Cancella(
        ...
        Try
            ...
            If objParametri.FlagCancellazioneLogica = AgronicaCoreDataProvider.AgronicaCoreParametri.enumCancellazioneLogica.CancellazioneLogica Then
                ...
                StrSQL.Length = 0
                StrSQL.Append(" UPDATE GIS_LayerElementiGrafici ")
                StrSQL.Append(" SET ")
                StrSQL.Append("      Username_Modifica = '" & Agro_SQL_SaveText(objParametri.UsernameOperazione) & "' ")
