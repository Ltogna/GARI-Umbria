...
Public Class GIS_LayerElementiGraficiXGruppiUtente_R
    ...
    Public Function Leggi(ByVal LayerCod As Integer,
        ...
        Try
            ...
            StrSQL.AppendLine("     [LayerElementiGrafici_Cod], perm.[Gruppi_Utente_cod] , [Flag_Inserimento], [Flag_Modifica] ")
            StrSQL.AppendLine("     ,[Flag_Cancellazione],[Flag_Informazioni],[Flag_Amministrazione] ")
