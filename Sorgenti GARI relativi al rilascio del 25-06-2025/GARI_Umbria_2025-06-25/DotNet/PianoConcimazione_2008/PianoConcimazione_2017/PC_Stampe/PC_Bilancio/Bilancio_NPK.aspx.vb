...
Public Class Bilancio_NPK
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsNothing(Request.QueryString("t")) Then
            ...
            Qs_AnalisiTestataCod = Stringa_Decodifica(Request.QueryString("t").ToString, _
        ...
        If Not IsNothing(Request.QueryString("n")) Then
            ...
            Qs_Key = Stringa_Decodifica(Request.QueryString("n").ToString, _
                                                AgroKey_EncoderDecoder, _
                                                Server)
        Else
            Qs_Key = ""
        ...
        Qs_PCTestataCod = Stringa_Decodifica(Request.QueryString("q").ToString, _
                                            AgroKey_EncoderDecoder, _
                                            Server)
