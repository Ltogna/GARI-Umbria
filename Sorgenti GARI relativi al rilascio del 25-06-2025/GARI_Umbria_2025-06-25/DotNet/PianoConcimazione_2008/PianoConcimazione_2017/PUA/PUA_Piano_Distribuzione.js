...
function PianoDistribuzione_onEdit(e) {
    ...
    // $("#txtNFertilizzazioniPrecedenti").prop("disabled", true).addClass(GIAS_K_STATE_DISABLED);
    KendoNumTB("txtNFertilizzazioniPrecedenti").enable(false);
    // $("#txtNFabbisogno").prop("disabled", true).addClass(GIAS_K_STATE_DISABLED);
    KendoNumTB("txtNFabbisogno").enable(false);
    ...
    // $("#txtResaRif").prop("disabled", true).addClass(GIAS_K_STATE_DISABLED);
    KendoNumTB("txtResaRif").enable(false);
    // $("#txtFattoreCorrettivoN").prop("disabled", true).addClass(GIAS_K_STATE_DISABLED);
    KendoNumTB("txtFattoreCorrettivoN").enable(false);
}
