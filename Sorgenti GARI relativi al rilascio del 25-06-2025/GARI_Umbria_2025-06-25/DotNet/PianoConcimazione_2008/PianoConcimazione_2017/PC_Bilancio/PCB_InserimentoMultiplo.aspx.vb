...
Public Class PCB_InserimentoMultiplo
    ...
    Private Sub Crea_Dt_Analisi(ByVal ListaPive As List(Of String), ByVal DataInizio As Date, ByVal DataFine As Date)
        ...
        Next
        If filtroPiva <> "" Then
            DtAnalisi = objAnalisi.LeggiConCertificati_Entita("", 0, 0, 0, DataInizio, DataFine, " piva IN (" & Left(filtroPiva, filtroPiva.Length - 1) & ")", "", objParametri_Server)
        End If
    ...
    Private Sub Aggrega_Griglia_Impianti()
        ...
        If Not IsNothing(Dt) Then
            ...
            If Not dtNew Is Nothing AndAlso dtNew.Rows.Count > 0 AndAlso
