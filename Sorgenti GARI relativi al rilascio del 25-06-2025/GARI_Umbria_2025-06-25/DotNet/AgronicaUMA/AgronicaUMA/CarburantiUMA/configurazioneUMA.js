...
function DateRendicontazione_controllaDati(e) {
    ...
    for (var j = 0; j < rows.length; j++) {
        ...
        if ((dataItem.Data_Fine_Blocco_Rendic_Conto_Proprio != null || dataItem.Data_Fine_Blocco_Rendic_Conto_Proprio != undefined) && dataItem.Data_Fine_Blocco_Rendic_Conto_Proprio.getFullYear() < 2100) {
