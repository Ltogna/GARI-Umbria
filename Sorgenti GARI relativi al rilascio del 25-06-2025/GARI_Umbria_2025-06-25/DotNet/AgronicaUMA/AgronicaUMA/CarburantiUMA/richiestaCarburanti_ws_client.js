...
function VerificaSuperficieAppezzamenti() {
    var parametri = {
        piva: $('#piva')[0].value,
        richiesta_cod: richiesta_cod,
    ...
    ajaxAgronicaSync(indirizzohttp + "/Verifica_Superficie_Appezzamenti",
        JSON.stringify(parametri),
        false,
        function (risposta) {
