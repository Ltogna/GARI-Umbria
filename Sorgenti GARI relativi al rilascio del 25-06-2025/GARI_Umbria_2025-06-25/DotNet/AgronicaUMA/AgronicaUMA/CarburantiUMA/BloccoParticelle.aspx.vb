...
#Region "script services Carica Griglia"
    ...
    Public Shared Function Leggi_Blocchi(ByVal piva As String,
        ...
        Try
            ...
            Dim Filtro_Visibilita_Utente = False
            ...
            r.RispostaStringa = JsonConvert.SerializeObject(IIf(dt.Rows.Count > 0, dt, dtTable_Pendenza), Formatting.None, serializerSettings)
            r.RispostaOK = True
