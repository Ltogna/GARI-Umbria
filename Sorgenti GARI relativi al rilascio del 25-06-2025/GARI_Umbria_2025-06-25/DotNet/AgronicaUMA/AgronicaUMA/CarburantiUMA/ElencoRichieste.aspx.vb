...
#Region "script services Carica Griglia"
    ...
    Public Shared Function Trova_Richieste(ByVal piva As String,
        ...
        If Sql_Permessi = "" OrElse nuovaVisibilita = True Then
    ...
    Private Shared Function OttieniLitriInEsubero(ByRef row As Object) As String
        ...
        If Not LitriInEsubero Then
            If (row.item("Acquistato_e_Rimanenza_Gasolio") > row.item("assegnato_gasolio") OrElse
                row.item("Acquistato_e_Rimanenza_Benzina") > row.item("assegnato_benzina") OrElse
                row.item("Acquistato_e_Rimanenza_Gasolio_Serra") > row.item("assegnato_gasolio_serra")) Then
                LitriInEsubero = True
            End If
        End If
